...
namespace Femto { namespace Reaktor {
  ...
  // 
  // *********************************************************
  void SQreaktor::binary_contract3(SQbinary &bin, string title, ofstream &f, string s, contDecl c, bool isBareLHS)
  {
    ...
    f <<  "\n"                                                                              ;     
    f <<  "!                  >> binary_contract3 subroutine is called <<                \n";
    f <<  "! ---------------------------- Parameters used -------------------------------\n" ;
    f <<  "!                                                                             \n" ;    
    ...
    for(vector<string>::iterator t = keys.begin();t != keys.end();++t){
      if(is_RDM(*t) || *t == "Fc1" || is_C4(*t) || is_C6(*t) || *t == C2_name()) printName2 += *t + "_, ";
