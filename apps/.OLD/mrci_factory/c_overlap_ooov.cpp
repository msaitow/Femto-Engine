...
#include <sci/ctnew2/c_overlap_ooov.h>                                            
...
orz::ct::BareAmpPack orz::ct::overlap_ooov(const orz::ct::Input &ctinp,                                    
  ...
  {
  // No.0
  //* O2(i,k,m,a)  <--  (    1.00000000) D3(i,m,k,o2,o1,o3) T2(o3,o2,o1,a) 
  for(int sa = 0;sa < nir;++sa){ 
  for(int ia = symblockinfo.psym()(sa,I_V,I_BEGIN);ia <= symblockinfo.psym()(sa,I_V,I_END);++ia){ 
    O2b = orz::DTensor(retval.namps_iamp()[ia]);
    T2b = T2.get_amp2(ia);
    FC_FUNC(g_if_overlap_ooov_no0_x0, G_IF_OVERLAP_OOOV_NO0_X0)
      (sa, ia, T2b.cptr(), O2b.cptr(), nir, nsym, psym);
    retval.acc_amp2(ia, O2b);
  }
  }
  }
  ...
  {
  // No.1
  //* O2(i,k,m,a)  <--  (    1.00000000) D2(i,o1,k,o2) T2(o1,o2,m,a) 
  for(int sa = 0;sa < nir;++sa){ 
  for(int ia = symblockinfo.psym()(sa,I_V,I_BEGIN);ia <= symblockinfo.psym()(sa,I_V,I_END);++ia){ 
    O2b = orz::DTensor(retval.namps_iamp()[ia]);
    T2b = T2.get_amp2(ia);
    FC_FUNC(g_if_overlap_ooov_no0_x1, G_IF_OVERLAP_OOOV_NO0_X1)
      (sa, ia, T2b.cptr(), O2b.cptr(), nir, nsym, psym);
    retval.acc_amp2(ia, O2b);
  }
  }
