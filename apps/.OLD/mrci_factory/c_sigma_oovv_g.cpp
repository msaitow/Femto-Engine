...
#include <sci/ctnew2/c_sigma_oovv_g.h>                                            
...
orz::ct::BareAmpPack orz::ct::sigma_oovv_g(const orz::ct::Input &ctinp,                                    
  ...
  {
  // No.0
  //* S2(i,k,a,c)  <--  (    1.00000000) T0 D2(i,o1,k,o2) V2(c,o2,o1,a) 
  ...
  for(int ic = symblockinfo.psym()(sc,I_V,I_BEGIN);ic <= symblockinfo.psym()(sc,I_V,I_END);++ic){ 
    ...
    FC_FUNC(g_if_sigma_oovv_g_no0_x0, G_IF_SIGMA_OOVV_G_NO0_X0)
