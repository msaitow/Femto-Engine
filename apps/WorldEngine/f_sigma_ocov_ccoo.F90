...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccoo_no0_x0_type1_eri_c &
  (sa0, ia0, sc0, ic0, T2, W0, nir, nsym, psym, flops)
...
call g_sigma_ocov_ccoo_no0_x0_type1_eri_c &
  (sa0, ia0, sc0, ic0, av2_i, Xcaaaa, d3, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaaaa)

end subroutine g_if_sigma_ocov_ccoo_no0_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccoo_no0_x0_type1_eri_c &
  (s_a0, i_a0, s_c0, i_c0, T2_, W0_, D3_, nir, nsym, psym, flops)
...
integer :: s_w, i_w, s_a1, i_a1, s_j, i_j, s_i, i_i, s_a3, i_a3
integer :: s_a2, i_a2
! W0(w,c0,j,a3,a2,i) += (    1.00000000) T2(w,c0,a1,a0) D3(j,i,a3,a1,a2,a0) 
do s_w = 0, nir-1
do s_a1 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
do s_a2 = 0, nir-1
if( &
IEOR(IEOR(s_w,s_c0),s_j) == IEOR(IEOR(s_a3,s_a2),s_i) .and. & 
IEOR(s_w,s_c0) == IEOR(s_a1,s_a0) .and. &
IEOR(IEOR(s_j,s_i),s_a3) == IEOR(IEOR(s_a1,s_a2),s_a0)) then

if(psym(I_LENGTH,I_O, s_j)*psym(I_LENGTH,I_O, s_i)*psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_a2) > 0 .and. &
...
call dgemm('n', 'n', psym(I_LENGTH,I_O, s_j)*psym(I_LENGTH,I_O, s_i)*psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_a2),&
                     psym(I_LENGTH,I_C, s_w),&
                     psym(I_LENGTH,I_O, s_a1),&
                     1.00000000d+00, &
                     Z1_,&
                     psym(I_LENGTH,I_O, s_j)*psym(I_LENGTH,I_O, s_i)*psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_a2),&
                     Z2_,&
                     psym(I_LENGTH,I_O, s_a1),&
                     0.0d+00,&
                     Z3_,&
...
! W0(w,c0,j,a3,a2,i)  <-- Z3
do i_w = psym(I_BEGIN, I_C, s_w), psym(I_END, I_C, s_w)
do i_j = psym(I_BEGIN, I_O, s_j), psym(I_END, I_O, s_j)
do i_a3 = psym(I_BEGIN, I_O, s_a3), psym(I_END, I_O, s_a3)
do i_a2 = psym(I_BEGIN, I_O, s_a2), psym(I_END, I_O, s_a2)
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
W0_(s_i, s_a2, s_a3, s_j, s_w)%array(i_i, i_a2, i_a3, i_j, i_w) = &
    W0_(s_i, s_a2, s_a3, s_j, s_w)%array(i_i, i_a2, i_a3, i_j, i_w) &
  + Z3_(i_j, i_i, i_a3, i_a2, i_w)
end do
end do
end do
end do
...
! Flop count
flops = flops + psym(I_LENGTH,I_O, s_j)*psym(I_LENGTH,I_O, s_i)*psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_a2) * &
                psym(I_LENGTH,I_C, s_w) * &
...
end subroutine g_sigma_ocov_ccoo_no0_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccoo_no0_x1_type1_eri_c &
  (sa, ia, sc0, ic0, V2, W0, S2, nir, nsym, psym, flops)
...
call g_sigma_ocov_ccoo_no0_x1_type1_eri_c &
  (sa, ia, sc0, ic0, h2_i, Xcaaaa, av2_i2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(h2_i)
deallocate(Xcaaaa)

end subroutine g_if_sigma_ocov_ccoo_no0_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccoo_no0_x1_type1_eri_c &
  (s_a, i_a, s_c0, i_c0, V2_, W0_, S2_, nir, nsym, psym, flops)
...
integer :: s_a2, i_a2, s_a3, i_a3, s_w, i_w, s_j, i_j, s_i, i_i
! S2(i,w,j,a) += (    2.00000000) V2(c0,a2,a3,a) W0(w,c0,j,a3,a2,i) 
do s_a2 = 0, nir-1
do s_a3 = 0, nir-1
do s_w = 0, nir-1
do s_j = 0, nir-1
...
IEOR(IEOR(s_w,s_c0),s_j) == IEOR(IEOR(s_a3,s_a2),s_i)) then
...
end subroutine g_sigma_ocov_ccoo_no0_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccoo_no0_x0_type1_eri_o &
  (sa, ia, sa0, ia0, V2, W7, nir, nsym, psym, flops)
...
call g_sigma_ocov_ccoo_no0_x0_type1_eri_o &
  (sa, ia, sa0, ia0, h2_i, Xca, d1, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xca)

end subroutine g_if_sigma_ocov_ccoo_no0_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccoo_no0_x0_type1_eri_o &
  (s_a, i_a, s_a0, i_a0, V2_, W7_, D1_, nir, nsym, psym, flops)
...
! W7(c0,i,a0,a) += (    1.00000000) V2(a0,c0,a1,a) D1(i,a1) 
do s_c0 = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
if( &
...
end subroutine g_sigma_ocov_ccoo_no0_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccoo_no0_x1_type1_eri_o &
  (sa, ia, sa0, ia0, T2, W7, S2, nir, nsym, psym, flops)
...
call set_symblock_Xca(sleft, W7, nir, nsym, psym) ! -> Xca (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ccoo_no0_x1_type1_eri_o &
  (sa, ia, sa0, ia0, av2_i, Xca, av2_i2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(av2_i)
deallocate(Xca)

end subroutine g_if_sigma_ocov_ccoo_no0_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccoo_no0_x1_type1_eri_o &
  (s_a, i_a, s_a0, i_a0, T2_, W7_, S2_, nir, nsym, psym, flops)
...
! S2(i,w,j,a) += (   -4.00000000) T2(w,c0,j,a0) W7(c0,i,a0,a) 
do s_w = 0, nir-1
do s_c0 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
if( &
IEOR(s_i,s_w) == IEOR(s_j,s_a) .and. & 
IEOR(s_w,s_c0) == IEOR(s_j,s_a0) .and. &
...
end subroutine g_sigma_ocov_ccoo_no0_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccoo_no1_x0_type1_eri_o &
  (sa, ia, sa0, ia0, V2, W8, nir, nsym, psym, flops)
...
call g_sigma_ocov_ccoo_no1_x0_type1_eri_o &
  (sa, ia, sa0, ia0, h2_i, Xca, d1, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xca)

end subroutine g_if_sigma_ocov_ccoo_no1_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccoo_no1_x0_type1_eri_o &
  (s_a, i_a, s_a0, i_a0, V2_, W8_, D1_, nir, nsym, psym, flops)
...
integer :: s_c0, i_c0, s_a1, i_a1, s_i, i_i
! W8(c0,i,a0,a) += (    1.00000000) V2(a0,c0,a1,a) D1(i,a1) 
do s_c0 = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
if( &
...
end subroutine g_sigma_ocov_ccoo_no1_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccoo_no1_x1_type1_eri_o &
  (sa, ia, sa0, ia0, T2, W8, S2, nir, nsym, psym, flops)
...
call set_symblock_Xca(sleft, W8, nir, nsym, psym) ! -> Xca (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ccoo_no1_x1_type1_eri_o &
  (sa, ia, sa0, ia0, av2_i, Xca, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ocov_ccoo_no1_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccoo_no1_x1_type1_eri_o &
  (s_a, i_a, s_a0, i_a0, T2_, W8_, S2_, nir, nsym, psym, flops)
...
! S2(i,w,j,a) += (    2.00000000) T2(c0,w,j,a0) W8(c0,i,a0,a) 
do s_c0 = 0, nir-1
do s_w = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
if( &
IEOR(s_i,s_w) == IEOR(s_j,s_a) .and. & 
IEOR(s_c0,s_w) == IEOR(s_j,s_a0) .and. &
IEOR(s_c0,s_i) == IEOR(s_a0,s_a)) then
...
end subroutine g_sigma_ocov_ccoo_no1_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccoo_no2_x0_type1_eri_o &
...
call g_sigma_ocov_ccoo_no2_x0_type1_eri_o &
  (sa, ia, sa1, ia1, h2_i, Xca, d1, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xca)

end subroutine g_if_sigma_ocov_ccoo_no2_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccoo_no2_x0_type1_eri_o &
  (s_a, i_a, s_a1, i_a1, V2_, W9_, D1_, nir, nsym, psym, flops)
...
! W9(c0,i,a1,a) += (    1.00000000) V2(a1,a,c0,a0) D1(i,a0) 
do s_c0 = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
if( &
IEOR(s_c0,s_i) == IEOR(s_a1,s_a) .and. & 
IEOR(s_a1,s_a) == IEOR(s_c0,s_a0) .and. &
...
end subroutine g_sigma_ocov_ccoo_no2_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccoo_no2_x1_type1_eri_o &
...
call set_symblock_Xca(sleft, W9, nir, nsym, psym) ! -> Xca (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ccoo_no2_x1_type1_eri_o &
  (sa, ia, sa1, ia1, av2_i, Xca, av2_i2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(av2_i)
deallocate(Xca)

end subroutine g_if_sigma_ocov_ccoo_no2_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccoo_no2_x1_type1_eri_o &
...
integer :: s_c0, i_c0, s_w, i_w, s_j, i_j, s_i, i_i
! S2(i,w,j,a) += (   -4.00000000) T2(c0,w,j,a1) W9(c0,i,a1,a) 
do s_c0 = 0, nir-1
do s_w = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
if( &
IEOR(s_i,s_w) == IEOR(s_j,s_a) .and. & 
IEOR(s_c0,s_w) == IEOR(s_j,s_a1) .and. &
...
end subroutine g_sigma_ocov_ccoo_no2_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccoo_no3_x0_type1_eri_o &
  (sa, ia, sa1, ia1, V2, W10, nir, nsym, psym, flops)
...
call g_sigma_ocov_ccoo_no3_x0_type1_eri_o &
  (sa, ia, sa1, ia1, h2_i, Xca, d1, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xca)

end subroutine g_if_sigma_ocov_ccoo_no3_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccoo_no3_x0_type1_eri_o &
  (s_a, i_a, s_a1, i_a1, V2_, W10_, D1_, nir, nsym, psym, flops)
...
integer :: s_c0, i_c0, s_a0, i_a0, s_i, i_i
! W10(c0,i,a1,a) += (    1.00000000) V2(a1,a,c0,a0) D1(i,a0) 
do s_c0 = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
if( &
...
end subroutine g_sigma_ocov_ccoo_no3_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccoo_no3_x1_type1_eri_o &
  (sa, ia, sa1, ia1, T2, W10, S2, nir, nsym, psym, flops)
...
call set_symblock_Xca(sleft, W10, nir, nsym, psym) ! -> Xca (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ccoo_no3_x1_type1_eri_o &
  (sa, ia, sa1, ia1, av2_i, Xca, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ocov_ccoo_no3_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccoo_no3_x1_type1_eri_o &
  (s_a, i_a, s_a1, i_a1, T2_, W10_, S2_, nir, nsym, psym, flops)
...
integer :: s_w, i_w, s_c0, i_c0, s_j, i_j, s_i, i_i
! S2(i,w,j,a) += (    2.00000000) T2(w,c0,j,a1) W10(c0,i,a1,a) 
do s_w = 0, nir-1
do s_c0 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ocov_ccoo_no3_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccoo_no0_x0_type1_eri_v &
  (sa, ia, sa0, ia0, V2, W1, nir, nsym, psym, flops)
...
call g_sigma_ocov_ccoo_no0_x0_type1_eri_v &
  (sa, ia, sa0, ia0, h2_i, Xca, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xca)

end subroutine g_if_sigma_ocov_ccoo_no0_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccoo_no0_x0_type1_eri_v &
  (s_a, i_a, s_a0, i_a0, V2_, W1_, D2_, nir, nsym, psym, flops)
...
integer :: s_a2, i_a2, s_c0, i_c0, s_a1, i_a1, s_i, i_i
! W1(c0,i,a0,a) += (    1.00000000) V2(a,a2,c0,a1) D2(i,a2,a0,a1) 
do s_a2 = 0, nir-1
do s_c0 = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ocov_ccoo_no0_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccoo_no0_x1_type1_eri_v &
  (sa, ia, sa0, ia0, T2, W1, S2, nir, nsym, psym, flops)
...
call set_symblock_Xca(sleft, W1, nir, nsym, psym) ! -> Xca (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ccoo_no0_x1_type1_eri_v &
  (sa, ia, sa0, ia0, av2_i, Xca, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ocov_ccoo_no0_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccoo_no0_x1_type1_eri_v &
  (s_a, i_a, s_a0, i_a0, T2_, W1_, S2_, nir, nsym, psym, flops)
...
integer :: s_w, i_w, s_c0, i_c0, s_j, i_j, s_i, i_i
! S2(i,w,j,a) += (    2.00000000) T2(w,c0,j,a0) W1(c0,i,a0,a) 
do s_w = 0, nir-1
do s_c0 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ocov_ccoo_no0_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccoo_no1_x0_type1_eri_v &
  (sa, ia, V2, W2, nir, nsym, psym, flops)
...
call g_sigma_ocov_ccoo_no1_x0_type1_eri_v &
  (sa, ia, h2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_ocov_ccoo_no1_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccoo_no1_x0_type1_eri_v &
  (s_a, i_a, V2_, W2_, D2_, nir, nsym, psym, flops)
...
! W2(c0,i,a0,a) += (    1.00000000) V2(a,a2,c0,a1) D2(i,a1,a0,a2) 
do s_a2 = 0, nir-1
do s_c0 = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
W2_(s_a0, s_i, s_c0)%array(i_a0, i_i, i_c0) = &
    W2_(s_a0, s_i, s_c0)%array(i_a0, i_i, i_c0) &
  + Z3_(i_i, i_a0, i_c0)
end do
end do
...
end subroutine g_sigma_ocov_ccoo_no1_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccoo_no1_x1_type1_eri_v &
  (sa, ia, sj, ij, T2, W2, S2, nir, nsym, psym, flops)
...
call set_symblock_Xcaa(sleft, W2, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ccoo_no1_x1_type1_eri_v &
...
end subroutine g_if_sigma_ocov_ccoo_no1_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccoo_no1_x1_type1_eri_v &
  (s_a, i_a, s_j, i_j, T2_, W2_, S2_, nir, nsym, psym, flops)
...
! S2(i,w,j,a) += (    2.00000000) T2(w,c0,a0,j) W2(c0,i,a0,a) 
do s_w = 0, nir-1
do s_c0 = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ocov_ccoo_no1_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccoo_no2_x0_type1_eri_v &
  (sa, ia, sa0, ia0, T2, V2, W3, nir, nsym, psym, flops)
...
call g_sigma_ocov_ccoo_no2_x0_type1_eri_v &
...
end subroutine g_if_sigma_ocov_ccoo_no2_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccoo_no2_x0_type1_eri_v &
  (s_a, i_a, s_a0, i_a0, T2_, V2_, W3_, nir, nsym, psym, flops)
...
! W3(w,a0,a2,a) += (    1.00000000) V2(a,a2,c0,a1) T2(w,c0,a1,a0) 
do s_a2 = 0, nir-1
do s_c0 = 0, nir-1
do s_a1 = 0, nir-1
do s_w = 0, nir-1
...
end subroutine g_sigma_ocov_ccoo_no2_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccoo_no2_x1_type1_eri_v &
  (sa, ia, sa0, ia0, W3, S2, nir, nsym, psym, flops)
...
call set_symblock_Xca(sleft, W3, nir, nsym, psym) ! -> Xca (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ccoo_no2_x1_type1_eri_v &
  (sa, ia, sa0, ia0, Xca, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xca)

end subroutine g_if_sigma_ocov_ccoo_no2_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccoo_no2_x1_type1_eri_v &
  (s_a, i_a, s_a0, i_a0, W3_, S2_, D2_, nir, nsym, psym, flops)
...
integer :: s_j, i_j, s_i, i_i, s_a2, i_a2, s_w, i_w
! S2(i,w,j,a) += (    2.00000000) D2(j,i,a2,a0) W3(w,a0,a2,a) 
do s_j = 0, nir-1
do s_i = 0, nir-1
do s_a2 = 0, nir-1
do s_w = 0, nir-1
if( &
IEOR(s_i,s_w) == IEOR(s_j,s_a) .and. & 
IEOR(s_j,s_i) == IEOR(s_a2,s_a0) .and. &
...
end subroutine g_sigma_ocov_ccoo_no2_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccoo_no3_x0_type1_eri_v &
  (sa, ia, sa1, ia1, T2, V2, W4, nir, nsym, psym, flops)
...
call g_sigma_ocov_ccoo_no3_x0_type1_eri_v &
...
end subroutine g_if_sigma_ocov_ccoo_no3_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccoo_no3_x0_type1_eri_v &
  (s_a, i_a, s_a1, i_a1, T2_, V2_, W4_, nir, nsym, psym, flops)
...
! W4(w,a0,a2,a) += (    1.00000000) V2(a,a2,c0,a1) T2(w,c0,a0,a1) 
do s_a2 = 0, nir-1
do s_c0 = 0, nir-1
do s_w = 0, nir-1
do s_a0 = 0, nir-1
...
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
do i_a2 = psym(I_BEGIN, I_O, s_a2), psym(I_END, I_O, s_a2)
W4_(s_a2, s_a0, s_w)%array(i_a2, i_a0, i_w) = &
    W4_(s_a2, s_a0, s_w)%array(i_a2, i_a0, i_w) &
  + Z3_(i_a2, i_w, i_a0)
end do
end do
...
end subroutine g_sigma_ocov_ccoo_no3_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccoo_no3_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W4, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ccoo_no3_x1_type1_eri_v &
  (sa, ia, Xcaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_ocov_ccoo_no3_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccoo_no3_x1_type1_eri_v &
  (s_a, i_a, W4_, S2_, D2_, nir, nsym, psym, flops)
...
integer :: s_j, i_j, s_i, i_i, s_a2, i_a2, s_a0, i_a0, s_w, i_w
! S2(i,w,j,a) += (   -4.00000000) D2(j,i,a2,a0) W4(w,a0,a2,a) 
do s_j = 0, nir-1
do s_i = 0, nir-1
do s_a2 = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_ocov_ccoo_no3_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccoo_no4_x0_type1_eri_v &
  (sa, ia, sa0, ia0, T2, V2, W5, nir, nsym, psym, flops)
...
call g_sigma_ocov_ccoo_no4_x0_type1_eri_v &
  (sa, ia, sa0, ia0, av2_i, h2_i, Xca, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ocov_ccoo_no4_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccoo_no4_x0_type1_eri_v &
  (s_a, i_a, s_a0, i_a0, T2_, V2_, W5_, nir, nsym, psym, flops)
...
integer :: s_a2, i_a2, s_c0, i_c0, s_a1, i_a1, s_w, i_w
! W5(w,a0,a1,a) += (    1.00000000) V2(a,a2,c0,a1) T2(w,c0,a2,a0) 
do s_a2 = 0, nir-1
do s_c0 = 0, nir-1
do s_a1 = 0, nir-1
do s_w = 0, nir-1
...
end subroutine g_sigma_ocov_ccoo_no4_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccoo_no4_x1_type1_eri_v &
  (sa, ia, sa0, ia0, W5, S2, nir, nsym, psym, flops)
...
call set_symblock_Xca(sleft, W5, nir, nsym, psym) ! -> Xca (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ccoo_no4_x1_type1_eri_v &
  (sa, ia, sa0, ia0, Xca, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xca)

end subroutine g_if_sigma_ocov_ccoo_no4_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccoo_no4_x1_type1_eri_v &
  (s_a, i_a, s_a0, i_a0, W5_, S2_, D2_, nir, nsym, psym, flops)
...
! S2(i,w,j,a) += (   -4.00000000) D2(j,i,a1,a0) W5(w,a0,a1,a) 
do s_j = 0, nir-1
do s_i = 0, nir-1
do s_a1 = 0, nir-1
do s_w = 0, nir-1
...
end subroutine g_sigma_ocov_ccoo_no4_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccoo_no5_x0_type1_eri_v &
...
call g_sigma_ocov_ccoo_no5_x0_type1_eri_v &
...
end subroutine g_if_sigma_ocov_ccoo_no5_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccoo_no5_x0_type1_eri_v &
...
! W6(w,a0,a1,a) += (    1.00000000) V2(a,a2,c0,a1) T2(w,c0,a0,a2) 
do s_c0 = 0, nir-1
do s_a1 = 0, nir-1
do s_w = 0, nir-1
do s_a0 = 0, nir-1
...
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
do i_a1 = psym(I_BEGIN, I_O, s_a1), psym(I_END, I_O, s_a1)
W6_(s_a1, s_a0, s_w)%array(i_a1, i_a0, i_w) = &
    W6_(s_a1, s_a0, s_w)%array(i_a1, i_a0, i_w) &
  + Z3_(i_a1, i_w, i_a0)
end do
end do
...
end subroutine g_sigma_ocov_ccoo_no5_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccoo_no5_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W6, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ccoo_no5_x1_type1_eri_v &
  (sa, ia, Xcaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_ocov_ccoo_no5_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccoo_no5_x1_type1_eri_v &
...
! S2(i,w,j,a) += (    2.00000000) D2(j,i,a1,a0) W6(w,a0,a1,a) 
do s_j = 0, nir-1
do s_i = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_ocov_ccoo_no5_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccoo_no6_x0_type1_eri_v &
  (sa, ia, sa0, ia0, T2, V2, W11, nir, nsym, psym, flops)
...
call g_sigma_ocov_ccoo_no6_x0_type1_eri_v &
...
end subroutine g_if_sigma_ocov_ccoo_no6_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccoo_no6_x0_type1_eri_v &
  (s_a, i_a, s_a0, i_a0, T2_, V2_, W11_, nir, nsym, psym, flops)
...
! W11(w,a) += (    1.00000000) V2(a,a1,c0,a0) T2(w,c0,a1,a0) 
do s_a1 = 0, nir-1
do s_c0 = 0, nir-1
do s_w = 0, nir-1
if( &
IEOR(s_w,s_a) == 0 .and. & 
IEOR(s_a,s_a1) == IEOR(s_c0,s_a0) .and. &
IEOR(s_w,s_c0) == IEOR(s_a1,s_a0)) then
...
end subroutine g_sigma_ocov_ccoo_no6_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccoo_no6_x1_type1_eri_v &
...
call set_symblock_Xc(sleft, W11, nir, nsym, psym) ! -> Xc (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ccoo_no6_x1_type1_eri_v &
  (sa, ia, Xc, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xc)

end subroutine g_if_sigma_ocov_ccoo_no6_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccoo_no6_x1_type1_eri_v &
...
! S2(i,w,j,a) += (    8.00000000) D1(j,i) W11(w,a) 
do s_j = 0, nir-1
do s_i = 0, nir-1
do s_w = 0, nir-1
if( &
...
end subroutine g_sigma_ocov_ccoo_no6_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccoo_no7_x0_type1_eri_v &
  (sa, ia, sa1, ia1, T2, V2, W12, nir, nsym, psym, flops)
...
call g_sigma_ocov_ccoo_no7_x0_type1_eri_v &
  (sa, ia, sa1, ia1, av2_i, h2_i, Xc, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(h2_i)
deallocate(Xc)

end subroutine g_if_sigma_ocov_ccoo_no7_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccoo_no7_x0_type1_eri_v &
  (s_a, i_a, s_a1, i_a1, T2_, V2_, W12_, nir, nsym, psym, flops)
...
! W12(w,a) += (    1.00000000) V2(a,a1,c0,a0) T2(w,c0,a0,a1) 
do s_c0 = 0, nir-1
do s_a0 = 0, nir-1
do s_w = 0, nir-1
if( &
...
end subroutine g_sigma_ocov_ccoo_no7_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccoo_no7_x1_type1_eri_v &
...
call set_symblock_Xc(sleft, W12, nir, nsym, psym) ! -> Xc (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ccoo_no7_x1_type1_eri_v &
  (sa, ia, Xc, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xc)

end subroutine g_if_sigma_ocov_ccoo_no7_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccoo_no7_x1_type1_eri_v &
...
integer :: s_j, i_j, s_i, i_i, s_w, i_w
! S2(i,w,j,a) += (   -4.00000000) D1(j,i) W12(w,a) 
do s_j = 0, nir-1
do s_i = 0, nir-1
do s_w = 0, nir-1
if( &
...
end subroutine g_sigma_ocov_ccoo_no7_x1_type1_eri_v
