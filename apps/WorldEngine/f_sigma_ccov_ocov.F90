...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no0_x0_type0_noeri &
...
call g_sigma_ccov_ocov_no0_x0_type0_noeri &
  (sa, ia, av2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_ccov_ocov_no0_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no0_x0_type0_noeri &
...
! W0(x,i,a2,a) += (    1.00000000) T2(a1,x,a0,a) D2(i,a2,a1,a0) 
do s_a1 = 0, nir-1
do s_x = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
...
IEOR(s_a1,s_x) == IEOR(s_a0,s_a) .and. &
...
end subroutine g_sigma_ccov_ocov_no0_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no0_x1_type0_noeri &
...
call g_sigma_ccov_ocov_no0_x1_type0_noeri &
  (sa, ia, Xcaa, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_ccov_ocov_no0_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no0_x1_type0_noeri &
...
! S2(w,x,i,a) += (   -2.00000000) Fc1(w,a2) W0(x,i,a2,a) 
do s_w = 0, nir-1
do s_a2 = 0, nir-1
do s_x = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ccov_ocov_no0_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no1_x0_type0_noeri &
...
call g_sigma_ccov_ocov_no1_x0_type0_noeri &
  (sa, ia, av2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_ccov_ocov_no1_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no1_x0_type0_noeri &
...
! W1(w,i,a2,a) += (    1.00000000) T2(a1,w,a0,a) D2(i,a2,a1,a0) 
do s_a1 = 0, nir-1
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ccov_ocov_no1_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no1_x1_type0_noeri &
...
call set_symblock_Xcaa(sleft, W1, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccov_ocov_no1_x1_type0_noeri &
  (sa, ia, Xcaa, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_ccov_ocov_no1_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no1_x1_type0_noeri &
...
end subroutine g_sigma_ccov_ocov_no1_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no2_x0_type0_noeri &
...
call g_sigma_ccov_ocov_no2_x0_type0_noeri &
  (sa, ia, av2_i, Xc, d1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xc)

end subroutine g_if_sigma_ccov_ocov_no2_x0_type0_noeri
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no2_x0_type0_noeri &
...
! W2(x,a) += (    1.00000000) T2(a1,x,a0,a) D1(a1,a0) 
do s_a1 = 0, nir-1
do s_x = 0, nir-1
do s_a0 = 0, nir-1
if( &
...
end subroutine g_sigma_ccov_ocov_no2_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no2_x1_type0_noeri &
...
call set_symblock_Xc(sleft, W2, nir, nsym, psym) ! -> Xc (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccov_ocov_no2_x1_type0_noeri &
  (sa, ia, Xc, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xc)

end subroutine g_if_sigma_ccov_ocov_no2_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no2_x1_type0_noeri &
...
! S2(w,x,i,a) += (    4.00000000) Fc1(w,i) W2(x,a) 
do s_w = 0, nir-1
do s_i = 0, nir-1
do s_x = 0, nir-1
if( &
...
end subroutine g_sigma_ccov_ocov_no2_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no3_x0_type0_noeri &
...
call g_sigma_ccov_ocov_no3_x0_type0_noeri &
  (sa, ia, av2_i, Xc, d1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xc)

end subroutine g_if_sigma_ccov_ocov_no3_x0_type0_noeri
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no3_x0_type0_noeri &
...
! W3(w,a) += (    1.00000000) T2(a1,w,a0,a) D1(a1,a0) 
do s_a1 = 0, nir-1
do s_w = 0, nir-1
do s_a0 = 0, nir-1
if( &
...
end subroutine g_sigma_ccov_ocov_no3_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no3_x1_type0_noeri &
...
call set_symblock_Xc(sleft, W3, nir, nsym, psym) ! -> Xc (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccov_ocov_no3_x1_type0_noeri &
  (sa, ia, Xc, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xc)

end subroutine g_if_sigma_ccov_ocov_no3_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no3_x1_type0_noeri &
...
! S2(w,x,i,a) += (   -2.00000000) Fc1(x,i) W3(w,a) 
do s_x = 0, nir-1
do s_i = 0, nir-1
do s_w = 0, nir-1
if( &
...
end subroutine g_sigma_ccov_ocov_no3_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no4_x0_type0_noeri &
...
call g_sigma_ccov_ocov_no4_x0_type0_noeri &
  (Xca, d1, fc1, nir, nsym, psym, flops)

deallocate(Xca)

end subroutine g_if_sigma_ccov_ocov_no4_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no4_x0_type0_noeri &
...
end subroutine g_sigma_ccov_ocov_no4_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no4_x1_type0_noeri &
...
call set_symblock_Xca(sleft, W4, nir, nsym, psym) ! -> Xca (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccov_ocov_no4_x1_type0_noeri &
...
end subroutine g_if_sigma_ccov_ocov_no4_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no4_x1_type0_noeri &
...
! S2(w,x,i,a) += (   -2.00000000) T2(a0,x,i,a) W4(w,a0) 
do s_a0 = 0, nir-1
do s_x = 0, nir-1
do s_i = 0, nir-1
do s_w = 0, nir-1
if( &
IEOR(s_w,s_x) == IEOR(s_i,s_a) .and. & 
IEOR(s_a0,s_x) == IEOR(s_i,s_a) .and. &
...
end subroutine g_sigma_ccov_ocov_no4_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no5_x0_type0_noeri &
...
call g_sigma_ccov_ocov_no5_x0_type0_noeri &
  (Xca, d1, fc1, nir, nsym, psym, flops)

deallocate(Xca)

end subroutine g_if_sigma_ccov_ocov_no5_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no5_x0_type0_noeri &
...
end subroutine g_sigma_ccov_ocov_no5_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no5_x1_type0_noeri &
...
call set_symblock_Xca(sleft, W5, nir, nsym, psym) ! -> Xca (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccov_ocov_no5_x1_type0_noeri &
  (sa, ia, av2_i, Xca, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccov_ocov_no5_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no5_x1_type0_noeri &
...
! S2(w,x,i,a) += (    1.00000000) T2(a0,w,i,a) W5(x,a0) 
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_i = 0, nir-1
do s_x = 0, nir-1
if( &
IEOR(s_w,s_x) == IEOR(s_i,s_a) .and. & 
IEOR(s_a0,s_w) == IEOR(s_i,s_a) .and. &
...
end subroutine g_sigma_ccov_ocov_no5_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no0_x0_type1_eri_c &
  (sa, ia, sc0, ic0, T2, W6, nir, nsym, psym, flops)
...
call g_sigma_ccov_ocov_no0_x0_type1_eri_c &
  (sa, ia, sc0, ic0, av2_i, Xaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xaa)

end subroutine g_if_sigma_ccov_ocov_no0_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no0_x0_type1_eri_c &
  (s_a, i_a, s_c0, i_c0, T2_, W6_, D2_, nir, nsym, psym, flops)
...
! W6(c0,i,a2,a) += (    1.00000000) T2(a1,c0,a0,a) D2(i,a2,a1,a0) 
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
do s_a2 = 0, nir-1
...
end subroutine g_sigma_ccov_ocov_no0_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no0_x1_type1_eri_c &
  (sa, ia, sc0, ic0, V2, W6, S2, nir, nsym, psym, flops)
...
call set_symblock_Xaa(sleft, W6, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccov_ocov_no0_x1_type1_eri_c &
...
end subroutine g_if_sigma_ccov_ocov_no0_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no0_x1_type1_eri_c &
  (s_a, i_a, s_c0, i_c0, V2_, W6_, S2_, nir, nsym, psym, flops)
...
! S2(w,x,i,a) += (    2.00000000) V2(c0,x,w,a2) W6(c0,i,a2,a) 
do s_x = 0, nir-1
do s_w = 0, nir-1
do s_a2 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ccov_ocov_no0_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no1_x0_type1_eri_c &
...
call g_sigma_ccov_ocov_no1_x0_type1_eri_c &
  (sw, iw, h2_i, Xaaa, d3, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_ccov_ocov_no1_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no1_x0_type1_eri_c &
  (s_w, i_w, V2_, W8_, D3_, nir, nsym, psym, flops)
...
integer :: s_a0, i_a0
! W8(w,i,a1,a0) += (    1.00000000) V2(w,a3,a4,a2) D3(i,a3,a4,a2,a1,a0) 
do s_a3 = 0, nir-1
do s_a4 = 0, nir-1
do s_a2 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ccov_ocov_no1_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no1_x1_type1_eri_c &
...
call set_symblock_Xaaa(sleft, W8, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccov_ocov_no1_x1_type1_eri_c &
...
end subroutine g_if_sigma_ccov_ocov_no1_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no1_x1_type1_eri_c &
...
integer :: s_a1, i_a1, s_x, i_x, s_a0, i_a0, s_i, i_i
! S2(w,x,i,a) += (   -2.00000000) T2(a1,x,a0,a) W8(w,i,a1,a0) 
do s_a1 = 0, nir-1
do s_x = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ccov_ocov_no1_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no2_x0_type1_eri_c &
...
call g_sigma_ccov_ocov_no2_x0_type1_eri_c &
  (sx, ix, h2_i, Xaaa, d3, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_ccov_ocov_no2_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no2_x0_type1_eri_c &
  (s_x, i_x, V2_, W9_, D3_, nir, nsym, psym, flops)
...
integer :: s_a3, i_a3, s_a4, i_a4, s_a2, i_a2, s_i, i_i, s_a1, i_a1
integer :: s_a0, i_a0
! W9(x,i,a1,a0) += (    1.00000000) V2(x,a3,a4,a2) D3(i,a3,a4,a2,a1,a0) 
do s_a3 = 0, nir-1
do s_a4 = 0, nir-1
do s_a2 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ccov_ocov_no2_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no2_x1_type1_eri_c &
...
call set_symblock_Xaaa(sleft, W9, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccov_ocov_no2_x1_type1_eri_c &
...
end subroutine g_if_sigma_ccov_ocov_no2_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no2_x1_type1_eri_c &
...
! S2(w,x,i,a) += (    1.00000000) T2(a1,w,a0,a) W9(x,i,a1,a0) 
do s_a1 = 0, nir-1
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ccov_ocov_no2_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no3_x0_type1_eri_c &
...
call g_sigma_ccov_ocov_no3_x0_type1_eri_c &
  (sa, ia, sc0, ic0, av2_i, W10, d1, nir, nsym, psym, flops)

deallocate(av2_i)

end subroutine g_if_sigma_ccov_ocov_no3_x0_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no3_x0_type1_eri_c &
...
! W10(c0,a) += (    1.00000000) T2(a1,c0,a0,a) D1(a1,a0) 
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
if( &
IEOR(s_c0,s_a) == 0 .and. & 
...
end subroutine g_sigma_ccov_ocov_no3_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no3_x1_type1_eri_c &
...
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccov_ocov_no3_x1_type1_eri_c &
  (sa, ia, sc0, ic0, h2_i, W10, av2_i2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(h2_i)

end subroutine g_if_sigma_ccov_ocov_no3_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no3_x1_type1_eri_c &
...
! S2(w,x,i,a) += (   -4.00000000) V2(c0,x,w,i) W10(c0,a) 
do s_x = 0, nir-1
do s_w = 0, nir-1
do s_i = 0, nir-1
if( &
...
end subroutine g_sigma_ccov_ocov_no3_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no4_x0_type1_eri_c &
...
call g_sigma_ccov_ocov_no4_x0_type1_eri_c &
  (sa, ia, sc0, ic0, av2_i, W11, d1, nir, nsym, psym, flops)

deallocate(av2_i)

end subroutine g_if_sigma_ccov_ocov_no4_x0_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no4_x0_type1_eri_c &
...
integer :: s_a1, i_a1, s_a0, i_a0
! W11(c0,a) += (    1.00000000) T2(a1,c0,a0,a) D1(a1,a0) 
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
if( &
IEOR(s_c0,s_a) == 0 .and. & 
...
end subroutine g_sigma_ccov_ocov_no4_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no4_x1_type1_eri_c &
...
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccov_ocov_no4_x1_type1_eri_c &
  (sa, ia, sc0, ic0, h2_i, W11, av2_i2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(h2_i)

end subroutine g_if_sigma_ccov_ocov_no4_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no4_x1_type1_eri_c &
...
! S2(w,x,i,a) += (    2.00000000) V2(c0,w,x,i) W11(c0,a) 
do s_w = 0, nir-1
do s_x = 0, nir-1
do s_i = 0, nir-1
if( &
...
end subroutine g_sigma_ccov_ocov_no4_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no5_x0_type1_eri_c &
...
call g_sigma_ccov_ocov_no5_x0_type1_eri_c &
  (sw, iw, h2_i, Xaaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_ccov_ocov_no5_x0_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no5_x0_type1_eri_c &
...
! W12(w,a1,a0,i) += (    1.00000000) V2(w,i,a3,a2) D2(a3,a2,a1,a0) 
do s_i = 0, nir-1
do s_a3 = 0, nir-1
do s_a2 = 0, nir-1
do s_a1 = 0, nir-1
...
end subroutine g_sigma_ccov_ocov_no5_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no5_x1_type1_eri_c &
...
call set_symblock_Xaaa(sleft, W12, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccov_ocov_no5_x1_type1_eri_c &
  (sa, ia, sw, iw, av2_i, Xaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccov_ocov_no5_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no5_x1_type1_eri_c &
...
integer :: s_a1, i_a1, s_x, i_x, s_a0, i_a0, s_i, i_i
! S2(w,x,i,a) += (    4.00000000) T2(a1,x,a0,a) W12(w,a1,a0,i) 
do s_a1 = 0, nir-1
do s_x = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ccov_ocov_no5_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no6_x0_type1_eri_c &
  (sx, ix, V2, W13, nir, nsym, psym, flops)
...
call g_sigma_ccov_ocov_no6_x0_type1_eri_c &
  (sx, ix, h2_i, Xaaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_ccov_ocov_no6_x0_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no6_x0_type1_eri_c &
  (s_x, i_x, V2_, W13_, D2_, nir, nsym, psym, flops)
...
integer :: s_i, i_i, s_a3, i_a3, s_a2, i_a2, s_a1, i_a1, s_a0, i_a0
! W13(x,a1,a0,i) += (    1.00000000) V2(x,i,a3,a2) D2(a3,a2,a1,a0) 
do s_i = 0, nir-1
do s_a3 = 0, nir-1
do s_a2 = 0, nir-1
do s_a1 = 0, nir-1
...
end subroutine g_sigma_ccov_ocov_no6_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no6_x1_type1_eri_c &
  (sa, ia, sx, ix, T2, W13, S2, nir, nsym, psym, flops)
...
call set_symblock_Xaaa(sleft, W13, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccov_ocov_no6_x1_type1_eri_c &
  (sa, ia, sx, ix, av2_i, Xaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccov_ocov_no6_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no6_x1_type1_eri_c &
  (s_a, i_a, s_x, i_x, T2_, W13_, S2_, nir, nsym, psym, flops)
...
integer :: s_a1, i_a1, s_w, i_w, s_a0, i_a0, s_i, i_i
! S2(w,x,i,a) += (   -2.00000000) T2(a1,w,a0,a) W13(x,a1,a0,i) 
do s_a1 = 0, nir-1
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ccov_ocov_no6_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no7_x0_type1_eri_c &
...
call g_sigma_ccov_ocov_no7_x0_type1_eri_c &
  (sw, iw, h2_i, Xaaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_ccov_ocov_no7_x0_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no7_x0_type1_eri_c &
...
! W14(w,a1,a0,i) += (    1.00000000) V2(w,a3,i,a2) D2(a3,a2,a1,a0) 
do s_a3 = 0, nir-1
do s_i = 0, nir-1
do s_a2 = 0, nir-1
do s_a1 = 0, nir-1
...
end subroutine g_sigma_ccov_ocov_no7_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no7_x1_type1_eri_c &
...
call set_symblock_Xaaa(sleft, W14, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccov_ocov_no7_x1_type1_eri_c &
  (sa, ia, sw, iw, av2_i, Xaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccov_ocov_no7_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no7_x1_type1_eri_c &
...
integer :: s_a0, i_a0, s_x, i_x, s_a1, i_a1, s_i, i_i
! S2(w,x,i,a) += (   -2.00000000) T2(a0,x,a1,a) W14(w,a1,a0,i) 
do s_a0 = 0, nir-1
do s_x = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
if( &
IEOR(s_w,s_x) == IEOR(s_i,s_a) .and. & 
IEOR(s_a0,s_x) == IEOR(s_a1,s_a) .and. &
IEOR(s_w,s_a1) == IEOR(s_a0,s_i)) then
...
end subroutine g_sigma_ccov_ocov_no7_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no8_x0_type1_eri_c &
  (sx, ix, V2, W15, nir, nsym, psym, flops)
...
call g_sigma_ccov_ocov_no8_x0_type1_eri_c &
  (sx, ix, h2_i, Xaaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_ccov_ocov_no8_x0_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no8_x0_type1_eri_c &
  (s_x, i_x, V2_, W15_, D2_, nir, nsym, psym, flops)
...
integer :: s_a3, i_a3, s_i, i_i, s_a2, i_a2, s_a1, i_a1, s_a0, i_a0
! W15(x,a1,a0,i) += (    1.00000000) V2(x,a3,i,a2) D2(a3,a2,a1,a0) 
do s_a3 = 0, nir-1
do s_i = 0, nir-1
do s_a2 = 0, nir-1
do s_a1 = 0, nir-1
...
end subroutine g_sigma_ccov_ocov_no8_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no8_x1_type1_eri_c &
  (sa, ia, sx, ix, T2, W15, S2, nir, nsym, psym, flops)
...
call set_symblock_Xaaa(sleft, W15, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccov_ocov_no8_x1_type1_eri_c &
  (sa, ia, sx, ix, av2_i, Xaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccov_ocov_no8_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no8_x1_type1_eri_c &
  (s_a, i_a, s_x, i_x, T2_, W15_, S2_, nir, nsym, psym, flops)
...
! S2(w,x,i,a) += (    1.00000000) T2(a0,w,a1,a) W15(x,a1,a0,i) 
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ccov_ocov_no8_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no9_x0_type1_eri_c &
...
call g_sigma_ccov_ocov_no9_x0_type1_eri_c &
  (sx, ix, h2_i, Xcca, d1, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xcca)

end subroutine g_if_sigma_ccov_ocov_no9_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no9_x0_type1_eri_c &
...
end subroutine g_sigma_ccov_ocov_no9_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no9_x1_type1_eri_c &
...
call set_symblock_Xcca(sleft, W16, nir, nsym, psym) ! -> Xcca (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccov_ocov_no9_x1_type1_eri_c &
...
end subroutine g_if_sigma_ccov_ocov_no9_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no9_x1_type1_eri_c &
...
integer :: s_a0, i_a0, s_c0, i_c0, s_i, i_i, s_w, i_w
! S2(w,x,i,a) += (    2.00000000) T2(a0,c0,i,a) W16(x,w,c0,a0) 
do s_a0 = 0, nir-1
do s_c0 = 0, nir-1
do s_i = 0, nir-1
do s_w = 0, nir-1
if( &
IEOR(s_w,s_x) == IEOR(s_i,s_a) .and. & 
IEOR(s_a0,s_c0) == IEOR(s_i,s_a) .and. &
...
end subroutine g_sigma_ccov_ocov_no9_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no10_x0_type1_eri_c &
...
call g_sigma_ccov_ocov_no10_x0_type1_eri_c &
  (sx, ix, h2_i, Xcca, d1, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xcca)

end subroutine g_if_sigma_ccov_ocov_no10_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no10_x0_type1_eri_c &
...
end subroutine g_sigma_ccov_ocov_no10_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no10_x1_type1_eri_c &
...
call set_symblock_Xcca(sleft, W17, nir, nsym, psym) ! -> Xcca (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccov_ocov_no10_x1_type1_eri_c &
  (sa, ia, sx, ix, av2_i, Xcca, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccov_ocov_no10_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no10_x1_type1_eri_c &
...
integer :: s_a0, i_a0, s_c0, i_c0, s_i, i_i, s_w, i_w
! S2(w,x,i,a) += (   -1.00000000) T2(a0,c0,i,a) W17(x,w,c0,a0) 
do s_a0 = 0, nir-1
do s_c0 = 0, nir-1
do s_i = 0, nir-1
do s_w = 0, nir-1
...
end subroutine g_sigma_ccov_ocov_no10_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no11_x0_type1_eri_c &
...
call g_sigma_ccov_ocov_no11_x0_type1_eri_c &
  (sw, iw, h2_i, Xa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xa)

end subroutine g_if_sigma_ccov_ocov_no11_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no11_x0_type1_eri_c &
...
end subroutine g_sigma_ccov_ocov_no11_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no11_x1_type1_eri_c &
...
call set_symblock_Xa(sleft, W18, nir, nsym, psym) ! -> Xa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccov_ocov_no11_x1_type1_eri_c &
...
end subroutine g_if_sigma_ccov_ocov_no11_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no11_x1_type1_eri_c &
...
integer :: s_a0, i_a0, s_x, i_x, s_i, i_i
! S2(w,x,i,a) += (   -2.00000000) T2(a0,x,i,a) W18(w,a0) 
do s_a0 = 0, nir-1
do s_x = 0, nir-1
do s_i = 0, nir-1
if( &
...
end subroutine g_sigma_ccov_ocov_no11_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no12_x0_type1_eri_c &
...
call g_sigma_ccov_ocov_no12_x0_type1_eri_c &
  (sx, ix, h2_i, Xa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xa)

end subroutine g_if_sigma_ccov_ocov_no12_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no12_x0_type1_eri_c &
...
end subroutine g_sigma_ccov_ocov_no12_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no12_x1_type1_eri_c &
...
call set_symblock_Xa(sleft, W19, nir, nsym, psym) ! -> Xa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccov_ocov_no12_x1_type1_eri_c &
...
end subroutine g_if_sigma_ccov_ocov_no12_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no12_x1_type1_eri_c &
...
! S2(w,x,i,a) += (    1.00000000) T2(a0,w,i,a) W19(x,a0) 
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_i = 0, nir-1
if( &
...
end subroutine g_sigma_ccov_ocov_no12_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no13_x0_type1_eri_c &
...
call g_sigma_ccov_ocov_no13_x0_type1_eri_c &
  (sw, iw, h2_i, Xaaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_ccov_ocov_no13_x0_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no13_x0_type1_eri_c &
  (s_w, i_w, V2_, W20_, D2_, nir, nsym, psym, flops)
...
! W20(w,i,a0,a1) += (    1.00000000) V2(w,a2,a3,a1) D2(i,a2,a0,a3) 
do s_a2 = 0, nir-1
do s_a3 = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ccov_ocov_no13_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no13_x1_type1_eri_c &
  (sa, ia, sw, iw, T2, W20, S2, nir, nsym, psym, flops)
...
call set_symblock_Xaaa(sleft, W20, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccov_ocov_no13_x1_type1_eri_c &
  (sa, ia, sw, iw, av2_i, Xaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccov_ocov_no13_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no13_x1_type1_eri_c &
  (s_a, i_a, s_w, i_w, T2_, W20_, S2_, nir, nsym, psym, flops)
...
integer :: s_a0, i_a0, s_x, i_x, s_a1, i_a1, s_i, i_i
! S2(w,x,i,a) += (   -2.00000000) T2(a0,x,a1,a) W20(w,i,a0,a1) 
do s_a0 = 0, nir-1
do s_x = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ccov_ocov_no13_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no14_x0_type1_eri_c &
...
call g_sigma_ccov_ocov_no14_x0_type1_eri_c &
  (sx, ix, h2_i, Xaaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_ccov_ocov_no14_x0_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no14_x0_type1_eri_c &
  (s_x, i_x, V2_, W21_, D2_, nir, nsym, psym, flops)
...
integer :: s_a2, i_a2, s_a3, i_a3, s_a1, i_a1, s_i, i_i, s_a0, i_a0
! W21(x,i,a0,a1) += (    1.00000000) V2(x,a2,a3,a1) D2(i,a2,a0,a3) 
do s_a2 = 0, nir-1
do s_a3 = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ccov_ocov_no14_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no14_x1_type1_eri_c &
  (sa, ia, sx, ix, T2, W21, S2, nir, nsym, psym, flops)
...
call set_symblock_Xaaa(sleft, W21, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccov_ocov_no14_x1_type1_eri_c &
  (sa, ia, sx, ix, av2_i, Xaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccov_ocov_no14_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no14_x1_type1_eri_c &
  (s_a, i_a, s_x, i_x, T2_, W21_, S2_, nir, nsym, psym, flops)
...
integer :: s_a0, i_a0, s_w, i_w, s_a1, i_a1, s_i, i_i
! S2(w,x,i,a) += (    1.00000000) T2(a0,w,a1,a) W21(x,i,a0,a1) 
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ccov_ocov_no14_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no15_x0_type1_eri_c &
...
call g_sigma_ccov_ocov_no15_x0_type1_eri_c &
  (sw, iw, h2_i, Xaaa, d1, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_ccov_ocov_no15_x0_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no15_x0_type1_eri_c &
...
! W22(w,a0,i,a1) += (    1.00000000) V2(w,i,a2,a1) D1(a2,a0) 
do s_i = 0, nir-1
do s_a2 = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_ccov_ocov_no15_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no15_x1_type1_eri_c &
  (sa, ia, sw, iw, T2, W22, S2, nir, nsym, psym, flops)
...
call set_symblock_Xaaa(sleft, W22, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccov_ocov_no15_x1_type1_eri_c &
  (sa, ia, sw, iw, av2_i, Xaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccov_ocov_no15_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no15_x1_type1_eri_c &
  (s_a, i_a, s_w, i_w, T2_, W22_, S2_, nir, nsym, psym, flops)
...
integer :: s_a0, i_a0, s_x, i_x, s_a1, i_a1, s_i, i_i
! S2(w,x,i,a) += (    4.00000000) T2(a0,x,a1,a) W22(w,a0,i,a1) 
do s_a0 = 0, nir-1
do s_x = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ccov_ocov_no15_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no16_x0_type1_eri_c &
...
call g_sigma_ccov_ocov_no16_x0_type1_eri_c &
  (sx, ix, h2_i, Xaaa, d1, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_ccov_ocov_no16_x0_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no16_x0_type1_eri_c &
...
integer :: s_i, i_i, s_a2, i_a2, s_a1, i_a1, s_a0, i_a0
! W23(x,a0,i,a1) += (    1.00000000) V2(x,i,a2,a1) D1(a2,a0) 
do s_i = 0, nir-1
do s_a2 = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_ccov_ocov_no16_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no16_x1_type1_eri_c &
  (sa, ia, sx, ix, T2, W23, S2, nir, nsym, psym, flops)
...
call set_symblock_Xaaa(sleft, W23, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccov_ocov_no16_x1_type1_eri_c &
  (sa, ia, sx, ix, av2_i, Xaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccov_ocov_no16_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no16_x1_type1_eri_c &
  (s_a, i_a, s_x, i_x, T2_, W23_, S2_, nir, nsym, psym, flops)
...
integer :: s_a0, i_a0, s_w, i_w, s_a1, i_a1, s_i, i_i
! S2(w,x,i,a) += (   -2.00000000) T2(a0,w,a1,a) W23(x,a0,i,a1) 
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ccov_ocov_no16_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no17_x0_type1_eri_c &
...
call g_sigma_ccov_ocov_no17_x0_type1_eri_c &
  (sw, iw, h2_i, Xaaa, d1, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_ccov_ocov_no17_x0_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no17_x0_type1_eri_c &
...
end subroutine g_sigma_ccov_ocov_no17_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no17_x1_type1_eri_c &
...
call set_symblock_Xaaa(sleft, W24, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccov_ocov_no17_x1_type1_eri_c &
  (sa, ia, sw, iw, av2_i, Xaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccov_ocov_no17_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no17_x1_type1_eri_c &
...
integer :: s_a0, i_a0, s_x, i_x, s_a1, i_a1, s_i, i_i
! S2(w,x,i,a) += (   -2.00000000) T2(a0,x,a1,a) W24(w,a0,i,a1) 
do s_a0 = 0, nir-1
do s_x = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ccov_ocov_no17_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no18_x0_type1_eri_c &
...
call g_sigma_ccov_ocov_no18_x0_type1_eri_c &
  (sx, ix, h2_i, Xaaa, d1, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_ccov_ocov_no18_x0_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no18_x0_type1_eri_c &
...
end subroutine g_sigma_ccov_ocov_no18_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no18_x1_type1_eri_c &
...
call set_symblock_Xaaa(sleft, W25, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccov_ocov_no18_x1_type1_eri_c &
  (sa, ia, sx, ix, av2_i, Xaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccov_ocov_no18_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no18_x1_type1_eri_c &
...
integer :: s_a0, i_a0, s_w, i_w, s_a1, i_a1, s_i, i_i
! S2(w,x,i,a) += (    1.00000000) T2(a0,w,a1,a) W25(x,a0,i,a1) 
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ccov_ocov_no18_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no0_x0_type1_eri_o &
...
call g_sigma_ccov_ocov_no0_x0_type1_eri_o &
  (sa, ia, sa2, ia2, av2_i, Xca, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xca)

end subroutine g_if_sigma_ccov_ocov_no0_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no0_x0_type1_eri_o &
...
! W7(c0,i,a2,a) += (    1.00000000) T2(a1,c0,a0,a) D2(i,a2,a1,a0) 
do s_a1 = 0, nir-1
do s_c0 = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ccov_ocov_no0_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no0_x1_type1_eri_o &
...
call set_symblock_Xca(sleft, W7, nir, nsym, psym) ! -> Xca (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccov_ocov_no0_x1_type1_eri_o &
...
end subroutine g_if_sigma_ccov_ocov_no0_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no0_x1_type1_eri_o &
...
! S2(w,x,i,a) += (   -1.00000000) V2(a2,x,w,c0) W7(c0,i,a2,a) 
do s_x = 0, nir-1
do s_w = 0, nir-1
do s_c0 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ccov_ocov_no0_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no0_x0_type1_eri_v &
...
call g_sigma_ccov_ocov_no0_x0_type1_eri_v &
  (sv0, iv0, av2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_ccov_ocov_no0_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no0_x0_type1_eri_v &
...
integer :: s_a1, i_a1, s_w, i_w, s_a0, i_a0, s_i, i_i, s_a2, i_a2
! W26(w,i,a2,v0) += (    1.00000000) T2(a1,w,a0,v0) D2(i,a2,a1,a0) 
do s_a1 = 0, nir-1
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ccov_ocov_no0_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no0_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W26, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccov_ocov_no0_x1_type1_eri_v &
...
end subroutine g_if_sigma_ccov_ocov_no0_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no0_x1_type1_eri_v &
...
end subroutine g_sigma_ccov_ocov_no0_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no1_x0_type1_eri_v &
...
call g_sigma_ccov_ocov_no1_x0_type1_eri_v &
  (sv0, iv0, av2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_ccov_ocov_no1_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no1_x0_type1_eri_v &
...
integer :: s_a1, i_a1, s_x, i_x, s_a0, i_a0, s_i, i_i, s_a2, i_a2
! W27(x,i,a2,v0) += (    1.00000000) T2(a1,x,a0,v0) D2(i,a2,a1,a0) 
do s_a1 = 0, nir-1
do s_x = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ccov_ocov_no1_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no1_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W27, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccov_ocov_no1_x1_type1_eri_v &
  (sa, ia, sv0, iv0, h2_i, Xcaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccov_ocov_no1_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no1_x1_type1_eri_v &
...
end subroutine g_sigma_ccov_ocov_no1_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no2_x0_type1_eri_v &
...
call g_sigma_ccov_ocov_no2_x0_type1_eri_v &
  (sv0, iv0, av2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_ccov_ocov_no2_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no2_x0_type1_eri_v &
...
integer :: s_a1, i_a1, s_x, i_x, s_a0, i_a0, s_i, i_i, s_a2, i_a2
! W28(x,i,a2,v0) += (    1.00000000) T2(a1,x,a0,v0) D2(i,a2,a1,a0) 
do s_a1 = 0, nir-1
do s_x = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
...
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
do i_a2 = psym(I_BEGIN, I_O, s_a2), psym(I_END, I_O, s_a2)
W28_(s_a2, s_i, s_x)%array(i_a2, i_i, i_x) = &
    W28_(s_a2, s_i, s_x)%array(i_a2, i_i, i_x) &
  + Z3_(i_i, i_a2, i_x)
end do
end do
...
end subroutine g_sigma_ccov_ocov_no2_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no2_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W28, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccov_ocov_no2_x1_type1_eri_v &
  (sa, ia, sv0, iv0, h2_i, Xcaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccov_ocov_no2_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no2_x1_type1_eri_v &
...
integer :: s_w, i_w, s_a2, i_a2, s_x, i_x, s_i, i_i
! S2(w,x,i,a) += (   -2.00000000) V2(v0,a,w,a2) W28(x,i,a2,v0) 
do s_w = 0, nir-1
do s_a2 = 0, nir-1
do s_x = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ccov_ocov_no2_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no3_x0_type1_eri_v &
...
call g_sigma_ccov_ocov_no3_x0_type1_eri_v &
  (sv0, iv0, av2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_ccov_ocov_no3_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no3_x0_type1_eri_v &
...
integer :: s_a1, i_a1, s_w, i_w, s_a0, i_a0, s_i, i_i, s_a2, i_a2
! W29(w,i,a2,v0) += (    1.00000000) T2(a1,w,a0,v0) D2(i,a2,a1,a0) 
do s_a1 = 0, nir-1
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
...
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
do i_a2 = psym(I_BEGIN, I_O, s_a2), psym(I_END, I_O, s_a2)
W29_(s_a2, s_i, s_w)%array(i_a2, i_i, i_w) = &
    W29_(s_a2, s_i, s_w)%array(i_a2, i_i, i_w) &
  + Z3_(i_i, i_a2, i_w)
end do
end do
...
end subroutine g_sigma_ccov_ocov_no3_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no3_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W29, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccov_ocov_no3_x1_type1_eri_v &
  (sa, ia, sv0, iv0, h2_i, Xcaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccov_ocov_no3_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no3_x1_type1_eri_v &
...
integer :: s_x, i_x, s_a2, i_a2, s_w, i_w, s_i, i_i
! S2(w,x,i,a) += (    1.00000000) V2(v0,a,x,a2) W29(w,i,a2,v0) 
do s_x = 0, nir-1
do s_a2 = 0, nir-1
do s_w = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ccov_ocov_no3_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no4_x0_type1_eri_v &
...
call g_sigma_ccov_ocov_no4_x0_type1_eri_v &
  (sv0, iv0, av2_i, Xc, d1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xc)

end subroutine g_if_sigma_ccov_ocov_no4_x0_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no4_x0_type1_eri_v &
...
integer :: s_a1, i_a1, s_x, i_x, s_a0, i_a0
! W30(x,v0) += (    1.00000000) T2(a1,x,a0,v0) D1(a1,a0) 
do s_a1 = 0, nir-1
do s_x = 0, nir-1
do s_a0 = 0, nir-1
if( &
...
end subroutine g_sigma_ccov_ocov_no4_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no4_x1_type1_eri_v &
...
call set_symblock_Xc(sleft, W30, nir, nsym, psym) ! -> Xc (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccov_ocov_no4_x1_type1_eri_v &
...
end subroutine g_if_sigma_ccov_ocov_no4_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no4_x1_type1_eri_v &
...
integer :: s_w, i_w, s_i, i_i, s_x, i_x
! S2(w,x,i,a) += (    4.00000000) V2(v0,a,w,i) W30(x,v0) 
do s_w = 0, nir-1
do s_i = 0, nir-1
do s_x = 0, nir-1
if( &
...
end subroutine g_sigma_ccov_ocov_no4_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no5_x0_type1_eri_v &
...
call g_sigma_ccov_ocov_no5_x0_type1_eri_v &
  (sv0, iv0, av2_i, Xc, d1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xc)

end subroutine g_if_sigma_ccov_ocov_no5_x0_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no5_x0_type1_eri_v &
...
integer :: s_a1, i_a1, s_w, i_w, s_a0, i_a0
! W31(w,v0) += (    1.00000000) T2(a1,w,a0,v0) D1(a1,a0) 
do s_a1 = 0, nir-1
do s_w = 0, nir-1
do s_a0 = 0, nir-1
if( &
...
end subroutine g_sigma_ccov_ocov_no5_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no5_x1_type1_eri_v &
...
call set_symblock_Xc(sleft, W31, nir, nsym, psym) ! -> Xc (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccov_ocov_no5_x1_type1_eri_v &
  (sa, ia, sv0, iv0, h2_i, Xc, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccov_ocov_no5_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no5_x1_type1_eri_v &
...
integer :: s_x, i_x, s_i, i_i, s_w, i_w
! S2(w,x,i,a) += (   -2.00000000) V2(v0,a,x,i) W31(w,v0) 
do s_x = 0, nir-1
do s_i = 0, nir-1
do s_w = 0, nir-1
if( &
...
end subroutine g_sigma_ccov_ocov_no5_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no6_x0_type1_eri_v &
  (sa, ia, V2, W32, nir, nsym, psym, flops)
...
call set_symblock_Xcav(sleft, W32, nir, nsym, psym) ! -> Xcav (allocate) 
call g_sigma_ccov_ocov_no6_x0_type1_eri_v &
  (sa, ia, h2_i, Xcav, d1, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xcav)

end subroutine g_if_sigma_ccov_ocov_no6_x0_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no6_x0_type1_eri_v &
  (s_a, i_a, V2_, W32_, D1_, nir, nsym, psym, flops)
...
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
do i_v0 = psym(I_BEGIN, I_V, s_v0), psym(I_END, I_V, s_v0)
W32_(s_v0, s_a0, s_x)%array(i_v0, i_a0, i_x) = &
    W32_(s_v0, s_a0, s_x)%array(i_v0, i_a0, i_x) &
  + Z3_(i_x, i_v0, i_a0)
end do
end do
...
end subroutine g_sigma_ccov_ocov_no6_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no6_x1_type1_eri_v &
  (sa, ia, si, ii, T2, W32, S2, nir, nsym, psym, flops)
...
call set_symblock_Xcav(sleft, W32, nir, nsym, psym) ! -> Xcav (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccov_ocov_no6_x1_type1_eri_v &
  (sa, ia, si, ii, av2_i, Xcav, av2_i2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(av2_i)
deallocate(Xcav)

end subroutine g_if_sigma_ccov_ocov_no6_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no6_x1_type1_eri_v &
  (s_a, i_a, s_i, i_i, T2_, W32_, S2_, nir, nsym, psym, flops)
...
! S2(w,x,i,a) += (   -2.00000000) T2(w,a0,v0,i) W32(x,a0,v0,a) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_v0 = 0, nir-1
do s_x = 0, nir-1
...
end subroutine g_sigma_ccov_ocov_no6_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no7_x0_type1_eri_v &
  (sa, ia, V2, W33, nir, nsym, psym, flops)
...
call set_symblock_Xcav(sleft, W33, nir, nsym, psym) ! -> Xcav (allocate) 
call g_sigma_ccov_ocov_no7_x0_type1_eri_v &
  (sa, ia, h2_i, Xcav, d1, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xcav)

end subroutine g_if_sigma_ccov_ocov_no7_x0_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no7_x0_type1_eri_v &
  (s_a, i_a, V2_, W33_, D1_, nir, nsym, psym, flops)
...
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
do i_v0 = psym(I_BEGIN, I_V, s_v0), psym(I_END, I_V, s_v0)
W33_(s_v0, s_a0, s_w)%array(i_v0, i_a0, i_w) = &
    W33_(s_v0, s_a0, s_w)%array(i_v0, i_a0, i_w) &
  + Z3_(i_w, i_v0, i_a0)
end do
end do
...
end subroutine g_sigma_ccov_ocov_no7_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no7_x1_type1_eri_v &
  (sa, ia, si, ii, T2, W33, S2, nir, nsym, psym, flops)
...
call set_symblock_Xcav(sleft, W33, nir, nsym, psym) ! -> Xcav (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccov_ocov_no7_x1_type1_eri_v &
  (sa, ia, si, ii, av2_i, Xcav, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccov_ocov_no7_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no7_x1_type1_eri_v &
  (s_a, i_a, s_i, i_i, T2_, W33_, S2_, nir, nsym, psym, flops)
...
! S2(w,x,i,a) += (    1.00000000) T2(x,a0,v0,i) W33(w,a0,v0,a) 
do s_x = 0, nir-1
do s_a0 = 0, nir-1
do s_v0 = 0, nir-1
do s_w = 0, nir-1
...
end subroutine g_sigma_ccov_ocov_no7_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no8_x0_type1_eri_v &
...
call g_sigma_ccov_ocov_no8_x0_type1_eri_v &
  (sa, ia, sv0, iv0, h2_i, Xca, d1, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xca)

end subroutine g_if_sigma_ccov_ocov_no8_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no8_x0_type1_eri_v &
...
end subroutine g_sigma_ccov_ocov_no8_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no8_x1_type1_eri_v &
...
call set_symblock_Xca(sleft, W34, nir, nsym, psym) ! -> Xca (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccov_ocov_no8_x1_type1_eri_v &
...
end subroutine g_if_sigma_ccov_ocov_no8_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no8_x1_type1_eri_v &
...
integer :: s_a0, i_a0, s_x, i_x, s_i, i_i, s_w, i_w
! S2(w,x,i,a) += (   -2.00000000) T2(a0,x,i,v0) W34(w,a0,v0,a) 
do s_a0 = 0, nir-1
do s_x = 0, nir-1
do s_i = 0, nir-1
do s_w = 0, nir-1
...
end subroutine g_sigma_ccov_ocov_no8_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no9_x0_type1_eri_v &
...
call g_sigma_ccov_ocov_no9_x0_type1_eri_v &
  (sa, ia, sv0, iv0, h2_i, Xca, d1, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xca)

end subroutine g_if_sigma_ccov_ocov_no9_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no9_x0_type1_eri_v &
...
end subroutine g_sigma_ccov_ocov_no9_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no9_x1_type1_eri_v &
...
call set_symblock_Xca(sleft, W35, nir, nsym, psym) ! -> Xca (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccov_ocov_no9_x1_type1_eri_v &
  (sa, ia, sv0, iv0, av2_i, Xca, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccov_ocov_no9_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no9_x1_type1_eri_v &
...
integer :: s_a0, i_a0, s_w, i_w, s_i, i_i, s_x, i_x
! S2(w,x,i,a) += (    1.00000000) T2(a0,w,i,v0) W35(x,a0,v0,a) 
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_i = 0, nir-1
do s_x = 0, nir-1
...
end subroutine g_sigma_ccov_ocov_no9_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no10_x0_type1_eri_v &
...
call g_sigma_ccov_ocov_no10_x0_type1_eri_v &
  (sv0, iv0, av2_i, Xc, d1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xc)

end subroutine g_if_sigma_ccov_ocov_no10_x0_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no10_x0_type1_eri_v &
...
integer :: s_a1, i_a1, s_w, i_w, s_a0, i_a0
! W36(w,v0) += (    1.00000000) T2(a1,w,a0,v0) D1(a1,a0) 
do s_a1 = 0, nir-1
do s_w = 0, nir-1
do s_a0 = 0, nir-1
if( &
...
end subroutine g_sigma_ccov_ocov_no10_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no10_x1_type1_eri_v &
...
call set_symblock_Xc(sleft, W36, nir, nsym, psym) ! -> Xc (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccov_ocov_no10_x1_type1_eri_v &
  (sa, ia, sv0, iv0, h2_i, Xc, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccov_ocov_no10_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no10_x1_type1_eri_v &
...
! S2(w,x,i,a) += (    4.00000000) V2(v0,i,x,a) W36(w,v0) 
do s_i = 0, nir-1
do s_x = 0, nir-1
do s_w = 0, nir-1
if( &
...
end subroutine g_sigma_ccov_ocov_no10_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no11_x0_type1_eri_v &
...
call g_sigma_ccov_ocov_no11_x0_type1_eri_v &
  (sv0, iv0, av2_i, Xc, d1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xc)

end subroutine g_if_sigma_ccov_ocov_no11_x0_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no11_x0_type1_eri_v &
...
integer :: s_a1, i_a1, s_x, i_x, s_a0, i_a0
! W37(x,v0) += (    1.00000000) T2(a1,x,a0,v0) D1(a1,a0) 
do s_a1 = 0, nir-1
do s_x = 0, nir-1
do s_a0 = 0, nir-1
if( &
...
end subroutine g_sigma_ccov_ocov_no11_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccov_ocov_no11_x1_type1_eri_v &
...
call set_symblock_Xc(sleft, W37, nir, nsym, psym) ! -> Xc (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccov_ocov_no11_x1_type1_eri_v &
  (sa, ia, sv0, iv0, h2_i, Xc, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccov_ocov_no11_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccov_ocov_no11_x1_type1_eri_v &
...
! S2(w,x,i,a) += (   -2.00000000) V2(v0,i,w,a) W37(x,v0) 
do s_i = 0, nir-1
do s_w = 0, nir-1
do s_x = 0, nir-1
if( &
...
end subroutine g_sigma_ccov_ocov_no11_x1_type1_eri_v
