...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_g_no0_x0_type0_noeri &
...
call g_sigma_coov_g_no0_x0_type0_noeri &
  (sa, ia, T0, av2_i2, d1, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)

end subroutine g_if_sigma_coov_g_no0_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_g_no0_x0_type0_noeri &
...
! S2(w,i,j,a) += (   -1.00000000) T0 D1(j,i) Fc1(w,a) 
do s_j = 0, nir-1
do s_i = 0, nir-1
do s_w = 0, nir-1
if( &
...
end subroutine g_sigma_coov_g_no0_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_g_no0_x0_type1_eri_v &
...
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_g_no0_x0_type1_eri_v &
  (sa, ia, T0, h2_i, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(h2_i)

end subroutine g_if_sigma_coov_g_no0_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_g_no0_x0_type1_eri_v &
...
! S2(w,i,j,a) += (   -1.00000000) T0 V2(a,a1,w,a0) D2(j,a0,a1,i) 
do s_a1 = 0, nir-1
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_coov_g_no0_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_g_no1_x0_type1_eri_v &
  (sa, ia, T0, V2, S2, nir, nsym, psym, flops)
...
call set_symblock_h2(sa, V2, nir, nsym, psym) ! -> h2_i (allocate)
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_g_no1_x0_type1_eri_v &
  (sa, ia, T0, h2_i, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(h2_i)

end subroutine g_if_sigma_coov_g_no1_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_g_no1_x0_type1_eri_v &
  (s_a, i_a, T0, V2_, S2_, D2_, nir, nsym, psym, flops)
...
! S2(w,i,j,a) += (   -1.00000000) T0 V2(a,w,a1,a0) D2(j,i,a1,a0) 
do s_w = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_coov_g_no1_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_g_no2_x0_type1_eri_v &
  (sa, ia, T0, V2, S2, nir, nsym, psym, flops)
...
call set_symblock_h2(sa, V2, nir, nsym, psym) ! -> h2_i (allocate)
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_g_no2_x0_type1_eri_v &
  (sa, ia, T0, h2_i, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(h2_i)

end subroutine g_if_sigma_coov_g_no2_x0_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_coov_g_no2_x0_type1_eri_v &
...
! S2(w,i,j,a) += (   -1.00000000) T0 V2(a,w,j,a0) D1(i,a0) 
do s_w = 0, nir-1
do s_j = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_g_no2_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_g_no3_x0_type1_eri_v &
  (sa, ia, T0, V2, S2, nir, nsym, psym, flops)
...
call set_symblock_h2(sa, V2, nir, nsym, psym) ! -> h2_i (allocate)
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_g_no3_x0_type1_eri_v &
  (sa, ia, T0, h2_i, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(h2_i)

end subroutine g_if_sigma_coov_g_no3_x0_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_coov_g_no3_x0_type1_eri_v &
  (s_a, i_a, T0, V2_, S2_, D1_, nir, nsym, psym, flops)
...
! S2(w,i,j,a) += (    2.00000000) T0 V2(a,a0,w,j) D1(i,a0) 
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_g_no3_x0_type1_eri_v
