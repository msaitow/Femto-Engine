...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_ooov_no0_x0_type0_noeri &
...
call g_sigma_coov_ooov_no0_x0_type0_noeri &
  (sa, ia, av2_i, Xaaa, d3, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_coov_ooov_no0_x0_type0_noeri
...
! >> Score :: 111111
! The best shot!
! RDM is rotated :: D3(j,a3,a2,i,a1,a0)  >> D3(a1,a0,a2,i,j,a3) 
! rowInd : @[a3, "active"] @[j, "active"] @[i, "active"] 
! summedInd : @[a2, "active"] @[a0, "active"] @[a1, "active"] 
! -- Check2 is skipped 
!    -- is4RDM.second false
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_ooov_no0_x0_type0_noeri &
...
integer :: s_i, i_i
! W0(j,a3,i,a) += (    1.00000000) T2(a1,a2,a0,a) D3(j,a3,a2,i,a1,a0) 
do s_a1 = 0, nir-1
do s_a2 = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
...
do s_i = 0, nir-1
if( &
IEOR(s_j,s_a3) == IEOR(s_i,s_a) .and. & 
IEOR(s_a1,s_a2) == IEOR(s_a0,s_a) .and. &
IEOR(IEOR(s_j,s_a3),s_a2) == IEOR(IEOR(s_i,s_a1),s_a0)) then

if(psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_j)*psym(I_LENGTH,I_O, s_i) > 0 .and. &
...
call dgemm('n', 'n', psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_j)*psym(I_LENGTH,I_O, s_i),&
                     1,&
                     psym(I_LENGTH,I_O, s_a2)*psym(I_LENGTH,I_O, s_a0)*psym(I_LENGTH,I_O, s_a1),&
                     1.00000000d+00, &
                     D3_(s_a3, s_j, s_i, s_a2, s_a0, s_a1)%array,&
                     psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_j)*psym(I_LENGTH,I_O, s_i),&
                     Z2_,&
                     psym(I_LENGTH,I_O, s_a2)*psym(I_LENGTH,I_O, s_a0)*psym(I_LENGTH,I_O, s_a1),&
                     0.0d+00,&
                     Z3_,&
...
W0_(s_i, s_a3, s_j)%array(i_i, i_a3, i_j) = &
    W0_(s_i, s_a3, s_j)%array(i_i, i_a3, i_j) &
  + Z3_(i_a3, i_j, i_i)
end do
end do
...
! Flop count
flops = flops + psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_j)*psym(I_LENGTH,I_O, s_i) * &
                1 * &
...
end subroutine g_sigma_coov_ooov_no0_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_ooov_no0_x1_type0_noeri &
...
call g_sigma_coov_ooov_no0_x1_type0_noeri &
  (sa, ia, Xaaa, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaaa)

end subroutine g_if_sigma_coov_ooov_no0_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_ooov_no0_x1_type0_noeri &
...
! S2(w,i,j,a) += (   -1.00000000) Fc1(w,a3) W0(j,a3,i,a) 
do s_w = 0, nir-1
do s_a3 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
IEOR(s_w,s_a3) == 0 .and. &
IEOR(s_j,s_a3) == IEOR(s_i,s_a)) then
...
end subroutine g_sigma_coov_ooov_no0_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_ooov_no1_x0_type0_noeri &
...
call g_sigma_coov_ooov_no1_x0_type0_noeri &
  (sa, ia, av2_i, Xa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xa)

end subroutine g_if_sigma_coov_ooov_no1_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_ooov_no1_x0_type0_noeri &
...
end subroutine g_sigma_coov_ooov_no1_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_ooov_no1_x1_type0_noeri &
...
call set_symblock_Xa(sleft, W1, nir, nsym, psym) ! -> Xa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_ooov_no1_x1_type0_noeri &
  (sa, ia, Xa, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xa)

end subroutine g_if_sigma_coov_ooov_no1_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_ooov_no1_x1_type0_noeri &
...
! S2(w,i,j,a) += (    2.00000000) Fc1(w,j) W1(i,a) 
do s_w = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
if( &
...
end subroutine g_sigma_coov_ooov_no1_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_ooov_no2_x0_type0_noeri &
...
call g_sigma_coov_ooov_no2_x0_type0_noeri &
  (sa, ia, av2_i, Xaaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_coov_ooov_no2_x0_type0_noeri
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_coov_ooov_no2_x0_type0_noeri &
...
integer :: s_a0, i_a0, s_a1, i_a1, s_j, i_j, s_i, i_i, s_a2, i_a2
! W2(i,a2,j,a) += (    1.00000000) T2(a0,a1,j,a) D2(i,a1,a2,a0) 
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
IEOR(s_a0,s_a1) == IEOR(s_j,s_a) .and. &
IEOR(s_i,s_a1) == IEOR(s_a2,s_a0)) then
...
do i_j = psym(I_BEGIN, I_O, s_j), psym(I_END, I_O, s_j)
Z1_(i_j, i_a0, i_a1) =  &
  T2_(s_j, s_a1, s_a0)%array(i_j, i_a1, i_a0)
end do
end do
end do
! Z2 <-- D2(i,a1,a2,a0) 
...
end subroutine g_sigma_coov_ooov_no2_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_ooov_no2_x1_type0_noeri &
...
call set_symblock_Xaaa(sleft, W2, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_ooov_no2_x1_type0_noeri &
  (sa, ia, Xaaa, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaaa)

end subroutine g_if_sigma_coov_ooov_no2_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_ooov_no2_x1_type0_noeri &
...
! S2(w,i,j,a) += (   -1.00000000) Fc1(w,a2) W2(i,a2,j,a) 
do s_w = 0, nir-1
do s_a2 = 0, nir-1
do s_i = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_coov_ooov_no2_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_ooov_no0_x0_type1_eri_c &
...
call g_sigma_coov_ooov_no0_x0_type1_eri_c &
  (sw, iw, h2_i, Xaaa, d3, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_coov_ooov_no0_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_ooov_no0_x0_type1_eri_c &
...
end subroutine g_sigma_coov_ooov_no0_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_ooov_no0_x1_type1_eri_c &
...
call set_symblock_Xaaa(sleft, W5, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_ooov_no0_x1_type1_eri_c &
...
end subroutine g_if_sigma_coov_ooov_no0_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_ooov_no0_x1_type1_eri_c &
...
integer :: s_a0, i_a0, s_a1, i_a1, s_j, i_j, s_i, i_i
! S2(w,i,j,a) += (   -1.00000000) T2(a0,a1,j,a) W5(w,i,a1,a0) 
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_ooov_no0_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_ooov_no1_x0_type1_eri_c &
...
call g_sigma_coov_ooov_no1_x0_type1_eri_c &
  (sw, iw, h2_i, Xaaaaa, d3, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaaaa)

end subroutine g_if_sigma_coov_ooov_no1_x0_type1_eri_c
...
! Information for debugging 
! >> Score :: 110110
! RDM is rotated :: D3(j,a3,a1,i,a0,a4)  >> D3(i,a1,a3,j,a4,a0) 
! summedInd : @[a3, "active"] @[a4, "active"] 
! colInd : @[j, "active"] @[a0, "active"] @[a1, "active"] @[i, "active"] 
subroutine g_sigma_coov_ooov_no1_x0_type1_eri_c &
...
! W6(w,j,a1,a0,i,a2) += (    1.00000000) V2(w,a3,a4,a2) D3(j,a3,a1,i,a0,a4) 
do s_a3 = 0, nir-1
do s_a4 = 0, nir-1
do s_a2 = 0, nir-1
do s_j = 0, nir-1
...
IEOR(s_w,s_a3) == IEOR(s_a4,s_a2) .and. &
IEOR(IEOR(s_j,s_a3),s_a1) == IEOR(IEOR(s_i,s_a0),s_a4)) then
...
do i_a4 = psym(I_BEGIN, I_O, s_a4), psym(I_END, I_O, s_a4)
do i_a3 = psym(I_BEGIN, I_O, s_a3), psym(I_END, I_O, s_a3)
Z2_(i_a3, i_a4, i_j, i_a0, i_a1, i_i) =  &
  D3_(s_a0, s_a4, s_j, s_a3, s_a1, s_i)%array(i_a0, i_a4, i_j, i_a3, i_a1, i_i)
end do
end do
end do
end do
...
end subroutine g_sigma_coov_ooov_no1_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_ooov_no1_x1_type1_eri_c &
...
call set_symblock_Xaaaaa(sleft, W6, nir, nsym, psym) ! -> Xaaaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_ooov_no1_x1_type1_eri_c &
...
end subroutine g_if_sigma_coov_ooov_no1_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_ooov_no1_x1_type1_eri_c &
...
! S2(w,i,j,a) += (   -1.00000000) T2(a0,a1,a2,a) W6(w,j,a1,a0,i,a2) 
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_a2 = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_coov_ooov_no1_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_ooov_no0_x0_type1_eri_o &
...
call g_sigma_coov_ooov_no0_x0_type1_eri_o &
  (sa, ia, sa4, ia4, av2_i, Xaa, d3, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xaa)

end subroutine g_if_sigma_coov_ooov_no0_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_ooov_no0_x0_type1_eri_o &
...
end subroutine g_sigma_coov_ooov_no0_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_ooov_no0_x1_type1_eri_o &
...
call set_symblock_Xaa(sleft, W3, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_ooov_no0_x1_type1_eri_o &
...
end subroutine g_if_sigma_coov_ooov_no0_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_ooov_no0_x1_type1_eri_o &
...
! S2(w,i,j,a) += (    2.00000000) V2(a4,a3,w,j) W3(i,a4,a3,a) 
do s_a3 = 0, nir-1
do s_w = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_ooov_no0_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_ooov_no1_x0_type1_eri_o &
...
call g_sigma_coov_ooov_no1_x0_type1_eri_o &
  (sa, ia, sa4, ia4, av2_i, Xaa, d3, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xaa)

end subroutine g_if_sigma_coov_ooov_no1_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_ooov_no1_x0_type1_eri_o &
...
integer :: s_a0, i_a0, s_a1, i_a1, s_a2, i_a2, s_i, i_i, s_a3, i_a3
! W4(i,a4,a3,a) += (    1.00000000) T2(a0,a1,a2,a) D3(i,a1,a4,a3,a2,a0) 
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_a2 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_ooov_no1_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_ooov_no1_x1_type1_eri_o &
...
call set_symblock_Xaa(sleft, W4, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_ooov_no1_x1_type1_eri_o &
  (sa, ia, sa4, ia4, h2_i, Xaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_ooov_no1_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_ooov_no1_x1_type1_eri_o &
...
! S2(w,i,j,a) += (   -1.00000000) V2(a4,w,j,a3) W4(i,a4,a3,a) 
do s_w = 0, nir-1
do s_j = 0, nir-1
do s_a3 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_ooov_no1_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_ooov_no2_x0_type1_eri_o &
...
call g_sigma_coov_ooov_no2_x0_type1_eri_o &
  (sa, ia, sa2, ia2, av2_i, Xaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xaa)

end subroutine g_if_sigma_coov_ooov_no2_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_ooov_no2_x0_type1_eri_o &
...
end subroutine g_sigma_coov_ooov_no2_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_ooov_no2_x1_type1_eri_o &
...
call set_symblock_Xaa(sleft, W7, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_ooov_no2_x1_type1_eri_o &
...
end subroutine g_if_sigma_coov_ooov_no2_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_ooov_no2_x1_type1_eri_o &
...
integer :: s_a3, i_a3, s_w, i_w, s_j, i_j, s_i, i_i
! S2(w,i,j,a) += (    2.00000000) V2(a2,a3,w,j) W7(i,a3,a2,a) 
do s_a3 = 0, nir-1
do s_w = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_ooov_no2_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_ooov_no3_x0_type1_eri_o &
  (sa, ia, sa2, ia2, T2, W8, nir, nsym, psym, flops)
...
call g_sigma_coov_ooov_no3_x0_type1_eri_o &
  (sa, ia, sa2, ia2, av2_i, Xaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xaa)

end subroutine g_if_sigma_coov_ooov_no3_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_ooov_no3_x0_type1_eri_o &
  (s_a, i_a, s_a2, i_a2, T2_, W8_, D2_, nir, nsym, psym, flops)
...
integer :: s_a1, i_a1, s_a0, i_a0, s_i, i_i, s_a3, i_a3
! W8(i,a3,a2,a) += (    1.00000000) T2(a1,a0,a,a2) D2(i,a1,a3,a0) 
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
do s_a3 = 0, nir-1
...
end subroutine g_sigma_coov_ooov_no3_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_ooov_no3_x1_type1_eri_o &
  (sa, ia, sa2, ia2, V2, W8, S2, nir, nsym, psym, flops)
...
call set_symblock_Xaa(sleft, W8, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_ooov_no3_x1_type1_eri_o &
  (sa, ia, sa2, ia2, h2_i, Xaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_ooov_no3_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_ooov_no3_x1_type1_eri_o &
  (s_a, i_a, s_a2, i_a2, V2_, W8_, S2_, nir, nsym, psym, flops)
...
integer :: s_j, i_j, s_w, i_w, s_a3, i_a3, s_i, i_i
! S2(w,i,j,a) += (   -1.00000000) V2(a2,j,w,a3) W8(i,a3,a2,a) 
do s_j = 0, nir-1
do s_w = 0, nir-1
do s_a3 = 0, nir-1
do s_i = 0, nir-1
if( &
IEOR(s_w,s_i) == IEOR(s_j,s_a) .and. & 
IEOR(s_a2,s_j) == IEOR(s_w,s_a3) .and. &
IEOR(s_i,s_a3) == IEOR(s_a2,s_a)) then
...
do i_j = psym(I_BEGIN, I_O, s_j), psym(I_END, I_O, s_j)
Z1_(i_j, i_w, i_a3) =  &
  V2_(s_a3, s_w, s_j)%array(i_a3, i_w, i_j)
end do
end do
end do
! Z2 <-- W8(i,a3,a2,a) 
...
end subroutine g_sigma_coov_ooov_no3_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_ooov_no0_x0_type1_eri_v &
...
call g_sigma_coov_ooov_no0_x0_type1_eri_v &
  (sv0, iv0, av2_i, Xaaa, d3, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_coov_ooov_no0_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_ooov_no0_x0_type1_eri_v &
...
end subroutine g_sigma_coov_ooov_no0_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_ooov_no0_x1_type1_eri_v &
...
call set_symblock_Xaaa(sleft, W9, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_ooov_no0_x1_type1_eri_v &
...
end subroutine g_if_sigma_coov_ooov_no0_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_ooov_no0_x1_type1_eri_v &
...
integer :: s_a3, i_a3, s_w, i_w, s_j, i_j, s_i, i_i
! S2(w,i,j,a) += (   -1.00000000) V2(v0,a3,w,a) W9(j,i,a3,v0) 
do s_a3 = 0, nir-1
do s_w = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_ooov_no0_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_ooov_no1_x0_type1_eri_v &
...
call g_sigma_coov_ooov_no1_x0_type1_eri_v &
  (sv0, iv0, av2_i, Xaaa, d3, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_coov_ooov_no1_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_ooov_no1_x0_type1_eri_v &
...
integer :: s_a1, i_a1, s_a2, i_a2, s_a0, i_a0, s_j, i_j, s_a3, i_a3
integer :: s_i, i_i
! W10(j,a3,i,v0) += (    1.00000000) T2(a1,a2,a0,v0) D3(j,a3,a2,i,a1,a0) 
do s_a1 = 0, nir-1
do s_a2 = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
...
do s_i = 0, nir-1
if( &
IEOR(s_j,s_a3) == IEOR(s_i,s_v0) .and. & 
IEOR(s_a1,s_a2) == IEOR(s_a0,s_v0) .and. &
IEOR(IEOR(s_j,s_a3),s_a2) == IEOR(IEOR(s_i,s_a1),s_a0)) then
...
do i_a3 = psym(I_BEGIN, I_O, s_a3), psym(I_END, I_O, s_a3)
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
W10_(s_i, s_a3, s_j)%array(i_i, i_a3, i_j) = &
    W10_(s_i, s_a3, s_j)%array(i_i, i_a3, i_j) &
  + Z3_(i_a3, i_j, i_i)
end do
end do
...
end subroutine g_sigma_coov_ooov_no1_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_ooov_no1_x1_type1_eri_v &
...
call set_symblock_Xaaa(sleft, W10, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_ooov_no1_x1_type1_eri_v &
  (sa, ia, sv0, iv0, h2_i, Xaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_ooov_no1_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_ooov_no1_x1_type1_eri_v &
...
integer :: s_w, i_w, s_a3, i_a3, s_j, i_j, s_i, i_i
! S2(w,i,j,a) += (   -1.00000000) V2(v0,a,w,a3) W10(j,a3,i,v0) 
do s_w = 0, nir-1
do s_a3 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
IEOR(s_j,s_a3) == IEOR(s_i,s_v0)) then
...
end subroutine g_sigma_coov_ooov_no1_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_ooov_no2_x0_type1_eri_v &
...
call g_sigma_coov_ooov_no2_x0_type1_eri_v &
  (sv0, iv0, av2_i, Xa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xa)

end subroutine g_if_sigma_coov_ooov_no2_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_ooov_no2_x0_type1_eri_v &
...
end subroutine g_sigma_coov_ooov_no2_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_ooov_no2_x1_type1_eri_v &
...
call set_symblock_Xa(sleft, W11, nir, nsym, psym) ! -> Xa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_ooov_no2_x1_type1_eri_v &
...
end subroutine g_if_sigma_coov_ooov_no2_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_ooov_no2_x1_type1_eri_v &
...
integer :: s_w, i_w, s_j, i_j, s_i, i_i
! S2(w,i,j,a) += (    2.00000000) V2(v0,a,w,j) W11(i,v0) 
do s_w = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
if( &
...
end subroutine g_sigma_coov_ooov_no2_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_ooov_no3_x0_type1_eri_v &
...
call g_sigma_coov_ooov_no3_x0_type1_eri_v &
  (sv0, iv0, av2_i, Xaaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_coov_ooov_no3_x0_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_coov_ooov_no3_x0_type1_eri_v &
...
end subroutine g_sigma_coov_ooov_no3_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_ooov_no3_x1_type1_eri_v &
...
call set_symblock_Xaaa(sleft, W12, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_ooov_no3_x1_type1_eri_v &
  (sa, ia, sv0, iv0, h2_i, Xaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_ooov_no3_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_ooov_no3_x1_type1_eri_v &
...
! S2(w,i,j,a) += (   -1.00000000) V2(v0,a2,w,a) W12(i,a2,j,v0) 
do s_a2 = 0, nir-1
do s_w = 0, nir-1
do s_i = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_coov_ooov_no3_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_ooov_no4_x0_type1_eri_v &
...
call g_sigma_coov_ooov_no4_x0_type1_eri_v &
  (sv0, iv0, av2_i, Xaaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_coov_ooov_no4_x0_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_coov_ooov_no4_x0_type1_eri_v &
...
integer :: s_a0, i_a0, s_a1, i_a1, s_j, i_j, s_i, i_i, s_a2, i_a2
! W13(i,a2,j,v0) += (    1.00000000) T2(a0,a1,j,v0) D2(i,a1,a2,a0) 
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
if( &
IEOR(s_i,s_a2) == IEOR(s_j,s_v0) .and. & 
IEOR(s_a0,s_a1) == IEOR(s_j,s_v0) .and. &
IEOR(s_i,s_a1) == IEOR(s_a2,s_a0)) then
...
end subroutine g_sigma_coov_ooov_no4_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_ooov_no4_x1_type1_eri_v &
...
call set_symblock_Xaaa(sleft, W13, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_ooov_no4_x1_type1_eri_v &
  (sa, ia, sv0, iv0, h2_i, Xaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_ooov_no4_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_ooov_no4_x1_type1_eri_v &
...
integer :: s_w, i_w, s_a2, i_a2, s_i, i_i, s_j, i_j
! S2(w,i,j,a) += (   -1.00000000) V2(v0,a,w,a2) W13(i,a2,j,v0) 
do s_w = 0, nir-1
do s_a2 = 0, nir-1
do s_i = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_coov_ooov_no4_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_ooov_no5_x0_type1_eri_v &
...
call g_sigma_coov_ooov_no5_x0_type1_eri_v &
  (sv0, iv0, av2_i, Xa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xa)

end subroutine g_if_sigma_coov_ooov_no5_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_ooov_no5_x0_type1_eri_v &
...
end subroutine g_sigma_coov_ooov_no5_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_ooov_no5_x1_type1_eri_v &
...
call set_symblock_Xa(sleft, W14, nir, nsym, psym) ! -> Xa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_ooov_no5_x1_type1_eri_v &
  (sa, ia, sv0, iv0, h2_i, Xa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_ooov_no5_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_ooov_no5_x1_type1_eri_v &
...
! S2(w,i,j,a) += (   -1.00000000) V2(v0,j,w,a) W14(i,v0) 
do s_j = 0, nir-1
do s_w = 0, nir-1
do s_i = 0, nir-1
if( &
...
end subroutine g_sigma_coov_ooov_no5_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_ooov_no0_x0_type1_d4c_c &
...
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_ooov_no0_x0_type1_d4c_c &
...
end subroutine g_if_sigma_coov_ooov_no0_x0_type1_d4c_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_ooov_no0_x0_type1_d4c_c &
...
! S2(w,i,j,a) += (   -1.00000000) T2(a1,a2,a0,a) C5(a1,a0,a2,i,j,w) 
do s_a1 = 0, nir-1
do s_a2 = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
...
IEOR(s_w,s_i) == IEOR(s_j,s_a) .and. & 
IEOR(s_a1,s_a2) == IEOR(s_a0,s_a) .and. &
IEOR(IEOR(s_a1,s_a0),s_a2) == IEOR(IEOR(s_i,s_j),s_w)) then

if(psym(I_LENGTH,I_O, s_i)*psym(I_LENGTH,I_O, s_j) > 0 .and. &
   psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_a0)*psym(I_LENGTH,I_O, s_a2) > 0) then

! Z1 <-- C5(a1,a0,a2,i,j,w) 
allocate(Z1_(psym(I_BEGIN,I_O, s_i):psym(I_END,I_O, s_i), &
             psym(I_BEGIN,I_O, s_j):psym(I_END,I_O, s_j), &
             psym(I_BEGIN,I_O, s_a1):psym(I_END,I_O, s_a1), &
             psym(I_BEGIN,I_O, s_a0):psym(I_END,I_O, s_a0), &
...
do i_j = psym(I_BEGIN, I_O, s_j), psym(I_END, I_O, s_j)
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
Z1_(i_i, i_j, i_a1, i_a0, i_a2) =  &
  C5_(s_j, s_i, s_a2, s_a0, s_a1)%array(i_j, i_i, i_a2, i_a0, i_a1)
end do
end do
end do
end do
...
end subroutine g_sigma_coov_ooov_no0_x0_type1_d4c_c
