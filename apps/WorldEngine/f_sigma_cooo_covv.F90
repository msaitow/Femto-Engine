...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_covv_no0_x0_type1_eri_o &
  (sj, ij, sv0, iv0, T2, V2, W3, nir, nsym, psym, flops)
...
call g_sigma_cooo_covv_no0_x0_type1_eri_o &
...
end subroutine g_if_sigma_cooo_covv_no0_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_covv_no0_x0_type1_eri_o &
  (s_j, i_j, s_v0, i_v0, T2_, V2_, W3_, nir, nsym, psym, flops)
...
! W3(w,a0,j,a1) += (    1.00000000) V2(j,v1,v0,a1) T2(w,a0,v1,v0) 
do s_v1 = 0, nir-1
do s_a1 = 0, nir-1
do s_w = 0, nir-1
do s_a0 = 0, nir-1
...
IEOR(s_j,s_v1) == IEOR(s_v0,s_a1) .and. &
...
Z1_(i_a1, i_v1) =  &
  V2_(s_a1, s_v0, s_v1)%array(i_a1, i_v0, i_v1)
end do
end do
! Z2 <-- T2(w,a0,v1,v0) 
...
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
do i_a1 = psym(I_BEGIN, I_O, s_a1), psym(I_END, I_O, s_a1)
W3_(s_a1, s_a0, s_w)%array(i_a1, i_a0, i_w) = &
    W3_(s_a1, s_a0, s_w)%array(i_a1, i_a0, i_w) &
  + Z3_(i_a1, i_w, i_a0)
end do
end do
...
end subroutine g_sigma_cooo_covv_no0_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_covv_no0_x1_type1_eri_o &
...
call g_sigma_cooo_covv_no0_x1_type1_eri_o &
  (sj, ij, Xcaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_cooo_covv_no0_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_covv_no0_x1_type1_eri_o &
...
! S2(w,k,i,j) += (   -1.00000000) D2(k,i,a1,a0) W3(w,a0,j,a1) 
do s_k = 0, nir-1
do s_i = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_cooo_covv_no0_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_covv_no1_x0_type1_eri_o &
  (sj, ij, sv1, iv1, T2, V2, W4, nir, nsym, psym, flops)
...
call g_sigma_cooo_covv_no1_x0_type1_eri_o &
  (sj, ij, sv1, iv1, av2_i, h2_i, Xcaa, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(h2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_cooo_covv_no1_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_covv_no1_x0_type1_eri_o &
  (s_j, i_j, s_v1, i_v1, T2_, V2_, W4_, nir, nsym, psym, flops)
...
! W4(w,a0,j,a1) += (    1.00000000) V2(j,v1,v0,a1) T2(w,a0,v0,v1) 
do s_v0 = 0, nir-1
do s_a1 = 0, nir-1
do s_w = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_cooo_covv_no1_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_covv_no1_x1_type1_eri_o &
...
call set_symblock_Xcaa(sleft, W4, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_covv_no1_x1_type1_eri_o &
  (sj, ij, Xcaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_cooo_covv_no1_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_covv_no1_x1_type1_eri_o &
...
! S2(w,k,i,j) += (   -1.00000000) D2(k,a0,a1,i) W4(w,a0,j,a1) 
do s_k = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_cooo_covv_no1_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_covv_no2_x0_type1_eri_o &
...
call g_sigma_cooo_covv_no2_x0_type1_eri_o &
  (sj, ij, sv1, iv1, av2_i, h2_i, Xcaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_cooo_covv_no2_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_covv_no2_x0_type1_eri_o &
...
! W5(w,a0,j,i) += (    1.00000000) V2(j,v1,v0,i) T2(w,a0,v0,v1) 
do s_v0 = 0, nir-1
do s_i = 0, nir-1
do s_w = 0, nir-1
do s_a0 = 0, nir-1
...
IEOR(s_j,s_v1) == IEOR(s_v0,s_i) .and. &
IEOR(s_w,s_a0) == IEOR(s_v0,s_v1)) then
...
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
Z1_(i_i, i_v0) =  &
  V2_(s_i, s_v0, s_v1)%array(i_i, i_v0, i_v1)
end do
end do
! Z2 <-- T2(w,a0,v0,v1) 
allocate(Z2_(psym(I_BEGIN,I_V, s_v0):psym(I_END,I_V, s_v0), &
...
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
W5_(s_i, s_a0, s_w)%array(i_i, i_a0, i_w) = &
    W5_(s_i, s_a0, s_w)%array(i_i, i_a0, i_w) &
  + Z3_(i_i, i_w, i_a0)
end do
end do
...
end subroutine g_sigma_cooo_covv_no2_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_covv_no2_x1_type1_eri_o &
...
call set_symblock_Xcaa(sleft, W5, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_covv_no2_x1_type1_eri_o &
  (sj, ij, Xcaa, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_cooo_covv_no2_x1_type1_eri_o
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_cooo_covv_no2_x1_type1_eri_o &
...
! S2(w,k,i,j) += (    2.00000000) D1(k,a0) W5(w,a0,j,i) 
do s_k = 0, nir-1
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_cooo_covv_no2_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_covv_no3_x0_type1_eri_o &
  (sj, ij, sv0, iv0, T2, V2, W6, nir, nsym, psym, flops)
...
call g_sigma_cooo_covv_no3_x0_type1_eri_o &
  (sj, ij, sv0, iv0, av2_i, h2_i, Xcaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_cooo_covv_no3_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_covv_no3_x0_type1_eri_o &
  (s_j, i_j, s_v0, i_v0, T2_, V2_, W6_, nir, nsym, psym, flops)
...
integer :: s_v1, i_v1, s_i, i_i, s_w, i_w, s_a0, i_a0
! W6(w,a0,j,i) += (    1.00000000) V2(j,v1,v0,i) T2(w,a0,v1,v0) 
do s_v1 = 0, nir-1
do s_i = 0, nir-1
do s_w = 0, nir-1
do s_a0 = 0, nir-1
...
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
W6_(s_i, s_a0, s_w)%array(i_i, i_a0, i_w) = &
    W6_(s_i, s_a0, s_w)%array(i_i, i_a0, i_w) &
  + Z3_(i_i, i_w, i_a0)
end do
end do
...
end subroutine g_sigma_cooo_covv_no3_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_covv_no3_x1_type1_eri_o &
...
call set_symblock_Xcaa(sleft, W6, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_covv_no3_x1_type1_eri_o &
  (sj, ij, Xcaa, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_cooo_covv_no3_x1_type1_eri_o
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_cooo_covv_no3_x1_type1_eri_o &
  (s_j, i_j, W6_, S2_, D1_, nir, nsym, psym, flops)
...
integer :: s_k, i_k, s_a0, i_a0, s_w, i_w, s_i, i_i
! S2(w,k,i,j) += (   -1.00000000) D1(k,a0) W6(w,a0,j,i) 
do s_k = 0, nir-1
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_cooo_covv_no3_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_covv_no0_x0_type1_eri_v &
...
call g_sigma_cooo_covv_no0_x0_type1_eri_v &
  (sv1, iv1, av2_i, h2_i, Xcaaa, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(h2_i)
deallocate(Xcaaa)

end subroutine g_if_sigma_cooo_covv_no0_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_covv_no0_x0_type1_eri_v &
...
integer :: s_a2, i_a2, s_v0, i_v0, s_a1, i_a1, s_a0, i_a0, s_w, i_w
! W0(w,a0,a2,a1) += (    1.00000000) V2(v1,a2,v0,a1) T2(a0,w,v0,v1) 
do s_a2 = 0, nir-1
do s_v0 = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
...
IEOR(s_v1,s_a2) == IEOR(s_v0,s_a1) .and. &
IEOR(s_a0,s_w) == IEOR(s_v0,s_v1)) then
...
do i_a2 = psym(I_BEGIN, I_O, s_a2), psym(I_END, I_O, s_a2)
do i_a1 = psym(I_BEGIN, I_O, s_a1), psym(I_END, I_O, s_a1)
W0_(s_a1, s_a2, s_a0, s_w)%array(i_a1, i_a2, i_a0, i_w) = &
    W0_(s_a1, s_a2, s_a0, s_w)%array(i_a1, i_a2, i_a0, i_w) &
  + Z3_(i_a2, i_a1, i_a0, i_w)
end do
end do
end do
end do
...
end subroutine g_sigma_cooo_covv_no0_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_covv_no1_x0_type1_eri_v &
...
call g_sigma_cooo_covv_no1_x0_type1_eri_v &
  (sv1, iv1, av2_i, h2_i, Xcaaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_cooo_covv_no1_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_covv_no1_x0_type1_eri_v &
...
integer :: s_i, i_i, s_v0, i_v0, s_a1, i_a1, s_a0, i_a0, s_w, i_w
! W1(w,a0,i,a1) += (    1.00000000) V2(v1,i,v0,a1) T2(a0,w,v0,v1) 
do s_i = 0, nir-1
do s_v0 = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
...
IEOR(s_v1,s_i) == IEOR(s_v0,s_a1) .and. &
IEOR(s_a0,s_w) == IEOR(s_v0,s_v1)) then
...
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
do i_a1 = psym(I_BEGIN, I_O, s_a1), psym(I_END, I_O, s_a1)
W1_(s_a1, s_i, s_a0, s_w)%array(i_a1, i_i, i_a0, i_w) = &
    W1_(s_a1, s_i, s_a0, s_w)%array(i_a1, i_i, i_a0, i_w) &
  + Z3_(i_i, i_a1, i_a0, i_w)
end do
end do
end do
end do
...
end subroutine g_sigma_cooo_covv_no1_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_covv_no2_x0_type1_eri_v &
...
call g_sigma_cooo_covv_no2_x0_type1_eri_v &
  (sv1, iv1, av2_i, h2_i, Xcaaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_cooo_covv_no2_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_covv_no2_x0_type1_eri_v &
...
integer :: s_i, i_i, s_v0, i_v0, s_a1, i_a1, s_w, i_w, s_a0, i_a0
! W2(w,a0,i,a1) += (    1.00000000) V2(v1,i,v0,a1) T2(w,a0,v0,v1) 
do s_i = 0, nir-1
do s_v0 = 0, nir-1
do s_a1 = 0, nir-1
do s_w = 0, nir-1
...
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
do i_a1 = psym(I_BEGIN, I_O, s_a1), psym(I_END, I_O, s_a1)
W2_(s_a1, s_i, s_a0, s_w)%array(i_a1, i_i, i_a0, i_w) = &
    W2_(s_a1, s_i, s_a0, s_w)%array(i_a1, i_i, i_a0, i_w) &
...
end subroutine g_sigma_cooo_covv_no2_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_covv_no0_x0_type2_eri_v &
...
call set_symblock_Xcaaa(sleft, W0, nir, nsym, psym) ! -> Xcaaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_covv_no0_x0_type2_eri_v &
  (sj, ij, Xcaaa, av2_i2, d3, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaaa)

end subroutine g_if_sigma_cooo_covv_no0_x0_type2_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_covv_no0_x0_type2_eri_v &
...
integer :: s_w, i_w
! S2(w,k,i,j) += (   -1.00000000) D3(k,j,a2,i,a1,a0) W0(w,a0,a2,a1) 
do s_k = 0, nir-1
do s_a2 = 0, nir-1
do s_i = 0, nir-1
do s_a1 = 0, nir-1
...
end subroutine g_sigma_cooo_covv_no0_x0_type2_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_covv_no1_x0_type2_eri_v &
...
call set_symblock_Xcaaa(sleft, W1, nir, nsym, psym) ! -> Xcaaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_covv_no1_x0_type2_eri_v &
  (sj, ij, Xcaaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaaa)

end subroutine g_if_sigma_cooo_covv_no1_x0_type2_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_covv_no1_x0_type2_eri_v &
...
! S2(w,k,i,j) += (    2.00000000) D2(k,j,a1,a0) W1(w,a0,i,a1) 
do s_k = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_w = 0, nir-1
...
end subroutine g_sigma_cooo_covv_no1_x0_type2_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_covv_no2_x0_type2_eri_v &
...
call set_symblock_Xcaaa(sleft, W2, nir, nsym, psym) ! -> Xcaaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_covv_no2_x0_type2_eri_v &
  (sj, ij, Xcaaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaaa)

end subroutine g_if_sigma_cooo_covv_no2_x0_type2_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_covv_no2_x0_type2_eri_v &
...
integer :: s_k, i_k, s_a1, i_a1, s_a0, i_a0, s_w, i_w, s_i, i_i
! S2(w,k,i,j) += (   -1.00000000) D2(k,j,a1,a0) W2(w,a0,i,a1) 
do s_k = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_w = 0, nir-1
...
end subroutine g_sigma_cooo_covv_no2_x0_type2_eri_v
