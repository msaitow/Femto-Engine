...
#ifndef C_SIGMA_COVV_G_H
#define C_SIGMA_COVV_G_H
...
void FC_FUNC(g_if_sigma_covv_g_no0_x0_type1_eri_v,G_IF_SIGMA_COVV_G_NO0_X0_TYPE1_ERI_V)
...
void FC_FUNC(g_if_sigma_covv_g_no1_x0_type1_eri_v,G_IF_SIGMA_COVV_G_NO1_X0_TYPE1_ERI_V)
  (const FC_INT &sb, const FC_INT &ib, 
   const double * const T0, 
   const double * const V2, const double * const S2, 
   const FC_INT &nir, const FC_INT * const nsym,  const FC_INT * const psym, const double * const);
