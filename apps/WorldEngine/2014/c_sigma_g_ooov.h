...
void FC_FUNC(g_if_sigma_g_ooov_no0_x0_type0_noeri,G_IF_SIGMA_G_OOOV_NO0_X0_TYPE0_NOERI)
...
void FC_FUNC(g_if_sigma_g_ooov_no0_x1_type0_noeri,G_IF_SIGMA_G_OOOV_NO0_X1_TYPE0_NOERI)
  (const FC_INT &sa2, const FC_INT &ia2, 
   const double * const T2, const double * const W0, const double * const S0, 
   const FC_INT &nir, const FC_INT * const nsym,  const FC_INT * const psym, const double * const);

void FC_FUNC(g_if_sigma_g_ooov_no0_x0_type1_eri_v,G_IF_SIGMA_G_OOOV_NO0_X0_TYPE1_ERI_V)
  (const FC_INT &sa2, const FC_INT &ia2, const FC_INT &sv0, const FC_INT &iv0, 
   const double * const V2, const double * const W1, 
   const FC_INT &nir, const FC_INT * const nsym,  const FC_INT * const psym, const double * const);

void FC_FUNC(g_if_sigma_g_ooov_no0_x1_type1_eri_v,G_IF_SIGMA_G_OOOV_NO0_X1_TYPE1_ERI_V)
  (const FC_INT &sa2, const FC_INT &ia2, const FC_INT &sv0, const FC_INT &iv0, 
   const double * const T2, const double * const W1, const double * const S0, 
   const FC_INT &nir, const FC_INT * const nsym,  const FC_INT * const psym, const double * const);

void FC_FUNC(g_if_sigma_g_ooov_no1_x0_type1_eri_v,G_IF_SIGMA_G_OOOV_NO1_X0_TYPE1_ERI_V)
  (const FC_INT &sv0, const FC_INT &iv0, 
   const double * const V2, const double * const W2, 
   const FC_INT &nir, const FC_INT * const nsym,  const FC_INT * const psym, const double * const);

void FC_FUNC(g_if_sigma_g_ooov_no1_x1_type1_eri_v,G_IF_SIGMA_G_OOOV_NO1_X1_TYPE1_ERI_V)
  (const FC_INT &sv0, const FC_INT &iv0, 
