...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no0_x0_type0_noeri &
...
call g_sigma_covv_ocov_no0_x0_type0_noeri &
  (sb, ib, av2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_covv_ocov_no0_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no0_x0_type0_noeri &
...
! W0(w,i,a2,b) += (    1.00000000) T2(a0,w,a1,b) D2(i,a2,a1,a0) 
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_covv_ocov_no0_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no0_x1_type0_noeri &
...
call g_sigma_covv_ocov_no0_x1_type0_noeri &
  (sb, ib, Xcaa, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_covv_ocov_no0_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no0_x1_type0_noeri &
...
end subroutine g_sigma_covv_ocov_no0_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no1_x0_type0_noeri &
...
sleft = 0
call set_symblock_Xcaav(sleft, W1, nir, nsym, psym) ! -> Xcaav (allocate) 
call g_sigma_covv_ocov_no1_x0_type0_noeri &
  (sa1, ia1, av2_i, Xcaav, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaav)

end subroutine g_if_sigma_covv_ocov_no1_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no1_x0_type0_noeri &
...
integer :: s_w, i_w, s_a0, i_a0, s_a, i_a, s_i, i_i, s_a2, i_a2
! W1(w,i,a2,a) += (    1.00000000) T2(w,a0,a,a1) D2(i,a2,a1,a0) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_a = 0, nir-1
do s_i = 0, nir-1
...
do i_a2 = psym(I_BEGIN, I_O, s_a2), psym(I_END, I_O, s_a2)
do i_a = psym(I_BEGIN, I_V, s_a), psym(I_END, I_V, s_a)
W1_(s_a, s_a2, s_i, s_w)%array(i_a, i_a2, i_i, i_w) = &
    W1_(s_a, s_a2, s_i, s_w)%array(i_a, i_a2, i_i, i_w) &
  + Z3_(i_w, i_a, i_i, i_a2)
end do
end do
end do
end do
...
end subroutine g_sigma_covv_ocov_no1_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no1_x1_type0_noeri &
...
call set_symblock_Xcaav(sleft, W1, nir, nsym, psym) ! -> Xcaav (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_covv_ocov_no1_x1_type0_noeri &
  (sb, ib, Xcaav, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaav)

end subroutine g_if_sigma_covv_ocov_no1_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no1_x1_type0_noeri &
...
! S2(w,i,a,b) += (    2.00000000) Fc1(b,a2) W1(w,i,a2,a) 
do s_a2 = 0, nir-1
do s_w = 0, nir-1
do s_i = 0, nir-1
do s_a = 0, nir-1
...
if(psym(I_LENGTH,I_C, s_w)*psym(I_LENGTH,I_O, s_i)*psym(I_LENGTH,I_V, s_a) > 0 .and. &
   psym(I_LENGTH,I_O, s_a2) > 0) then
...
end subroutine g_sigma_covv_ocov_no1_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no2_x0_type0_noeri &
...
call g_sigma_covv_ocov_no2_x0_type0_noeri &
  (sa1, ia1, av2_i, Xcav, d1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcav)

end subroutine g_if_sigma_covv_ocov_no2_x0_type0_noeri
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no2_x0_type0_noeri &
  (s_a1, i_a1, T2_, W2_, D1_, nir, nsym, psym, flops)
...
! W2(w,i,a1,a) += (    1.00000000) T2(w,a0,a,a1) D1(i,a0) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_a = 0, nir-1
do s_i = 0, nir-1
...
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
do i_a = psym(I_BEGIN, I_V, s_a), psym(I_END, I_V, s_a)
W2_(s_a, s_i, s_w)%array(i_a, i_i, i_w) = &
    W2_(s_a, s_i, s_w)%array(i_a, i_i, i_w) &
  + Z3_(i_w, i_a, i_i)
end do
end do
...
end subroutine g_sigma_covv_ocov_no2_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no2_x1_type0_noeri &
  (sa1, ia1, sb, ib, W2, S2, nir, nsym, psym, flops)
...
call set_symblock_Xcav(sleft, W2, nir, nsym, psym) ! -> Xcav (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_covv_ocov_no2_x1_type0_noeri &
  (sa1, ia1, sb, ib, Xcav, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcav)

end subroutine g_if_sigma_covv_ocov_no2_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no2_x1_type0_noeri &
  (s_a1, i_a1, s_b, i_b, W2_, S2_, Fc1_, nir, nsym, psym, flops)
...
! S2(w,i,a,b) += (    2.00000000) Fc1(b,a1) W2(w,i,a1,a) 
do s_w = 0, nir-1
do s_i = 0, nir-1
do s_a = 0, nir-1
if( &
...
end subroutine g_sigma_covv_ocov_no2_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no3_x0_type0_noeri &
...
call g_sigma_covv_ocov_no3_x0_type0_noeri &
  (sb, ib, av2_i, Xcaa, d1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_covv_ocov_no3_x0_type0_noeri
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no3_x0_type0_noeri &
...
! W3(w,i,a1,b) += (    1.00000000) T2(a0,w,a1,b) D1(i,a0) 
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_covv_ocov_no3_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no3_x1_type0_noeri &
...
call set_symblock_Xcaa(sleft, W3, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_covv_ocov_no3_x1_type0_noeri &
  (sb, ib, Xcaa, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_covv_ocov_no3_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no3_x1_type0_noeri &
...
! S2(w,i,a,b) += (   -1.00000000) Fc1(a1,a) W3(w,i,a1,b) 
do s_a1 = 0, nir-1
do s_a = 0, nir-1
do s_w = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_covv_ocov_no3_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no0_x0_type1_eri_c &
...
call g_sigma_covv_ocov_no0_x0_type1_eri_c &
  (sb, ib, sc0, ic0, av2_i, Xaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xaa)

end subroutine g_if_sigma_covv_ocov_no0_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no0_x0_type1_eri_c &
...
! W4(c0,i,a2,b) += (    1.00000000) T2(a0,c0,a1,b) D2(i,a2,a1,a0) 
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
do s_a2 = 0, nir-1
...
IEOR(s_a0,s_c0) == IEOR(s_a1,s_b) .and. &
IEOR(s_i,s_a2) == IEOR(s_a1,s_a0)) then
...
end subroutine g_sigma_covv_ocov_no0_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no0_x1_type1_eri_c &
...
call set_symblock_Xaa(sleft, W4, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_covv_ocov_no0_x1_type1_eri_c &
...
end subroutine g_if_sigma_covv_ocov_no0_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no0_x1_type1_eri_c &
...
end subroutine g_sigma_covv_ocov_no0_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no1_x0_type1_eri_c &
...
call g_sigma_covv_ocov_no1_x0_type1_eri_c &
  (sb, ib, sc0, ic0, av2_i, Xaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xaa)

end subroutine g_if_sigma_covv_ocov_no1_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no1_x0_type1_eri_c &
...
integer :: s_a0, i_a0, s_a1, i_a1, s_i, i_i, s_a2, i_a2
! W5(c0,i,a2,b) += (    1.00000000) T2(a0,c0,a1,b) D2(i,a2,a1,a0) 
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
do s_a2 = 0, nir-1
...
end subroutine g_sigma_covv_ocov_no1_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no1_x1_type1_eri_c &
...
call set_symblock_Xaa(sleft, W5, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_covv_ocov_no1_x1_type1_eri_c &
  (sb, ib, sc0, ic0, h2_i, Xaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_covv_ocov_no1_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no1_x1_type1_eri_c &
...
end subroutine g_sigma_covv_ocov_no1_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no2_x0_type1_eri_c &
...
call g_sigma_covv_ocov_no2_x0_type1_eri_c &
...
end subroutine g_if_sigma_covv_ocov_no2_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no2_x0_type1_eri_c &
...
! W10(w,a0,b,a) += (    1.00000000) V2(w,a,c0,a1) T2(a0,c0,a1,b) 
do s_a = 0, nir-1
do s_c0 = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
...
IEOR(s_a0,s_c0) == IEOR(s_a1,s_b)) then
...
end subroutine g_sigma_covv_ocov_no2_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no2_x1_type1_eri_c &
...
call set_symblock_Xav(sleft, W10, nir, nsym, psym) ! -> Xav (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_covv_ocov_no2_x1_type1_eri_c &
  (sb, ib, sw, iw, Xav, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xav)

end subroutine g_if_sigma_covv_ocov_no2_x1_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no2_x1_type1_eri_c &
...
! S2(w,i,a,b) += (   -2.00000000) D1(i,a0) W10(w,a0,b,a) 
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_a = 0, nir-1
if( &
...
end subroutine g_sigma_covv_ocov_no2_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no3_x0_type1_eri_c &
...
call g_sigma_covv_ocov_no3_x0_type1_eri_c &
  (sb, ib, sw, iw, av2_i, h2_i, Xav, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_covv_ocov_no3_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no3_x0_type1_eri_c &
...
! W16(w,a0,b,a) += (    1.00000000) V2(w,c0,a1,a) T2(a0,c0,a1,b) 
do s_c0 = 0, nir-1
do s_a1 = 0, nir-1
do s_a = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_covv_ocov_no3_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no3_x1_type1_eri_c &
...
call set_symblock_Xav(sleft, W16, nir, nsym, psym) ! -> Xav (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_covv_ocov_no3_x1_type1_eri_c &
  (sb, ib, sw, iw, Xav, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xav)

end subroutine g_if_sigma_covv_ocov_no3_x1_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no3_x1_type1_eri_c &
...
integer :: s_i, i_i, s_a0, i_a0, s_a, i_a
! S2(w,i,a,b) += (    1.00000000) D1(i,a0) W16(w,a0,b,a) 
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_a = 0, nir-1
if( &
...
end subroutine g_sigma_covv_ocov_no3_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no0_x0_type1_eri_o &
...
call g_sigma_covv_ocov_no0_x0_type1_eri_o &
  (sa1, ia1, h2_i, Xaav, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaav)

end subroutine g_if_sigma_covv_ocov_no0_x0_type1_eri_o
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no0_x0_type1_eri_o &
...
! W11(i,a0,a1,a) += (    1.00000000) V2(a1,a3,a2,a) D2(i,a2,a3,a0) 
do s_a3 = 0, nir-1
do s_a2 = 0, nir-1
do s_a = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_covv_ocov_no0_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no0_x1_type1_eri_o &
...
call set_symblock_Xaav(sleft, W11, nir, nsym, psym) ! -> Xaav (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_covv_ocov_no0_x1_type1_eri_o &
...
end subroutine g_if_sigma_covv_ocov_no0_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no0_x1_type1_eri_o &
...
! S2(w,i,a,b) += (   -1.00000000) T2(w,a0,b,a1) W11(i,a0,a1,a) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
do s_a = 0, nir-1
if( &
IEOR(s_w,s_i) == IEOR(s_a,s_b) .and. & 
IEOR(s_w,s_a0) == IEOR(s_b,s_a1) .and. &
...
end subroutine g_sigma_covv_ocov_no0_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no1_x0_type1_eri_o &
...
call g_sigma_covv_ocov_no1_x0_type1_eri_o &
  (sa2, ia2, h2_i, Xaav, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaav)

end subroutine g_if_sigma_covv_ocov_no1_x0_type1_eri_o
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no1_x0_type1_eri_o &
...
end subroutine g_sigma_covv_ocov_no1_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no1_x1_type1_eri_o &
...
call set_symblock_Xaav(sleft, W17, nir, nsym, psym) ! -> Xaav (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_covv_ocov_no1_x1_type1_eri_o &
...
end subroutine g_if_sigma_covv_ocov_no1_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no1_x1_type1_eri_o &
...
integer :: s_w, i_w, s_a0, i_a0, s_i, i_i, s_a, i_a
! S2(w,i,a,b) += (   -1.00000000) T2(w,a0,b,a2) W17(i,a0,a2,a) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
do s_a = 0, nir-1
if( &
IEOR(s_w,s_i) == IEOR(s_a,s_b) .and. & 
IEOR(s_w,s_a0) == IEOR(s_b,s_a2) .and. &
...
end subroutine g_sigma_covv_ocov_no1_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no0_x0_type0_eri_v &
  (sa1, ia1, T2, W7, nir, nsym, psym, flops)
...
call g_sigma_covv_ocov_no0_x0_type0_eri_v &
  (sa1, ia1, av2_i, Xcaav, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaav)

end subroutine g_if_sigma_covv_ocov_no0_x0_type0_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no0_x0_type0_eri_v &
  (s_a1, i_a1, T2_, W7_, D2_, nir, nsym, psym, flops)
...
integer :: s_c0, i_c0, s_a0, i_a0, s_a, i_a, s_i, i_i, s_a2, i_a2
! W7(c0,i,a2,a) += (    1.00000000) T2(c0,a0,a,a1) D2(i,a2,a1,a0) 
do s_c0 = 0, nir-1
do s_a0 = 0, nir-1
do s_a = 0, nir-1
do s_i = 0, nir-1
...
IEOR(s_c0,s_a0) == IEOR(s_a,s_a1) .and. &
IEOR(s_i,s_a2) == IEOR(s_a1,s_a0)) then
...
end subroutine g_sigma_covv_ocov_no0_x0_type0_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no1_x0_type0_eri_v &
...
call g_sigma_covv_ocov_no1_x0_type0_eri_v &
  (sa1, ia1, av2_i, Xcaav, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaav)

end subroutine g_if_sigma_covv_ocov_no1_x0_type0_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no1_x0_type0_eri_v &
...
integer :: s_c0, i_c0, s_a0, i_a0, s_a, i_a, s_i, i_i, s_a2, i_a2
! W8(c0,i,a2,a) += (    1.00000000) T2(c0,a0,a,a1) D2(i,a2,a1,a0) 
do s_c0 = 0, nir-1
do s_a0 = 0, nir-1
do s_a = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_covv_ocov_no1_x0_type0_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no0_x0_type1_eri_v &
...
call g_sigma_covv_ocov_no0_x0_type1_eri_v &
  (sa, ia, h2_i, Xaaa, d3, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_covv_ocov_no0_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no0_x0_type1_eri_v &
...
integer :: s_a0, i_a0
! W6(i,a1,a0,a) += (    1.00000000) V2(a,a3,a4,a2) D3(i,a3,a4,a2,a1,a0) 
do s_a3 = 0, nir-1
do s_a4 = 0, nir-1
do s_a2 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_covv_ocov_no0_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no0_x1_type1_eri_v &
...
call set_symblock_Xaaa(sleft, W6, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_covv_ocov_no0_x1_type1_eri_v &
...
end subroutine g_if_sigma_covv_ocov_no0_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no0_x1_type1_eri_v &
...
integer :: s_a0, i_a0, s_w, i_w, s_a1, i_a1, s_i, i_i
! S2(w,i,a,b) += (   -1.00000000) T2(a0,w,a1,b) W6(i,a1,a0,a) 
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_covv_ocov_no0_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no1_x0_type1_eri_v &
...
call set_symblock_Xcaav(sleft, W7, nir, nsym, psym) ! -> Xcaav (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_covv_ocov_no1_x0_type1_eri_v &
...
end subroutine g_if_sigma_covv_ocov_no1_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no1_x0_type1_eri_v &
...
end subroutine g_sigma_covv_ocov_no1_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no2_x0_type1_eri_v &
...
call set_symblock_Xcaav(sleft, W8, nir, nsym, psym) ! -> Xcaav (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_covv_ocov_no2_x0_type1_eri_v &
  (sb, ib, h2_i, Xcaav, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_covv_ocov_no2_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no2_x0_type1_eri_v &
...
! S2(w,i,a,b) += (   -2.00000000) V2(b,a2,w,c0) W8(c0,i,a2,a) 
do s_a2 = 0, nir-1
do s_w = 0, nir-1
do s_c0 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_covv_ocov_no2_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no3_x0_type1_eri_v &
  (sa1, ia1, sb, ib, V2, W9, nir, nsym, psym, flops)
...
call g_sigma_covv_ocov_no3_x0_type1_eri_v &
  (sa1, ia1, sb, ib, h2_i, Xaa, d3, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaa)

end subroutine g_if_sigma_covv_ocov_no3_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no3_x0_type1_eri_v &
  (s_a1, i_a1, s_b, i_b, V2_, W9_, D3_, nir, nsym, psym, flops)
...
end subroutine g_sigma_covv_ocov_no3_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no3_x1_type1_eri_v &
  (sa1, ia1, sb, ib, T2, W9, S2, nir, nsym, psym, flops)
...
call set_symblock_Xaa(sleft, W9, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_covv_ocov_no3_x1_type1_eri_v &
  (sa1, ia1, sb, ib, av2_i, Xaa, av2_i2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(av2_i)
deallocate(Xaa)

end subroutine g_if_sigma_covv_ocov_no3_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no3_x1_type1_eri_v &
  (s_a1, i_a1, s_b, i_b, T2_, W9_, S2_, nir, nsym, psym, flops)
...
integer :: s_w, i_w, s_a0, i_a0, s_a, i_a, s_i, i_i
! S2(w,i,a,b) += (    2.00000000) T2(w,a0,a,a1) W9(i,a1,a0,b) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_a = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_covv_ocov_no3_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no4_x0_type1_eri_v &
  (sa1, ia1, sb, ib, T2, V2, W12, nir, nsym, psym, flops)
...
call g_sigma_covv_ocov_no4_x0_type1_eri_v &
...
end subroutine g_if_sigma_covv_ocov_no4_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no4_x0_type1_eri_v &
  (s_a1, i_a1, s_b, i_b, T2_, V2_, W12_, nir, nsym, psym, flops)
...
! W12(w,a0,a,b) += (    1.00000000) V2(b,w,c0,a1) T2(c0,a0,a,a1) 
do s_w = 0, nir-1
do s_c0 = 0, nir-1
do s_a0 = 0, nir-1
do s_a = 0, nir-1
...
IEOR(s_c0,s_a0) == IEOR(s_a,s_a1)) then
...
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
do i_a = psym(I_BEGIN, I_V, s_a), psym(I_END, I_V, s_a)
W12_(s_a, s_a0, s_w)%array(i_a, i_a0, i_w) = &
    W12_(s_a, s_a0, s_w)%array(i_a, i_a0, i_w) &
  + Z3_(i_a0, i_a, i_w)
end do
end do
...
end subroutine g_sigma_covv_ocov_no4_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no4_x1_type1_eri_v &
  (sb, ib, W12, S2, nir, nsym, psym, flops)
...
call set_symblock_Xcav(sleft, W12, nir, nsym, psym) ! -> Xcav (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_covv_ocov_no4_x1_type1_eri_v &
  (sb, ib, Xcav, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcav)

end subroutine g_if_sigma_covv_ocov_no4_x1_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no4_x1_type1_eri_v &
  (s_b, i_b, W12_, S2_, D1_, nir, nsym, psym, flops)
...
! S2(w,i,a,b) += (    1.00000000) D1(i,a0) W12(w,a0,a,b) 
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_a = 0, nir-1
...
end subroutine g_sigma_covv_ocov_no4_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no5_x0_type1_eri_v &
  (sa1, ia1, sb, ib, V2, W13, nir, nsym, psym, flops)
...
call g_sigma_covv_ocov_no5_x0_type1_eri_v &
  (sa1, ia1, sb, ib, h2_i, Xaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaa)

end subroutine g_if_sigma_covv_ocov_no5_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no5_x0_type1_eri_v &
  (s_a1, i_a1, s_b, i_b, V2_, W13_, D2_, nir, nsym, psym, flops)
...
integer :: s_a2, i_a2, s_a3, i_a3, s_i, i_i, s_a0, i_a0
...
end subroutine g_sigma_covv_ocov_no5_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no5_x1_type1_eri_v &
  (sa1, ia1, sb, ib, T2, W13, S2, nir, nsym, psym, flops)
...
call set_symblock_Xaa(sleft, W13, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_covv_ocov_no5_x1_type1_eri_v &
  (sa1, ia1, sb, ib, av2_i, Xaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_covv_ocov_no5_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no5_x1_type1_eri_v &
  (s_a1, i_a1, s_b, i_b, T2_, W13_, S2_, nir, nsym, psym, flops)
...
integer :: s_w, i_w, s_a0, i_a0, s_a, i_a, s_i, i_i
! S2(w,i,a,b) += (    2.00000000) T2(w,a0,a,a1) W13(i,a0,a1,b) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_a = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_covv_ocov_no5_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no6_x0_type1_eri_v &
  (sa1, ia1, sb, ib, T2, V2, W14, nir, nsym, psym, flops)
...
call g_sigma_covv_ocov_no6_x0_type1_eri_v &
  (sa1, ia1, sb, ib, av2_i, h2_i, Xcav, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_covv_ocov_no6_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no6_x0_type1_eri_v &
  (s_a1, i_a1, s_b, i_b, T2_, V2_, W14_, nir, nsym, psym, flops)
...
integer :: s_w, i_w, s_c0, i_c0, s_a0, i_a0, s_a, i_a
! W14(w,a0,a,b) += (    1.00000000) V2(b,a1,w,c0) T2(c0,a0,a,a1) 
do s_w = 0, nir-1
do s_c0 = 0, nir-1
do s_a0 = 0, nir-1
do s_a = 0, nir-1
...
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
do i_a = psym(I_BEGIN, I_V, s_a), psym(I_END, I_V, s_a)
W14_(s_a, s_a0, s_w)%array(i_a, i_a0, i_w) = &
    W14_(s_a, s_a0, s_w)%array(i_a, i_a0, i_w) &
  + Z3_(i_a0, i_a, i_w)
end do
end do
...
end subroutine g_sigma_covv_ocov_no6_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no6_x1_type1_eri_v &
  (sb, ib, W14, S2, nir, nsym, psym, flops)
...
call set_symblock_Xcav(sleft, W14, nir, nsym, psym) ! -> Xcav (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_covv_ocov_no6_x1_type1_eri_v &
  (sb, ib, Xcav, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcav)

end subroutine g_if_sigma_covv_ocov_no6_x1_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no6_x1_type1_eri_v &
  (s_b, i_b, W14_, S2_, D1_, nir, nsym, psym, flops)
...
integer :: s_i, i_i, s_a0, i_a0, s_w, i_w, s_a, i_a
! S2(w,i,a,b) += (   -2.00000000) D1(i,a0) W14(w,a0,a,b) 
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_a = 0, nir-1
...
end subroutine g_sigma_covv_ocov_no6_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no7_x0_type1_eri_v &
  (sa2, ia2, sb, ib, V2, W15, nir, nsym, psym, flops)
...
call g_sigma_covv_ocov_no7_x0_type1_eri_v &
  (sa2, ia2, sb, ib, h2_i, Xaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaa)

end subroutine g_if_sigma_covv_ocov_no7_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no7_x0_type1_eri_v &
  (s_a2, i_a2, s_b, i_b, V2_, W15_, D2_, nir, nsym, psym, flops)
...
end subroutine g_sigma_covv_ocov_no7_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no7_x1_type1_eri_v &
  (sa2, ia2, sb, ib, T2, W15, S2, nir, nsym, psym, flops)
...
call set_symblock_Xaa(sleft, W15, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_covv_ocov_no7_x1_type1_eri_v &
  (sa2, ia2, sb, ib, av2_i, Xaa, av2_i2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(av2_i)
deallocate(Xaa)

end subroutine g_if_sigma_covv_ocov_no7_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no7_x1_type1_eri_v &
  (s_a2, i_a2, s_b, i_b, T2_, W15_, S2_, nir, nsym, psym, flops)
...
integer :: s_w, i_w, s_a0, i_a0, s_a, i_a, s_i, i_i
! S2(w,i,a,b) += (    2.00000000) T2(w,a0,a,a2) W15(i,a0,a2,b) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_a = 0, nir-1
do s_i = 0, nir-1
if( &
IEOR(s_w,s_i) == IEOR(s_a,s_b) .and. & 
IEOR(s_w,s_a0) == IEOR(s_a,s_a2) .and. &
...
end subroutine g_sigma_covv_ocov_no7_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no8_x0_type1_eri_v &
...
call g_sigma_covv_ocov_no8_x0_type1_eri_v &
  (sv0, iv0, av2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_covv_ocov_no8_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no8_x0_type1_eri_v &
...
integer :: s_a0, i_a0, s_w, i_w, s_a1, i_a1, s_i, i_i, s_a2, i_a2
! W18(w,i,a2,v0) += (    1.00000000) T2(a0,w,a1,v0) D2(i,a2,a1,a0) 
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_covv_ocov_no8_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no8_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W18, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_covv_ocov_no8_x1_type1_eri_v &
...
end subroutine g_if_sigma_covv_ocov_no8_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no8_x1_type1_eri_v &
...
end subroutine g_sigma_covv_ocov_no8_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no9_x0_type1_eri_v &
...
call g_sigma_covv_ocov_no9_x0_type1_eri_v &
  (sv0, iv0, av2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_covv_ocov_no9_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no9_x0_type1_eri_v &
...
integer :: s_a0, i_a0, s_w, i_w, s_a1, i_a1, s_i, i_i, s_a2, i_a2
! W19(w,i,a2,v0) += (    1.00000000) T2(a0,w,a1,v0) D2(i,a2,a1,a0) 
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_covv_ocov_no9_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no9_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W19, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_covv_ocov_no9_x1_type1_eri_v &
  (sb, ib, sv0, iv0, h2_i, Xcaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_covv_ocov_no9_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no9_x1_type1_eri_v &
...
! S2(w,i,a,b) += (    2.00000000) V2(v0,a,b,a2) W19(w,i,a2,v0) 
do s_a = 0, nir-1
do s_a2 = 0, nir-1
do s_w = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_covv_ocov_no9_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no10_x0_type1_eri_v &
  (sa1, ia1, sb, ib, T2, V2, W20, nir, nsym, psym, flops)
...
call g_sigma_covv_ocov_no10_x0_type1_eri_v &
  (sa1, ia1, sb, ib, av2_i, h2_i, Xcav, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_covv_ocov_no10_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no10_x0_type1_eri_v &
  (s_a1, i_a1, s_b, i_b, T2_, V2_, W20_, nir, nsym, psym, flops)
...
! W20(w,a0,b,a) += (    1.00000000) V2(b,v0,a1,a) T2(w,a0,v0,a1) 
do s_v0 = 0, nir-1
do s_a = 0, nir-1
do s_w = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_covv_ocov_no10_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no10_x1_type1_eri_v &
...
call set_symblock_Xcav(sleft, W20, nir, nsym, psym) ! -> Xcav (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_covv_ocov_no10_x1_type1_eri_v &
  (sb, ib, Xcav, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcav)

end subroutine g_if_sigma_covv_ocov_no10_x1_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no10_x1_type1_eri_v &
...
integer :: s_i, i_i, s_a0, i_a0, s_w, i_w, s_a, i_a
! S2(w,i,a,b) += (   -1.00000000) D1(i,a0) W20(w,a0,b,a) 
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_a = 0, nir-1
...
end subroutine g_sigma_covv_ocov_no10_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no11_x0_type1_eri_v &
  (sa1, ia1, sb, ib, T2, V2, W21, nir, nsym, psym, flops)
...
call g_sigma_covv_ocov_no11_x0_type1_eri_v &
  (sa1, ia1, sb, ib, av2_i, h2_i, Xcav, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_covv_ocov_no11_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no11_x0_type1_eri_v &
  (s_a1, i_a1, s_b, i_b, T2_, V2_, W21_, nir, nsym, psym, flops)
...
integer :: s_v0, i_v0, s_a, i_a, s_w, i_w, s_a0, i_a0
! W21(w,a0,b,a) += (    1.00000000) V2(b,a1,v0,a) T2(w,a0,v0,a1) 
do s_v0 = 0, nir-1
do s_a = 0, nir-1
do s_w = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_covv_ocov_no11_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_covv_ocov_no11_x1_type1_eri_v &
...
call set_symblock_Xcav(sleft, W21, nir, nsym, psym) ! -> Xcav (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_covv_ocov_no11_x1_type1_eri_v &
  (sb, ib, Xcav, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcav)

end subroutine g_if_sigma_covv_ocov_no11_x1_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_covv_ocov_no11_x1_type1_eri_v &
...
integer :: s_i, i_i, s_a0, i_a0, s_w, i_w, s_a, i_a
! S2(w,i,a,b) += (    2.00000000) D1(i,a0) W21(w,a0,b,a) 
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_a = 0, nir-1
...
end subroutine g_sigma_covv_ocov_no11_x1_type1_eri_v
