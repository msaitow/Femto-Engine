...
#ifndef C_SIGMA_G_COVV_H
#define C_SIGMA_G_COVV_H
...
void FC_FUNC(g_if_sigma_g_covv_no0_x0_type1_eri_v,G_IF_SIGMA_G_COVV_NO0_X0_TYPE1_ERI_V)
...
void FC_FUNC(g_if_sigma_g_covv_no0_x1_type1_eri_v,G_IF_SIGMA_G_COVV_NO0_X1_TYPE1_ERI_V)
  (const FC_INT &sv0, const FC_INT &iv0, const FC_INT &sv1, const FC_INT &iv1, 
   const double * const T2, const double * const W0, const double * const S0, 
   const FC_INT &nir, const FC_INT * const nsym,  const FC_INT * const psym, const double * const);

void FC_FUNC(g_if_sigma_g_covv_no1_x0_type1_eri_v,G_IF_SIGMA_G_COVV_NO1_X0_TYPE1_ERI_V)
  (const FC_INT &sv1, const FC_INT &iv1, 
   const double * const V2, const double * const W1, 
   const FC_INT &nir, const FC_INT * const nsym,  const FC_INT * const psym, const double * const);

void FC_FUNC(g_if_sigma_g_covv_no1_x1_type1_eri_v,G_IF_SIGMA_G_COVV_NO1_X1_TYPE1_ERI_V)
  (const FC_INT &sv1, const FC_INT &iv1, 
