...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no0_x0_type0_noeri &
...
call g_sigma_coov_cooo_no0_x0_type0_noeri &
  (sa0, ia0, av2_i, Xcaaa, d3, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaaa)

end subroutine g_if_sigma_coov_cooo_no0_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no0_x0_type0_noeri &
...
integer :: s_w, i_w, s_a2, i_a2, s_a1, i_a1, s_j, i_j, s_a3, i_a3
integer :: s_i, i_i
! W0(w,j,a3,i) += (    1.00000000) T2(w,a2,a1,a0) D3(j,a1,a3,i,a2,a0) 
do s_w = 0, nir-1
do s_a2 = 0, nir-1
do s_a1 = 0, nir-1
do s_j = 0, nir-1
...
IEOR(IEOR(s_j,s_a1),s_a3) == IEOR(IEOR(s_i,s_a2),s_a0)) then
...
Z1_(i_j, i_a3, i_i, i_a1, i_a2) =  &
  D3_(s_a0, s_a2, s_i, s_a3, s_a1, s_j)%array(i_a0, i_a2, i_i, i_a3, i_a1, i_j)
end do
end do
end do
end do
...
end subroutine g_sigma_coov_cooo_no0_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no0_x1_type0_noeri &
...
call g_sigma_coov_cooo_no0_x1_type0_noeri &
  (sa, ia, Xcaaa, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaaa)

end subroutine g_if_sigma_coov_cooo_no0_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no0_x1_type0_noeri &
...
! S2(w,i,j,a) += (   -1.00000000) Fc1(a3,a) W0(w,j,a3,i) 
do s_a3 = 0, nir-1
do s_w = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_cooo_no0_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no1_x0_type0_noeri &
...
call g_sigma_coov_cooo_no1_x0_type0_noeri &
  (sa1, ia1, av2_i, Xcaaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaaa)

end subroutine g_if_sigma_coov_cooo_no1_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no1_x0_type0_noeri &
...
end subroutine g_sigma_coov_cooo_no1_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no1_x1_type0_noeri &
...
call set_symblock_Xcaaa(sleft, W1, nir, nsym, psym) ! -> Xcaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no1_x1_type0_noeri &
  (sa, ia, Xcaaa, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaaa)

end subroutine g_if_sigma_coov_cooo_no1_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no1_x1_type0_noeri &
...
! S2(w,i,j,a) += (    2.00000000) Fc1(a2,a) W1(w,i,a2,j) 
do s_a2 = 0, nir-1
do s_w = 0, nir-1
do s_i = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_coov_cooo_no1_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no2_x0_type0_noeri &
...
call g_sigma_coov_cooo_no2_x0_type0_noeri &
  (sj, ij, av2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_cooo_no2_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no2_x0_type0_noeri &
...
! W2(w,i,a2,j) += (    1.00000000) T2(w,a0,a1,j) D2(i,a2,a1,a0) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_cooo_no2_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no2_x1_type0_noeri &
...
call set_symblock_Xcaa(sleft, W2, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no2_x1_type0_noeri &
  (sa, ia, sj, ij, Xcaa, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_cooo_no2_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no2_x1_type0_noeri &
...
! S2(w,i,j,a) += (   -1.00000000) Fc1(a2,a) W2(w,i,a2,j) 
do s_a2 = 0, nir-1
do s_w = 0, nir-1
do s_i = 0, nir-1
if( &
...
end subroutine g_sigma_coov_cooo_no2_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no3_x0_type0_noeri &
...
call g_sigma_coov_cooo_no3_x0_type0_noeri &
  (sa0, ia0, av2_i, Xcaaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaaa)

end subroutine g_if_sigma_coov_cooo_no3_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no3_x0_type0_noeri &
...
end subroutine g_sigma_coov_cooo_no3_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no3_x1_type0_noeri &
...
call set_symblock_Xcaaa(sleft, W3, nir, nsym, psym) ! -> Xcaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no3_x1_type0_noeri &
  (sa, ia, Xcaaa, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaaa)

end subroutine g_if_sigma_coov_cooo_no3_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no3_x1_type0_noeri &
...
! S2(w,i,j,a) += (   -1.00000000) Fc1(a2,a) W3(w,j,i,a2) 
do s_a2 = 0, nir-1
do s_w = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_cooo_no3_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no4_x0_type0_noeri &
...
call g_sigma_coov_cooo_no4_x0_type0_noeri &
  (sj, ij, av2_i, Xcaa, d1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_cooo_no4_x0_type0_noeri
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no4_x0_type0_noeri &
...
end subroutine g_sigma_coov_cooo_no4_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no4_x1_type0_noeri &
...
call set_symblock_Xcaa(sleft, W4, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no4_x1_type0_noeri &
  (sa, ia, sj, ij, Xcaa, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_cooo_no4_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no4_x1_type0_noeri &
...
! S2(w,i,j,a) += (   -1.00000000) Fc1(a1,a) W4(w,i,a1,j) 
do s_a1 = 0, nir-1
do s_w = 0, nir-1
do s_i = 0, nir-1
if( &
...
end subroutine g_sigma_coov_cooo_no4_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no5_x0_type0_noeri &
...
call g_sigma_coov_cooo_no5_x0_type0_noeri &
  (sa2, ia2, av2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_cooo_no5_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no5_x0_type0_noeri &
...
! W5(w,j,i,a2) += (    1.00000000) T2(w,a1,a0,a2) D2(j,a0,a1,i) 
do s_w = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_coov_cooo_no5_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no5_x1_type0_noeri &
...
call set_symblock_Xcaa(sleft, W5, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no5_x1_type0_noeri &
  (sa, ia, sa2, ia2, Xcaa, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_cooo_no5_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no5_x1_type0_noeri &
...
! S2(w,i,j,a) += (   -1.00000000) Fc1(a2,a) W5(w,j,i,a2) 
do s_w = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
if( &
...
end subroutine g_sigma_coov_cooo_no5_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no6_x0_type0_noeri &
...
call g_sigma_coov_cooo_no6_x0_type0_noeri &
  (sa1, ia1, av2_i, Xcaa, d1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_cooo_no6_x0_type0_noeri
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no6_x0_type0_noeri &
...
end subroutine g_sigma_coov_cooo_no6_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no6_x1_type0_noeri &
...
call set_symblock_Xcaa(sleft, W6, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no6_x1_type0_noeri &
  (sa, ia, sa1, ia1, Xcaa, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_cooo_no6_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no6_x1_type0_noeri &
...
! S2(w,i,j,a) += (    2.00000000) Fc1(a1,a) W6(w,i,j,a1) 
do s_w = 0, nir-1
do s_i = 0, nir-1
do s_j = 0, nir-1
if( &
...
end subroutine g_sigma_coov_cooo_no6_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no0_x0_type1_eri_o &
...
call g_sigma_coov_cooo_no0_x0_type1_eri_o &
  (sa2, ia2, av2_i, Xcaaaa, d3, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaaaa)

end subroutine g_if_sigma_coov_cooo_no0_x0_type1_eri_o
...
! >> Score :: 111111
! The best shot!
! RDM is rotated :: D3(j,a4,a3,i,a1,a0)  >> D3(a0,a1,i,a3,a4,j) 
! rowInd : @[j, "active"] @[a4, "active"] @[a3, "active"] @[i, "active"] 
! summedInd : @[a1, "active"] @[a0, "active"] 
! -- Check2 is skipped 
!    -- is4RDM.second false
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no0_x0_type1_eri_o &
...
integer :: s_a1, i_a1, s_w, i_w, s_a0, i_a0, s_j, i_j, s_a4, i_a4
integer :: s_a3, i_a3, s_i, i_i
! W17(w,j,a3,a4,i,a2) += (    1.00000000) T2(a1,w,a0,a2) D3(j,a4,a3,i,a1,a0) 
do s_a1 = 0, nir-1
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
...
do s_i = 0, nir-1
if( &
IEOR(IEOR(s_w,s_j),s_a3) == IEOR(IEOR(s_a4,s_i),s_a2) .and. & 
IEOR(s_a1,s_w) == IEOR(s_a0,s_a2) .and. &
IEOR(IEOR(s_j,s_a4),s_a3) == IEOR(IEOR(s_i,s_a1),s_a0)) then

if(psym(I_LENGTH,I_O, s_j)*psym(I_LENGTH,I_O, s_a4)*psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_i) > 0 .and. &
   psym(I_LENGTH,I_C, s_w) > 0 .and. &
   psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_a0) > 0) then
...
! Gemm Z1 * Z2 to form Z3
call dgemm('n', 'n', psym(I_LENGTH,I_O, s_j)*psym(I_LENGTH,I_O, s_a4)*psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_i),&
                     psym(I_LENGTH,I_C, s_w),&
                     psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_a0),&
                     1.00000000d+00, &
                     D3_(s_j, s_a4, s_a3, s_i, s_a1, s_a0)%array,&
                     psym(I_LENGTH,I_O, s_j)*psym(I_LENGTH,I_O, s_a4)*psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_i),&
                     Z2_,&
                     psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_a0),&
                     0.0d+00,&
                     Z3_,&
...
! W17(w,j,a3,a4,i,a2)  <-- Z3
do i_w = psym(I_BEGIN, I_C, s_w), psym(I_END, I_C, s_w)
do i_j = psym(I_BEGIN, I_O, s_j), psym(I_END, I_O, s_j)
do i_a3 = psym(I_BEGIN, I_O, s_a3), psym(I_END, I_O, s_a3)
do i_a4 = psym(I_BEGIN, I_O, s_a4), psym(I_END, I_O, s_a4)
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
W17_(s_i, s_a4, s_a3, s_j, s_w)%array(i_i, i_a4, i_a3, i_j, i_w) = &
    W17_(s_i, s_a4, s_a3, s_j, s_w)%array(i_i, i_a4, i_a3, i_j, i_w) &
  + Z3_(i_j, i_a4, i_a3, i_i, i_w)
end do
end do
end do
end do
...
! Flop count
flops = flops + psym(I_LENGTH,I_O, s_j)*psym(I_LENGTH,I_O, s_a4)*psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_i) * &
                psym(I_LENGTH,I_C, s_w) * &
                psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_a0) * 2.0d+00
...
end subroutine g_sigma_coov_cooo_no0_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no0_x1_type1_eri_o &
...
call set_symblock_Xcaaaa(sleft, W17, nir, nsym, psym) ! -> Xcaaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no0_x1_type1_eri_o &
...
end subroutine g_if_sigma_coov_cooo_no0_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no0_x1_type1_eri_o &
...
! S2(w,i,j,a) += (   -1.00000000) V2(a2,a4,a3,a) W17(w,j,a3,a4,i,a2) 
do s_a4 = 0, nir-1
do s_a3 = 0, nir-1
do s_w = 0, nir-1
do s_j = 0, nir-1
...
IEOR(IEOR(s_w,s_j),s_a3) == IEOR(IEOR(s_a4,s_i),s_a2)) then

if(psym(I_LENGTH,I_C, s_w)*psym(I_LENGTH,I_O, s_j)*psym(I_LENGTH,I_O, s_i) > 0 .and. &
   psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_a4) > 0) then

! Z1 <-- W17(w,j,a3,a4,i,a2) 
allocate(Z1_(psym(I_BEGIN,I_C, s_w):psym(I_END,I_C, s_w), &
             psym(I_BEGIN,I_O, s_j):psym(I_END,I_O, s_j), &
             psym(I_BEGIN,I_O, s_i):psym(I_END,I_O, s_i), &
             psym(I_BEGIN,I_O, s_a3):psym(I_END,I_O, s_a3), &
...
end subroutine g_sigma_coov_cooo_no0_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no1_x0_type1_eri_o &
...
call g_sigma_coov_cooo_no1_x0_type1_eri_o &
  (sa3, ia3, av2_i, Xcaaaa, d3, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaaaa)

end subroutine g_if_sigma_coov_cooo_no1_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no1_x0_type1_eri_o &
...
end subroutine g_sigma_coov_cooo_no1_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no1_x1_type1_eri_o &
...
call set_symblock_Xcaaaa(sleft, W19, nir, nsym, psym) ! -> Xcaaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no1_x1_type1_eri_o &
...
end subroutine g_if_sigma_coov_cooo_no1_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no1_x1_type1_eri_o &
...
! S2(w,i,j,a) += (   -1.00000000) V2(a3,a,a4,a2) W19(w,j,a4,i,a2,a3) 
do s_a4 = 0, nir-1
do s_a2 = 0, nir-1
do s_w = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_coov_cooo_no1_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no2_x0_type1_eri_o &
...
call g_sigma_coov_cooo_no2_x0_type1_eri_o &
  (sa3, ia3, av2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_cooo_no2_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no2_x0_type1_eri_o &
...
end subroutine g_sigma_coov_cooo_no2_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no2_x1_type1_eri_o &
...
call set_symblock_Xcaa(sleft, W20, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no2_x1_type1_eri_o &
...
end subroutine g_if_sigma_coov_cooo_no2_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no2_x1_type1_eri_o &
...
! S2(w,i,j,a) += (   -1.00000000) V2(a3,a,j,a2) W20(w,i,a2,a3) 
do s_j = 0, nir-1
do s_a2 = 0, nir-1
do s_w = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_cooo_no2_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no3_x0_type1_eri_o &
...
call g_sigma_coov_cooo_no3_x0_type1_eri_o &
  (sa, ia, sa1, ia1, h2_i, Xaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaa)

end subroutine g_if_sigma_coov_cooo_no3_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no3_x0_type1_eri_o &
...
! W22(i,a0,a1,a) += (    1.00000000) V2(a1,a3,a2,a) D2(i,a2,a3,a0) 
do s_a3 = 0, nir-1
do s_a2 = 0, nir-1
do s_i = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_coov_cooo_no3_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no3_x1_type1_eri_o &
...
call set_symblock_Xaa(sleft, W22, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no3_x1_type1_eri_o &
...
end subroutine g_if_sigma_coov_cooo_no3_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no3_x1_type1_eri_o &
...
! S2(w,i,j,a) += (   -1.00000000) T2(a0,w,j,a1) W22(i,a0,a1,a) 
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_cooo_no3_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no4_x0_type1_eri_o &
...
call g_sigma_coov_cooo_no4_x0_type1_eri_o &
  (sa, ia, sa2, ia2, h2_i, Xaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaa)

end subroutine g_if_sigma_coov_cooo_no4_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no4_x0_type1_eri_o &
...
end subroutine g_sigma_coov_cooo_no4_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no4_x1_type1_eri_o &
...
call set_symblock_Xaa(sleft, W24, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no4_x1_type1_eri_o &
...
end subroutine g_if_sigma_coov_cooo_no4_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no4_x1_type1_eri_o &
...
integer :: s_a0, i_a0, s_w, i_w, s_j, i_j, s_i, i_i
! S2(w,i,j,a) += (   -1.00000000) T2(a0,w,j,a2) W24(i,a0,a2,a) 
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_cooo_no4_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no5_x0_type1_eri_o &
...
call g_sigma_coov_cooo_no5_x0_type1_eri_o &
  (sa2, ia2, av2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_cooo_no5_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no5_x0_type1_eri_o &
...
end subroutine g_sigma_coov_cooo_no5_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no5_x1_type1_eri_o &
...
call set_symblock_Xcaa(sleft, W25, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no5_x1_type1_eri_o &
...
end subroutine g_if_sigma_coov_cooo_no5_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no5_x1_type1_eri_o &
...
! S2(w,i,j,a) += (    2.00000000) V2(a2,j,a3,a) W25(w,i,a3,a2) 
do s_j = 0, nir-1
do s_a3 = 0, nir-1
do s_w = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_cooo_no5_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no6_x0_type1_eri_o &
...
call g_sigma_coov_cooo_no6_x0_type1_eri_o &
  (sa2, ia2, av2_i, Xcaaaa, d3, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaaaa)

end subroutine g_if_sigma_coov_cooo_no6_x0_type1_eri_o
...
! Information for debugging 
! >> Score :: 111010
! RDM is rotated :: D3(j,a0,a3,i,a1,a4)  >> D3(a4,a1,a0,j,i,a3) 
! rowInd : @[a3, "active"] @[i, "active"] @[j, "active"] @[a4, "active"] 
! summedInd : @[a1, "active"] @[a0, "active"] 
! -- Check2 is skipped 
!    -- is4RDM.second false
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no6_x0_type1_eri_o &
...
integer :: s_w, i_w, s_a1, i_a1, s_a0, i_a0, s_j, i_j, s_a3, i_a3
integer :: s_i, i_i, s_a4, i_a4
! W27(w,j,a3,i,a4,a2) += (    1.00000000) T2(w,a1,a0,a2) D3(j,a0,a3,i,a1,a4) 
do s_w = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
...
IEOR(s_w,s_a1) == IEOR(s_a0,s_a2) .and. &
IEOR(IEOR(s_j,s_a0),s_a3) == IEOR(IEOR(s_i,s_a1),s_a4)) then

if(psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_i)*psym(I_LENGTH,I_O, s_j)*psym(I_LENGTH,I_O, s_a4) > 0 .and. &
   psym(I_LENGTH,I_C, s_w) > 0 .and. &
   psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_a0) > 0) then

! Z1 <-- D3(a4,a1,a0,j,i,a3) 
...
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
do i_a3 = psym(I_BEGIN, I_O, s_a3), psym(I_END, I_O, s_a3)
Z1_(i_a3, i_i, i_j, i_a4, i_a1, i_a0) =  &
  D3_(s_a3, s_i, s_j, s_a0, s_a1, s_a4)%array(i_a3, i_i, i_j, i_a0, i_a1, i_a4)
end do
end do
end do
end do
...
! Gemm Z1 * Z2 to form Z3
call dgemm('n', 'n', psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_i)*psym(I_LENGTH,I_O, s_j)*psym(I_LENGTH,I_O, s_a4),&
                     psym(I_LENGTH,I_C, s_w),&
                     psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_a0),&
                     1.00000000d+00, &
                     Z1_,&
                     psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_i)*psym(I_LENGTH,I_O, s_j)*psym(I_LENGTH,I_O, s_a4),&
                     Z2_,&
                     psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_a0),&
                     0.0d+00,&
                     Z3_,&
...
! Flop count
flops = flops + psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_i)*psym(I_LENGTH,I_O, s_j)*psym(I_LENGTH,I_O, s_a4) * &
                psym(I_LENGTH,I_C, s_w) * &
                psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_a0) * 2.0d+00
...
end subroutine g_sigma_coov_cooo_no6_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no6_x1_type1_eri_o &
...
call set_symblock_Xcaaaa(sleft, W27, nir, nsym, psym) ! -> Xcaaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no6_x1_type1_eri_o &
  (sa, ia, sa2, ia2, h2_i, Xcaaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_cooo_no6_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no6_x1_type1_eri_o &
...
integer :: s_a4, i_a4, s_a3, i_a3, s_w, i_w, s_j, i_j, s_i, i_i
! S2(w,i,j,a) += (   -1.00000000) V2(a2,a4,a3,a) W27(w,j,a3,i,a4,a2) 
do s_a4 = 0, nir-1
do s_a3 = 0, nir-1
do s_w = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_coov_cooo_no6_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no7_x0_type1_eri_o &
...
call g_sigma_coov_cooo_no7_x0_type1_eri_o &
  (sa3, ia3, av2_i, Xcaaaa, d3, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaaaa)

end subroutine g_if_sigma_coov_cooo_no7_x0_type1_eri_o
...
! Information for debugging 
! >> Score :: 111010
! RDM is rotated :: D3(j,a0,a4,a2,a1,i)  >> D3(i,a1,a0,j,a2,a4) 
! rowInd : @[a4, "active"] @[a2, "active"] @[j, "active"] @[i, "active"] 
! summedInd : @[a1, "active"] @[a0, "active"] 
! -- Check2 is skipped 
!    -- is4RDM.second false
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no7_x0_type1_eri_o &
...
integer :: s_w, i_w, s_a1, i_a1, s_a0, i_a0, s_j, i_j, s_a4, i_a4
integer :: s_a2, i_a2, s_i, i_i
! W29(w,j,a4,a2,i,a3) += (    1.00000000) T2(w,a1,a0,a3) D3(j,a0,a4,a2,a1,i) 
do s_w = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
...
do s_i = 0, nir-1
if( &
IEOR(IEOR(s_w,s_j),s_a4) == IEOR(IEOR(s_a2,s_i),s_a3) .and. & 
IEOR(s_w,s_a1) == IEOR(s_a0,s_a3) .and. &
IEOR(IEOR(s_j,s_a0),s_a4) == IEOR(IEOR(s_a2,s_a1),s_i)) then

if(psym(I_LENGTH,I_O, s_a4)*psym(I_LENGTH,I_O, s_a2)*psym(I_LENGTH,I_O, s_j)*psym(I_LENGTH,I_O, s_i) > 0 .and. &
   psym(I_LENGTH,I_C, s_w) > 0 .and. &
   psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_a0) > 0) then

! Z1 <-- D3(i,a1,a0,j,a2,a4) 
...
do i_a2 = psym(I_BEGIN, I_O, s_a2), psym(I_END, I_O, s_a2)
do i_a4 = psym(I_BEGIN, I_O, s_a4), psym(I_END, I_O, s_a4)
Z1_(i_a4, i_a2, i_j, i_i, i_a1, i_a0) =  &
  D3_(s_a4, s_a2, s_j, s_a0, s_a1, s_i)%array(i_a4, i_a2, i_j, i_a0, i_a1, i_i)
end do
end do
end do
end do
...
! Gemm Z1 * Z2 to form Z3
call dgemm('n', 'n', psym(I_LENGTH,I_O, s_a4)*psym(I_LENGTH,I_O, s_a2)*psym(I_LENGTH,I_O, s_j)*psym(I_LENGTH,I_O, s_i),&
                     psym(I_LENGTH,I_C, s_w),&
                     psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_a0),&
                     1.00000000d+00, &
                     Z1_,&
                     psym(I_LENGTH,I_O, s_a4)*psym(I_LENGTH,I_O, s_a2)*psym(I_LENGTH,I_O, s_j)*psym(I_LENGTH,I_O, s_i),&
                     Z2_,&
                     psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_a0),&
                     0.0d+00,&
                     Z3_,&
...
! W29(w,j,a4,a2,i,a3)  <-- Z3
do i_w = psym(I_BEGIN, I_C, s_w), psym(I_END, I_C, s_w)
do i_j = psym(I_BEGIN, I_O, s_j), psym(I_END, I_O, s_j)
do i_a4 = psym(I_BEGIN, I_O, s_a4), psym(I_END, I_O, s_a4)
do i_a2 = psym(I_BEGIN, I_O, s_a2), psym(I_END, I_O, s_a2)
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
W29_(s_i, s_a2, s_a4, s_j, s_w)%array(i_i, i_a2, i_a4, i_j, i_w) = &
    W29_(s_i, s_a2, s_a4, s_j, s_w)%array(i_i, i_a2, i_a4, i_j, i_w) &
  + Z3_(i_a4, i_a2, i_j, i_i, i_w)
end do
end do
end do
end do
...
! Flop count
flops = flops + psym(I_LENGTH,I_O, s_a4)*psym(I_LENGTH,I_O, s_a2)*psym(I_LENGTH,I_O, s_j)*psym(I_LENGTH,I_O, s_i) * &
                psym(I_LENGTH,I_C, s_w) * &
                psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_a0) * 2.0d+00
...
end subroutine g_sigma_coov_cooo_no7_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no7_x1_type1_eri_o &
...
call set_symblock_Xcaaaa(sleft, W29, nir, nsym, psym) ! -> Xcaaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no7_x1_type1_eri_o &
  (sa, ia, sa3, ia3, h2_i, Xcaaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_cooo_no7_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no7_x1_type1_eri_o &
...
integer :: s_a4, i_a4, s_a2, i_a2, s_w, i_w, s_j, i_j, s_i, i_i
! S2(w,i,j,a) += (   -1.00000000) V2(a3,a,a4,a2) W29(w,j,a4,a2,i,a3) 
do s_a4 = 0, nir-1
do s_a2 = 0, nir-1
do s_w = 0, nir-1
do s_j = 0, nir-1
...
IEOR(s_w,s_i) == IEOR(s_j,s_a) .and. & 
IEOR(s_a3,s_a) == IEOR(s_a4,s_a2) .and. &
IEOR(IEOR(s_w,s_j),s_a4) == IEOR(IEOR(s_a2,s_i),s_a3)) then

if(psym(I_LENGTH,I_C, s_w)*psym(I_LENGTH,I_O, s_j)*psym(I_LENGTH,I_O, s_i) > 0 .and. &
   psym(I_LENGTH,I_O, s_a4)*psym(I_LENGTH,I_O, s_a2) > 0) then

! Z1 <-- W29(w,j,a4,a2,i,a3) 
allocate(Z1_(psym(I_BEGIN,I_C, s_w):psym(I_END,I_C, s_w), &
             psym(I_BEGIN,I_O, s_j):psym(I_END,I_O, s_j), &
             psym(I_BEGIN,I_O, s_i):psym(I_END,I_O, s_i), &
             psym(I_BEGIN,I_O, s_a4):psym(I_END,I_O, s_a4), &
...
end subroutine g_sigma_coov_cooo_no7_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no8_x0_type1_eri_o &
...
call g_sigma_coov_cooo_no8_x0_type1_eri_o &
  (sa3, ia3, av2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_cooo_no8_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no8_x0_type1_eri_o &
...
integer :: s_w, i_w, s_a0, i_a0, s_a1, i_a1, s_i, i_i, s_a2, i_a2
! W30(w,i,a2,a3) += (    1.00000000) T2(w,a0,a1,a3) D2(i,a0,a1,a2) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_cooo_no8_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no8_x1_type1_eri_o &
...
call set_symblock_Xcaa(sleft, W30, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no8_x1_type1_eri_o &
  (sa, ia, sa3, ia3, h2_i, Xcaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_cooo_no8_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no8_x1_type1_eri_o &
...
integer :: s_j, i_j, s_a2, i_a2, s_w, i_w, s_i, i_i
! S2(w,i,j,a) += (   -1.00000000) V2(a3,a,j,a2) W30(w,i,a2,a3) 
do s_j = 0, nir-1
do s_a2 = 0, nir-1
do s_w = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_cooo_no8_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no9_x0_type1_eri_o &
...
call g_sigma_coov_cooo_no9_x0_type1_eri_o &
  (sa, ia, sa1, ia1, h2_i, Xaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaa)

end subroutine g_if_sigma_coov_cooo_no9_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no9_x0_type1_eri_o &
...
end subroutine g_sigma_coov_cooo_no9_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no9_x1_type1_eri_o &
...
call set_symblock_Xaa(sleft, W32, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no9_x1_type1_eri_o &
  (sa, ia, sa1, ia1, av2_i, Xaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_cooo_no9_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no9_x1_type1_eri_o &
...
integer :: s_w, i_w, s_a0, i_a0, s_j, i_j, s_i, i_i
! S2(w,i,j,a) += (    2.00000000) T2(w,a0,j,a1) W32(i,a0,a1,a) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_cooo_no9_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no10_x0_type1_eri_o &
...
call g_sigma_coov_cooo_no10_x0_type1_eri_o &
  (sa, ia, sa2, ia2, h2_i, Xaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaa)

end subroutine g_if_sigma_coov_cooo_no10_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no10_x0_type1_eri_o &
...
end subroutine g_sigma_coov_cooo_no10_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no10_x1_type1_eri_o &
...
call set_symblock_Xaa(sleft, W34, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no10_x1_type1_eri_o &
  (sa, ia, sa2, ia2, av2_i, Xaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_cooo_no10_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no10_x1_type1_eri_o &
...
integer :: s_w, i_w, s_a0, i_a0, s_j, i_j, s_i, i_i
! S2(w,i,j,a) += (    2.00000000) T2(w,a0,j,a2) W34(i,a0,a2,a) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_cooo_no10_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no11_x0_type1_eri_o &
...
call g_sigma_coov_cooo_no11_x0_type1_eri_o &
  (sa2, ia2, av2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_cooo_no11_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no11_x0_type1_eri_o &
...
! W35(w,i,a3,a2) += (    1.00000000) T2(w,a0,a1,a2) D2(i,a3,a1,a0) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_cooo_no11_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no11_x1_type1_eri_o &
...
call set_symblock_Xcaa(sleft, W35, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no11_x1_type1_eri_o &
  (sa, ia, sa2, ia2, h2_i, Xcaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_cooo_no11_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no11_x1_type1_eri_o &
...
integer :: s_j, i_j, s_a3, i_a3, s_w, i_w, s_i, i_i
! S2(w,i,j,a) += (   -1.00000000) V2(a2,j,a3,a) W35(w,i,a3,a2) 
do s_j = 0, nir-1
do s_a3 = 0, nir-1
do s_w = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_cooo_no11_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no0_x0_type0_eri_v &
...
call g_sigma_coov_cooo_no0_x0_type0_eri_v &
  (sa0, ia0, av2_i, Xcaaa, d3, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaaa)

end subroutine g_if_sigma_coov_cooo_no0_x0_type0_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no0_x0_type0_eri_v &
...
end subroutine g_sigma_coov_cooo_no0_x0_type0_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no1_x0_type0_eri_v &
...
call g_sigma_coov_cooo_no1_x0_type0_eri_v &
  (sa0, ia0, av2_i, Xcaaa, d3, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaaa)

end subroutine g_if_sigma_coov_cooo_no1_x0_type0_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no1_x0_type0_eri_v &
...
integer :: s_i, i_i
! W8(c0,j,a3,i) += (    1.00000000) T2(c0,a2,a1,a0) D3(j,a1,a3,i,a2,a0) 
do s_c0 = 0, nir-1
do s_a2 = 0, nir-1
do s_a1 = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_coov_cooo_no1_x0_type0_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no2_x0_type0_eri_v &
...
call g_sigma_coov_cooo_no2_x0_type0_eri_v &
  (sa1, ia1, av2_i, Xcaaa, d3, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaaa)

end subroutine g_if_sigma_coov_cooo_no2_x0_type0_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no2_x0_type0_eri_v &
...
integer :: s_w, i_w, s_a0, i_a0, s_a2, i_a2, s_i, i_i, s_a4, i_a4
integer :: s_a3, i_a3
! W9(w,i,a4,a3) += (    1.00000000) T2(w,a0,a2,a1) D3(i,a4,a2,a3,a1,a0) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_a2 = 0, nir-1
do s_i = 0, nir-1
...
do s_a3 = 0, nir-1
if( &
IEOR(s_w,s_i) == IEOR(s_a4,s_a3) .and. & 
IEOR(s_w,s_a0) == IEOR(s_a2,s_a1) .and. &
IEOR(IEOR(s_i,s_a4),s_a2) == IEOR(IEOR(s_a3,s_a1),s_a0)) then
...
do i_a4 = psym(I_BEGIN, I_O, s_a4), psym(I_END, I_O, s_a4)
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
Z1_(i_i, i_a4, i_a3, i_a2, i_a0) =  &
  D3_(s_a0, s_a1, s_a3, s_a2, s_a4, s_i)%array(i_a0, i_a1, i_a3, i_a2, i_a4, i_i)
end do
end do
end do
end do
...
do i_a4 = psym(I_BEGIN, I_O, s_a4), psym(I_END, I_O, s_a4)
do i_a3 = psym(I_BEGIN, I_O, s_a3), psym(I_END, I_O, s_a3)
W9_(s_a3, s_a4, s_i, s_w)%array(i_a3, i_a4, i_i, i_w) = &
    W9_(s_a3, s_a4, s_i, s_w)%array(i_a3, i_a4, i_i, i_w) &
  + Z3_(i_i, i_a4, i_a3, i_w)
end do
end do
end do
end do
...
end subroutine g_sigma_coov_cooo_no2_x0_type0_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no3_x0_type0_eri_v &
...
call g_sigma_coov_cooo_no3_x0_type0_eri_v &
  (sa1, ia1, av2_i, Xcaaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaaa)

end subroutine g_if_sigma_coov_cooo_no3_x0_type0_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no3_x0_type0_eri_v &
...
end subroutine g_sigma_coov_cooo_no3_x0_type0_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no4_x0_type0_eri_v &
...
call g_sigma_coov_cooo_no4_x0_type0_eri_v &
  (sa1, ia1, av2_i, Xcaaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaaa)

end subroutine g_if_sigma_coov_cooo_no4_x0_type0_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no4_x0_type0_eri_v &
...
end subroutine g_sigma_coov_cooo_no4_x0_type0_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no5_x0_type0_eri_v &
...
call g_sigma_coov_cooo_no5_x0_type0_eri_v &
  (sj, ij, av2_i, Xcaaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaaa)

end subroutine g_if_sigma_coov_cooo_no5_x0_type0_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no5_x0_type0_eri_v &
...
end subroutine g_sigma_coov_cooo_no5_x0_type0_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no6_x0_type0_eri_v &
...
call g_sigma_coov_cooo_no6_x0_type0_eri_v &
  (sj, ij, av2_i, Xcaaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaaa)

end subroutine g_if_sigma_coov_cooo_no6_x0_type0_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no6_x0_type0_eri_v &
...
integer :: s_c0, i_c0, s_a0, i_a0, s_a1, i_a1, s_i, i_i, s_a2, i_a2
! W14(c0,i,a2,j) += (    1.00000000) T2(c0,a0,a1,j) D2(i,a2,a1,a0) 
do s_c0 = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_cooo_no6_x0_type0_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no0_x0_type1_eri_v &
...
call set_symblock_Xcaaa(sleft, W7, nir, nsym, psym) ! -> Xcaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no0_x0_type1_eri_v &
...
end subroutine g_if_sigma_coov_cooo_no0_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no0_x0_type1_eri_v &
...
! S2(w,i,j,a) += (    1.00000000) V2(a,w,c0,a3) W7(c0,j,a3,i) 
do s_w = 0, nir-1
do s_c0 = 0, nir-1
do s_a3 = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_coov_cooo_no0_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no1_x0_type1_eri_v &
...
call set_symblock_Xcaaa(sleft, W8, nir, nsym, psym) ! -> Xcaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no1_x0_type1_eri_v &
  (sa, ia, h2_i, Xcaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_cooo_no1_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no1_x0_type1_eri_v &
...
! S2(w,i,j,a) += (    1.00000000) V2(a,a3,w,c0) W8(c0,j,a3,i) 
do s_a3 = 0, nir-1
do s_w = 0, nir-1
do s_c0 = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_coov_cooo_no1_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no2_x0_type1_eri_v &
...
call set_symblock_Xcaaa(sleft, W9, nir, nsym, psym) ! -> Xcaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no2_x0_type1_eri_v &
  (sa, ia, h2_i, Xcaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_cooo_no2_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no2_x0_type1_eri_v &
...
! S2(w,i,j,a) += (   -1.00000000) V2(a,a4,j,a3) W9(w,i,a4,a3) 
do s_a4 = 0, nir-1
do s_j = 0, nir-1
do s_a3 = 0, nir-1
do s_w = 0, nir-1
...
IEOR(s_w,s_i) == IEOR(s_a4,s_a3)) then
...
end subroutine g_sigma_coov_cooo_no2_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no3_x0_type1_eri_v &
...
call set_symblock_Xcaaa(sleft, W10, nir, nsym, psym) ! -> Xcaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no3_x0_type1_eri_v &
  (sa, ia, h2_i, Xcaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_cooo_no3_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no3_x0_type1_eri_v &
...
! S2(w,i,j,a) += (    1.00000000) V2(a,w,c0,a2) W10(c0,i,a2,j) 
do s_w = 0, nir-1
do s_c0 = 0, nir-1
do s_a2 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_cooo_no3_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no4_x0_type1_eri_v &
...
call set_symblock_Xcaaa(sleft, W11, nir, nsym, psym) ! -> Xcaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no4_x0_type1_eri_v &
  (sa, ia, h2_i, Xcaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_cooo_no4_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no4_x0_type1_eri_v &
...
! S2(w,i,j,a) += (   -2.00000000) V2(a,a2,w,c0) W11(c0,i,a2,j) 
do s_a2 = 0, nir-1
do s_w = 0, nir-1
do s_c0 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_cooo_no4_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no5_x0_type1_eri_v &
...
call g_sigma_coov_cooo_no5_x0_type1_eri_v &
  (sa, ia, sa1, ia1, h2_i, Xaa, d3, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaa)

end subroutine g_if_sigma_coov_cooo_no5_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no5_x0_type1_eri_v &
...
end subroutine g_sigma_coov_cooo_no5_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no5_x1_type1_eri_v &
...
call set_symblock_Xaa(sleft, W12, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no5_x1_type1_eri_v &
  (sa, ia, sa1, ia1, av2_i, Xaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_cooo_no5_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no5_x1_type1_eri_v &
...
integer :: s_w, i_w, s_a0, i_a0, s_j, i_j, s_i, i_i
! S2(w,i,j,a) += (    2.00000000) T2(w,a0,j,a1) W12(i,a1,a0,a) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_cooo_no5_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no6_x0_type1_eri_v &
...
call set_symblock_Xcaaa(sleft, W13, nir, nsym, psym) ! -> Xcaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no6_x0_type1_eri_v &
  (sa, ia, h2_i, Xcaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_cooo_no6_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no6_x0_type1_eri_v &
...
integer :: s_w, i_w, s_c0, i_c0, s_a2, i_a2, s_i, i_i, s_j, i_j
! S2(w,i,j,a) += (    1.00000000) V2(a,w,c0,a2) W13(c0,i,a2,j) 
do s_w = 0, nir-1
do s_c0 = 0, nir-1
do s_a2 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_cooo_no6_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no7_x0_type1_eri_v &
...
call set_symblock_Xcaaa(sleft, W14, nir, nsym, psym) ! -> Xcaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no7_x0_type1_eri_v &
  (sa, ia, h2_i, Xcaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_cooo_no7_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no7_x0_type1_eri_v &
...
integer :: s_a2, i_a2, s_w, i_w, s_c0, i_c0, s_i, i_i, s_j, i_j
! S2(w,i,j,a) += (    1.00000000) V2(a,a2,w,c0) W14(c0,i,a2,j) 
do s_a2 = 0, nir-1
do s_w = 0, nir-1
do s_c0 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_cooo_no7_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no8_x0_type1_eri_v &
...
call g_sigma_coov_cooo_no8_x0_type1_eri_v &
  (sa, ia, h2_i, Xaaa, d3, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_coov_cooo_no8_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no8_x0_type1_eri_v &
...
integer :: s_a0, i_a0
! W15(i,a1,a0,a) += (    1.00000000) V2(a,a3,a4,a2) D3(i,a3,a4,a2,a1,a0) 
do s_a3 = 0, nir-1
do s_a4 = 0, nir-1
do s_a2 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_cooo_no8_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no8_x1_type1_eri_v &
...
call set_symblock_Xaaa(sleft, W15, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no8_x1_type1_eri_v &
...
end subroutine g_if_sigma_coov_cooo_no8_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no8_x1_type1_eri_v &
...
integer :: s_w, i_w, s_a0, i_a0, s_a1, i_a1, s_i, i_i
! S2(w,i,j,a) += (   -1.00000000) T2(w,a0,a1,j) W15(i,a1,a0,a) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_cooo_no8_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no9_x0_type1_eri_v &
...
call g_sigma_coov_cooo_no9_x0_type1_eri_v &
...
end subroutine g_if_sigma_coov_cooo_no9_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no9_x0_type1_eri_v &
...
end subroutine g_sigma_coov_cooo_no9_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no9_x1_type1_eri_v &
...
call set_symblock_Xca(sleft, W16, nir, nsym, psym) ! -> Xca (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no9_x1_type1_eri_v &
  (sa, ia, sa0, ia0, Xca, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xca)

end subroutine g_if_sigma_coov_cooo_no9_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no9_x1_type1_eri_v &
...
! S2(w,i,j,a) += (   -2.00000000) D2(j,i,a1,a0) W16(w,a1,a0,a) 
do s_j = 0, nir-1
do s_i = 0, nir-1
do s_a1 = 0, nir-1
do s_w = 0, nir-1
...
end subroutine g_sigma_coov_cooo_no9_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no10_x0_type1_eri_v &
...
call g_sigma_coov_cooo_no10_x0_type1_eri_v &
  (sa, ia, sa0, ia0, av2_i, h2_i, Xca, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_cooo_no10_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no10_x0_type1_eri_v &
...
end subroutine g_sigma_coov_cooo_no10_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no10_x1_type1_eri_v &
...
call set_symblock_Xca(sleft, W18, nir, nsym, psym) ! -> Xca (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no10_x1_type1_eri_v &
  (sa, ia, sa0, ia0, Xca, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xca)

end subroutine g_if_sigma_coov_cooo_no10_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no10_x1_type1_eri_v &
...
integer :: s_j, i_j, s_i, i_i, s_a1, i_a1, s_w, i_w
! S2(w,i,j,a) += (    1.00000000) D2(j,i,a1,a0) W18(w,a1,a0,a) 
do s_j = 0, nir-1
do s_i = 0, nir-1
do s_a1 = 0, nir-1
do s_w = 0, nir-1
...
end subroutine g_sigma_coov_cooo_no10_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no11_x0_type1_eri_v &
...
call g_sigma_coov_cooo_no11_x0_type1_eri_v &
...
end subroutine g_if_sigma_coov_cooo_no11_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no11_x0_type1_eri_v &
...
end subroutine g_sigma_coov_cooo_no11_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no11_x1_type1_eri_v &
...
call set_symblock_Xca(sleft, W21, nir, nsym, psym) ! -> Xca (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no11_x1_type1_eri_v &
  (sa, ia, sj, ij, Xca, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xca)

end subroutine g_if_sigma_coov_cooo_no11_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no11_x1_type1_eri_v &
...
! S2(w,i,j,a) += (   -2.00000000) D1(i,a0) W21(w,a0,j,a) 
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_w = 0, nir-1
if( &
...
end subroutine g_sigma_coov_cooo_no11_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no12_x0_type1_eri_v &
...
call g_sigma_coov_cooo_no12_x0_type1_eri_v &
  (sa, ia, sj, ij, av2_i, h2_i, Xca, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_cooo_no12_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no12_x0_type1_eri_v &
...
end subroutine g_sigma_coov_cooo_no12_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no12_x1_type1_eri_v &
...
call set_symblock_Xca(sleft, W23, nir, nsym, psym) ! -> Xca (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no12_x1_type1_eri_v &
  (sa, ia, sj, ij, Xca, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xca)

end subroutine g_if_sigma_coov_cooo_no12_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no12_x1_type1_eri_v &
...
integer :: s_i, i_i, s_a0, i_a0, s_w, i_w
! S2(w,i,j,a) += (    1.00000000) D1(i,a0) W23(w,a0,j,a) 
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_w = 0, nir-1
if( &
...
end subroutine g_sigma_coov_cooo_no12_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no13_x0_type1_eri_v &
...
call g_sigma_coov_cooo_no13_x0_type1_eri_v &
...
end subroutine g_if_sigma_coov_cooo_no13_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no13_x0_type1_eri_v &
...
end subroutine g_sigma_coov_cooo_no13_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no13_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W26, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no13_x1_type1_eri_v &
  (sa, ia, Xcaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_cooo_no13_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no13_x1_type1_eri_v &
...
end subroutine g_sigma_coov_cooo_no13_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no14_x0_type1_eri_v &
...
call g_sigma_coov_cooo_no14_x0_type1_eri_v &
  (sa, ia, sa2, ia2, av2_i, h2_i, Xcaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_cooo_no14_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no14_x0_type1_eri_v &
...
end subroutine g_sigma_coov_cooo_no14_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no14_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W28, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no14_x1_type1_eri_v &
  (sa, ia, Xcaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_cooo_no14_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no14_x1_type1_eri_v &
...
! S2(w,i,j,a) += (    1.00000000) D2(j,a0,a1,i) W28(w,a1,a0,a) 
do s_j = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_cooo_no14_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no15_x0_type1_eri_v &
...
call g_sigma_coov_cooo_no15_x0_type1_eri_v &
...
end subroutine g_if_sigma_coov_cooo_no15_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no15_x0_type1_eri_v &
...
end subroutine g_sigma_coov_cooo_no15_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no15_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W31, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no15_x1_type1_eri_v &
  (sa, ia, Xcaa, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_cooo_no15_x1_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no15_x1_type1_eri_v &
...
end subroutine g_sigma_coov_cooo_no15_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no16_x0_type1_eri_v &
...
call g_sigma_coov_cooo_no16_x0_type1_eri_v &
  (sa, ia, sa1, ia1, av2_i, h2_i, Xcaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_cooo_no16_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no16_x0_type1_eri_v &
...
end subroutine g_sigma_coov_cooo_no16_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no16_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W33, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no16_x1_type1_eri_v &
  (sa, ia, Xcaa, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_cooo_no16_x1_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no16_x1_type1_eri_v &
...
integer :: s_i, i_i, s_a0, i_a0, s_w, i_w, s_j, i_j
! S2(w,i,j,a) += (   -2.00000000) D1(i,a0) W33(w,a0,j,a) 
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_coov_cooo_no16_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no17_x0_type1_eri_v &
...
call g_sigma_coov_cooo_no17_x0_type1_eri_v &
  (sa, ia, sa1, ia1, av2_i, h2_i, Xcaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_cooo_no17_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no17_x0_type1_eri_v &
...
end subroutine g_sigma_coov_cooo_no17_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no17_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W36, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no17_x1_type1_eri_v &
  (sa, ia, Xcaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_cooo_no17_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no17_x1_type1_eri_v &
...
! S2(w,i,j,a) += (   -1.00000000) D2(j,i,a0,a3) W36(w,a0,a3,a) 
do s_j = 0, nir-1
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_a3 = 0, nir-1
...
end subroutine g_sigma_coov_cooo_no17_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no18_x0_type1_eri_v &
...
call g_sigma_coov_cooo_no18_x0_type1_eri_v &
  (sa, ia, sa2, ia2, av2_i, h2_i, Xcaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_cooo_no18_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no18_x0_type1_eri_v &
...
end subroutine g_sigma_coov_cooo_no18_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no18_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W37, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no18_x1_type1_eri_v &
  (sa, ia, Xcaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_cooo_no18_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no18_x1_type1_eri_v &
...
integer :: s_j, i_j, s_a3, i_a3, s_a0, i_a0, s_i, i_i, s_w, i_w
! S2(w,i,j,a) += (   -1.00000000) D2(j,a3,a0,i) W37(w,a0,a3,a) 
do s_j = 0, nir-1
do s_a3 = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
...
if( &
IEOR(s_w,s_i) == IEOR(s_j,s_a) .and. & 
IEOR(s_j,s_a3) == IEOR(s_a0,s_i) .and. &
IEOR(s_w,s_a0) == IEOR(s_a3,s_a)) then
...
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
do i_j = psym(I_BEGIN, I_O, s_j), psym(I_END, I_O, s_j)
Z1_(i_j, i_i, i_a3, i_a0) =  &
  D2_(s_i, s_a0, s_a3, s_j)%array(i_i, i_a0, i_a3, i_j)
end do
end do
end do
end do
...
end subroutine g_sigma_coov_cooo_no18_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no19_x0_type1_eri_v &
...
call g_sigma_coov_cooo_no19_x0_type1_eri_v &
  (sa, ia, sa2, ia2, av2_i, h2_i, Xcaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_cooo_no19_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no19_x0_type1_eri_v &
...
end subroutine g_sigma_coov_cooo_no19_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no19_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W38, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no19_x1_type1_eri_v &
  (sa, ia, Xcaa, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_cooo_no19_x1_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no19_x1_type1_eri_v &
...
integer :: s_i, i_i, s_a0, i_a0, s_w, i_w, s_j, i_j
! S2(w,i,j,a) += (    2.00000000) D1(i,a0) W38(w,a0,j,a) 
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_coov_cooo_no19_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no20_x0_type1_eri_v &
...
call g_sigma_coov_cooo_no20_x0_type1_eri_v &
  (sa, ia, sa1, ia1, av2_i, h2_i, Xcaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_cooo_no20_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no20_x0_type1_eri_v &
...
end subroutine g_sigma_coov_cooo_no20_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no20_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W39, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no20_x1_type1_eri_v &
  (sa, ia, Xcaa, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_cooo_no20_x1_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no20_x1_type1_eri_v &
...
integer :: s_i, i_i, s_a0, i_a0, s_w, i_w, s_j, i_j
! S2(w,i,j,a) += (   -1.00000000) D1(i,a0) W39(w,a0,j,a) 
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_coov_cooo_no20_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_cooo_no0_x0_type1_d4c_v &
...
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_cooo_no0_x0_type1_d4c_v &
...
end subroutine g_if_sigma_coov_cooo_no0_x0_type1_d4c_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_cooo_no0_x0_type1_d4c_v &
...
! S2(w,i,j,a) += (   -1.00000000) T2(w,a2,a1,a0) C5(a0,a2,a1,j,i,a) 
do s_w = 0, nir-1
do s_a2 = 0, nir-1
do s_a1 = 0, nir-1
do s_j = 0, nir-1
...
IEOR(s_w,s_i) == IEOR(s_j,s_a) .and. & 
IEOR(s_w,s_a2) == IEOR(s_a1,s_a0) .and. &
IEOR(IEOR(s_a0,s_a2),s_a1) == IEOR(IEOR(s_j,s_i),s_a)) then

if(psym(I_LENGTH,I_O, s_j)*psym(I_LENGTH,I_O, s_i) > 0 .and. &
   psym(I_LENGTH,I_C, s_w) > 0 .and. &
   psym(I_LENGTH,I_O, s_a2)*psym(I_LENGTH,I_O, s_a1) > 0) then

! Z1 <-- C5(a0,a2,a1,j,i,a) 
allocate(Z1_(psym(I_BEGIN,I_O, s_j):psym(I_END,I_O, s_j), &
             psym(I_BEGIN,I_O, s_i):psym(I_END,I_O, s_i), &
             psym(I_BEGIN,I_O, s_a2):psym(I_END,I_O, s_a2), &
             psym(I_BEGIN,I_O, s_a1):psym(I_END,I_O, s_a1)))
...
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
do i_j = psym(I_BEGIN, I_O, s_j), psym(I_END, I_O, s_j)
Z1_(i_j, i_i, i_a2, i_a1) =  &
  C5_(s_i, s_j, s_a1, s_a2, s_a0)%array(i_i, i_j, i_a1, i_a2, i_a0)
end do
end do
end do
end do
...
end subroutine g_sigma_coov_cooo_no0_x0_type1_d4c_v
