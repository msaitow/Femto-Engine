...
!                                    Generated date : Wed Apr 30 09:44:34 2014
...
!                                                                       
! **********************************************************************
subroutine g_if_sigmacomm_oovv_oovv_no0_x0_type0_noeri &
...
call g_sigmacomm_oovv_oovv_no0_x0_type0_noeri &
  (sa, ia, av2_i, Xaav, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xaav)

end subroutine g_if_sigmacomm_oovv_oovv_no0_x0_type0_noeri
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigmacomm_oovv_oovv_no0_x0_type0_noeri &
...
! W0(j,i,v0,a) += (    1.00000000) T2(a1,a0,v0,a) D2(j,a1,i,a0) 
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_v0 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
if( &
IEOR(s_j,s_i) == IEOR(s_v0,s_a) .and. & 
IEOR(s_a1,s_a0) == IEOR(s_v0,s_a) .and. &
...
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
do i_v0 = psym(I_BEGIN, I_V, s_v0), psym(I_END, I_V, s_v0)
W0_(s_v0, s_i, s_j)%array(i_v0, i_i, i_j) = &
    W0_(s_v0, s_i, s_j)%array(i_v0, i_i, i_j) &
  + Z3_(i_v0, i_j, i_i)
end do
end do
...
end subroutine g_sigmacomm_oovv_oovv_no0_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigmacomm_oovv_oovv_no0_x1_type0_noeri &
...
call g_sigmacomm_oovv_oovv_no0_x1_type0_noeri &
  (sa, ia, Xaav, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaav)

end subroutine g_if_sigmacomm_oovv_oovv_no0_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigmacomm_oovv_oovv_no0_x1_type0_noeri &
...
integer :: s_v0, i_v0, s_b, i_b, s_j, i_j, s_i, i_i
! S2(j,i,b,a) += (    2.00000000) Fc1(v0,b) W0(j,i,v0,a) 
do s_v0 = 0, nir-1
do s_b = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
if( &
IEOR(s_j,s_i) == IEOR(s_b,s_a) .and. & 
IEOR(s_v0,s_b) == 0 .and. &
IEOR(s_j,s_i) == IEOR(s_v0,s_a)) then
...
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
do i_b = psym(I_BEGIN, I_V, s_b), psym(I_END, I_V, s_b)
S2_(s_b, s_i, s_j)%array(i_b, i_i, i_j) = &
    S2_(s_b, s_i, s_j)%array(i_b, i_i, i_j) &
  + Z3_(i_b, i_j, i_i)
end do
end do
...
end subroutine g_sigmacomm_oovv_oovv_no0_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigmacomm_oovv_oovv_no1_x0_type0_noeri &
...
call g_sigmacomm_oovv_oovv_no1_x0_type0_noeri &
  (sb, ib, av2_i, Xaav, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xaav)

end subroutine g_if_sigmacomm_oovv_oovv_no1_x0_type0_noeri
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigmacomm_oovv_oovv_no1_x0_type0_noeri &
  (s_b, i_b, T2_, W1_, D2_, nir, nsym, psym, flops)
...
! W1(j,i,b,v0) += (    1.00000000) T2(a0,a1,v0,b) D2(j,a1,i,a0) 
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_v0 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
if( &
IEOR(s_j,s_i) == IEOR(s_b,s_v0) .and. & 
IEOR(s_a0,s_a1) == IEOR(s_v0,s_b) .and. &
IEOR(s_j,s_a1) == IEOR(s_i,s_a0)) then
...
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
do i_v0 = psym(I_BEGIN, I_V, s_v0), psym(I_END, I_V, s_v0)
W1_(s_v0, s_i, s_j)%array(i_v0, i_i, i_j) = &
    W1_(s_v0, s_i, s_j)%array(i_v0, i_i, i_j) &
  + Z3_(i_v0, i_j, i_i)
end do
end do
...
end subroutine g_sigmacomm_oovv_oovv_no1_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigmacomm_oovv_oovv_no1_x1_type0_noeri &
...
call g_sigmacomm_oovv_oovv_no1_x1_type0_noeri &
  (sb, ib, Xaav, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaav)

end subroutine g_if_sigmacomm_oovv_oovv_no1_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigmacomm_oovv_oovv_no1_x1_type0_noeri &
...
integer :: s_v0, i_v0, s_a, i_a, s_j, i_j, s_i, i_i
! S2(i,j,a,b) += (    2.00000000) Fc1(v0,a) W1(j,i,b,v0) 
do s_v0 = 0, nir-1
do s_a = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
IEOR(s_v0,s_a) == 0 .and. &
IEOR(s_j,s_i) == IEOR(s_b,s_v0)) then
...
end subroutine g_sigmacomm_oovv_oovv_no1_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigmacomm_oovv_oovv_no2_x0_type0_noeri &
...
call g_sigmacomm_oovv_oovv_no2_x0_type0_noeri &
  (Xaaaa, d2, fc1, nir, nsym, psym, flops)

deallocate(Xaaaa)

end subroutine g_if_sigmacomm_oovv_oovv_no2_x0_type0_noeri
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigmacomm_oovv_oovv_no2_x0_type0_noeri &
...
integer :: s_j, i_j, s_a2, i_a2, s_i, i_i, s_a0, i_a0, s_a1, i_a1
! W2(j,i,a0,a1) += (    1.00000000) D2(j,a2,i,a0) Fc1(a2,a1) 
do s_j = 0, nir-1
do s_a2 = 0, nir-1
do s_i = 0, nir-1
do s_a0 = 0, nir-1
...
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
do i_a1 = psym(I_BEGIN, I_O, s_a1), psym(I_END, I_O, s_a1)
W2_(s_a1, s_a0, s_i, s_j)%array(i_a1, i_a0, i_i, i_j) = &
    W2_(s_a1, s_a0, s_i, s_j)%array(i_a1, i_a0, i_i, i_j) &
...
end subroutine g_sigmacomm_oovv_oovv_no2_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigmacomm_oovv_oovv_no2_x1_type0_noeri &
...
call set_symblock_Xaaaa(sleft, W2, nir, nsym, psym) ! -> Xaaaa (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigmacomm_oovv_oovv_no2_x1_type0_noeri &
  (sb, ib, av2_i, Xaaaa, av2_i2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(av2_i)
deallocate(Xaaaa)

end subroutine g_if_sigmacomm_oovv_oovv_no2_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigmacomm_oovv_oovv_no2_x1_type0_noeri &
...
integer :: s_a0, i_a0, s_a1, i_a1, s_a, i_a, s_j, i_j, s_i, i_i
! S2(i,j,a,b) += (   -2.00000000) T2(a0,a1,a,b) W2(j,i,a0,a1) 
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_a = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigmacomm_oovv_oovv_no2_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigmacomm_oovv_oovv_no3_x0_type0_noeri &
...
sleft = 0
call set_symblock_Xaaaa(sleft, W3, nir, nsym, psym) ! -> Xaaaa (allocate) 
call g_sigmacomm_oovv_oovv_no3_x0_type0_noeri &
  (Xaaaa, d2, fc1, nir, nsym, psym, flops)

deallocate(Xaaaa)

end subroutine g_if_sigmacomm_oovv_oovv_no3_x0_type0_noeri
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigmacomm_oovv_oovv_no3_x0_type0_noeri &
...
! W3(j,i,a0,a1) += (    1.00000000) D2(j,a0,i,a2) Fc1(a2,a1) 
do s_j = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
do s_a2 = 0, nir-1
...
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
do i_a1 = psym(I_BEGIN, I_O, s_a1), psym(I_END, I_O, s_a1)
W3_(s_a1, s_a0, s_i, s_j)%array(i_a1, i_a0, i_i, i_j) = &
    W3_(s_a1, s_a0, s_i, s_j)%array(i_a1, i_a0, i_i, i_j) &
...
end subroutine g_sigmacomm_oovv_oovv_no3_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigmacomm_oovv_oovv_no3_x1_type0_noeri &
...
call set_symblock_Xaaaa(sleft, W3, nir, nsym, psym) ! -> Xaaaa (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigmacomm_oovv_oovv_no3_x1_type0_noeri &
  (sb, ib, av2_i, Xaaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigmacomm_oovv_oovv_no3_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigmacomm_oovv_oovv_no3_x1_type0_noeri &
...
! S2(i,j,a,b) += (   -2.00000000) T2(a1,a0,a,b) W3(j,i,a0,a1) 
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_a = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigmacomm_oovv_oovv_no3_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigmacomm_oovv_oovv_no4_x0_type0_noeri &
  (sb, ib, E0, T2, S2, nir, nsym, psym, flops)
...
call set_symblock_av2(sb, T2, nir, nsym, psym) ! -> av2_i (allocate)
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigmacomm_oovv_oovv_no4_x0_type0_noeri &
  (sb, ib, E0, av2_i, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(av2_i)

end subroutine g_if_sigmacomm_oovv_oovv_no4_x0_type0_noeri
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigmacomm_oovv_oovv_no4_x0_type0_noeri &
  (s_b, i_b, E0, T2_, S2_, D2_, nir, nsym, psym, flops)
...
integer :: s_a0, i_a0, s_a1, i_a1, s_a, i_a, s_j, i_j, s_i, i_i
! S2(i,j,a,b) += (    2.00000000) E0 T2(a0,a1,a,b) D2(j,a1,i,a0) 
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_a = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigmacomm_oovv_oovv_no4_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigmacomm_oovv_oovv_no0_x0_type1_eri_o &
  (sa1, ia1, V2, W9, nir, nsym, psym, flops)
...
call g_sigmacomm_oovv_oovv_no0_x0_type1_eri_o &
  (sa1, ia1, h2_i, Xaaa, d3, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaa)

end subroutine g_if_sigmacomm_oovv_oovv_no0_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigmacomm_oovv_oovv_no0_x0_type1_eri_o &
  (s_a1, i_a1, V2_, W9_, D3_, nir, nsym, psym, flops)
...
integer :: s_a0, i_a0
! W9(j,i,a0,a1) += (    1.00000000) V2(a1,a3,a4,a2) D3(j,a3,i,a0,a4,a2) 
do s_a3 = 0, nir-1
do s_a4 = 0, nir-1
do s_a2 = 0, nir-1
do s_j = 0, nir-1
...
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
W9_(s_a0, s_i, s_j)%array(i_a0, i_i, i_j) = &
    W9_(s_a0, s_i, s_j)%array(i_a0, i_i, i_j) &
  + Z3_(i_i, i_a0, i_j)
end do
end do
...
end subroutine g_sigmacomm_oovv_oovv_no0_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigmacomm_oovv_oovv_no0_x1_type1_eri_o &
...
call set_symblock_Xaaa(sleft, W9, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigmacomm_oovv_oovv_no0_x1_type1_eri_o &
  (sa1, ia1, sb, ib, av2_i, Xaaa, av2_i2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(av2_i)
deallocate(Xaaa)

end subroutine g_if_sigmacomm_oovv_oovv_no0_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigmacomm_oovv_oovv_no0_x1_type1_eri_o &
...
! S2(i,j,a,b) += (   -2.00000000) T2(a0,a1,a,b) W9(j,i,a0,a1) 
do s_a0 = 0, nir-1
do s_a = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigmacomm_oovv_oovv_no0_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigmacomm_oovv_oovv_no1_x0_type1_eri_o &
  (sa1, ia1, V2, W10, nir, nsym, psym, flops)
...
call g_sigmacomm_oovv_oovv_no1_x0_type1_eri_o &
  (sa1, ia1, h2_i, Xaaa, d3, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaa)

end subroutine g_if_sigmacomm_oovv_oovv_no1_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigmacomm_oovv_oovv_no1_x0_type1_eri_o &
  (s_a1, i_a1, V2_, W10_, D3_, nir, nsym, psym, flops)
...
integer :: s_i, i_i
! W10(j,i,a0,a1) += (    1.00000000) V2(a1,a3,a4,a2) D3(j,a0,i,a3,a4,a2) 
do s_a3 = 0, nir-1
do s_a4 = 0, nir-1
do s_a2 = 0, nir-1
do s_j = 0, nir-1
...
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
W10_(s_a0, s_i, s_j)%array(i_a0, i_i, i_j) = &
    W10_(s_a0, s_i, s_j)%array(i_a0, i_i, i_j) &
  + Z3_(i_j, i_a0, i_i)
end do
end do
...
end subroutine g_sigmacomm_oovv_oovv_no1_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigmacomm_oovv_oovv_no1_x1_type1_eri_o &
  (sa1, ia1, sb, ib, T2, W10, S2, nir, nsym, psym, flops)
...
call set_symblock_Xaaa(sleft, W10, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigmacomm_oovv_oovv_no1_x1_type1_eri_o &
  (sa1, ia1, sb, ib, av2_i, Xaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigmacomm_oovv_oovv_no1_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigmacomm_oovv_oovv_no1_x1_type1_eri_o &
  (s_a1, i_a1, s_b, i_b, T2_, W10_, S2_, nir, nsym, psym, flops)
...
integer :: s_a0, i_a0, s_a, i_a, s_j, i_j, s_i, i_i
! S2(i,j,a,b) += (   -2.00000000) T2(a1,a0,a,b) W10(j,i,a0,a1) 
do s_a0 = 0, nir-1
do s_a = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigmacomm_oovv_oovv_no1_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigmacomm_oovv_oovv_no2_x0_type1_eri_o &
...
call g_sigmacomm_oovv_oovv_no2_x0_type1_eri_o &
  (sa1, ia1, h2_i, Xaaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaa)

end subroutine g_if_sigmacomm_oovv_oovv_no2_x0_type1_eri_o
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigmacomm_oovv_oovv_no2_x0_type1_eri_o &
...
! W11(j,i,a1,a0) += (    1.00000000) V2(a1,a3,a2,a0) D2(j,a3,i,a2) 
do s_a3 = 0, nir-1
do s_a2 = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
...
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
W11_(s_a0, s_i, s_j)%array(i_a0, i_i, i_j) = &
    W11_(s_a0, s_i, s_j)%array(i_a0, i_i, i_j) &
  + Z3_(i_a0, i_j, i_i)
end do
end do
...
end subroutine g_sigmacomm_oovv_oovv_no2_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigmacomm_oovv_oovv_no2_x1_type1_eri_o &
...
call set_symblock_Xaaa(sleft, W11, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigmacomm_oovv_oovv_no2_x1_type1_eri_o &
  (sa1, ia1, sb, ib, av2_i, Xaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigmacomm_oovv_oovv_no2_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigmacomm_oovv_oovv_no2_x1_type1_eri_o &
...
integer :: s_a0, i_a0, s_a, i_a, s_j, i_j, s_i, i_i
! S2(i,j,a,b) += (   -2.00000000) T2(a0,a1,a,b) W11(j,i,a1,a0) 
do s_a0 = 0, nir-1
do s_a = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigmacomm_oovv_oovv_no2_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigmacomm_oovv_oovv_no0_x0_type1_eri_v &
...
call g_sigmacomm_oovv_oovv_no0_x0_type1_eri_v &
  (sv0, iv0, h2_i, Xaaaav, d3, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaaav)

end subroutine g_if_sigmacomm_oovv_oovv_no0_x0_type1_eri_v
...
! Information for debugging 
! >> Score :: 111010
! RDM is rotated :: D3(j,a1,i,a3,a2,a0)  >> D3(a1,j,a3,i,a0,a2) 
! summedInd : @[a2, "active"] @[a3, "active"] 
! colInd : @[i, "active"] @[a0, "active"] @[j, "active"] @[a1, "active"] 
subroutine g_sigmacomm_oovv_oovv_no0_x0_type1_eri_v &
  (s_v0, i_v0, V2_, W4_, D3_, nir, nsym, psym, flops)
...
integer :: s_a2, i_a2, s_a3, i_a3, s_a, i_a, s_j, i_j, s_a1, i_a1
integer :: s_i, i_i, s_a0, i_a0
! W4(j,i,a1,a0,v0,a) += (    1.00000000) V2(v0,a2,a3,a) D3(j,a1,i,a3,a2,a0) 
do s_a2 = 0, nir-1
do s_a3 = 0, nir-1
do s_a = 0, nir-1
do s_j = 0, nir-1
...
do s_a0 = 0, nir-1
if( &
IEOR(IEOR(s_j,s_i),s_a1) == IEOR(IEOR(s_a0,s_v0),s_a) .and. & 
IEOR(s_v0,s_a2) == IEOR(s_a3,s_a) .and. &
...
do i_a3 = psym(I_BEGIN, I_O, s_a3), psym(I_END, I_O, s_a3)
do i_a2 = psym(I_BEGIN, I_O, s_a2), psym(I_END, I_O, s_a2)
Z2_(i_a2, i_a3, i_i, i_a0, i_j, i_a1) =  &
  D3_(s_a2, s_a0, s_i, s_a3, s_j, s_a1)%array(i_a2, i_a0, i_i, i_a3, i_j, i_a1)
end do
end do
end do
end do
...
end subroutine g_sigmacomm_oovv_oovv_no0_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigmacomm_oovv_oovv_no0_x1_type1_eri_v &
  (sb, ib, sv0, iv0, T2, W4, S2, nir, nsym, psym, flops)
...
call set_symblock_Xaaaav(sleft, W4, nir, nsym, psym) ! -> Xaaaav (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigmacomm_oovv_oovv_no0_x1_type1_eri_v &
  (sb, ib, sv0, iv0, av2_i, Xaaaav, av2_i2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(av2_i)
deallocate(Xaaaav)

end subroutine g_if_sigmacomm_oovv_oovv_no0_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigmacomm_oovv_oovv_no0_x1_type1_eri_v &
  (s_b, i_b, s_v0, i_v0, T2_, W4_, S2_, nir, nsym, psym, flops)
...
! S2(i,j,a,b) += (    2.00000000) T2(a1,a0,b,v0) W4(j,i,a1,a0,v0,a) 
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigmacomm_oovv_oovv_no0_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigmacomm_oovv_oovv_no1_x0_type1_eri_v &
  (sb, ib, sv0, iv0, V2, W5, nir, nsym, psym, flops)
...
call g_sigmacomm_oovv_oovv_no1_x0_type1_eri_v &
  (sb, ib, sv0, iv0, h2_i, Xaaaa, d3, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaaa)

end subroutine g_if_sigmacomm_oovv_oovv_no1_x0_type1_eri_v
...
! Information for debugging 
! >> Score :: 111010
! RDM is rotated :: D3(j,a2,i,a1,a3,a0)  >> D3(a0,a3,a2,j,a1,i) 
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigmacomm_oovv_oovv_no1_x0_type1_eri_v &
  (s_b, i_b, s_v0, i_v0, V2_, W5_, D3_, nir, nsym, psym, flops)
...
integer :: s_a3, i_a3, s_a2, i_a2, s_j, i_j, s_i, i_i, s_a1, i_a1
integer :: s_a0, i_a0
! W5(j,i,a1,a0,v0,b) += (    1.00000000) V2(v0,a3,b,a2) D3(j,a2,i,a1,a3,a0) 
do s_a3 = 0, nir-1
do s_a2 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
do s_a0 = 0, nir-1
if( &
IEOR(IEOR(s_j,s_i),s_a1) == IEOR(IEOR(s_a0,s_v0),s_b) .and. & 
IEOR(s_v0,s_a3) == IEOR(s_b,s_a2) .and. &
IEOR(IEOR(s_j,s_a2),s_i) == IEOR(IEOR(s_a1,s_a3),s_a0)) then

if(psym(I_LENGTH,I_O, s_i)*psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_j)*psym(I_LENGTH,I_O, s_a0) > 0 .and. &
   psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_a2) > 0) then

! Z1 <-- D3(a0,a3,a2,j,a1,i) 
...
do i_a1 = psym(I_BEGIN, I_O, s_a1), psym(I_END, I_O, s_a1)
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
Z1_(i_i, i_a1, i_j, i_a0, i_a3, i_a2) =  &
  D3_(s_i, s_a1, s_j, s_a2, s_a3, s_a0)%array(i_i, i_a1, i_j, i_a2, i_a3, i_a0)
end do
end do
end do
end do
...
do i_a3 = psym(I_BEGIN, I_O, s_a3), psym(I_END, I_O, s_a3)
Z2_(i_a3, i_a2) =  &
  V2_(s_a2, s_b, s_a3)%array(i_a2, i_b, i_a3)
end do
end do

! Z3 <-- W5(j,i,a1,a0,v0,b) 
allocate(Z3_(psym(I_BEGIN,I_O, s_i):psym(I_END,I_O, s_i), &
             psym(I_BEGIN,I_O, s_a1):psym(I_END,I_O, s_a1), &
             psym(I_BEGIN,I_O, s_j):psym(I_END,I_O, s_j), &
             psym(I_BEGIN,I_O, s_a0):psym(I_END,I_O, s_a0)))
...
end subroutine g_sigmacomm_oovv_oovv_no1_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigmacomm_oovv_oovv_no1_x1_type1_eri_v &
  (sb, ib, sv0, iv0, T2, W5, S2, nir, nsym, psym, flops)
...
call set_symblock_Xaaaa(sleft, W5, nir, nsym, psym) ! -> Xaaaa (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigmacomm_oovv_oovv_no1_x1_type1_eri_v &
  (sb, ib, sv0, iv0, av2_i, Xaaaa, av2_i2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(av2_i)
deallocate(Xaaaa)

end subroutine g_if_sigmacomm_oovv_oovv_no1_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigmacomm_oovv_oovv_no1_x1_type1_eri_v &
  (s_b, i_b, s_v0, i_v0, T2_, W5_, S2_, nir, nsym, psym, flops)
...
integer :: s_a1, i_a1, s_a0, i_a0, s_a, i_a, s_j, i_j, s_i, i_i
! S2(i,j,a,b) += (    2.00000000) T2(a1,a0,a,v0) W5(j,i,a1,a0,v0,b) 
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_a = 0, nir-1
do s_j = 0, nir-1
...
IEOR(IEOR(s_j,s_i),s_a1) == IEOR(IEOR(s_a0,s_v0),s_b)) then
...
end subroutine g_sigmacomm_oovv_oovv_no1_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigmacomm_oovv_oovv_no2_x0_type1_eri_v &
  (sb, ib, sv0, iv0, V2, W6, nir, nsym, psym, flops)
...
call set_symblock_Xaaaa(sleft, W6, nir, nsym, psym) ! -> Xaaaa (allocate) 
call g_sigmacomm_oovv_oovv_no2_x0_type1_eri_v &
  (sb, ib, sv0, iv0, h2_i, Xaaaa, d3, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaaa)

end subroutine g_if_sigmacomm_oovv_oovv_no2_x0_type1_eri_v
...
! >> Score :: 111111
! The best shot!
! RDM is rotated :: D3(j,a1,i,a0,a3,a2)  >> D3(a2,a3,a0,i,a1,j) 
! rowInd : @[j, "active"] @[a1, "active"] @[i, "active"] @[a0, "active"] 
! summedInd : @[a3, "active"] @[a2, "active"] 
! -- Check2 is skipped 
!    -- is4RDM.second false
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigmacomm_oovv_oovv_no2_x0_type1_eri_v &
  (s_b, i_b, s_v0, i_v0, V2_, W6_, D3_, nir, nsym, psym, flops)
...
integer :: s_a0, i_a0
! W6(j,i,a1,a0,v0,b) += (    1.00000000) V2(v0,b,a3,a2) D3(j,a1,i,a0,a3,a2) 
do s_a3 = 0, nir-1
do s_a2 = 0, nir-1
do s_j = 0, nir-1
do s_a1 = 0, nir-1
...
if( &
IEOR(IEOR(s_j,s_i),s_a1) == IEOR(IEOR(s_a0,s_v0),s_b) .and. & 
IEOR(s_v0,s_b) == IEOR(s_a3,s_a2) .and. &
IEOR(IEOR(s_j,s_a1),s_i) == IEOR(IEOR(s_a0,s_a3),s_a2)) then

if(psym(I_LENGTH,I_O, s_j)*psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_i)*psym(I_LENGTH,I_O, s_a0) > 0 .and. &
   psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_a2) > 0) then
...
do i_a3 = psym(I_BEGIN, I_O, s_a3), psym(I_END, I_O, s_a3)
Z2_(i_a3, i_a2) =  &
  V2_(s_a2, s_a3, s_b)%array(i_a2, i_a3, i_b)
end do
end do

! Z3 <-- W6(j,i,a1,a0,v0,b) 
allocate(Z3_(psym(I_BEGIN,I_O, s_j):psym(I_END,I_O, s_j), &
             psym(I_BEGIN,I_O, s_a1):psym(I_END,I_O, s_a1), &
             psym(I_BEGIN,I_O, s_i):psym(I_END,I_O, s_i), &
             psym(I_BEGIN,I_O, s_a0):psym(I_END,I_O, s_a0)))
...
! Gemm Z1 * Z2 to form Z3
call dgemm('n', 'n', psym(I_LENGTH,I_O, s_j)*psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_i)*psym(I_LENGTH,I_O, s_a0),&
                     1,&
                     psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_a2),&
                     1.00000000d+00, &
                     D3_(s_j, s_a1, s_i, s_a0, s_a3, s_a2)%array,&
...
! W6(j,i,a1,a0,v0,b)  <-- Z3
do i_j = psym(I_BEGIN, I_O, s_j), psym(I_END, I_O, s_j)
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
do i_a1 = psym(I_BEGIN, I_O, s_a1), psym(I_END, I_O, s_a1)
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
W6_(s_a0, s_a1, s_i, s_j)%array(i_a0, i_a1, i_i, i_j) = &
    W6_(s_a0, s_a1, s_i, s_j)%array(i_a0, i_a1, i_i, i_j) &
  + Z3_(i_j, i_a1, i_i, i_a0)
end do
end do
end do
end do
...
! Flop count
flops = flops + psym(I_LENGTH,I_O, s_j)*psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_i)*psym(I_LENGTH,I_O, s_a0) * &
                1 * &
                psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_a2) * 2.0d+00
...
end subroutine g_sigmacomm_oovv_oovv_no2_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigmacomm_oovv_oovv_no2_x1_type1_eri_v &
...
call set_symblock_Xaaaa(sleft, W6, nir, nsym, psym) ! -> Xaaaa (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigmacomm_oovv_oovv_no2_x1_type1_eri_v &
  (sb, ib, sv0, iv0, av2_i, Xaaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigmacomm_oovv_oovv_no2_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigmacomm_oovv_oovv_no2_x1_type1_eri_v &
...
integer :: s_a0, i_a0, s_a1, i_a1, s_a, i_a, s_j, i_j, s_i, i_i
! S2(i,j,a,b) += (    2.00000000) T2(a0,a1,a,v0) W6(j,i,a1,a0,v0,b) 
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_a = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigmacomm_oovv_oovv_no2_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigmacomm_oovv_oovv_no3_x0_type1_eri_v &
...
call g_sigmacomm_oovv_oovv_no3_x0_type1_eri_v &
  (sv0, iv0, h2_i, Xaaaav, d3, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaaav)

end subroutine g_if_sigmacomm_oovv_oovv_no3_x0_type1_eri_v
...
subroutine g_sigmacomm_oovv_oovv_no3_x0_type1_eri_v &
  (s_v0, i_v0, V2_, W7_, D3_, nir, nsym, psym, flops)
...
integer :: s_a, i_a, s_a3, i_a3, s_a2, i_a2, s_j, i_j, s_a1, i_a1
integer :: s_i, i_i, s_a0, i_a0
! W7(j,i,a1,a0,v0,a) += (    1.00000000) V2(v0,a,a3,a2) D3(j,a1,i,a0,a3,a2) 
do s_a = 0, nir-1
do s_a3 = 0, nir-1
do s_a2 = 0, nir-1
do s_j = 0, nir-1
...
if( &
IEOR(IEOR(s_j,s_i),s_a1) == IEOR(IEOR(s_a0,s_v0),s_a) .and. & 
IEOR(s_v0,s_a) == IEOR(s_a3,s_a2) .and. &
IEOR(IEOR(s_j,s_a1),s_i) == IEOR(IEOR(s_a0,s_a3),s_a2)) then
...
end subroutine g_sigmacomm_oovv_oovv_no3_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigmacomm_oovv_oovv_no3_x1_type1_eri_v &
...
call set_symblock_Xaaaav(sleft, W7, nir, nsym, psym) ! -> Xaaaav (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigmacomm_oovv_oovv_no3_x1_type1_eri_v &
  (sb, ib, sv0, iv0, av2_i, Xaaaav, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigmacomm_oovv_oovv_no3_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigmacomm_oovv_oovv_no3_x1_type1_eri_v &
...
integer :: s_a1, i_a1, s_a0, i_a0, s_j, i_j, s_i, i_i, s_a, i_a
! S2(i,j,a,b) += (    2.00000000) T2(a1,a0,b,v0) W7(j,i,a1,a0,v0,a) 
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigmacomm_oovv_oovv_no3_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigmacomm_oovv_oovv_no4_x0_type1_eri_v &
  (sb, ib, sv0, iv0, T2, V2, W8, nir, nsym, psym, flops)
...
call g_sigmacomm_oovv_oovv_no4_x0_type1_eri_v &
...
end subroutine g_if_sigmacomm_oovv_oovv_no4_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigmacomm_oovv_oovv_no4_x0_type1_eri_v &
  (s_b, i_b, s_v0, i_v0, T2_, V2_, W8_, nir, nsym, psym, flops)
...
integer :: s_v1, i_v1, s_a, i_a, s_a1, i_a1, s_a0, i_a0
! W8(a1,a0,b,a) += (    1.00000000) V2(b,v1,v0,a) T2(a1,a0,v1,v0) 
do s_v1 = 0, nir-1
do s_a = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigmacomm_oovv_oovv_no4_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigmacomm_oovv_oovv_no4_x1_type1_eri_v &
  (sb, ib, W8, S2, nir, nsym, psym, flops)
...
call set_symblock_Xaav(sleft, W8, nir, nsym, psym) ! -> Xaav (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigmacomm_oovv_oovv_no4_x1_type1_eri_v &
  (sb, ib, Xaav, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaav)

end subroutine g_if_sigmacomm_oovv_oovv_no4_x1_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigmacomm_oovv_oovv_no4_x1_type1_eri_v &
  (s_b, i_b, W8_, S2_, D2_, nir, nsym, psym, flops)
...
! S2(i,j,a,b) += (    2.00000000) D2(j,a1,i,a0) W8(a1,a0,b,a) 
do s_j = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigmacomm_oovv_oovv_no4_x1_type1_eri_v
