...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no0_x0_type1_eri_c &
  (sv0, iv0, sx, ix, T2, V2, W0, nir, nsym, psym, flops)

use f_mr_module, only : symblock1, symblock2, symblock3, symblock4, symblock5, symblock6
use f_mr_if_module
implicit none

integer, intent(inout) :: sv0, iv0, sx, ix
...
call set_symblock_Xcaaaa(sleft, W0, nir, nsym, psym) ! -> Xcaaaa (allocate) 
call g_sigma_ccoo_coov_no0_x0_type1_eri_c &
  (sv0, iv0, sx, ix, av2_i, h2_i, Xcaaaa, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(h2_i)
deallocate(Xcaaaa)

end subroutine g_if_sigma_ccoo_coov_no0_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no0_x0_type1_eri_c &
  (s_v0, i_v0, s_x, i_x, T2_, V2_, W0_, nir, nsym, psym, flops)
...
! W0(w,x,a1,a0,a3,a2) += (    1.00000000) V2(x,a3,v0,a2) T2(w,a1,a0,v0) 
do s_a3 = 0, nir-1
do s_a2 = 0, nir-1
do s_w = 0, nir-1
do s_a1 = 0, nir-1
...
do i_a3 = psym(I_BEGIN, I_O, s_a3), psym(I_END, I_O, s_a3)
do i_a2 = psym(I_BEGIN, I_O, s_a2), psym(I_END, I_O, s_a2)
W0_(s_a2, s_a3, s_a0, s_a1, s_w)%array(i_a2, i_a3, i_a0, i_a1, i_w) = &
    W0_(s_a2, s_a3, s_a0, s_a1, s_w)%array(i_a2, i_a3, i_a0, i_a1, i_w) &
...
end subroutine g_sigma_ccoo_coov_no0_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no0_x1_type1_eri_c &
  (sj, ij, sx, ix, W0, S2, nir, nsym, psym, flops)
...
call g_sigma_ccoo_coov_no0_x1_type1_eri_c &
  (sj, ij, sx, ix, Xcaaaa, av2_i2, d3, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaaaa)

end subroutine g_if_sigma_ccoo_coov_no0_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no0_x1_type1_eri_c &
  (s_j, i_j, s_x, i_x, W0_, S2_, D3_, nir, nsym, psym, flops)
...
integer :: s_a3, i_a3, s_i, i_i, s_a0, i_a0, s_a1, i_a1, s_a2, i_a2
integer :: s_w, i_w
! S2(w,x,i,j) += (    1.00000000) D3(j,a3,i,a0,a1,a2) W0(w,x,a1,a0,a3,a2) 
do s_a3 = 0, nir-1
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
...
IEOR(IEOR(s_j,s_a3),s_i) == IEOR(IEOR(s_a0,s_a1),s_a2) .and. &
...
Z1_(i_i, i_a3, i_a0, i_a1, i_a2) =  &
  D3_(s_a2, s_a1, s_a0, s_i, s_a3, s_j)%array(i_a2, i_a1, i_a0, i_i, i_a3, i_j)
end do
end do
end do
end do
...
end subroutine g_sigma_ccoo_coov_no0_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no1_x0_type1_eri_c &
  (sv0, iv0, sw, iw, T2, V2, W1, nir, nsym, psym, flops)

use f_mr_module, only : symblock1, symblock2, symblock3, symblock4, symblock5, symblock6
use f_mr_if_module
implicit none

integer, intent(inout) :: sv0, iv0, sw, iw
...
call g_sigma_ccoo_coov_no1_x0_type1_eri_c &
  (sv0, iv0, sw, iw, av2_i, h2_i, Xcaaaa, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(h2_i)
deallocate(Xcaaaa)

end subroutine g_if_sigma_ccoo_coov_no1_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no1_x0_type1_eri_c &
  (s_v0, i_v0, s_w, i_w, T2_, V2_, W1_, nir, nsym, psym, flops)
...
integer :: s_a3, i_a3, s_a2, i_a2, s_x, i_x, s_a1, i_a1, s_a0, i_a0
! W1(x,w,a1,a0,a3,a2) += (    1.00000000) V2(w,a3,v0,a2) T2(x,a1,a0,v0) 
do s_a3 = 0, nir-1
do s_a2 = 0, nir-1
do s_x = 0, nir-1
do s_a1 = 0, nir-1
...
IEOR(s_x,s_a1) == IEOR(s_a0,s_v0)) then

if(psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_a2) > 0 .and. &
   psym(I_LENGTH,I_C, s_x)*psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_a0) > 0) then
...
! Gemm Z1 * Z2 to form Z3
call dgemm('n', 'n', psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_a2),&
                     psym(I_LENGTH,I_C, s_x)*psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_a0),&
                     1,&
                     1.00000000d+00, &
                     Z1_,&
                     psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_a2),&
...
do i_a3 = psym(I_BEGIN, I_O, s_a3), psym(I_END, I_O, s_a3)
do i_a2 = psym(I_BEGIN, I_O, s_a2), psym(I_END, I_O, s_a2)
W1_(s_a2, s_a3, s_a0, s_a1, s_x)%array(i_a2, i_a3, i_a0, i_a1, i_x) = &
    W1_(s_a2, s_a3, s_a0, s_a1, s_x)%array(i_a2, i_a3, i_a0, i_a1, i_x) &
  + Z3_(i_a3, i_a2, i_x, i_a1, i_a0)
end do
end do
end do
end do
...
end subroutine g_sigma_ccoo_coov_no1_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no1_x1_type1_eri_c &
  (sj, ij, sw, iw, W1, S2, nir, nsym, psym, flops)
...
call set_symblock_Xcaaaa(sleft, W1, nir, nsym, psym) ! -> Xcaaaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccoo_coov_no1_x1_type1_eri_c &
  (sj, ij, sw, iw, Xcaaaa, av2_i2, d3, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaaaa)

end subroutine g_if_sigma_ccoo_coov_no1_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no1_x1_type1_eri_c &
  (s_j, i_j, s_w, i_w, W1_, S2_, D3_, nir, nsym, psym, flops)
...
integer :: s_a0, i_a0, s_i, i_i, s_a3, i_a3, s_a1, i_a1, s_a2, i_a2
integer :: s_x, i_x
! S2(w,x,i,j) += (    1.00000000) D3(j,a0,i,a3,a1,a2) W1(x,w,a1,a0,a3,a2) 
do s_a0 = 0, nir-1
do s_i = 0, nir-1
do s_a3 = 0, nir-1
do s_a1 = 0, nir-1
...
if( &
IEOR(s_w,s_x) == IEOR(s_i,s_j) .and. & 
IEOR(IEOR(s_j,s_a0),s_i) == IEOR(IEOR(s_a3,s_a1),s_a2) .and. &
IEOR(IEOR(s_x,s_w),s_a1) == IEOR(IEOR(s_a0,s_a3),s_a2)) then

if(psym(I_LENGTH,I_O, s_i) > 0 .and. &
   psym(I_LENGTH,I_C, s_x) > 0 .and. &
   psym(I_LENGTH,I_O, s_a0)*psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_a2) > 0) then

! Z1 <-- D3(j,a0,i,a3,a1,a2) 
allocate(Z1_(psym(I_BEGIN,I_O, s_i):psym(I_END,I_O, s_i), &
             psym(I_BEGIN,I_O, s_a0):psym(I_END,I_O, s_a0), &
             psym(I_BEGIN,I_O, s_a3):psym(I_END,I_O, s_a3), &
             psym(I_BEGIN,I_O, s_a1):psym(I_END,I_O, s_a1), &
...
call dgemm('n', 'n', psym(I_LENGTH,I_O, s_i),&
                     ...
                     psym(I_LENGTH,I_O, s_a0)*psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_a2),&
                     1.00000000d+00, &
                     Z1_,&
                     psym(I_LENGTH,I_O, s_i),&
                     Z2_,&
...
flops = flops + psym(I_LENGTH,I_O, s_i) * &
                psym(I_LENGTH,I_C, s_x) * &
                psym(I_LENGTH,I_O, s_a0)*psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_a2) * 2.0d+00
...
end subroutine g_sigma_ccoo_coov_no1_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no2_x0_type1_eri_c &
...
call g_sigma_ccoo_coov_no2_x0_type1_eri_c &
  (sw, iw, h2_i, Xaav, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaav)

end subroutine g_if_sigma_ccoo_coov_no2_x0_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no2_x0_type1_eri_c &
...
! W10(w,i,a0,v0) += (    1.00000000) V2(w,a2,v0,a1) D2(i,a2,a0,a1) 
do s_a2 = 0, nir-1
do s_v0 = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ccoo_coov_no2_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no2_x1_type1_eri_c &
  (sj, ij, sw, iw, T2, W10, S2, nir, nsym, psym, flops)
...
call set_symblock_Xaav(sleft, W10, nir, nsym, psym) ! -> Xaav (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccoo_coov_no2_x1_type1_eri_c &
...
end subroutine g_if_sigma_ccoo_coov_no2_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no2_x1_type1_eri_c &
  (s_j, i_j, s_w, i_w, T2_, W10_, S2_, nir, nsym, psym, flops)
...
! S2(w,x,i,j) += (   -2.00000000) T2(a0,x,v0,j) W10(w,i,a0,v0) 
do s_a0 = 0, nir-1
do s_x = 0, nir-1
do s_v0 = 0, nir-1
do s_i = 0, nir-1
if( &
IEOR(s_w,s_x) == IEOR(s_i,s_j) .and. & 
IEOR(s_a0,s_x) == IEOR(s_v0,s_j) .and. &
...
end subroutine g_sigma_ccoo_coov_no2_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no3_x0_type1_eri_c &
...
call g_sigma_ccoo_coov_no3_x0_type1_eri_c &
  (sx, ix, h2_i, Xaav, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaav)

end subroutine g_if_sigma_ccoo_coov_no3_x0_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no3_x0_type1_eri_c &
...
integer :: s_a2, i_a2, s_v0, i_v0, s_a1, i_a1, s_i, i_i, s_a0, i_a0
! W11(x,i,a0,v0) += (    1.00000000) V2(x,a2,v0,a1) D2(i,a2,a0,a1) 
do s_a2 = 0, nir-1
do s_v0 = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ccoo_coov_no3_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no3_x1_type1_eri_c &
  (sj, ij, sx, ix, T2, W11, S2, nir, nsym, psym, flops)
...
call set_symblock_Xaav(sleft, W11, nir, nsym, psym) ! -> Xaav (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccoo_coov_no3_x1_type1_eri_c &
...
end subroutine g_if_sigma_ccoo_coov_no3_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no3_x1_type1_eri_c &
  (s_j, i_j, s_x, i_x, T2_, W11_, S2_, nir, nsym, psym, flops)
...
! S2(w,x,i,j) += (    1.00000000) T2(a0,w,v0,j) W11(x,i,a0,v0) 
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_v0 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ccoo_coov_no3_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no4_x0_type1_eri_c &
...
call g_sigma_ccoo_coov_no4_x0_type1_eri_c &
  (sw, iw, h2_i, Xaav, d1, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaav)

end subroutine g_if_sigma_ccoo_coov_no4_x0_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no4_x0_type1_eri_c &
  (s_w, i_w, V2_, W14_, D1_, nir, nsym, psym, flops)
...
! W14(w,a0,i,v0) += (    1.00000000) V2(w,i,v0,a1) D1(a1,a0) 
do s_i = 0, nir-1
do s_v0 = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_ccoo_coov_no4_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no4_x1_type1_eri_c &
  (sj, ij, sw, iw, T2, W14, S2, nir, nsym, psym, flops)
...
call set_symblock_Xaav(sleft, W14, nir, nsym, psym) ! -> Xaav (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccoo_coov_no4_x1_type1_eri_c &
  (sj, ij, sw, iw, av2_i, Xaav, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccoo_coov_no4_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no4_x1_type1_eri_c &
  (s_j, i_j, s_w, i_w, T2_, W14_, S2_, nir, nsym, psym, flops)
...
integer :: s_a0, i_a0, s_x, i_x, s_v0, i_v0, s_i, i_i
! S2(w,x,i,j) += (    4.00000000) T2(a0,x,v0,j) W14(w,a0,i,v0) 
do s_a0 = 0, nir-1
do s_x = 0, nir-1
do s_v0 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ccoo_coov_no4_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no5_x0_type1_eri_c &
...
call g_sigma_ccoo_coov_no5_x0_type1_eri_c &
  (sx, ix, h2_i, Xaav, d1, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaav)

end subroutine g_if_sigma_ccoo_coov_no5_x0_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no5_x0_type1_eri_c &
  (s_x, i_x, V2_, W15_, D1_, nir, nsym, psym, flops)
...
integer :: s_i, i_i, s_v0, i_v0, s_a1, i_a1, s_a0, i_a0
! W15(x,a0,i,v0) += (    1.00000000) V2(x,i,v0,a1) D1(a1,a0) 
do s_i = 0, nir-1
do s_v0 = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_ccoo_coov_no5_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no5_x1_type1_eri_c &
  (sj, ij, sx, ix, T2, W15, S2, nir, nsym, psym, flops)
...
call set_symblock_Xaav(sleft, W15, nir, nsym, psym) ! -> Xaav (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccoo_coov_no5_x1_type1_eri_c &
  (sj, ij, sx, ix, av2_i, Xaav, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccoo_coov_no5_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no5_x1_type1_eri_c &
  (s_j, i_j, s_x, i_x, T2_, W15_, S2_, nir, nsym, psym, flops)
...
integer :: s_a0, i_a0, s_w, i_w, s_v0, i_v0, s_i, i_i
! S2(w,x,i,j) += (   -2.00000000) T2(a0,w,v0,j) W15(x,a0,i,v0) 
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_v0 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ccoo_coov_no5_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no6_x0_type1_eri_c &
...
call g_sigma_ccoo_coov_no6_x0_type1_eri_c &
  (sw, iw, h2_i, Xaav, d1, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaav)

end subroutine g_if_sigma_ccoo_coov_no6_x0_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no6_x0_type1_eri_c &
...
end subroutine g_sigma_ccoo_coov_no6_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no6_x1_type1_eri_c &
...
call set_symblock_Xaav(sleft, W24, nir, nsym, psym) ! -> Xaav (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccoo_coov_no6_x1_type1_eri_c &
  (sj, ij, sw, iw, av2_i, Xaav, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccoo_coov_no6_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no6_x1_type1_eri_c &
...
integer :: s_a0, i_a0, s_x, i_x, s_v0, i_v0, s_i, i_i
! S2(w,x,i,j) += (   -2.00000000) T2(a0,x,v0,j) W24(w,a0,i,v0) 
do s_a0 = 0, nir-1
do s_x = 0, nir-1
do s_v0 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ccoo_coov_no6_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no7_x0_type1_eri_c &
...
call g_sigma_ccoo_coov_no7_x0_type1_eri_c &
  (sx, ix, h2_i, Xaav, d1, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaav)

end subroutine g_if_sigma_ccoo_coov_no7_x0_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no7_x0_type1_eri_c &
...
end subroutine g_sigma_ccoo_coov_no7_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no7_x1_type1_eri_c &
...
call set_symblock_Xaav(sleft, W25, nir, nsym, psym) ! -> Xaav (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccoo_coov_no7_x1_type1_eri_c &
  (sj, ij, sx, ix, av2_i, Xaav, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccoo_coov_no7_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no7_x1_type1_eri_c &
...
integer :: s_a0, i_a0, s_w, i_w, s_v0, i_v0, s_i, i_i
! S2(w,x,i,j) += (    1.00000000) T2(a0,w,v0,j) W25(x,a0,i,v0) 
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_v0 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ccoo_coov_no7_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no0_x0_type1_eri_o &
...
call g_sigma_ccoo_coov_no0_x0_type1_eri_o &
  (sj, ij, sv0, iv0, h2_i, Xca, d1, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xca)

end subroutine g_if_sigma_ccoo_coov_no0_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no0_x0_type1_eri_o &
  (s_j, i_j, s_v0, i_v0, V2_, W18_, D1_, nir, nsym, psym, flops)
...
end subroutine g_sigma_ccoo_coov_no0_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no0_x1_type1_eri_o &
...
call set_symblock_Xca(sleft, W18, nir, nsym, psym) ! -> Xca (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccoo_coov_no0_x1_type1_eri_o &
...
end subroutine g_if_sigma_ccoo_coov_no0_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no0_x1_type1_eri_o &
...
! S2(w,x,i,j) += (    4.00000000) T2(w,a0,i,v0) W18(x,a0,j,v0) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
do s_x = 0, nir-1
...
end subroutine g_sigma_ccoo_coov_no0_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no1_x0_type1_eri_o &
...
call g_sigma_ccoo_coov_no1_x0_type1_eri_o &
  (sj, ij, sv0, iv0, h2_i, Xca, d1, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xca)

end subroutine g_if_sigma_ccoo_coov_no1_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no1_x0_type1_eri_o &
  (s_j, i_j, s_v0, i_v0, V2_, W19_, D1_, nir, nsym, psym, flops)
...
end subroutine g_sigma_ccoo_coov_no1_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no1_x1_type1_eri_o &
...
call set_symblock_Xca(sleft, W19, nir, nsym, psym) ! -> Xca (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccoo_coov_no1_x1_type1_eri_o &
  (sj, ij, sv0, iv0, av2_i, Xca, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccoo_coov_no1_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no1_x1_type1_eri_o &
...
! S2(w,x,i,j) += (   -2.00000000) T2(x,a0,i,v0) W19(w,a0,j,v0) 
do s_x = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
do s_w = 0, nir-1
...
end subroutine g_sigma_ccoo_coov_no1_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no0_x0_type1_eri_v &
...
call g_sigma_ccoo_coov_no0_x0_type1_eri_v &
  (sj, ij, sv0, iv0, av2_i, Xca, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xca)

end subroutine g_if_sigma_ccoo_coov_no0_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no0_x0_type1_eri_v &
...
integer :: s_w, i_w, s_a1, i_a1, s_a0, i_a0, s_a2, i_a2
! W2(w,j,a2,v0) += (    1.00000000) T2(w,a1,a0,v0) D2(j,a0,a1,a2) 
do s_w = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_a2 = 0, nir-1
...
IEOR(s_j,s_a0) == IEOR(s_a1,s_a2)) then
...
do i_a2 = psym(I_BEGIN, I_O, s_a2), psym(I_END, I_O, s_a2)
Z1_(i_a2, i_a0, i_a1) =  &
  D2_(s_a2, s_a1, s_a0, s_j)%array(i_a2, i_a1, i_a0, i_j)
end do
end do
end do
! Z2 <-- T2(w,a1,a0,v0) 
...
end subroutine g_sigma_ccoo_coov_no0_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no0_x1_type1_eri_v &
...
call set_symblock_Xca(sleft, W2, nir, nsym, psym) ! -> Xca (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccoo_coov_no0_x1_type1_eri_v &
...
end subroutine g_if_sigma_ccoo_coov_no0_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no0_x1_type1_eri_v &
...
end subroutine g_sigma_ccoo_coov_no0_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no1_x0_type1_eri_v &
...
call g_sigma_ccoo_coov_no1_x0_type1_eri_v &
  (sj, ij, sv0, iv0, av2_i, Xca, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xca)

end subroutine g_if_sigma_ccoo_coov_no1_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no1_x0_type1_eri_v &
...
integer :: s_x, i_x, s_a1, i_a1, s_a0, i_a0, s_a2, i_a2
! W3(x,j,a2,v0) += (    1.00000000) T2(x,a1,a0,v0) D2(j,a0,a1,a2) 
do s_x = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_a2 = 0, nir-1
...
end subroutine g_sigma_ccoo_coov_no1_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no1_x1_type1_eri_v &
...
call set_symblock_Xca(sleft, W3, nir, nsym, psym) ! -> Xca (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccoo_coov_no1_x1_type1_eri_v &
  (sj, ij, sv0, iv0, h2_i, Xca, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccoo_coov_no1_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no1_x1_type1_eri_v &
...
end subroutine g_sigma_ccoo_coov_no1_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no2_x0_type1_eri_v &
...
call g_sigma_ccoo_coov_no2_x0_type1_eri_v &
  (sj, ij, sv0, iv0, h2_i, Xca, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xca)

end subroutine g_if_sigma_ccoo_coov_no2_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no2_x0_type1_eri_v &
...
! W4(w,j,a0,v0) += (    1.00000000) V2(v0,a1,w,a2) D2(j,a2,a0,a1) 
do s_a1 = 0, nir-1
do s_w = 0, nir-1
do s_a2 = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_ccoo_coov_no2_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no2_x1_type1_eri_v &
...
call set_symblock_Xca(sleft, W4, nir, nsym, psym) ! -> Xca (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccoo_coov_no2_x1_type1_eri_v &
  (sj, ij, sv0, iv0, av2_i, Xca, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccoo_coov_no2_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no2_x1_type1_eri_v &
...
integer :: s_x, i_x, s_a0, i_a0, s_i, i_i, s_w, i_w
! S2(w,x,i,j) += (    1.00000000) T2(x,a0,i,v0) W4(w,j,a0,v0) 
do s_x = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
do s_w = 0, nir-1
...
end subroutine g_sigma_ccoo_coov_no2_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no3_x0_type1_eri_v &
...
call g_sigma_ccoo_coov_no3_x0_type1_eri_v &
  (sj, ij, sv0, iv0, h2_i, Xca, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xca)

end subroutine g_if_sigma_ccoo_coov_no3_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no3_x0_type1_eri_v &
...
! W5(x,j,a0,v0) += (    1.00000000) V2(v0,a1,x,a2) D2(j,a2,a0,a1) 
do s_a1 = 0, nir-1
do s_x = 0, nir-1
do s_a2 = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_ccoo_coov_no3_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no3_x1_type1_eri_v &
...
call set_symblock_Xca(sleft, W5, nir, nsym, psym) ! -> Xca (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccoo_coov_no3_x1_type1_eri_v &
  (sj, ij, sv0, iv0, av2_i, Xca, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccoo_coov_no3_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no3_x1_type1_eri_v &
...
integer :: s_w, i_w, s_a0, i_a0, s_i, i_i, s_x, i_x
! S2(w,x,i,j) += (   -2.00000000) T2(w,a0,i,v0) W5(x,j,a0,v0) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
do s_x = 0, nir-1
...
end subroutine g_sigma_ccoo_coov_no3_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no4_x0_type1_eri_v &
...
call g_sigma_ccoo_coov_no4_x0_type1_eri_v &
  (sj, ij, sv0, iv0, av2_i, Xca, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xca)

end subroutine g_if_sigma_ccoo_coov_no4_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no4_x0_type1_eri_v &
...
integer :: s_w, i_w, s_a1, i_a1, s_a0, i_a0, s_a2, i_a2
! W6(w,j,a2,v0) += (    1.00000000) T2(w,a1,a0,v0) D2(j,a2,a1,a0) 
do s_w = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_a2 = 0, nir-1
...
end subroutine g_sigma_ccoo_coov_no4_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no4_x1_type1_eri_v &
...
call set_symblock_Xca(sleft, W6, nir, nsym, psym) ! -> Xca (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccoo_coov_no4_x1_type1_eri_v &
  (sj, ij, sv0, iv0, h2_i, Xca, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccoo_coov_no4_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no4_x1_type1_eri_v &
...
! S2(w,x,i,j) += (    1.00000000) V2(v0,i,x,a2) W6(w,j,a2,v0) 
do s_i = 0, nir-1
do s_x = 0, nir-1
do s_a2 = 0, nir-1
do s_w = 0, nir-1
...
end subroutine g_sigma_ccoo_coov_no4_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no5_x0_type1_eri_v &
...
call g_sigma_ccoo_coov_no5_x0_type1_eri_v &
  (sj, ij, sv0, iv0, av2_i, Xca, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xca)

end subroutine g_if_sigma_ccoo_coov_no5_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no5_x0_type1_eri_v &
...
integer :: s_x, i_x, s_a1, i_a1, s_a0, i_a0, s_a2, i_a2
! W7(x,j,a2,v0) += (    1.00000000) T2(x,a1,a0,v0) D2(j,a0,a1,a2) 
do s_x = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_a2 = 0, nir-1
...
end subroutine g_sigma_ccoo_coov_no5_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no5_x1_type1_eri_v &
...
call set_symblock_Xca(sleft, W7, nir, nsym, psym) ! -> Xca (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccoo_coov_no5_x1_type1_eri_v &
  (sj, ij, sv0, iv0, h2_i, Xca, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccoo_coov_no5_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no5_x1_type1_eri_v &
...
! S2(w,x,i,j) += (    1.00000000) V2(v0,i,w,a2) W7(x,j,a2,v0) 
do s_i = 0, nir-1
do s_w = 0, nir-1
do s_a2 = 0, nir-1
do s_x = 0, nir-1
...
end subroutine g_sigma_ccoo_coov_no5_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no6_x0_type1_eri_v &
...
call g_sigma_ccoo_coov_no6_x0_type1_eri_v &
  (sv0, iv0, av2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_ccoo_coov_no6_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no6_x0_type1_eri_v &
...
! W8(w,i,a2,v0) += (    1.00000000) T2(w,a1,a0,v0) D2(i,a0,a1,a2) 
do s_w = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ccoo_coov_no6_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no6_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W8, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccoo_coov_no6_x1_type1_eri_v &
...
end subroutine g_if_sigma_ccoo_coov_no6_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no6_x1_type1_eri_v &
...
end subroutine g_sigma_ccoo_coov_no6_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no7_x0_type1_eri_v &
...
call g_sigma_ccoo_coov_no7_x0_type1_eri_v &
  (sv0, iv0, av2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_ccoo_coov_no7_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no7_x0_type1_eri_v &
...
! W9(x,i,a2,v0) += (    1.00000000) T2(x,a1,a0,v0) D2(i,a0,a1,a2) 
do s_x = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ccoo_coov_no7_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no7_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W9, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccoo_coov_no7_x1_type1_eri_v &
  (sj, ij, sv0, iv0, h2_i, Xcaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccoo_coov_no7_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no7_x1_type1_eri_v &
...
end subroutine g_sigma_ccoo_coov_no7_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no8_x0_type1_eri_v &
...
call g_sigma_ccoo_coov_no8_x0_type1_eri_v &
  (sv0, iv0, av2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_ccoo_coov_no8_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no8_x0_type1_eri_v &
...
integer :: s_w, i_w, s_a1, i_a1, s_a0, i_a0, s_i, i_i, s_a2, i_a2
! W12(w,i,a2,v0) += (    1.00000000) T2(w,a1,a0,v0) D2(i,a0,a1,a2) 
do s_w = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
...
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
do i_a2 = psym(I_BEGIN, I_O, s_a2), psym(I_END, I_O, s_a2)
W12_(s_a2, s_i, s_w)%array(i_a2, i_i, i_w) = &
    W12_(s_a2, s_i, s_w)%array(i_a2, i_i, i_w) &
  + Z3_(i_i, i_a2, i_w)
end do
end do
...
end subroutine g_sigma_ccoo_coov_no8_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no8_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W12, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccoo_coov_no8_x1_type1_eri_v &
  (sj, ij, sv0, iv0, h2_i, Xcaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccoo_coov_no8_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no8_x1_type1_eri_v &
...
! S2(w,x,i,j) += (    1.00000000) V2(v0,j,x,a2) W12(w,i,a2,v0) 
do s_x = 0, nir-1
do s_a2 = 0, nir-1
do s_w = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ccoo_coov_no8_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no9_x0_type1_eri_v &
...
call g_sigma_ccoo_coov_no9_x0_type1_eri_v &
  (sv0, iv0, av2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_ccoo_coov_no9_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no9_x0_type1_eri_v &
...
integer :: s_x, i_x, s_a1, i_a1, s_a0, i_a0, s_i, i_i, s_a2, i_a2
! W13(x,i,a2,v0) += (    1.00000000) T2(x,a1,a0,v0) D2(i,a2,a1,a0) 
do s_x = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
...
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
do i_a2 = psym(I_BEGIN, I_O, s_a2), psym(I_END, I_O, s_a2)
W13_(s_a2, s_i, s_x)%array(i_a2, i_i, i_x) = &
    W13_(s_a2, s_i, s_x)%array(i_a2, i_i, i_x) &
  + Z3_(i_i, i_a2, i_x)
end do
end do
...
end subroutine g_sigma_ccoo_coov_no9_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no9_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W13, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccoo_coov_no9_x1_type1_eri_v &
  (sj, ij, sv0, iv0, h2_i, Xcaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccoo_coov_no9_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no9_x1_type1_eri_v &
...
! S2(w,x,i,j) += (    1.00000000) V2(v0,j,w,a2) W13(x,i,a2,v0) 
do s_w = 0, nir-1
do s_a2 = 0, nir-1
do s_x = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ccoo_coov_no9_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no10_x0_type1_eri_v &
...
call g_sigma_ccoo_coov_no10_x0_type1_eri_v &
  (sv0, iv0, av2_i, Xc, d1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xc)

end subroutine g_if_sigma_ccoo_coov_no10_x0_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no10_x0_type1_eri_v &
...
integer :: s_w, i_w, s_a1, i_a1, s_a0, i_a0
! W16(w,v0) += (    1.00000000) T2(w,a1,a0,v0) D1(a1,a0) 
do s_w = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
if( &
...
end subroutine g_sigma_ccoo_coov_no10_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no10_x1_type1_eri_v &
...
call set_symblock_Xc(sleft, W16, nir, nsym, psym) ! -> Xc (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccoo_coov_no10_x1_type1_eri_v &
...
end subroutine g_if_sigma_ccoo_coov_no10_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no10_x1_type1_eri_v &
...
! S2(w,x,i,j) += (    1.00000000) V2(v0,j,x,i) W16(w,v0) 
do s_x = 0, nir-1
do s_i = 0, nir-1
do s_w = 0, nir-1
if( &
...
end subroutine g_sigma_ccoo_coov_no10_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no11_x0_type1_eri_v &
...
call g_sigma_ccoo_coov_no11_x0_type1_eri_v &
  (sv0, iv0, av2_i, Xc, d1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xc)

end subroutine g_if_sigma_ccoo_coov_no11_x0_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no11_x0_type1_eri_v &
...
integer :: s_x, i_x, s_a1, i_a1, s_a0, i_a0
! W17(x,v0) += (    1.00000000) T2(x,a1,a0,v0) D1(a1,a0) 
do s_x = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
if( &
...
end subroutine g_sigma_ccoo_coov_no11_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no11_x1_type1_eri_v &
...
call set_symblock_Xc(sleft, W17, nir, nsym, psym) ! -> Xc (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccoo_coov_no11_x1_type1_eri_v &
  (sj, ij, sv0, iv0, h2_i, Xc, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccoo_coov_no11_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no11_x1_type1_eri_v &
...
! S2(w,x,i,j) += (   -2.00000000) V2(v0,j,w,i) W17(x,v0) 
do s_w = 0, nir-1
do s_i = 0, nir-1
do s_x = 0, nir-1
if( &
...
end subroutine g_sigma_ccoo_coov_no11_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no12_x0_type1_eri_v &
...
call g_sigma_ccoo_coov_no12_x0_type1_eri_v &
  (sj, ij, sv0, iv0, h2_i, Xca, d1, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xca)

end subroutine g_if_sigma_ccoo_coov_no12_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no12_x0_type1_eri_v &
...
end subroutine g_sigma_ccoo_coov_no12_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no12_x1_type1_eri_v &
...
call set_symblock_Xca(sleft, W20, nir, nsym, psym) ! -> Xca (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccoo_coov_no12_x1_type1_eri_v &
  (sj, ij, sv0, iv0, av2_i, Xca, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccoo_coov_no12_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no12_x1_type1_eri_v &
...
integer :: s_x, i_x, s_a0, i_a0, s_i, i_i, s_w, i_w
! S2(w,x,i,j) += (    1.00000000) T2(x,a0,i,v0) W20(w,a0,j,v0) 
do s_x = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
do s_w = 0, nir-1
...
end subroutine g_sigma_ccoo_coov_no12_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no13_x0_type1_eri_v &
...
call g_sigma_ccoo_coov_no13_x0_type1_eri_v &
  (sj, ij, sv0, iv0, h2_i, Xca, d1, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xca)

end subroutine g_if_sigma_ccoo_coov_no13_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no13_x0_type1_eri_v &
...
end subroutine g_sigma_ccoo_coov_no13_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no13_x1_type1_eri_v &
...
call set_symblock_Xca(sleft, W21, nir, nsym, psym) ! -> Xca (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccoo_coov_no13_x1_type1_eri_v &
  (sj, ij, sv0, iv0, av2_i, Xca, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccoo_coov_no13_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no13_x1_type1_eri_v &
...
integer :: s_w, i_w, s_a0, i_a0, s_i, i_i, s_x, i_x
! S2(w,x,i,j) += (   -2.00000000) T2(w,a0,i,v0) W21(x,a0,j,v0) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
do s_x = 0, nir-1
...
end subroutine g_sigma_ccoo_coov_no13_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no14_x0_type1_eri_v &
...
call g_sigma_ccoo_coov_no14_x0_type1_eri_v &
  (sv0, iv0, av2_i, Xc, d1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xc)

end subroutine g_if_sigma_ccoo_coov_no14_x0_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no14_x0_type1_eri_v &
...
integer :: s_w, i_w, s_a1, i_a1, s_a0, i_a0
! W22(w,v0) += (    1.00000000) T2(w,a1,a0,v0) D1(a1,a0) 
do s_w = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
if( &
...
end subroutine g_sigma_ccoo_coov_no14_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no14_x1_type1_eri_v &
...
call set_symblock_Xc(sleft, W22, nir, nsym, psym) ! -> Xc (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccoo_coov_no14_x1_type1_eri_v &
  (sj, ij, sv0, iv0, h2_i, Xc, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccoo_coov_no14_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no14_x1_type1_eri_v &
...
! S2(w,x,i,j) += (   -2.00000000) V2(v0,i,x,j) W22(w,v0) 
do s_i = 0, nir-1
do s_x = 0, nir-1
do s_w = 0, nir-1
if( &
...
end subroutine g_sigma_ccoo_coov_no14_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no15_x0_type1_eri_v &
...
call g_sigma_ccoo_coov_no15_x0_type1_eri_v &
  (sv0, iv0, av2_i, Xc, d1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xc)

end subroutine g_if_sigma_ccoo_coov_no15_x0_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no15_x0_type1_eri_v &
...
integer :: s_x, i_x, s_a1, i_a1, s_a0, i_a0
! W23(x,v0) += (    1.00000000) T2(x,a1,a0,v0) D1(a1,a0) 
do s_x = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
if( &
...
end subroutine g_sigma_ccoo_coov_no15_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccoo_coov_no15_x1_type1_eri_v &
...
call set_symblock_Xc(sleft, W23, nir, nsym, psym) ! -> Xc (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccoo_coov_no15_x1_type1_eri_v &
  (sj, ij, sv0, iv0, h2_i, Xc, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccoo_coov_no15_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccoo_coov_no15_x1_type1_eri_v &
...
! S2(w,x,i,j) += (    1.00000000) V2(v0,i,w,j) W23(x,v0) 
do s_i = 0, nir-1
do s_w = 0, nir-1
do s_x = 0, nir-1
if( &
...
end subroutine g_sigma_ccoo_coov_no15_x1_type1_eri_v
