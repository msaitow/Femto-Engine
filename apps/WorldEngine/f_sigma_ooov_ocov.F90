...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ooov_ocov_no0_x0_type0_noeri &
...
call g_sigma_ooov_ocov_no0_x0_type0_noeri &
  (sa, ia, av2_i, Xaaa, fc1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_ooov_ocov_no0_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ooov_ocov_no0_x0_type0_noeri &
...
integer :: s_a1, i_a1, s_c0, i_c0, s_a0, i_a0, s_a2, i_a2
! W0(a2,a1,a0,a) += (    1.00000000) T2(a1,c0,a0,a) Fc1(c0,a2) 
do s_a1 = 0, nir-1
do s_c0 = 0, nir-1
do s_a0 = 0, nir-1
do s_a2 = 0, nir-1
...
end subroutine g_sigma_ooov_ocov_no0_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ooov_ocov_no0_x1_type0_noeri &
...
call g_sigma_ooov_ocov_no0_x1_type0_noeri &
  (sa, ia, Xaaa, av2_i2, d3, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaaa)

end subroutine g_if_sigma_ooov_ocov_no0_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ooov_ocov_no0_x1_type0_noeri &
...
integer :: s_a0, i_a0
! S2(i,j,k,a) += (   -1.00000000) D3(k,i,a2,j,a1,a0) W0(a2,a1,a0,a) 
do s_k = 0, nir-1
do s_i = 0, nir-1
do s_a2 = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_ooov_ocov_no0_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ooov_ocov_no1_x0_type0_noeri &
...
call g_sigma_ooov_ocov_no1_x0_type0_noeri &
  (sa, ia, av2_i, Xaaa, fc1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_ooov_ocov_no1_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ooov_ocov_no1_x0_type0_noeri &
...
integer :: s_a0, i_a0, s_c0, i_c0, s_k, i_k, s_a1, i_a1
! W1(a1,a0,k,a) += (    1.00000000) T2(a0,c0,k,a) Fc1(c0,a1) 
do s_a0 = 0, nir-1
do s_c0 = 0, nir-1
do s_k = 0, nir-1
do s_a1 = 0, nir-1
...
IEOR(s_a0,s_c0) == IEOR(s_k,s_a) .and. &
...
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
Z1_(i_a0, i_k, i_c0) =  &
  T2_(s_k, s_c0, s_a0)%array(i_k, i_c0, i_a0)
end do
end do
end do
! Z2 <-- Fc1(c0,a1) 
...
end subroutine g_sigma_ooov_ocov_no1_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ooov_ocov_no1_x1_type0_noeri &
...
call set_symblock_Xaaa(sleft, W1, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ooov_ocov_no1_x1_type0_noeri &
  (sa, ia, Xaaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaaa)

end subroutine g_if_sigma_ooov_ocov_no1_x1_type0_noeri
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ooov_ocov_no1_x1_type0_noeri &
...
! S2(i,j,k,a) += (   -1.00000000) D2(j,a1,i,a0) W1(a1,a0,k,a) 
do s_j = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_ooov_ocov_no1_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ooov_ocov_no2_x0_type0_noeri &
...
call g_sigma_ooov_ocov_no2_x0_type0_noeri &
  (sa, ia, av2_i, Xa, fc1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xa)

end subroutine g_if_sigma_ooov_ocov_no2_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ooov_ocov_no2_x0_type0_noeri &
...
integer :: s_a0, i_a0, s_c0, i_c0, s_a1, i_a1
! W2(a0,a) += (    1.00000000) T2(a0,c0,a1,a) Fc1(c0,a1) 
do s_a0 = 0, nir-1
do s_c0 = 0, nir-1
do s_a1 = 0, nir-1
if( &
...
end subroutine g_sigma_ooov_ocov_no2_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ooov_ocov_no2_x1_type0_noeri &
...
call set_symblock_Xa(sleft, W2, nir, nsym, psym) ! -> Xa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ooov_ocov_no2_x1_type0_noeri &
  (sa, ia, Xa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xa)

end subroutine g_if_sigma_ooov_ocov_no2_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ooov_ocov_no2_x1_type0_noeri &
...
! S2(i,j,k,a) += (   -1.00000000) D2(k,i,a0,j) W2(a0,a) 
do s_k = 0, nir-1
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_ooov_ocov_no2_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ooov_ocov_no0_x0_type1_eri_c &
...
call g_sigma_ooov_ocov_no0_x0_type1_eri_c &
  (sc0, ic0, h2_i, Xaaa, d3, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_ooov_ocov_no0_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ooov_ocov_no0_x0_type1_eri_c &
...
integer :: s_a0, i_a0
! W4(c0,j,i,a0) += (    1.00000000) V2(c0,a2,a3,a1) D3(j,a2,i,a0,a3,a1) 
do s_a2 = 0, nir-1
do s_a3 = 0, nir-1
do s_a1 = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_ooov_ocov_no0_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ooov_ocov_no0_x1_type1_eri_c &
...
call set_symblock_Xaaa(sleft, W4, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ooov_ocov_no0_x1_type1_eri_c &
...
end subroutine g_if_sigma_ooov_ocov_no0_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ooov_ocov_no0_x1_type1_eri_c &
...
! S2(i,j,k,a) += (   -1.00000000) T2(a0,c0,k,a) W4(c0,j,i,a0) 
do s_a0 = 0, nir-1
do s_k = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ooov_ocov_no0_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ooov_ocov_no0_x0_type1_eri_o &
...
call g_sigma_ooov_ocov_no0_x0_type1_eri_o &
  (sk, ik, h2_i, Xcaaaa, d3, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xcaaaa)

end subroutine g_if_sigma_ooov_ocov_no0_x0_type1_eri_o
...
! Information for debugging 
! >> Score :: 111001
! RDM is rotated :: D3(j,a2,i,a3,a1,a0)  >> D3(a3,i,a0,a1,a2,j) 
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ooov_ocov_no0_x0_type1_eri_o &
...
! W3(c0,j,i,a1,a0,k) += (    1.00000000) V2(k,a3,c0,a2) D3(j,a2,i,a3,a1,a0) 
do s_a3 = 0, nir-1
do s_c0 = 0, nir-1
do s_a2 = 0, nir-1
do s_j = 0, nir-1
...
IEOR(IEOR(s_j,s_a2),s_i) == IEOR(IEOR(s_a3,s_a1),s_a0)) then
...
Z1_(i_j, i_i, i_a1, i_a0, i_a2, i_a3) =  &
  D3_(s_j, s_a2, s_a1, s_a0, s_i, s_a3)%array(i_j, i_a2, i_a1, i_a0, i_i, i_a3)
end do
end do
end do
end do
...
end subroutine g_sigma_ooov_ocov_no0_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ooov_ocov_no0_x1_type1_eri_o &
...
call set_symblock_Xcaaaa(sleft, W3, nir, nsym, psym) ! -> Xcaaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ooov_ocov_no0_x1_type1_eri_o &
...
end subroutine g_if_sigma_ooov_ocov_no0_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ooov_ocov_no0_x1_type1_eri_o &
...
integer :: s_a0, i_a0, s_c0, i_c0, s_a1, i_a1, s_j, i_j, s_i, i_i
! S2(i,j,k,a) += (   -1.00000000) T2(a0,c0,a1,a) W3(c0,j,i,a1,a0,k) 
do s_a0 = 0, nir-1
do s_c0 = 0, nir-1
do s_a1 = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_ooov_ocov_no0_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ooov_ocov_no1_x0_type1_eri_o &
...
call g_sigma_ooov_ocov_no1_x0_type1_eri_o &
...
end subroutine g_if_sigma_ooov_ocov_no1_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ooov_ocov_no1_x0_type1_eri_o &
...
! W5(a0,a3,a1,a) += (    1.00000000) V2(a3,a1,c0,a2) T2(a0,c0,a2,a) 
do s_a1 = 0, nir-1
do s_c0 = 0, nir-1
do s_a2 = 0, nir-1
do s_a0 = 0, nir-1
...
IEOR(s_a0,s_c0) == IEOR(s_a2,s_a)) then
...
do i_c0 = psym(I_BEGIN, I_C, s_c0), psym(I_END, I_C, s_c0)
Z2_(i_c0, i_a2, i_a0) =  &
  T2_(s_a2, s_c0, s_a0)%array(i_a2, i_c0, i_a0)
end do
end do
end do
...
end subroutine g_sigma_ooov_ocov_no1_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ooov_ocov_no1_x1_type1_eri_o &
...
call set_symblock_Xaa(sleft, W5, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ooov_ocov_no1_x1_type1_eri_o &
  (sa, ia, sa3, ia3, Xaa, av2_i2, d3, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaa)

end subroutine g_if_sigma_ooov_ocov_no1_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ooov_ocov_no1_x1_type1_eri_o &
...
! S2(i,j,k,a) += (   -1.00000000) D3(k,i,a3,a1,a0,j) W5(a0,a3,a1,a) 
do s_k = 0, nir-1
do s_i = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_ooov_ocov_no1_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ooov_ocov_no2_x0_type1_eri_o &
...
call g_sigma_ooov_ocov_no2_x0_type1_eri_o &
...
end subroutine g_if_sigma_ooov_ocov_no2_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ooov_ocov_no2_x0_type1_eri_o &
...
! W6(a0,a3,a2,a) += (    1.00000000) V2(a2,c0,a3,a1) T2(a0,c0,a1,a) 
do s_c0 = 0, nir-1
do s_a3 = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_ooov_ocov_no2_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ooov_ocov_no2_x1_type1_eri_o &
...
call set_symblock_Xaa(sleft, W6, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ooov_ocov_no2_x1_type1_eri_o &
  (sa, ia, sa2, ia2, Xaa, av2_i2, d3, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaa)

end subroutine g_if_sigma_ooov_ocov_no2_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ooov_ocov_no2_x1_type1_eri_o &
...
integer :: s_k, i_k, s_i, i_i, s_j, i_j, s_a0, i_a0, s_a3, i_a3
! S2(i,j,k,a) += (   -1.00000000) D3(k,i,a2,j,a0,a3) W6(a0,a3,a2,a) 
do s_k = 0, nir-1
do s_i = 0, nir-1
do s_j = 0, nir-1
do s_a0 = 0, nir-1
...
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
do i_k = psym(I_BEGIN, I_O, s_k), psym(I_END, I_O, s_k)
Z1_(i_k, i_i, i_j, i_a0, i_a3) =  &
  D3_(s_a3, s_a0, s_j, s_a2, s_i, s_k)%array(i_a3, i_a0, i_j, i_a2, i_i, i_k)
end do
end do
end do
end do
...
end subroutine g_sigma_ooov_ocov_no2_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ooov_ocov_no3_x0_type1_eri_o &
...
call g_sigma_ooov_ocov_no3_x0_type1_eri_o &
...
end subroutine g_if_sigma_ooov_ocov_no3_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ooov_ocov_no3_x0_type1_eri_o &
...
! W7(a0,k,a2,a) += (    1.00000000) V2(k,a2,c0,a1) T2(a0,c0,a1,a) 
do s_a2 = 0, nir-1
do s_c0 = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_ooov_ocov_no3_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ooov_ocov_no3_x1_type1_eri_o &
...
call set_symblock_Xaa(sleft, W7, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ooov_ocov_no3_x1_type1_eri_o &
  (sa, ia, sk, ik, Xaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaa)

end subroutine g_if_sigma_ooov_ocov_no3_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ooov_ocov_no3_x1_type1_eri_o &
...
! S2(i,j,k,a) += (   -1.00000000) D2(j,a0,i,a2) W7(a0,k,a2,a) 
do s_j = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
do s_a2 = 0, nir-1
...
end subroutine g_sigma_ooov_ocov_no3_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ooov_ocov_no4_x0_type1_eri_o &
...
call g_sigma_ooov_ocov_no4_x0_type1_eri_o &
  (sa, ia, sk, ik, av2_i, h2_i, Xaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ooov_ocov_no4_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ooov_ocov_no4_x0_type1_eri_o &
...
integer :: s_a2, i_a2, s_c0, i_c0, s_a1, i_a1, s_a0, i_a0
! W8(a0,k,a1,a) += (    1.00000000) V2(k,a2,c0,a1) T2(a0,c0,a2,a) 
do s_a2 = 0, nir-1
do s_c0 = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_ooov_ocov_no4_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ooov_ocov_no4_x1_type1_eri_o &
...
call set_symblock_Xaa(sleft, W8, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ooov_ocov_no4_x1_type1_eri_o &
  (sa, ia, sk, ik, Xaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaa)

end subroutine g_if_sigma_ooov_ocov_no4_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ooov_ocov_no4_x1_type1_eri_o &
...
! S2(i,j,k,a) += (   -1.00000000) D2(j,a1,i,a0) W8(a0,k,a1,a) 
do s_j = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_ooov_ocov_no4_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ooov_ocov_no0_x0_type1_eri_v &
  (sa, ia, sa0, ia0, T2, V2, W9, nir, nsym, psym, flops)
...
call g_sigma_ooov_ocov_no0_x0_type1_eri_v &
...
end subroutine g_if_sigma_ooov_ocov_no0_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ooov_ocov_no0_x0_type1_eri_v &
  (s_a, i_a, s_a0, i_a0, T2_, V2_, W9_, nir, nsym, psym, flops)
...
integer :: s_a2, i_a2, s_v0, i_v0, s_c0, i_c0, s_a1, i_a1
! W9(a1,a0,a2,a) += (    1.00000000) V2(a,a2,v0,c0) T2(c0,a1,v0,a0) 
do s_a2 = 0, nir-1
do s_v0 = 0, nir-1
do s_c0 = 0, nir-1
do s_a1 = 0, nir-1
...
end subroutine g_sigma_ooov_ocov_no0_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ooov_ocov_no0_x1_type1_eri_v &
  (sa, ia, sa0, ia0, W9, S2, nir, nsym, psym, flops)
...
call set_symblock_Xaa(sleft, W9, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ooov_ocov_no0_x1_type1_eri_v &
  (sa, ia, sa0, ia0, Xaa, av2_i2, d3, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaa)

end subroutine g_if_sigma_ooov_ocov_no0_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ooov_ocov_no0_x1_type1_eri_v &
  (s_a, i_a, s_a0, i_a0, W9_, S2_, D3_, nir, nsym, psym, flops)
...
integer :: s_k, i_k, s_i, i_i, s_a2, i_a2, s_j, i_j, s_a1, i_a1
! S2(i,j,k,a) += (    2.00000000) D3(k,i,a2,j,a1,a0) W9(a1,a0,a2,a) 
do s_k = 0, nir-1
do s_i = 0, nir-1
do s_a2 = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_ooov_ocov_no0_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ooov_ocov_no1_x0_type1_eri_v &
  (sa, ia, sa0, ia0, T2, V2, W10, nir, nsym, psym, flops)
...
call g_sigma_ooov_ocov_no1_x0_type1_eri_v &
  (sa, ia, sa0, ia0, av2_i, h2_i, Xaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ooov_ocov_no1_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ooov_ocov_no1_x0_type1_eri_v &
  (s_a, i_a, s_a0, i_a0, T2_, V2_, W10_, nir, nsym, psym, flops)
...
integer :: s_v0, i_v0, s_c0, i_c0, s_a2, i_a2, s_a1, i_a1
! W10(a1,a0,a2,a) += (    1.00000000) V2(a,v0,c0,a2) T2(c0,a1,v0,a0) 
do s_v0 = 0, nir-1
do s_c0 = 0, nir-1
do s_a2 = 0, nir-1
do s_a1 = 0, nir-1
...
do i_a1 = psym(I_BEGIN, I_O, s_a1), psym(I_END, I_O, s_a1)
do i_a2 = psym(I_BEGIN, I_O, s_a2), psym(I_END, I_O, s_a2)
W10_(s_a2, s_a1)%array(i_a2, i_a1) = &
    W10_(s_a2, s_a1)%array(i_a2, i_a1) &
  + Z3_(i_a2, i_a1)
end do
end do
...
end subroutine g_sigma_ooov_ocov_no1_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ooov_ocov_no1_x1_type1_eri_v &
  (sa, ia, sa0, ia0, W10, S2, nir, nsym, psym, flops)
...
call set_symblock_Xaa(sleft, W10, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ooov_ocov_no1_x1_type1_eri_v &
  (sa, ia, sa0, ia0, Xaa, av2_i2, d3, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaa)

end subroutine g_if_sigma_ooov_ocov_no1_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ooov_ocov_no1_x1_type1_eri_v &
  (s_a, i_a, s_a0, i_a0, W10_, S2_, D3_, nir, nsym, psym, flops)
...
integer :: s_k, i_k, s_i, i_i, s_a2, i_a2, s_j, i_j, s_a1, i_a1
! S2(i,j,k,a) += (   -1.00000000) D3(k,i,a2,j,a1,a0) W10(a1,a0,a2,a) 
do s_k = 0, nir-1
do s_i = 0, nir-1
do s_a2 = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_ooov_ocov_no1_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ooov_ocov_no2_x0_type1_eri_v &
  (sa, ia, sk, ik, T2, V2, W11, nir, nsym, psym, flops)
...
call g_sigma_ooov_ocov_no2_x0_type1_eri_v &
  (sa, ia, sk, ik, av2_i, h2_i, Xaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ooov_ocov_no2_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ooov_ocov_no2_x0_type1_eri_v &
  (s_a, i_a, s_k, i_k, T2_, V2_, W11_, nir, nsym, psym, flops)
...
! W11(a0,k,a1,a) += (    1.00000000) V2(a,a1,v0,c0) T2(c0,a0,v0,k) 
do s_a1 = 0, nir-1
do s_v0 = 0, nir-1
do s_c0 = 0, nir-1
do s_a0 = 0, nir-1
...
IEOR(s_c0,s_a0) == IEOR(s_v0,s_k)) then
...
end subroutine g_sigma_ooov_ocov_no2_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ooov_ocov_no2_x1_type1_eri_v &
  (sa, ia, sk, ik, W11, S2, nir, nsym, psym, flops)
...
call set_symblock_Xaa(sleft, W11, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ooov_ocov_no2_x1_type1_eri_v &
  (sa, ia, sk, ik, Xaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaa)

end subroutine g_if_sigma_ooov_ocov_no2_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ooov_ocov_no2_x1_type1_eri_v &
  (s_a, i_a, s_k, i_k, W11_, S2_, D2_, nir, nsym, psym, flops)
...
integer :: s_j, i_j, s_a1, i_a1, s_i, i_i, s_a0, i_a0
! S2(i,j,k,a) += (    2.00000000) D2(j,a1,i,a0) W11(a0,k,a1,a) 
do s_j = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_ooov_ocov_no2_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ooov_ocov_no3_x0_type1_eri_v &
  (sa, ia, sk, ik, T2, V2, W12, nir, nsym, psym, flops)
...
call g_sigma_ooov_ocov_no3_x0_type1_eri_v &
  (sa, ia, sk, ik, av2_i, h2_i, Xaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ooov_ocov_no3_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ooov_ocov_no3_x0_type1_eri_v &
  (s_a, i_a, s_k, i_k, T2_, V2_, W12_, nir, nsym, psym, flops)
...
! W12(a0,k,a1,a) += (    1.00000000) V2(a,v0,c0,a1) T2(c0,a0,v0,k) 
do s_v0 = 0, nir-1
do s_c0 = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_ooov_ocov_no3_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ooov_ocov_no3_x1_type1_eri_v &
  (sa, ia, sk, ik, W12, S2, nir, nsym, psym, flops)
...
call set_symblock_Xaa(sleft, W12, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ooov_ocov_no3_x1_type1_eri_v &
  (sa, ia, sk, ik, Xaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaa)

end subroutine g_if_sigma_ooov_ocov_no3_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ooov_ocov_no3_x1_type1_eri_v &
  (s_a, i_a, s_k, i_k, W12_, S2_, D2_, nir, nsym, psym, flops)
...
integer :: s_j, i_j, s_a1, i_a1, s_i, i_i, s_a0, i_a0
! S2(i,j,k,a) += (   -1.00000000) D2(j,a1,i,a0) W12(a0,k,a1,a) 
do s_j = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_ooov_ocov_no3_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ooov_ocov_no4_x0_type1_eri_v &
  (sa, ia, sa1, ia1, T2, V2, W13, nir, nsym, psym, flops)
...
call g_sigma_ooov_ocov_no4_x0_type1_eri_v &
...
end subroutine g_if_sigma_ooov_ocov_no4_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ooov_ocov_no4_x0_type1_eri_v &
  (s_a, i_a, s_a1, i_a1, T2_, V2_, W13_, nir, nsym, psym, flops)
...
! W13(a0,a) += (    1.00000000) V2(a,a1,v0,c0) T2(c0,a0,v0,a1) 
do s_v0 = 0, nir-1
do s_c0 = 0, nir-1
do s_a0 = 0, nir-1
if( &
...
end subroutine g_sigma_ooov_ocov_no4_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ooov_ocov_no4_x1_type1_eri_v &
...
call set_symblock_Xa(sleft, W13, nir, nsym, psym) ! -> Xa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ooov_ocov_no4_x1_type1_eri_v &
  (sa, ia, Xa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xa)

end subroutine g_if_sigma_ooov_ocov_no4_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ooov_ocov_no4_x1_type1_eri_v &
...
integer :: s_k, i_k, s_i, i_i, s_a0, i_a0, s_j, i_j
! S2(i,j,k,a) += (    2.00000000) D2(k,i,a0,j) W13(a0,a) 
do s_k = 0, nir-1
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_ooov_ocov_no4_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ooov_ocov_no5_x0_type1_eri_v &
  (sa, ia, sa1, ia1, T2, V2, W14, nir, nsym, psym, flops)
...
call g_sigma_ooov_ocov_no5_x0_type1_eri_v &
  (sa, ia, sa1, ia1, av2_i, h2_i, Xa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ooov_ocov_no5_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ooov_ocov_no5_x0_type1_eri_v &
  (s_a, i_a, s_a1, i_a1, T2_, V2_, W14_, nir, nsym, psym, flops)
...
integer :: s_v0, i_v0, s_c0, i_c0, s_a0, i_a0
! W14(a0,a) += (    1.00000000) V2(a,v0,c0,a1) T2(c0,a0,v0,a1) 
do s_v0 = 0, nir-1
do s_c0 = 0, nir-1
do s_a0 = 0, nir-1
if( &
...
end subroutine g_sigma_ooov_ocov_no5_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ooov_ocov_no5_x1_type1_eri_v &
...
call set_symblock_Xa(sleft, W14, nir, nsym, psym) ! -> Xa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ooov_ocov_no5_x1_type1_eri_v &
  (sa, ia, Xa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xa)

end subroutine g_if_sigma_ooov_ocov_no5_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ooov_ocov_no5_x1_type1_eri_v &
...
integer :: s_k, i_k, s_i, i_i, s_a0, i_a0, s_j, i_j
! S2(i,j,k,a) += (   -1.00000000) D2(k,i,a0,j) W14(a0,a) 
do s_k = 0, nir-1
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_ooov_ocov_no5_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ooov_ocov_no0_x0_type1_d4c_c &
...
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ooov_ocov_no0_x0_type1_d4c_c &
...
end subroutine g_if_sigma_ooov_ocov_no0_x0_type1_d4c_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ooov_ocov_no0_x0_type1_d4c_c &
...
! S2(i,j,k,a) += (   -1.00000000) T2(a1,c0,a0,a) C5(a0,a1,i,k,j,c0) 
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
do s_k = 0, nir-1
...
IEOR(s_i,s_j) == IEOR(s_k,s_a) .and. & 
IEOR(s_a1,s_c0) == IEOR(s_a0,s_a) .and. &
IEOR(IEOR(s_a0,s_a1),s_i) == IEOR(IEOR(s_k,s_j),s_c0)) then

if(psym(I_LENGTH,I_O, s_i)*psym(I_LENGTH,I_O, s_k)*psym(I_LENGTH,I_O, s_j) > 0 .and. &
   psym(I_LENGTH,I_O, s_a0)*psym(I_LENGTH,I_O, s_a1) > 0) then

! Z1 <-- C5(a0,a1,i,k,j,c0) 
...
end subroutine g_sigma_ooov_ocov_no0_x0_type1_d4c_c
