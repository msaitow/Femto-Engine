...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no0_x0_type0_noeri &
  (sv0, iv0, T2, W0, nir, nsym, psym, flops)
...
call g_sigma_cooo_coov_no0_x0_type0_noeri &
  (sv0, iv0, av2_i, Xcaaa, fc1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaaa)

end subroutine g_if_sigma_cooo_coov_no0_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no0_x0_type0_noeri &
  (s_v0, i_v0, T2_, W0_, Fc1_, nir, nsym, psym, flops)
...
integer :: s_w, i_w, s_a0, i_a0, s_a1, i_a1, s_a2, i_a2
! W0(w,a2,a0,a1) += (    1.00000000) T2(w,a0,a1,v0) Fc1(v0,a2) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_a2 = 0, nir-1
...
if(psym(I_LENGTH,I_C, s_w)*psym(I_LENGTH,I_O, s_a0)*psym(I_LENGTH,I_O, s_a1) > 0 .and. &
...
call dgemm('n', 'n', psym(I_LENGTH,I_C, s_w)*psym(I_LENGTH,I_O, s_a0)*psym(I_LENGTH,I_O, s_a1),&
                     psym(I_LENGTH,I_O, s_a2),&
                     1,&
                     1.00000000d+00, &
                     Z1_,&
                     psym(I_LENGTH,I_C, s_w)*psym(I_LENGTH,I_O, s_a0)*psym(I_LENGTH,I_O, s_a1),&
                     Z2_,&
                     1,&
                     0.0d+00,&
                     Z3_,&
...
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
do i_a1 = psym(I_BEGIN, I_O, s_a1), psym(I_END, I_O, s_a1)
W0_(s_a1, s_a0, s_a2, s_w)%array(i_a1, i_a0, i_a2, i_w) = &
    W0_(s_a1, s_a0, s_a2, s_w)%array(i_a1, i_a0, i_a2, i_w) &
  + Z3_(i_w, i_a0, i_a1, i_a2)
end do
end do
end do
end do
...
! Flop count
flops = flops + psym(I_LENGTH,I_C, s_w)*psym(I_LENGTH,I_O, s_a0)*psym(I_LENGTH,I_O, s_a1) * &
                psym(I_LENGTH,I_O, s_a2) * &
                1 * 2.0d+00
...
end subroutine g_sigma_cooo_coov_no0_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no0_x1_type0_noeri &
...
call g_sigma_cooo_coov_no0_x1_type0_noeri &
  (sj, ij, Xcaaa, av2_i2, d3, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaaa)

end subroutine g_if_sigma_cooo_coov_no0_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no0_x1_type0_noeri &
  (s_j, i_j, W0_, S2_, D3_, nir, nsym, psym, flops)
...
integer :: s_k, i_k, s_a2, i_a2, s_a0, i_a0, s_a1, i_a1, s_i, i_i
integer :: s_w, i_w
! S2(w,k,i,j) += (   -1.00000000) D3(k,j,a2,a0,a1,i) W0(w,a2,a0,a1) 
do s_k = 0, nir-1
do s_a2 = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
...
IEOR(IEOR(s_k,s_j),s_a2) == IEOR(IEOR(s_a0,s_a1),s_i) .and. &
...
Z1_(i_k, i_i, i_a2, i_a0, i_a1) =  &
  D3_(s_i, s_a1, s_a0, s_a2, s_j, s_k)%array(i_i, i_a1, i_a0, i_a2, i_j, i_k)
end do
end do
end do
end do
...
end subroutine g_sigma_cooo_coov_no0_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no1_x0_type0_noeri &
...
call g_sigma_cooo_coov_no1_x0_type0_noeri &
  (sv0, iv0, av2_i, Xcaaa, fc1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaaa)

end subroutine g_if_sigma_cooo_coov_no1_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no1_x0_type0_noeri &
...
integer :: s_w, i_w, s_a0, i_a0, s_i, i_i, s_a1, i_a1
! W1(w,a1,a0,i) += (    1.00000000) T2(w,a0,i,v0) Fc1(v0,a1) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
do s_a1 = 0, nir-1
...
if(psym(I_LENGTH,I_C, s_w)*psym(I_LENGTH,I_O, s_a0)*psym(I_LENGTH,I_O, s_i) > 0 .and. &
...
! Gemm Z1 * Z2 to form Z3
call dgemm('n', 'n', psym(I_LENGTH,I_C, s_w)*psym(I_LENGTH,I_O, s_a0)*psym(I_LENGTH,I_O, s_i),&
                     psym(I_LENGTH,I_O, s_a1),&
                     1,&
                     1.00000000d+00, &
                     Z1_,&
                     psym(I_LENGTH,I_C, s_w)*psym(I_LENGTH,I_O, s_a0)*psym(I_LENGTH,I_O, s_i),&
                     Z2_,&
                     1,&
                     0.0d+00,&
                     Z3_,&
...
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
W1_(s_i, s_a0, s_a1, s_w)%array(i_i, i_a0, i_a1, i_w) = &
    W1_(s_i, s_a0, s_a1, s_w)%array(i_i, i_a0, i_a1, i_w) &
  + Z3_(i_w, i_a0, i_i, i_a1)
end do
end do
end do
end do
...
! Flop count
flops = flops + psym(I_LENGTH,I_C, s_w)*psym(I_LENGTH,I_O, s_a0)*psym(I_LENGTH,I_O, s_i) * &
                psym(I_LENGTH,I_O, s_a1) * &
                1 * 2.0d+00
...
end subroutine g_sigma_cooo_coov_no1_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no1_x1_type0_noeri &
...
call set_symblock_Xcaaa(sleft, W1, nir, nsym, psym) ! -> Xcaaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no1_x1_type0_noeri &
  (sj, ij, Xcaaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaaa)

end subroutine g_if_sigma_cooo_coov_no1_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no1_x1_type0_noeri &
...
! S2(w,k,i,j) += (    2.00000000) D2(k,j,a1,a0) W1(w,a1,a0,i) 
do s_k = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_w = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no1_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no2_x0_type0_noeri &
...
call set_symblock_av2(sv0, T2, nir, nsym, psym) ! -> av2_i (allocate)
sleft = 0
call set_symblock_Xcaaa(sleft, W2, nir, nsym, psym) ! -> Xcaaa (allocate) 
call g_sigma_cooo_coov_no2_x0_type0_noeri &
  (sv0, iv0, av2_i, Xcaaa, fc1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaaa)

end subroutine g_if_sigma_cooo_coov_no2_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no2_x0_type0_noeri &
...
! W2(w,i,a0,a1) += (    1.00000000) T2(w,a0,a1,v0) Fc1(v0,i) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
do i_a1 = psym(I_BEGIN, I_O, s_a1), psym(I_END, I_O, s_a1)
W2_(s_a1, s_a0, s_i, s_w)%array(i_a1, i_a0, i_i, i_w) = &
    W2_(s_a1, s_a0, s_i, s_w)%array(i_a1, i_a0, i_i, i_w) &
  + Z3_(i_w, i_a0, i_a1, i_i)
end do
end do
end do
end do
...
end subroutine g_sigma_cooo_coov_no2_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no2_x1_type0_noeri &
...
call set_symblock_Xcaaa(sleft, W2, nir, nsym, psym) ! -> Xcaaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no2_x1_type0_noeri &
  (sj, ij, Xcaaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaaa)

end subroutine g_if_sigma_cooo_coov_no2_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no2_x1_type0_noeri &
  (s_j, i_j, W2_, S2_, D2_, nir, nsym, psym, flops)
...
integer :: s_k, i_k, s_a1, i_a1, s_a0, i_a0, s_w, i_w, s_i, i_i
! S2(w,k,i,j) += (   -1.00000000) D2(k,j,a1,a0) W2(w,i,a0,a1) 
do s_k = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_w = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no2_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no3_x0_type0_noeri &
...
call g_sigma_cooo_coov_no3_x0_type0_noeri &
  (sj, ij, av2_i, Xcaa, fc1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_cooo_coov_no3_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no3_x0_type0_noeri &
...
! W3(w,a1,a0,j) += (    1.00000000) T2(a0,w,v0,j) Fc1(v0,a1) 
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_v0 = 0, nir-1
do s_a1 = 0, nir-1
...
IEOR(s_a0,s_w) == IEOR(s_v0,s_j) .and. &
IEOR(s_v0,s_a1) == 0) then
...
end subroutine g_sigma_cooo_coov_no3_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no3_x1_type0_noeri &
...
call set_symblock_Xcaa(sleft, W3, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no3_x1_type0_noeri &
  (sj, ij, Xcaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_cooo_coov_no3_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no3_x1_type0_noeri &
...
integer :: s_k, i_k, s_i, i_i, s_a1, i_a1, s_a0, i_a0, s_w, i_w
! S2(w,k,i,j) += (   -1.00000000) D2(k,i,a1,a0) W3(w,a1,a0,j) 
do s_k = 0, nir-1
do s_i = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no3_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no4_x0_type0_noeri &
  (sj, ij, sv0, iv0, T2, W4, nir, nsym, psym, flops)
...
call g_sigma_cooo_coov_no4_x0_type0_noeri &
  (sj, ij, sv0, iv0, av2_i, Xcaa, fc1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_cooo_coov_no4_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no4_x0_type0_noeri &
  (s_j, i_j, s_v0, i_v0, T2_, W4_, Fc1_, nir, nsym, psym, flops)
...
integer :: s_w, i_w, s_a0, i_a0, s_a1, i_a1
! W4(w,j,a0,a1) += (    1.00000000) T2(w,a0,a1,v0) Fc1(v0,j) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
if( &
...
if(psym(I_LENGTH,I_C, s_w)*psym(I_LENGTH,I_O, s_a0)*psym(I_LENGTH,I_O, s_a1) > 0) then
...
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
do i_a1 = psym(I_BEGIN, I_O, s_a1), psym(I_END, I_O, s_a1)
W4_(s_a1, s_a0, s_w)%array(i_a1, i_a0, i_w) = &
    W4_(s_a1, s_a0, s_w)%array(i_a1, i_a0, i_w) &
  + Z3_(i_w, i_a0, i_a1)
end do
end do
...
end subroutine g_sigma_cooo_coov_no4_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no4_x1_type0_noeri &
...
call set_symblock_Xcaa(sleft, W4, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no4_x1_type0_noeri &
  (sj, ij, Xcaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_cooo_coov_no4_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no4_x1_type0_noeri &
...
! S2(w,k,i,j) += (   -1.00000000) D2(k,a0,a1,i) W4(w,j,a0,a1) 
do s_k = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no4_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no5_x0_type0_noeri &
  (sv0, iv0, T2, W5, nir, nsym, psym, flops)
...
call g_sigma_cooo_coov_no5_x0_type0_noeri &
  (sv0, iv0, av2_i, Xcaa, d1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_cooo_coov_no5_x0_type0_noeri
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no5_x0_type0_noeri &
  (s_v0, i_v0, T2_, W5_, D1_, nir, nsym, psym, flops)
...
integer :: s_w, i_w, s_a0, i_a0, s_i, i_i, s_k, i_k
! W5(w,k,i,v0) += (    1.00000000) T2(w,a0,i,v0) D1(k,a0) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
do s_k = 0, nir-1
...
do i_k = psym(I_BEGIN, I_O, s_k), psym(I_END, I_O, s_k)
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
W5_(s_i, s_k, s_w)%array(i_i, i_k, i_w) = &
    W5_(s_i, s_k, s_w)%array(i_i, i_k, i_w) &
  + Z3_(i_w, i_i, i_k)
end do
end do
...
end subroutine g_sigma_cooo_coov_no5_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no5_x1_type0_noeri &
  (sj, ij, sv0, iv0, W5, S2, nir, nsym, psym, flops)
...
call set_symblock_Xcaa(sleft, W5, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no5_x1_type0_noeri &
  (sj, ij, sv0, iv0, Xcaa, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_cooo_coov_no5_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no5_x1_type0_noeri &
  (s_j, i_j, s_v0, i_v0, W5_, S2_, Fc1_, nir, nsym, psym, flops)
...
integer :: s_w, i_w, s_k, i_k, s_i, i_i
! S2(w,k,i,j) += (    2.00000000) Fc1(v0,j) W5(w,k,i,v0) 
do s_w = 0, nir-1
do s_k = 0, nir-1
do s_i = 0, nir-1
if( &
...
if(psym(I_LENGTH,I_C, s_w)*psym(I_LENGTH,I_O, s_k)*psym(I_LENGTH,I_O, s_i) > 0) then
...
! Gemm Z1 * Z2 to form Z3
call dgemm('n', 'n', psym(I_LENGTH,I_C, s_w)*psym(I_LENGTH,I_O, s_k)*psym(I_LENGTH,I_O, s_i),&
                     1,&
                     1,&
                     2.00000000d+00, &
                     Z1_,&
                     psym(I_LENGTH,I_C, s_w)*psym(I_LENGTH,I_O, s_k)*psym(I_LENGTH,I_O, s_i),&
                     Z2_,&
                     1,&
                     0.0d+00,&
                     Z3_,&
...
! Flop count
flops = flops + psym(I_LENGTH,I_C, s_w)*psym(I_LENGTH,I_O, s_k)*psym(I_LENGTH,I_O, s_i) * &
                1 * &
                1 * 2.0d+00
...
end subroutine g_sigma_cooo_coov_no5_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no6_x0_type0_noeri &
...
call g_sigma_cooo_coov_no6_x0_type0_noeri &
  (sj, ij, av2_i, Xcav, d1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcav)

end subroutine g_if_sigma_cooo_coov_no6_x0_type0_noeri
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no6_x0_type0_noeri &
...
integer :: s_a0, i_a0, s_w, i_w, s_v0, i_v0, s_k, i_k
! W6(w,k,j,v0) += (    1.00000000) T2(a0,w,v0,j) D1(k,a0) 
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_v0 = 0, nir-1
do s_k = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no6_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no6_x1_type0_noeri &
...
call set_symblock_Xcav(sleft, W6, nir, nsym, psym) ! -> Xcav (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no6_x1_type0_noeri &
  (sj, ij, Xcav, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcav)

end subroutine g_if_sigma_cooo_coov_no6_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no6_x1_type0_noeri &
...
! S2(w,k,i,j) += (   -1.00000000) Fc1(v0,i) W6(w,k,j,v0) 
do s_v0 = 0, nir-1
do s_i = 0, nir-1
do s_w = 0, nir-1
do s_k = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no6_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no0_x0_type1_eri_c &
...
call g_sigma_cooo_coov_no0_x0_type1_eri_c &
...
end subroutine g_if_sigma_cooo_coov_no0_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no0_x0_type1_eri_c &
...
! W18(w,a0,j,a1) += (    1.00000000) V2(w,a1,v0,c0) T2(a0,c0,v0,j) 
do s_a1 = 0, nir-1
do s_v0 = 0, nir-1
do s_c0 = 0, nir-1
do s_a0 = 0, nir-1
...
IEOR(s_a0,s_c0) == IEOR(s_v0,s_j)) then
...
end subroutine g_sigma_cooo_coov_no0_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no0_x1_type1_eri_c &
...
call set_symblock_Xaa(sleft, W18, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no0_x1_type1_eri_c &
  (sj, ij, sw, iw, Xaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaa)

end subroutine g_if_sigma_cooo_coov_no0_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no0_x1_type1_eri_c &
...
! S2(w,k,i,j) += (    1.00000000) D2(k,a0,a1,i) W18(w,a0,j,a1) 
do s_k = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no0_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no1_x0_type1_eri_c &
...
call g_sigma_cooo_coov_no1_x0_type1_eri_c &
  (sj, ij, sw, iw, av2_i, h2_i, Xaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_cooo_coov_no1_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no1_x0_type1_eri_c &
...
! W19(w,a0,j,a1) += (    1.00000000) V2(w,c0,v0,a1) T2(a0,c0,v0,j) 
do s_c0 = 0, nir-1
do s_v0 = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no1_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no1_x1_type1_eri_c &
...
call set_symblock_Xaa(sleft, W19, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no1_x1_type1_eri_c &
  (sj, ij, sw, iw, Xaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaa)

end subroutine g_if_sigma_cooo_coov_no1_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no1_x1_type1_eri_c &
...
integer :: s_k, i_k, s_i, i_i, s_a1, i_a1, s_a0, i_a0
! S2(w,k,i,j) += (    1.00000000) D2(k,i,a1,a0) W19(w,a0,j,a1) 
do s_k = 0, nir-1
do s_i = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no1_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no2_x0_type1_eri_c &
...
call g_sigma_cooo_coov_no2_x0_type1_eri_c &
  (sj, ij, sw, iw, av2_i, h2_i, Xaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_cooo_coov_no2_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no2_x0_type1_eri_c &
...
! W23(w,a0,j,i) += (    1.00000000) V2(w,i,v0,c0) T2(a0,c0,v0,j) 
do s_i = 0, nir-1
do s_v0 = 0, nir-1
do s_c0 = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no2_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no2_x1_type1_eri_c &
...
call set_symblock_Xaa(sleft, W23, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no2_x1_type1_eri_c &
  (sj, ij, sw, iw, Xaa, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaa)

end subroutine g_if_sigma_cooo_coov_no2_x1_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no2_x1_type1_eri_c &
...
! S2(w,k,i,j) += (   -2.00000000) D1(k,a0) W23(w,a0,j,i) 
do s_k = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
if( &
...
end subroutine g_sigma_cooo_coov_no2_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no3_x0_type1_eri_c &
...
call g_sigma_cooo_coov_no3_x0_type1_eri_c &
  (sj, ij, sw, iw, av2_i, h2_i, Xaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_cooo_coov_no3_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no3_x0_type1_eri_c &
...
! W31(w,a0,j,i) += (    1.00000000) V2(w,c0,v0,i) T2(a0,c0,v0,j) 
do s_c0 = 0, nir-1
do s_v0 = 0, nir-1
do s_i = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no3_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no3_x1_type1_eri_c &
...
call set_symblock_Xaa(sleft, W31, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no3_x1_type1_eri_c &
  (sj, ij, sw, iw, Xaa, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaa)

end subroutine g_if_sigma_cooo_coov_no3_x1_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no3_x1_type1_eri_c &
...
integer :: s_k, i_k, s_a0, i_a0, s_i, i_i
! S2(w,k,i,j) += (    1.00000000) D1(k,a0) W31(w,a0,j,i) 
do s_k = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
if( &
...
end subroutine g_sigma_cooo_coov_no3_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no0_x0_type1_eri_o &
  (sa3, ia3, sv0, iv0, T2, V2, W10, nir, nsym, psym, flops)

use f_mr_module, only : symblock1, symblock2, symblock3, symblock4, symblock5, symblock6
use f_mr_if_module
implicit none

integer, intent(inout) :: sa3, ia3, sv0, iv0
...
call g_sigma_cooo_coov_no0_x0_type1_eri_o &
  (sa3, ia3, sv0, iv0, av2_i, h2_i, Xcaaaa, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(h2_i)
deallocate(Xcaaaa)

end subroutine g_if_sigma_cooo_coov_no0_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no0_x0_type1_eri_o &
  (s_a3, i_a3, s_v0, i_v0, T2_, V2_, W10_, nir, nsym, psym, flops)
...
integer :: s_i, i_i, s_a2, i_a2, s_w, i_w, s_a0, i_a0, s_a1, i_a1
! W10(w,a0,a1,i,a3,a2) += (    1.00000000) V2(a3,v0,i,a2) T2(w,a0,a1,v0) 
do s_i = 0, nir-1
do s_a2 = 0, nir-1
do s_w = 0, nir-1
do s_a0 = 0, nir-1
...
if(psym(I_LENGTH,I_O, s_i)*psym(I_LENGTH,I_O, s_a2) > 0 .and. &
   psym(I_LENGTH,I_C, s_w)*psym(I_LENGTH,I_O, s_a0)*psym(I_LENGTH,I_O, s_a1) > 0) then
...
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
do i_a2 = psym(I_BEGIN, I_O, s_a2), psym(I_END, I_O, s_a2)
W10_(s_a2, s_i, s_a1, s_a0, s_w)%array(i_a2, i_i, i_a1, i_a0, i_w) = &
    W10_(s_a2, s_i, s_a1, s_a0, s_w)%array(i_a2, i_i, i_a1, i_a0, i_w) &
  + Z3_(i_i, i_a2, i_w, i_a0, i_a1)
end do
end do
end do
end do
...
end subroutine g_sigma_cooo_coov_no0_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no0_x1_type1_eri_o &
  (sa3, ia3, sj, ij, W10, S2, nir, nsym, psym, flops)

use f_mr_module, only : symblock1, symblock2, symblock3, symblock4, symblock5, symblock6
use f_mr_if_module
implicit none

integer, intent(inout) :: sa3, ia3, sj, ij
...
call set_symblock_Xcaaaa(sleft, W10, nir, nsym, psym) ! -> Xcaaaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no0_x1_type1_eri_o &
  (sa3, ia3, sj, ij, Xcaaaa, av2_i2, d3, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaaaa)

end subroutine g_if_sigma_cooo_coov_no0_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no0_x1_type1_eri_o &
  (s_a3, i_a3, s_j, i_j, W10_, S2_, D3_, nir, nsym, psym, flops)
...
integer :: s_k, i_k, s_a0, i_a0, s_a1, i_a1, s_a2, i_a2, s_w, i_w
integer :: s_i, i_i
! S2(w,k,i,j) += (   -1.00000000) D3(k,j,a3,a0,a1,a2) W10(w,a0,a1,i,a3,a2) 
do s_k = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_a2 = 0, nir-1
...
if( &
IEOR(s_w,s_k) == IEOR(s_i,s_j) .and. & 
IEOR(IEOR(s_k,s_j),s_a3) == IEOR(IEOR(s_a0,s_a1),s_a2) .and. &
IEOR(IEOR(s_w,s_a0),s_a1) == IEOR(IEOR(s_i,s_a3),s_a2)) then

if(psym(I_LENGTH,I_C, s_w)*psym(I_LENGTH,I_O, s_i) > 0 .and. &
   psym(I_LENGTH,I_O, s_k) > 0 .and. &
   psym(I_LENGTH,I_O, s_a0)*psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_a2) > 0) then
...
do i_a1 = psym(I_BEGIN, I_O, s_a1), psym(I_END, I_O, s_a1)
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
Z2_(i_a0, i_a1, i_a2, i_k) =  &
  D3_(s_a2, s_a1, s_a0, s_a3, s_j, s_k)%array(i_a2, i_a1, i_a0, i_a3, i_j, i_k)
end do
end do
end do
end do
...
end subroutine g_sigma_cooo_coov_no0_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no1_x0_type1_eri_o &
  (si, ii, sv0, iv0, T2, V2, W15, nir, nsym, psym, flops)

use f_mr_module, only : symblock1, symblock2, symblock3, symblock4, symblock5, symblock6
use f_mr_if_module
implicit none

integer, intent(inout) :: si, ii, sv0, iv0
...
call set_symblock_Xcaaaa(sleft, W15, nir, nsym, psym) ! -> Xcaaaa (allocate) 
call g_sigma_cooo_coov_no1_x0_type1_eri_o &
  (si, ii, sv0, iv0, av2_i, h2_i, Xcaaaa, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(h2_i)
deallocate(Xcaaaa)

end subroutine g_if_sigma_cooo_coov_no1_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no1_x0_type1_eri_o &
  (s_i, i_i, s_v0, i_v0, T2_, V2_, W15_, nir, nsym, psym, flops)
...
type(symblock3), intent(inout) :: T2_(0:nir-1, 0:nir-1, 0:nir-1)
type(symblock3), intent(inout) :: V2_(0:nir-1, 0:nir-1, 0:nir-1)
type(symblock5), intent(inout) :: W15_(0:nir-1, 0:nir-1, 0:nir-1, 0:nir-1, 0:nir-1)
...
integer :: s_a3, i_a3, s_a2, i_a2, s_w, i_w, s_a0, i_a0, s_a1, i_a1
! W15(w,a0,a1,a3,i,a2) += (    1.00000000) V2(i,v0,a3,a2) T2(w,a0,a1,v0) 
do s_a3 = 0, nir-1
do s_a2 = 0, nir-1
do s_w = 0, nir-1
do s_a0 = 0, nir-1
...
do i_a3 = psym(I_BEGIN, I_O, s_a3), psym(I_END, I_O, s_a3)
do i_a2 = psym(I_BEGIN, I_O, s_a2), psym(I_END, I_O, s_a2)
W15_(s_a2, s_a3, s_a1, s_a0, s_w)%array(i_a2, i_a3, i_a1, i_a0, i_w) = &
    W15_(s_a2, s_a3, s_a1, s_a0, s_w)%array(i_a2, i_a3, i_a1, i_a0, i_w) &
  + Z3_(i_a3, i_a2, i_w, i_a0, i_a1)
end do
end do
end do
end do
...
end subroutine g_sigma_cooo_coov_no1_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no1_x1_type1_eri_o &
  (si, ii, sj, ij, W15, S2, nir, nsym, psym, flops)
...
call set_symblock_Xcaaaa(sleft, W15, nir, nsym, psym) ! -> Xcaaaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no1_x1_type1_eri_o &
  (si, ii, sj, ij, Xcaaaa, av2_i2, d3, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaaaa)

end subroutine g_if_sigma_cooo_coov_no1_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no1_x1_type1_eri_o &
  (s_i, i_i, s_j, i_j, W15_, S2_, D3_, nir, nsym, psym, flops)
...
integer :: s_k, i_k, s_a3, i_a3, s_a2, i_a2, s_a1, i_a1, s_a0, i_a0
integer :: s_w, i_w
! S2(w,k,i,j) += (   -1.00000000) D3(k,j,a3,a2,a1,a0) W15(w,a0,a1,a3,i,a2) 
do s_k = 0, nir-1
do s_a3 = 0, nir-1
do s_a2 = 0, nir-1
do s_a1 = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no1_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no2_x0_type1_eri_o &
  (sj, ij, sv0, iv0, T2, V2, W16, nir, nsym, psym, flops)
...
call g_sigma_cooo_coov_no2_x0_type1_eri_o &
...
end subroutine g_if_sigma_cooo_coov_no2_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no2_x0_type1_eri_o &
  (s_j, i_j, s_v0, i_v0, T2_, V2_, W16_, nir, nsym, psym, flops)
...
! W16(w,a0,a1,j) += (    1.00000000) V2(j,w,v0,c0) T2(c0,a0,a1,v0) 
do s_w = 0, nir-1
do s_c0 = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
...
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
do i_a1 = psym(I_BEGIN, I_O, s_a1), psym(I_END, I_O, s_a1)
W16_(s_a1, s_a0, s_w)%array(i_a1, i_a0, i_w) = &
    W16_(s_a1, s_a0, s_w)%array(i_a1, i_a0, i_w) &
  + Z3_(i_a0, i_a1, i_w)
end do
end do
...
end subroutine g_sigma_cooo_coov_no2_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no2_x1_type1_eri_o &
  (sj, ij, W16, S2, nir, nsym, psym, flops)
...
call set_symblock_Xcaa(sleft, W16, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no2_x1_type1_eri_o &
  (sj, ij, Xcaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_cooo_coov_no2_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no2_x1_type1_eri_o &
  (s_j, i_j, W16_, S2_, D2_, nir, nsym, psym, flops)
...
integer :: s_k, i_k, s_i, i_i, s_a1, i_a1, s_a0, i_a0, s_w, i_w
! S2(w,k,i,j) += (    1.00000000) D2(k,i,a1,a0) W16(w,a0,a1,j) 
do s_k = 0, nir-1
do s_i = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no2_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no3_x0_type1_eri_o &
  (sj, ij, sv0, iv0, T2, V2, W17, nir, nsym, psym, flops)
...
call g_sigma_cooo_coov_no3_x0_type1_eri_o &
  (sj, ij, sv0, iv0, av2_i, h2_i, Xcaaaa, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(h2_i)
deallocate(Xcaaaa)

end subroutine g_if_sigma_cooo_coov_no3_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no3_x0_type1_eri_o &
  (s_j, i_j, s_v0, i_v0, T2_, V2_, W17_, nir, nsym, psym, flops)
...
integer :: s_a2, i_a2, s_a3, i_a3, s_w, i_w, s_a0, i_a0, s_a1, i_a1
! W17(w,a0,a1,j,a3,a2) += (    1.00000000) V2(j,a2,v0,a3) T2(w,a0,a1,v0) 
do s_a2 = 0, nir-1
do s_a3 = 0, nir-1
do s_w = 0, nir-1
do s_a0 = 0, nir-1
...
do i_a3 = psym(I_BEGIN, I_O, s_a3), psym(I_END, I_O, s_a3)
do i_a2 = psym(I_BEGIN, I_O, s_a2), psym(I_END, I_O, s_a2)
W17_(s_a2, s_a3, s_a1, s_a0, s_w)%array(i_a2, i_a3, i_a1, i_a0, i_w) = &
    W17_(s_a2, s_a3, s_a1, s_a0, s_w)%array(i_a2, i_a3, i_a1, i_a0, i_w) &
  + Z3_(i_a2, i_a3, i_w, i_a0, i_a1)
end do
end do
end do
end do
...
end subroutine g_sigma_cooo_coov_no3_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no3_x1_type1_eri_o &
  (sj, ij, W17, S2, nir, nsym, psym, flops)
...
call set_symblock_Xcaaaa(sleft, W17, nir, nsym, psym) ! -> Xcaaaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no3_x1_type1_eri_o &
  (sj, ij, Xcaaaa, av2_i2, d3, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaaaa)

end subroutine g_if_sigma_cooo_coov_no3_x1_type1_eri_o
...
! >> Score :: 110101
! RDM is rotated :: D3(k,a2,a3,a0,a1,i)  >> D3(a0,a3,a2,k,i,a1) 
! rowInd : @[k, "active"] @[i, "active"] 
! summedInd : @[a1, "active"] @[a2, "active"] @[a3, "active"] @[a0, "active"] 
! -- Check2 is skipped 
!    -- is4RDM.second false
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no3_x1_type1_eri_o &
  (s_j, i_j, W17_, S2_, D3_, nir, nsym, psym, flops)
...
integer :: s_k, i_k, s_a2, i_a2, s_a3, i_a3, s_a0, i_a0, s_a1, i_a1
integer :: s_i, i_i, s_w, i_w
! S2(w,k,i,j) += (   -1.00000000) D3(k,a2,a3,a0,a1,i) W17(w,a0,a1,j,a3,a2) 
do s_k = 0, nir-1
do s_a2 = 0, nir-1
do s_a3 = 0, nir-1
do s_a0 = 0, nir-1
...
if( &
IEOR(s_w,s_k) == IEOR(s_i,s_j) .and. & 
IEOR(IEOR(s_k,s_a2),s_a3) == IEOR(IEOR(s_a0,s_a1),s_i) .and. &
IEOR(IEOR(s_w,s_a0),s_a1) == IEOR(IEOR(s_j,s_a3),s_a2)) then

if(psym(I_LENGTH,I_O, s_k)*psym(I_LENGTH,I_O, s_i) > 0 .and. &
   psym(I_LENGTH,I_C, s_w) > 0 .and. &
   psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_a2)*psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_a0) > 0) then

! Z1 <-- D3(a0,a3,a2,k,i,a1) 
allocate(Z1_(psym(I_BEGIN,I_O, s_k):psym(I_END,I_O, s_k), &
             psym(I_BEGIN,I_O, s_i):psym(I_END,I_O, s_i), &
             psym(I_BEGIN,I_O, s_a1):psym(I_END,I_O, s_a1), &
             psym(I_BEGIN,I_O, s_a2):psym(I_END,I_O, s_a2), &
...
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
do i_k = psym(I_BEGIN, I_O, s_k), psym(I_END, I_O, s_k)
Z1_(i_k, i_i, i_a1, i_a2, i_a3, i_a0) =  &
  D3_(s_a1, s_i, s_k, s_a2, s_a3, s_a0)%array(i_a1, i_i, i_k, i_a2, i_a3, i_a0)
end do
end do
end do
end do
...
call dgemm('n', 'n', psym(I_LENGTH,I_O, s_k)*psym(I_LENGTH,I_O, s_i),&
                     psym(I_LENGTH,I_C, s_w),&
                     psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_a2)*psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_a0),&
                     - 1.00000000d+00, &
                     Z1_,&
                     psym(I_LENGTH,I_O, s_k)*psym(I_LENGTH,I_O, s_i),&
                     Z2_,&
...
flops = flops + psym(I_LENGTH,I_O, s_k)*psym(I_LENGTH,I_O, s_i) * &
                psym(I_LENGTH,I_C, s_w) * &
                psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_a2)*psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_a0) * 2.0d+00
...
end subroutine g_sigma_cooo_coov_no3_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no4_x0_type1_eri_o &
  (sj, ij, sv0, iv0, T2, V2, W21, nir, nsym, psym, flops)
...
call g_sigma_cooo_coov_no4_x0_type1_eri_o &
  (sj, ij, sv0, iv0, av2_i, h2_i, Xcaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_cooo_coov_no4_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no4_x0_type1_eri_o &
  (s_j, i_j, s_v0, i_v0, T2_, V2_, W21_, nir, nsym, psym, flops)
...
integer :: s_w, i_w, s_c0, i_c0, s_a0, i_a0, s_a1, i_a1
! W21(w,a0,a1,j) += (    1.00000000) V2(j,v0,w,c0) T2(c0,a0,a1,v0) 
do s_w = 0, nir-1
do s_c0 = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
...
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
do i_a1 = psym(I_BEGIN, I_O, s_a1), psym(I_END, I_O, s_a1)
W21_(s_a1, s_a0, s_w)%array(i_a1, i_a0, i_w) = &
    W21_(s_a1, s_a0, s_w)%array(i_a1, i_a0, i_w) &
  + Z3_(i_a0, i_a1, i_w)
end do
end do
...
end subroutine g_sigma_cooo_coov_no4_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no4_x1_type1_eri_o &
...
call set_symblock_Xcaa(sleft, W21, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no4_x1_type1_eri_o &
  (sj, ij, Xcaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_cooo_coov_no4_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no4_x1_type1_eri_o &
...
integer :: s_k, i_k, s_a0, i_a0, s_a1, i_a1, s_i, i_i, s_w, i_w
! S2(w,k,i,j) += (    1.00000000) D2(k,a0,a1,i) W21(w,a0,a1,j) 
do s_k = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no4_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no5_x0_type1_eri_o &
  (sj, ij, sv0, iv0, T2, V2, W22, nir, nsym, psym, flops)
...
call set_symblock_Xcaaaa(sleft, W22, nir, nsym, psym) ! -> Xcaaaa (allocate) 
call g_sigma_cooo_coov_no5_x0_type1_eri_o &
  (sj, ij, sv0, iv0, av2_i, h2_i, Xcaaaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_cooo_coov_no5_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no5_x0_type1_eri_o &
  (s_j, i_j, s_v0, i_v0, T2_, V2_, W22_, nir, nsym, psym, flops)
...
type(symblock3), intent(inout) :: T2_(0:nir-1, 0:nir-1, 0:nir-1)
type(symblock3), intent(inout) :: V2_(0:nir-1, 0:nir-1, 0:nir-1)
type(symblock5), intent(inout) :: W22_(0:nir-1, 0:nir-1, 0:nir-1, 0:nir-1, 0:nir-1)
...
integer :: s_a3, i_a3, s_a2, i_a2, s_w, i_w, s_a0, i_a0, s_a1, i_a1
! W22(w,a0,a1,a3,j,a2) += (    1.00000000) V2(j,v0,a3,a2) T2(w,a0,a1,v0) 
do s_a3 = 0, nir-1
do s_a2 = 0, nir-1
do s_w = 0, nir-1
do s_a0 = 0, nir-1
...
do i_a3 = psym(I_BEGIN, I_O, s_a3), psym(I_END, I_O, s_a3)
do i_a2 = psym(I_BEGIN, I_O, s_a2), psym(I_END, I_O, s_a2)
W22_(s_a2, s_a3, s_a1, s_a0, s_w)%array(i_a2, i_a3, i_a1, i_a0, i_w) = &
    W22_(s_a2, s_a3, s_a1, s_a0, s_w)%array(i_a2, i_a3, i_a1, i_a0, i_w) &
  + Z3_(i_a3, i_a2, i_w, i_a0, i_a1)
end do
end do
...
end subroutine g_sigma_cooo_coov_no5_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no5_x1_type1_eri_o &
  (sj, ij, W22, S2, nir, nsym, psym, flops)
...
call set_symblock_Xcaaaa(sleft, W22, nir, nsym, psym) ! -> Xcaaaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no5_x1_type1_eri_o &
  (sj, ij, Xcaaaa, av2_i2, d3, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaaaa)

end subroutine g_if_sigma_cooo_coov_no5_x1_type1_eri_o
...
! Information for debugging 
! >> Score :: 110101
! RDM is rotated :: D3(k,a0,a3,a2,a1,i)  >> D3(a2,a3,a0,k,i,a1) 
! rowInd : @[k, "active"] @[i, "active"] 
! summedInd : @[a1, "active"] @[a0, "active"] @[a3, "active"] @[a2, "active"] 
! -- Check2 is skipped 
!    -- is4RDM.second false
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no5_x1_type1_eri_o &
  (s_j, i_j, W22_, S2_, D3_, nir, nsym, psym, flops)
...
integer :: s_k, i_k, s_a0, i_a0, s_a3, i_a3, s_a2, i_a2, s_a1, i_a1
integer :: s_i, i_i, s_w, i_w
! S2(w,k,i,j) += (   -1.00000000) D3(k,a0,a3,a2,a1,i) W22(w,a0,a1,a3,j,a2) 
do s_k = 0, nir-1
do s_a0 = 0, nir-1
do s_a3 = 0, nir-1
do s_a2 = 0, nir-1
...
if( &
IEOR(s_w,s_k) == IEOR(s_i,s_j) .and. & 
IEOR(IEOR(s_k,s_a0),s_a3) == IEOR(IEOR(s_a2,s_a1),s_i) .and. &
IEOR(IEOR(s_w,s_a0),s_a1) == IEOR(IEOR(s_a3,s_j),s_a2)) then

if(psym(I_LENGTH,I_O, s_k)*psym(I_LENGTH,I_O, s_i) > 0 .and. &
   psym(I_LENGTH,I_C, s_w) > 0 .and. &
   psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_a0)*psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_a2) > 0) then

! Z1 <-- D3(a2,a3,a0,k,i,a1) 
allocate(Z1_(psym(I_BEGIN,I_O, s_k):psym(I_END,I_O, s_k), &
             psym(I_BEGIN,I_O, s_i):psym(I_END,I_O, s_i), &
             psym(I_BEGIN,I_O, s_a1):psym(I_END,I_O, s_a1), &
             psym(I_BEGIN,I_O, s_a0):psym(I_END,I_O, s_a0), &
...
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
do i_k = psym(I_BEGIN, I_O, s_k), psym(I_END, I_O, s_k)
Z1_(i_k, i_i, i_a1, i_a0, i_a3, i_a2) =  &
  D3_(s_a1, s_i, s_k, s_a0, s_a3, s_a2)%array(i_a1, i_i, i_k, i_a0, i_a3, i_a2)
end do
end do
end do
end do
...
call dgemm('n', 'n', psym(I_LENGTH,I_O, s_k)*psym(I_LENGTH,I_O, s_i),&
                     psym(I_LENGTH,I_C, s_w),&
                     psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_a0)*psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_a2),&
                     - 1.00000000d+00, &
                     Z1_,&
                     psym(I_LENGTH,I_O, s_k)*psym(I_LENGTH,I_O, s_i),&
                     Z2_,&
...
flops = flops + psym(I_LENGTH,I_O, s_k)*psym(I_LENGTH,I_O, s_i) * &
                psym(I_LENGTH,I_C, s_w) * &
                psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_a0)*psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_a2) * 2.0d+00
...
end subroutine g_sigma_cooo_coov_no5_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no6_x0_type1_eri_o &
  (sj, ij, sv0, iv0, T2, V2, W26, nir, nsym, psym, flops)
...
call g_sigma_cooo_coov_no6_x0_type1_eri_o &
  (sj, ij, sv0, iv0, av2_i, h2_i, Xcaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_cooo_coov_no6_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no6_x0_type1_eri_o &
  (s_j, i_j, s_v0, i_v0, T2_, V2_, W26_, nir, nsym, psym, flops)
...
! W26(w,a0,i,j) += (    1.00000000) V2(j,w,v0,c0) T2(c0,a0,i,v0) 
do s_w = 0, nir-1
do s_c0 = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
...
IEOR(s_j,s_w) == IEOR(s_v0,s_c0) .and. &
IEOR(s_c0,s_a0) == IEOR(s_i,s_v0)) then
...
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
W26_(s_i, s_a0, s_w)%array(i_i, i_a0, i_w) = &
    W26_(s_i, s_a0, s_w)%array(i_i, i_a0, i_w) &
  + Z3_(i_a0, i_i, i_w)
end do
end do
...
end subroutine g_sigma_cooo_coov_no6_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no6_x1_type1_eri_o &
  (sj, ij, W26, S2, nir, nsym, psym, flops)
...
call set_symblock_Xcaa(sleft, W26, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no6_x1_type1_eri_o &
  (sj, ij, Xcaa, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_cooo_coov_no6_x1_type1_eri_o
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no6_x1_type1_eri_o &
  (s_j, i_j, W26_, S2_, D1_, nir, nsym, psym, flops)
...
! S2(w,k,i,j) += (    1.00000000) D1(k,a0) W26(w,a0,i,j) 
do s_k = 0, nir-1
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no6_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no7_x0_type1_eri_o &
  (sj, ij, sv0, iv0, T2, V2, W28, nir, nsym, psym, flops)
...
call g_sigma_cooo_coov_no7_x0_type1_eri_o &
  (sj, ij, sv0, iv0, av2_i, h2_i, Xcaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_cooo_coov_no7_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no7_x0_type1_eri_o &
  (s_j, i_j, s_v0, i_v0, T2_, V2_, W28_, nir, nsym, psym, flops)
...
integer :: s_w, i_w, s_c0, i_c0, s_a0, i_a0, s_i, i_i
! W28(w,a0,i,j) += (    1.00000000) V2(j,v0,w,c0) T2(c0,a0,i,v0) 
do s_w = 0, nir-1
do s_c0 = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
...
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
W28_(s_i, s_a0, s_w)%array(i_i, i_a0, i_w) = &
    W28_(s_i, s_a0, s_w)%array(i_i, i_a0, i_w) &
  + Z3_(i_a0, i_i, i_w)
end do
end do
...
end subroutine g_sigma_cooo_coov_no7_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no7_x1_type1_eri_o &
  (sj, ij, W28, S2, nir, nsym, psym, flops)
...
call set_symblock_Xcaa(sleft, W28, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no7_x1_type1_eri_o &
  (sj, ij, Xcaa, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_cooo_coov_no7_x1_type1_eri_o
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no7_x1_type1_eri_o &
  (s_j, i_j, W28_, S2_, D1_, nir, nsym, psym, flops)
...
integer :: s_k, i_k, s_a0, i_a0, s_w, i_w, s_i, i_i
! S2(w,k,i,j) += (   -2.00000000) D1(k,a0) W28(w,a0,i,j) 
do s_k = 0, nir-1
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no7_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no8_x0_type1_eri_o &
  (sj, ij, sv0, iv0, T2, V2, W36, nir, nsym, psym, flops)
...
call g_sigma_cooo_coov_no8_x0_type1_eri_o &
  (sj, ij, sv0, iv0, av2_i, h2_i, Xcaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_cooo_coov_no8_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no8_x0_type1_eri_o &
  (s_j, i_j, s_v0, i_v0, T2_, V2_, W36_, nir, nsym, psym, flops)
...
integer :: s_a1, i_a1, s_a2, i_a2, s_w, i_w, s_a0, i_a0
! W36(w,a0,j,a2) += (    1.00000000) V2(j,a1,v0,a2) T2(w,a0,a1,v0) 
do s_a1 = 0, nir-1
do s_a2 = 0, nir-1
do s_w = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no8_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no8_x1_type1_eri_o &
...
call set_symblock_Xcaa(sleft, W36, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no8_x1_type1_eri_o &
  (sj, ij, Xcaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_cooo_coov_no8_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no8_x1_type1_eri_o &
...
! S2(w,k,i,j) += (   -1.00000000) D2(k,i,a2,a0) W36(w,a0,j,a2) 
do s_k = 0, nir-1
do s_i = 0, nir-1
do s_a2 = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no8_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no9_x0_type1_eri_o &
  (sj, ij, sv0, iv0, T2, V2, W37, nir, nsym, psym, flops)
...
call g_sigma_cooo_coov_no9_x0_type1_eri_o &
  (sj, ij, sv0, iv0, av2_i, h2_i, Xcaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_cooo_coov_no9_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no9_x0_type1_eri_o &
  (s_j, i_j, s_v0, i_v0, T2_, V2_, W37_, nir, nsym, psym, flops)
...
integer :: s_a2, i_a2, s_a1, i_a1, s_w, i_w, s_a0, i_a0
! W37(w,a0,a2,j) += (    1.00000000) V2(j,v0,a2,a1) T2(w,a0,a1,v0) 
do s_a2 = 0, nir-1
do s_a1 = 0, nir-1
do s_w = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no9_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no9_x1_type1_eri_o &
...
call set_symblock_Xcaa(sleft, W37, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no9_x1_type1_eri_o &
  (sj, ij, Xcaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_cooo_coov_no9_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no9_x1_type1_eri_o &
...
! S2(w,k,i,j) += (   -1.00000000) D2(k,a0,a2,i) W37(w,a0,a2,j) 
do s_k = 0, nir-1
do s_a0 = 0, nir-1
do s_a2 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no9_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no10_x0_type1_eri_o &
  (sj, ij, sv0, iv0, T2, V2, W38, nir, nsym, psym, flops)
...
call g_sigma_cooo_coov_no10_x0_type1_eri_o &
  (sj, ij, sv0, iv0, av2_i, h2_i, Xcaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_cooo_coov_no10_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no10_x0_type1_eri_o &
  (s_j, i_j, s_v0, i_v0, T2_, V2_, W38_, nir, nsym, psym, flops)
...
integer :: s_i, i_i, s_a1, i_a1, s_w, i_w, s_a0, i_a0
! W38(w,a0,i,j) += (    1.00000000) V2(j,v0,i,a1) T2(w,a0,a1,v0) 
do s_i = 0, nir-1
do s_a1 = 0, nir-1
do s_w = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no10_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no10_x1_type1_eri_o &
...
call set_symblock_Xcaa(sleft, W38, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no10_x1_type1_eri_o &
  (sj, ij, Xcaa, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_cooo_coov_no10_x1_type1_eri_o
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no10_x1_type1_eri_o &
...
integer :: s_k, i_k, s_a0, i_a0, s_w, i_w, s_i, i_i
! S2(w,k,i,j) += (    2.00000000) D1(k,a0) W38(w,a0,i,j) 
do s_k = 0, nir-1
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no10_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no11_x0_type1_eri_o &
  (sj, ij, sv0, iv0, T2, V2, W39, nir, nsym, psym, flops)
...
call g_sigma_cooo_coov_no11_x0_type1_eri_o &
  (sj, ij, sv0, iv0, av2_i, h2_i, Xcaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_cooo_coov_no11_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no11_x0_type1_eri_o &
  (s_j, i_j, s_v0, i_v0, T2_, V2_, W39_, nir, nsym, psym, flops)
...
integer :: s_a1, i_a1, s_i, i_i, s_w, i_w, s_a0, i_a0
! W39(w,a0,j,i) += (    1.00000000) V2(j,a1,v0,i) T2(w,a0,a1,v0) 
do s_a1 = 0, nir-1
do s_i = 0, nir-1
do s_w = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no11_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no11_x1_type1_eri_o &
...
call set_symblock_Xcaa(sleft, W39, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no11_x1_type1_eri_o &
  (sj, ij, Xcaa, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_cooo_coov_no11_x1_type1_eri_o
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no11_x1_type1_eri_o &
...
integer :: s_k, i_k, s_a0, i_a0, s_w, i_w, s_i, i_i
! S2(w,k,i,j) += (   -1.00000000) D1(k,a0) W39(w,a0,j,i) 
do s_k = 0, nir-1
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no11_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no0_x0_type1_eri_v &
...
call g_sigma_cooo_coov_no0_x0_type1_eri_v &
...
end subroutine g_if_sigma_cooo_coov_no0_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no0_x0_type1_eri_v &
...
! W7(w,a0,a1,a2) += (    1.00000000) V2(v0,c0,w,a2) T2(c0,a0,a1,v0) 
do s_c0 = 0, nir-1
do s_w = 0, nir-1
do s_a2 = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no0_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no1_x0_type1_eri_v &
...
call g_sigma_cooo_coov_no1_x0_type1_eri_v &
  (sv0, iv0, av2_i, h2_i, Xcaaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_cooo_coov_no1_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no1_x0_type1_eri_v &
...
! W8(w,a0,a1,a2) += (    1.00000000) V2(v0,a2,w,c0) T2(c0,a0,a1,v0) 
do s_a2 = 0, nir-1
do s_w = 0, nir-1
do s_c0 = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no1_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no2_x0_type1_eri_v &
...
call g_sigma_cooo_coov_no2_x0_type1_eri_v &
  (sv0, iv0, av2_i, h2_i, Xcaaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_cooo_coov_no2_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no2_x0_type1_eri_v &
...
! W9(w,a0,a1,i) += (    1.00000000) V2(v0,c0,w,i) T2(c0,a0,a1,v0) 
do s_c0 = 0, nir-1
do s_w = 0, nir-1
do s_i = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no2_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no3_x0_type1_eri_v &
...
call g_sigma_cooo_coov_no3_x0_type1_eri_v &
  (sv0, iv0, av2_i, h2_i, Xcaaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_cooo_coov_no3_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no3_x0_type1_eri_v &
...
! W11(w,a0,i,a1) += (    1.00000000) V2(v0,c0,w,a1) T2(c0,a0,i,v0) 
do s_c0 = 0, nir-1
do s_w = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no3_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no4_x0_type1_eri_v &
...
call g_sigma_cooo_coov_no4_x0_type1_eri_v &
  (sv0, iv0, av2_i, h2_i, Xcaaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_cooo_coov_no4_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no4_x0_type1_eri_v &
...
! W12(w,a0,i,a1) += (    1.00000000) V2(v0,a1,w,c0) T2(c0,a0,i,v0) 
do s_a1 = 0, nir-1
do s_w = 0, nir-1
do s_c0 = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no4_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no5_x0_type1_eri_v &
...
call g_sigma_cooo_coov_no5_x0_type1_eri_v &
  (sj, ij, sv0, iv0, h2_i, Xaa, d3, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaa)

end subroutine g_if_sigma_cooo_coov_no5_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no5_x0_type1_eri_v &
...
end subroutine g_sigma_cooo_coov_no5_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no5_x1_type1_eri_v &
...
call set_symblock_Xaa(sleft, W13, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no5_x1_type1_eri_v &
...
end subroutine g_if_sigma_cooo_coov_no5_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no5_x1_type1_eri_v &
...
integer :: s_w, i_w, s_a0, i_a0, s_i, i_i, s_k, i_k
! S2(w,k,i,j) += (    2.00000000) T2(w,a0,i,v0) W13(k,j,a0,v0) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
do s_k = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no5_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no6_x0_type1_eri_v &
...
call g_sigma_cooo_coov_no6_x0_type1_eri_v &
  (sv0, iv0, av2_i, h2_i, Xcaaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_cooo_coov_no6_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no6_x0_type1_eri_v &
...
! W14(w,a0,a1,i) += (    1.00000000) V2(v0,i,w,c0) T2(c0,a0,a1,v0) 
do s_i = 0, nir-1
do s_w = 0, nir-1
do s_c0 = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no6_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no7_x0_type1_eri_v &
...
call g_sigma_cooo_coov_no7_x0_type1_eri_v &
  (sv0, iv0, h2_i, Xaaa, d3, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_cooo_coov_no7_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no7_x0_type1_eri_v &
...
integer :: s_a0, i_a0
! W20(k,i,a0,v0) += (    1.00000000) V2(v0,a2,a3,a1) D3(k,i,a3,a1,a2,a0) 
do s_a2 = 0, nir-1
do s_a3 = 0, nir-1
do s_a1 = 0, nir-1
do s_k = 0, nir-1
...
do s_a0 = 0, nir-1
if( &
IEOR(s_k,s_i) == IEOR(s_a0,s_v0) .and. & 
IEOR(s_v0,s_a2) == IEOR(s_a3,s_a1) .and. &
...
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
W20_(s_a0, s_i, s_k)%array(i_a0, i_i, i_k) = &
    W20_(s_a0, s_i, s_k)%array(i_a0, i_i, i_k) &
  + Z3_(i_i, i_k, i_a0)
end do
end do
...
end subroutine g_sigma_cooo_coov_no7_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no7_x1_type1_eri_v &
...
call set_symblock_Xaaa(sleft, W20, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no7_x1_type1_eri_v &
...
end subroutine g_if_sigma_cooo_coov_no7_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no7_x1_type1_eri_v &
...
! S2(w,k,i,j) += (   -1.00000000) T2(w,a0,j,v0) W20(k,i,a0,v0) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_k = 0, nir-1
do s_i = 0, nir-1
...
IEOR(s_k,s_i) == IEOR(s_a0,s_v0)) then
...
end subroutine g_sigma_cooo_coov_no7_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no8_x0_type1_eri_v &
...
call g_sigma_cooo_coov_no8_x0_type1_eri_v &
  (sv0, iv0, h2_i, Xaaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_cooo_coov_no8_x0_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no8_x0_type1_eri_v &
...
! W24(k,a0,i,v0) += (    1.00000000) V2(v0,a2,i,a1) D2(k,a1,a2,a0) 
do s_a2 = 0, nir-1
do s_i = 0, nir-1
do s_a1 = 0, nir-1
do s_k = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no8_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no8_x1_type1_eri_v &
...
call set_symblock_Xaaa(sleft, W24, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no8_x1_type1_eri_v &
  (sj, ij, sv0, iv0, av2_i, Xaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_cooo_coov_no8_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no8_x1_type1_eri_v &
...
integer :: s_w, i_w, s_a0, i_a0, s_k, i_k, s_i, i_i
! S2(w,k,i,j) += (   -1.00000000) T2(w,a0,j,v0) W24(k,a0,i,v0) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_k = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no8_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no9_x0_type1_eri_v &
...
call g_sigma_cooo_coov_no9_x0_type1_eri_v &
  (sv0, iv0, av2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_cooo_coov_no9_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no9_x0_type1_eri_v &
...
integer :: s_w, i_w, s_a0, i_a0, s_a1, i_a1, s_k, i_k, s_a2, i_a2
! W25(w,k,a2,v0) += (    1.00000000) T2(w,a0,a1,v0) D2(k,a0,a1,a2) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_k = 0, nir-1
...
IEOR(s_w,s_a0) == IEOR(s_a1,s_v0) .and. &
IEOR(s_k,s_a0) == IEOR(s_a1,s_a2)) then
...
do i_a2 = psym(I_BEGIN, I_O, s_a2), psym(I_END, I_O, s_a2)
do i_k = psym(I_BEGIN, I_O, s_k), psym(I_END, I_O, s_k)
Z1_(i_k, i_a2, i_a0, i_a1) =  &
  D2_(s_a2, s_a1, s_a0, s_k)%array(i_a2, i_a1, i_a0, i_k)
end do
end do
end do
end do
...
end subroutine g_sigma_cooo_coov_no9_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no9_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W25, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no9_x1_type1_eri_v &
...
end subroutine g_if_sigma_cooo_coov_no9_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no9_x1_type1_eri_v &
...
end subroutine g_sigma_cooo_coov_no9_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no10_x0_type1_eri_v &
...
call g_sigma_cooo_coov_no10_x0_type1_eri_v &
  (sj, ij, sv0, iv0, h2_i, Xaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaa)

end subroutine g_if_sigma_cooo_coov_no10_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no10_x0_type1_eri_v &
...
end subroutine g_sigma_cooo_coov_no10_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no10_x1_type1_eri_v &
...
call set_symblock_Xaa(sleft, W27, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no10_x1_type1_eri_v &
  (sj, ij, sv0, iv0, av2_i, Xaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_cooo_coov_no10_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no10_x1_type1_eri_v &
...
integer :: s_w, i_w, s_a0, i_a0, s_i, i_i, s_k, i_k
! S2(w,k,i,j) += (    2.00000000) T2(w,a0,i,v0) W27(k,a0,j,v0) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
do s_k = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no10_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no11_x0_type1_eri_v &
...
call g_sigma_cooo_coov_no11_x0_type1_eri_v &
  (sj, ij, sv0, iv0, h2_i, Xaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaa)

end subroutine g_if_sigma_cooo_coov_no11_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no11_x0_type1_eri_v &
...
end subroutine g_sigma_cooo_coov_no11_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no11_x1_type1_eri_v &
...
call set_symblock_Xaa(sleft, W29, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no11_x1_type1_eri_v &
  (sj, ij, sv0, iv0, av2_i, Xaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_cooo_coov_no11_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no11_x1_type1_eri_v &
...
integer :: s_w, i_w, s_a0, i_a0, s_i, i_i, s_k, i_k
! S2(w,k,i,j) += (    2.00000000) T2(w,a0,i,v0) W29(k,a0,j,v0) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
do s_k = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no11_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no12_x0_type1_eri_v &
...
call g_sigma_cooo_coov_no12_x0_type1_eri_v &
  (sv0, iv0, av2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_cooo_coov_no12_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no12_x0_type1_eri_v &
...
integer :: s_w, i_w, s_a0, i_a0, s_a1, i_a1, s_k, i_k, s_a2, i_a2
! W30(w,k,a2,v0) += (    1.00000000) T2(w,a0,a1,v0) D2(k,a2,a1,a0) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_k = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no12_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no12_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W30, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no12_x1_type1_eri_v &
  (sj, ij, sv0, iv0, h2_i, Xcaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_cooo_coov_no12_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no12_x1_type1_eri_v &
...
integer :: s_i, i_i, s_a2, i_a2, s_w, i_w, s_k, i_k
! S2(w,k,i,j) += (   -1.00000000) V2(v0,i,j,a2) W30(w,k,a2,v0) 
do s_i = 0, nir-1
do s_a2 = 0, nir-1
do s_w = 0, nir-1
do s_k = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no12_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no13_x0_type1_eri_v &
...
call g_sigma_cooo_coov_no13_x0_type1_eri_v &
  (sv0, iv0, h2_i, Xaaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_cooo_coov_no13_x0_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no13_x0_type1_eri_v &
...
end subroutine g_sigma_cooo_coov_no13_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no13_x1_type1_eri_v &
...
call set_symblock_Xaaa(sleft, W32, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no13_x1_type1_eri_v &
  (sj, ij, sv0, iv0, av2_i, Xaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_cooo_coov_no13_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no13_x1_type1_eri_v &
...
integer :: s_w, i_w, s_a0, i_a0, s_k, i_k, s_i, i_i
! S2(w,k,i,j) += (   -1.00000000) T2(w,a0,j,v0) W32(k,a0,i,v0) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_k = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no13_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no14_x0_type1_eri_v &
...
call g_sigma_cooo_coov_no14_x0_type1_eri_v &
  (sv0, iv0, av2_i, h2_i, Xcaaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_cooo_coov_no14_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no14_x0_type1_eri_v &
...
integer :: s_a2, i_a2, s_a3, i_a3, s_a1, i_a1, s_w, i_w, s_a0, i_a0
! W33(w,a0,a3,a2) += (    1.00000000) V2(v0,a2,a3,a1) T2(w,a0,a1,v0) 
do s_a2 = 0, nir-1
do s_a3 = 0, nir-1
do s_a1 = 0, nir-1
do s_w = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no14_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no15_x0_type1_eri_v &
...
call g_sigma_cooo_coov_no15_x0_type1_eri_v &
  (sv0, iv0, av2_i, h2_i, Xcaaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_cooo_coov_no15_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no15_x0_type1_eri_v &
...
integer :: s_a2, i_a2, s_i, i_i, s_a1, i_a1, s_w, i_w, s_a0, i_a0
! W34(w,a0,i,a2) += (    1.00000000) V2(v0,a2,i,a1) T2(w,a0,a1,v0) 
do s_a2 = 0, nir-1
do s_i = 0, nir-1
do s_a1 = 0, nir-1
do s_w = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no15_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no16_x0_type1_eri_v &
...
call g_sigma_cooo_coov_no16_x0_type1_eri_v &
  (sv0, iv0, av2_i, h2_i, Xcaaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_cooo_coov_no16_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no16_x0_type1_eri_v &
...
integer :: s_i, i_i, s_a2, i_a2, s_a1, i_a1, s_w, i_w, s_a0, i_a0
! W35(w,a0,a2,i) += (    1.00000000) V2(v0,i,a2,a1) T2(w,a0,a1,v0) 
do s_i = 0, nir-1
do s_a2 = 0, nir-1
do s_a1 = 0, nir-1
do s_w = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no16_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no0_x0_type2_eri_v &
...
call set_symblock_Xcaaa(sleft, W7, nir, nsym, psym) ! -> Xcaaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no0_x0_type2_eri_v &
  (sj, ij, Xcaaa, av2_i2, d3, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaaa)

end subroutine g_if_sigma_cooo_coov_no0_x0_type2_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no0_x0_type2_eri_v &
...
integer :: s_w, i_w
! S2(w,k,i,j) += (    1.00000000) D3(k,j,a2,i,a1,a0) W7(w,a0,a1,a2) 
do s_k = 0, nir-1
do s_a2 = 0, nir-1
do s_i = 0, nir-1
do s_a1 = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no0_x0_type2_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no1_x0_type2_eri_v &
...
call set_symblock_Xcaaa(sleft, W8, nir, nsym, psym) ! -> Xcaaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no1_x0_type2_eri_v &
  (sj, ij, Xcaaa, av2_i2, d3, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaaa)

end subroutine g_if_sigma_cooo_coov_no1_x0_type2_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no1_x0_type2_eri_v &
...
integer :: s_k, i_k, s_a2, i_a2, s_a0, i_a0, s_a1, i_a1, s_i, i_i
integer :: s_w, i_w
! S2(w,k,i,j) += (    1.00000000) D3(k,j,a2,a0,a1,i) W8(w,a0,a1,a2) 
do s_k = 0, nir-1
do s_a2 = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no1_x0_type2_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no2_x0_type2_eri_v &
...
call set_symblock_Xcaaa(sleft, W9, nir, nsym, psym) ! -> Xcaaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no2_x0_type2_eri_v &
  (sj, ij, Xcaaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaaa)

end subroutine g_if_sigma_cooo_coov_no2_x0_type2_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no2_x0_type2_eri_v &
...
integer :: s_k, i_k, s_a1, i_a1, s_a0, i_a0, s_w, i_w, s_i, i_i
! S2(w,k,i,j) += (   -2.00000000) D2(k,j,a1,a0) W9(w,a0,a1,i) 
do s_k = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_w = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no2_x0_type2_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no3_x0_type2_eri_v &
...
call set_symblock_Xcaaa(sleft, W11, nir, nsym, psym) ! -> Xcaaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no3_x0_type2_eri_v &
  (sj, ij, Xcaaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaaa)

end subroutine g_if_sigma_cooo_coov_no3_x0_type2_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no3_x0_type2_eri_v &
...
integer :: s_k, i_k, s_a1, i_a1, s_a0, i_a0, s_w, i_w, s_i, i_i
! S2(w,k,i,j) += (    1.00000000) D2(k,j,a1,a0) W11(w,a0,i,a1) 
do s_k = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_w = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no3_x0_type2_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no4_x0_type2_eri_v &
...
call set_symblock_Xcaaa(sleft, W12, nir, nsym, psym) ! -> Xcaaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no4_x0_type2_eri_v &
  (sj, ij, Xcaaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaaa)

end subroutine g_if_sigma_cooo_coov_no4_x0_type2_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no4_x0_type2_eri_v &
...
integer :: s_k, i_k, s_a1, i_a1, s_a0, i_a0, s_w, i_w, s_i, i_i
! S2(w,k,i,j) += (   -2.00000000) D2(k,j,a1,a0) W12(w,a0,i,a1) 
do s_k = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_w = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no4_x0_type2_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no5_x0_type2_eri_v &
...
call set_symblock_Xcaaa(sleft, W14, nir, nsym, psym) ! -> Xcaaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no5_x0_type2_eri_v &
  (sj, ij, Xcaaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaaa)

end subroutine g_if_sigma_cooo_coov_no5_x0_type2_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no5_x0_type2_eri_v &
...
integer :: s_k, i_k, s_a1, i_a1, s_a0, i_a0, s_w, i_w, s_i, i_i
! S2(w,k,i,j) += (    1.00000000) D2(k,j,a1,a0) W14(w,a0,a1,i) 
do s_k = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_w = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no5_x0_type2_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no6_x0_type2_eri_v &
...
call set_symblock_Xcaaa(sleft, W33, nir, nsym, psym) ! -> Xcaaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no6_x0_type2_eri_v &
  (sj, ij, Xcaaa, av2_i2, d3, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaaa)

end subroutine g_if_sigma_cooo_coov_no6_x0_type2_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no6_x0_type2_eri_v &
...
integer :: s_k, i_k, s_a3, i_a3, s_i, i_i, s_a2, i_a2, s_a0, i_a0
integer :: s_w, i_w
! S2(w,k,i,j) += (   -1.00000000) D3(k,j,a3,i,a2,a0) W33(w,a0,a3,a2) 
do s_k = 0, nir-1
do s_a3 = 0, nir-1
do s_i = 0, nir-1
do s_a2 = 0, nir-1
...
if( &
IEOR(s_w,s_k) == IEOR(s_i,s_j) .and. & 
IEOR(IEOR(s_k,s_j),s_a3) == IEOR(IEOR(s_i,s_a2),s_a0) .and. &
...
Z1_(i_k, i_i, i_a3, i_a2, i_a0) =  &
  D3_(s_a0, s_a2, s_i, s_a3, s_j, s_k)%array(i_a0, i_a2, i_i, i_a3, i_j, i_k)
end do
end do
end do
end do
...
end subroutine g_sigma_cooo_coov_no6_x0_type2_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no7_x0_type2_eri_v &
...
call set_symblock_Xcaaa(sleft, W34, nir, nsym, psym) ! -> Xcaaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no7_x0_type2_eri_v &
  (sj, ij, Xcaaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaaa)

end subroutine g_if_sigma_cooo_coov_no7_x0_type2_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no7_x0_type2_eri_v &
...
! S2(w,k,i,j) += (    2.00000000) D2(k,j,a2,a0) W34(w,a0,i,a2) 
do s_k = 0, nir-1
do s_a2 = 0, nir-1
do s_a0 = 0, nir-1
do s_w = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no7_x0_type2_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no8_x0_type2_eri_v &
...
call set_symblock_Xcaaa(sleft, W35, nir, nsym, psym) ! -> Xcaaa (allocate) 
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no8_x0_type2_eri_v &
  (sj, ij, Xcaaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaaa)

end subroutine g_if_sigma_cooo_coov_no8_x0_type2_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no8_x0_type2_eri_v &
...
integer :: s_k, i_k, s_a2, i_a2, s_a0, i_a0, s_w, i_w, s_i, i_i
! S2(w,k,i,j) += (   -1.00000000) D2(k,j,a2,a0) W35(w,a0,a2,i) 
do s_k = 0, nir-1
do s_a2 = 0, nir-1
do s_a0 = 0, nir-1
do s_w = 0, nir-1
...
end subroutine g_sigma_cooo_coov_no8_x0_type2_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_cooo_coov_no0_x0_type1_d4c_v &
  (sj, ij, sv0, iv0, C5, T2, S2, nir, nsym, psym, flops)
...
call set_symblock_av2_2(sj, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_cooo_coov_no0_x0_type1_d4c_v &
  (sj, ij, sv0, iv0, d4cf, av2_i, av2_i2, nir, nsym, psym, flops)

deallocate(d4cf)
deallocate(av2_i2)
deallocate(av2_i)

end subroutine g_if_sigma_cooo_coov_no0_x0_type1_d4c_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_cooo_coov_no0_x0_type1_d4c_v &
  (s_j, i_j, s_v0, i_v0, C5_, T2_, S2_, nir, nsym, psym, flops)
...
integer :: s_w, i_w, s_a0, i_a0, s_a1, i_a1, s_i, i_i, s_k, i_k
! S2(w,k,i,j) += (   -1.00000000) T2(w,a0,a1,v0) C5(i,a1,j,k,a0,v0) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
IEOR(s_w,s_k) == IEOR(s_i,s_j) .and. & 
IEOR(s_w,s_a0) == IEOR(s_a1,s_v0) .and. &
IEOR(IEOR(s_i,s_a1),s_j) == IEOR(IEOR(s_k,s_a0),s_v0)) then

if(psym(I_LENGTH,I_O, s_i)*psym(I_LENGTH,I_O, s_k) > 0 .and. &
   psym(I_LENGTH,I_C, s_w) > 0 .and. &
   psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_a0) > 0) then

! Z1 <-- C5(i,a1,j,k,a0,v0) 
allocate(Z1_(psym(I_BEGIN,I_O, s_i):psym(I_END,I_O, s_i), &
             psym(I_BEGIN,I_O, s_k):psym(I_END,I_O, s_k), &
             psym(I_BEGIN,I_O, s_a1):psym(I_END,I_O, s_a1), &
             psym(I_BEGIN,I_O, s_a0):psym(I_END,I_O, s_a0)))
...
do i_k = psym(I_BEGIN, I_O, s_k), psym(I_END, I_O, s_k)
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
Z1_(i_i, i_k, i_a1, i_a0) =  &
  C5_(s_a0, s_k, s_j, s_a1, s_i)%array(i_a0, i_k, i_j, i_a1, i_i)
end do
end do
end do
end do
...
end subroutine g_sigma_cooo_coov_no0_x0_type1_d4c_v
