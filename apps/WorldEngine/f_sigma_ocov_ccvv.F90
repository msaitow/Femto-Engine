...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccvv_no0_x0_type0_noeri &
...
call g_sigma_ocov_ccvv_no0_x0_type0_noeri &
  (sa, ia, av2_i, Xc, fc1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xc)

end subroutine g_if_sigma_ocov_ccvv_no0_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccvv_no0_x0_type0_noeri &
...
end subroutine g_sigma_ocov_ccvv_no0_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccvv_no0_x1_type0_noeri &
...
call g_sigma_ocov_ccvv_no0_x1_type0_noeri &
  (sa, ia, Xc, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xc)

end subroutine g_if_sigma_ocov_ccvv_no0_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccvv_no0_x1_type0_noeri &
...
! S2(i,w,j,a) += (    8.00000000) D1(j,i) W0(w,a) 
do s_j = 0, nir-1
do s_i = 0, nir-1
do s_w = 0, nir-1
if( &
...
end subroutine g_sigma_ocov_ccvv_no0_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccvv_no1_x0_type0_noeri &
...
call g_sigma_ocov_ccvv_no1_x0_type0_noeri &
  (sa, ia, av2_i, Xc, fc1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xc)

end subroutine g_if_sigma_ocov_ccvv_no1_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccvv_no1_x0_type0_noeri &
...
end subroutine g_sigma_ocov_ccvv_no1_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccvv_no1_x1_type0_noeri &
...
call set_symblock_Xc(sleft, W1, nir, nsym, psym) ! -> Xc (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ccvv_no1_x1_type0_noeri &
  (sa, ia, Xc, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xc)

end subroutine g_if_sigma_ocov_ccvv_no1_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccvv_no1_x1_type0_noeri &
...
integer :: s_j, i_j, s_i, i_i, s_w, i_w
! S2(i,w,j,a) += (   -4.00000000) D1(j,i) W1(w,a) 
do s_j = 0, nir-1
do s_i = 0, nir-1
do s_w = 0, nir-1
if( &
...
end subroutine g_sigma_ocov_ccvv_no1_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccvv_no0_x0_type1_eri_c &
...
call g_sigma_ocov_ccvv_no0_x0_type1_eri_c &
  (sa, ia, sw, iw, av2_i, h2_i, W2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(h2_i)

end subroutine g_if_sigma_ocov_ccvv_no0_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccvv_no0_x0_type1_eri_c &
...
end subroutine g_sigma_ocov_ccvv_no0_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccvv_no0_x1_type1_eri_c &
...
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ccvv_no0_x1_type1_eri_c &
  (sa, ia, sw, iw, W2, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)

end subroutine g_if_sigma_ocov_ccvv_no0_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccvv_no0_x1_type1_eri_c &
...
! S2(i,w,j,a) += (   -8.00000000) D1(j,i) W2(w,a) 
do s_j = 0, nir-1
do s_i = 0, nir-1
if( &
IEOR(s_i,s_w) == IEOR(s_j,s_a) .and. & 
...
end subroutine g_sigma_ocov_ccvv_no0_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccvv_no1_x0_type1_eri_c &
...
call g_sigma_ocov_ccvv_no1_x0_type1_eri_c &
  (sa, ia, sw, iw, av2_i, h2_i, W3, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(h2_i)

end subroutine g_if_sigma_ocov_ccvv_no1_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccvv_no1_x0_type1_eri_c &
...
end subroutine g_sigma_ocov_ccvv_no1_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccvv_no1_x1_type1_eri_c &
...
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ccvv_no1_x1_type1_eri_c &
  (sa, ia, sw, iw, W3, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)

end subroutine g_if_sigma_ocov_ccvv_no1_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccvv_no1_x1_type1_eri_c &
...
integer :: s_j, i_j, s_i, i_i
! S2(i,w,j,a) += (    4.00000000) D1(j,i) W3(w,a) 
do s_j = 0, nir-1
do s_i = 0, nir-1
if( &
IEOR(s_i,s_w) == IEOR(s_j,s_a) .and. & 
...
end subroutine g_sigma_ocov_ccvv_no1_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccvv_no0_x0_type1_eri_v &
...
call g_sigma_ocov_ccvv_no0_x0_type1_eri_v &
  (sv0, iv0, h2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_ocov_ccvv_no0_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccvv_no0_x0_type1_eri_v &
...
end subroutine g_sigma_ocov_ccvv_no0_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccvv_no0_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W4, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ccvv_no0_x1_type1_eri_v &
...
end subroutine g_if_sigma_ocov_ccvv_no0_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccvv_no0_x1_type1_eri_v &
...
! S2(i,w,j,a) += (   -4.00000000) T2(w,c0,a,v0) W4(c0,j,i,v0) 
do s_w = 0, nir-1
do s_c0 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ocov_ccvv_no0_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccvv_no1_x0_type1_eri_v &
...
call g_sigma_ocov_ccvv_no1_x0_type1_eri_v &
  (sv0, iv0, h2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_ocov_ccvv_no1_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccvv_no1_x0_type1_eri_v &
...
integer :: s_a1, i_a1, s_c0, i_c0, s_a0, i_a0, s_j, i_j, s_i, i_i
! W5(c0,j,i,v0) += (    1.00000000) V2(v0,a1,c0,a0) D2(j,i,a0,a1) 
do s_a1 = 0, nir-1
do s_c0 = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_ocov_ccvv_no1_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccvv_no1_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W5, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ccvv_no1_x1_type1_eri_v &
  (sa, ia, sv0, iv0, av2_i, Xcaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ocov_ccvv_no1_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccvv_no1_x1_type1_eri_v &
...
integer :: s_w, i_w, s_c0, i_c0, s_j, i_j, s_i, i_i
! S2(i,w,j,a) += (    2.00000000) T2(w,c0,v0,a) W5(c0,j,i,v0) 
do s_w = 0, nir-1
do s_c0 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ocov_ccvv_no1_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccvv_no2_x0_type1_eri_v &
...
call g_sigma_ocov_ccvv_no2_x0_type1_eri_v &
  (sv0, iv0, h2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_ocov_ccvv_no2_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccvv_no2_x0_type1_eri_v &
...
end subroutine g_sigma_ocov_ccvv_no2_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccvv_no2_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W6, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ccvv_no2_x1_type1_eri_v &
  (sa, ia, sv0, iv0, av2_i, Xcaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ocov_ccvv_no2_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccvv_no2_x1_type1_eri_v &
...
integer :: s_w, i_w, s_c0, i_c0, s_j, i_j, s_i, i_i
! S2(i,w,j,a) += (    8.00000000) T2(w,c0,a,v0) W6(c0,j,i,v0) 
do s_w = 0, nir-1
do s_c0 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ocov_ccvv_no2_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccvv_no3_x0_type1_eri_v &
...
call g_sigma_ocov_ccvv_no3_x0_type1_eri_v &
  (sv0, iv0, h2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_ocov_ccvv_no3_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccvv_no3_x0_type1_eri_v &
...
end subroutine g_sigma_ocov_ccvv_no3_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccvv_no3_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W7, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ccvv_no3_x1_type1_eri_v &
  (sa, ia, sv0, iv0, av2_i, Xcaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ocov_ccvv_no3_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccvv_no3_x1_type1_eri_v &
...
integer :: s_w, i_w, s_c0, i_c0, s_j, i_j, s_i, i_i
! S2(i,w,j,a) += (   -4.00000000) T2(w,c0,v0,a) W7(c0,j,i,v0) 
do s_w = 0, nir-1
do s_c0 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ocov_ccvv_no3_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccvv_no4_x0_type1_eri_v &
...
call g_sigma_ocov_ccvv_no4_x0_type1_eri_v &
  (sv0, iv0, h2_i, Xcaa, d1, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_ocov_ccvv_no4_x0_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ocov_ccvv_no4_x0_type1_eri_v &
...
end subroutine g_sigma_ocov_ccvv_no4_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccvv_no4_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W8, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ccvv_no4_x1_type1_eri_v &
  (sa, ia, sv0, iv0, av2_i, Xcaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ocov_ccvv_no4_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccvv_no4_x1_type1_eri_v &
...
! S2(i,w,j,a) += (    8.00000000) T2(w,c0,a,v0) W8(c0,i,j,v0) 
do s_w = 0, nir-1
do s_c0 = 0, nir-1
do s_i = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_ocov_ccvv_no4_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccvv_no5_x0_type1_eri_v &
...
call g_sigma_ocov_ccvv_no5_x0_type1_eri_v &
  (sv0, iv0, h2_i, Xcaa, d1, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_ocov_ccvv_no5_x0_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ocov_ccvv_no5_x0_type1_eri_v &
...
end subroutine g_sigma_ocov_ccvv_no5_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccvv_no5_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W9, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ccvv_no5_x1_type1_eri_v &
  (sa, ia, sv0, iv0, av2_i, Xcaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ocov_ccvv_no5_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccvv_no5_x1_type1_eri_v &
...
integer :: s_w, i_w, s_c0, i_c0, s_i, i_i, s_j, i_j
! S2(i,w,j,a) += (   -4.00000000) T2(w,c0,v0,a) W9(c0,i,j,v0) 
do s_w = 0, nir-1
do s_c0 = 0, nir-1
do s_i = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_ocov_ccvv_no5_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccvv_no6_x0_type1_eri_v &
...
call g_sigma_ocov_ccvv_no6_x0_type1_eri_v &
  (sv0, iv0, h2_i, Xcaa, d1, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_ocov_ccvv_no6_x0_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ocov_ccvv_no6_x0_type1_eri_v &
...
end subroutine g_sigma_ocov_ccvv_no6_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccvv_no6_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W10, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ccvv_no6_x1_type1_eri_v &
  (sa, ia, sv0, iv0, av2_i, Xcaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ocov_ccvv_no6_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccvv_no6_x1_type1_eri_v &
...
integer :: s_w, i_w, s_c0, i_c0, s_i, i_i, s_j, i_j
! S2(i,w,j,a) += (   -4.00000000) T2(w,c0,a,v0) W10(c0,i,j,v0) 
do s_w = 0, nir-1
do s_c0 = 0, nir-1
do s_i = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_ocov_ccvv_no6_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccvv_no7_x0_type1_eri_v &
...
call g_sigma_ocov_ccvv_no7_x0_type1_eri_v &
  (sv0, iv0, h2_i, Xcaa, d1, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_ocov_ccvv_no7_x0_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ocov_ccvv_no7_x0_type1_eri_v &
...
end subroutine g_sigma_ocov_ccvv_no7_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccvv_no7_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W11, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ccvv_no7_x1_type1_eri_v &
  (sa, ia, sv0, iv0, av2_i, Xcaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ocov_ccvv_no7_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccvv_no7_x1_type1_eri_v &
...
integer :: s_w, i_w, s_c0, i_c0, s_i, i_i, s_j, i_j
! S2(i,w,j,a) += (    2.00000000) T2(w,c0,v0,a) W11(c0,i,j,v0) 
do s_w = 0, nir-1
do s_c0 = 0, nir-1
do s_i = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_ocov_ccvv_no7_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccvv_no8_x0_type1_eri_v &
...
call g_sigma_ocov_ccvv_no8_x0_type1_eri_v &
...
end subroutine g_if_sigma_ocov_ccvv_no8_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccvv_no8_x0_type1_eri_v &
...
end subroutine g_sigma_ocov_ccvv_no8_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccvv_no8_x1_type1_eri_v &
...
call set_symblock_Xc(sleft, W12, nir, nsym, psym) ! -> Xc (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ccvv_no8_x1_type1_eri_v &
  (sa, ia, Xc, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xc)

end subroutine g_if_sigma_ocov_ccvv_no8_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccvv_no8_x1_type1_eri_v &
...
integer :: s_j, i_j, s_i, i_i, s_w, i_w
! S2(i,w,j,a) += (    8.00000000) D1(j,i) W12(w,a) 
do s_j = 0, nir-1
do s_i = 0, nir-1
do s_w = 0, nir-1
if( &
...
end subroutine g_sigma_ocov_ccvv_no8_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccvv_no9_x0_type1_eri_v &
...
call g_sigma_ocov_ccvv_no9_x0_type1_eri_v &
...
end subroutine g_if_sigma_ocov_ccvv_no9_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccvv_no9_x0_type1_eri_v &
...
end subroutine g_sigma_ocov_ccvv_no9_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ccvv_no9_x1_type1_eri_v &
...
call set_symblock_Xc(sleft, W13, nir, nsym, psym) ! -> Xc (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ccvv_no9_x1_type1_eri_v &
  (sa, ia, Xc, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xc)

end subroutine g_if_sigma_ocov_ccvv_no9_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ccvv_no9_x1_type1_eri_v &
...
integer :: s_j, i_j, s_i, i_i, s_w, i_w
! S2(i,w,j,a) += (   -4.00000000) D1(j,i) W13(w,a) 
do s_j = 0, nir-1
do s_i = 0, nir-1
do s_w = 0, nir-1
if( &
...
end subroutine g_sigma_ocov_ccvv_no9_x1_type1_eri_v
