...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no0_x0_type0_noeri &
...
call g_sigma_coov_covv_no0_x0_type0_noeri &
  (sa, ia, av2_i, Xcaa, fc1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_covv_no0_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_covv_no0_x0_type0_noeri &
...
end subroutine g_sigma_coov_covv_no0_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no0_x1_type0_noeri &
...
call g_sigma_coov_covv_no0_x1_type0_noeri &
  (sa, ia, Xcaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_covv_no0_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_covv_no0_x1_type0_noeri &
...
! S2(w,i,j,a) += (   -1.00000000) D2(j,a1,a0,i) W0(w,a1,a0,a) 
do s_j = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_covv_no0_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no1_x0_type0_noeri &
...
call g_sigma_coov_covv_no1_x0_type0_noeri &
  (sa, ia, av2_i, Xcav, d1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcav)

end subroutine g_if_sigma_coov_covv_no1_x0_type0_noeri
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_coov_covv_no1_x0_type0_noeri &
...
end subroutine g_sigma_coov_covv_no1_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no1_x1_type0_noeri &
...
call set_symblock_Xcav(sleft, W1, nir, nsym, psym) ! -> Xcav (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_covv_no1_x1_type0_noeri &
  (sa, ia, Xcav, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcav)

end subroutine g_if_sigma_coov_covv_no1_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_covv_no1_x1_type0_noeri &
...
! S2(w,i,j,a) += (    2.00000000) Fc1(v0,j) W1(w,i,v0,a) 
do s_v0 = 0, nir-1
do s_j = 0, nir-1
do s_w = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_covv_no1_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no2_x0_type0_noeri &
...
call g_sigma_coov_covv_no2_x0_type0_noeri &
  (sa, ia, av2_i, Xcaa, fc1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_covv_no2_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_covv_no2_x0_type0_noeri &
...
end subroutine g_sigma_coov_covv_no2_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no2_x1_type0_noeri &
...
call set_symblock_Xcaa(sleft, W2, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_covv_no2_x1_type0_noeri &
  (sa, ia, Xcaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_covv_no2_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_covv_no2_x1_type0_noeri &
...
! S2(w,i,j,a) += (   -1.00000000) D2(j,i,a0,a1) W2(w,a1,a0,a) 
do s_j = 0, nir-1
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
...
end subroutine g_sigma_coov_covv_no2_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no3_x0_type0_noeri &
...
call g_sigma_coov_covv_no3_x0_type0_noeri &
  (sa, ia, av2_i, Xcav, d1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcav)

end subroutine g_if_sigma_coov_covv_no3_x0_type0_noeri
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_coov_covv_no3_x0_type0_noeri &
...
end subroutine g_sigma_coov_covv_no3_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no3_x1_type0_noeri &
...
call set_symblock_Xcav(sleft, W3, nir, nsym, psym) ! -> Xcav (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_covv_no3_x1_type0_noeri &
  (sa, ia, Xcav, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcav)

end subroutine g_if_sigma_coov_covv_no3_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_covv_no3_x1_type0_noeri &
...
integer :: s_v0, i_v0, s_j, i_j, s_w, i_w, s_i, i_i
! S2(w,i,j,a) += (   -1.00000000) Fc1(v0,j) W3(w,i,a,v0) 
do s_v0 = 0, nir-1
do s_j = 0, nir-1
do s_w = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_covv_no3_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no0_x0_type1_eri_c &
...
call g_sigma_coov_covv_no0_x0_type1_eri_c &
...
end subroutine g_if_sigma_coov_covv_no0_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_covv_no0_x0_type1_eri_c &
...
end subroutine g_sigma_coov_covv_no0_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no0_x1_type1_eri_c &
...
call set_symblock_Xaa(sleft, W4, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_covv_no0_x1_type1_eri_c &
  (sa, ia, sw, iw, Xaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaa)

end subroutine g_if_sigma_coov_covv_no0_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_covv_no0_x1_type1_eri_c &
...
integer :: s_j, i_j, s_a1, i_a1, s_a0, i_a0, s_i, i_i
! S2(w,i,j,a) += (   -2.00000000) D2(j,a1,a0,i) W4(w,a0,a1,a) 
do s_j = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_covv_no0_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no1_x0_type1_eri_c &
...
call g_sigma_coov_covv_no1_x0_type1_eri_c &
  (sa, ia, sw, iw, av2_i, h2_i, Xaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_covv_no1_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_covv_no1_x0_type1_eri_c &
...
end subroutine g_sigma_coov_covv_no1_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no1_x1_type1_eri_c &
...
call set_symblock_Xaa(sleft, W5, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_covv_no1_x1_type1_eri_c &
  (sa, ia, sw, iw, Xaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaa)

end subroutine g_if_sigma_coov_covv_no1_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_covv_no1_x1_type1_eri_c &
...
integer :: s_j, i_j, s_a1, i_a1, s_a0, i_a0, s_i, i_i
! S2(w,i,j,a) += (    1.00000000) D2(j,a1,a0,i) W5(w,a0,a1,a) 
do s_j = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_covv_no1_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no2_x0_type1_eri_c &
...
call g_sigma_coov_covv_no2_x0_type1_eri_c &
  (sa, ia, sw, iw, av2_i, h2_i, Xaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_covv_no2_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_covv_no2_x0_type1_eri_c &
...
end subroutine g_sigma_coov_covv_no2_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no2_x1_type1_eri_c &
...
call set_symblock_Xaa(sleft, W7, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_covv_no2_x1_type1_eri_c &
  (sa, ia, sw, iw, Xaa, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaa)

end subroutine g_if_sigma_coov_covv_no2_x1_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_coov_covv_no2_x1_type1_eri_c &
...
! S2(w,i,j,a) += (    4.00000000) D1(i,a0) W7(w,a0,j,a) 
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
if( &
...
end subroutine g_sigma_coov_covv_no2_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no3_x0_type1_eri_c &
...
call g_sigma_coov_covv_no3_x0_type1_eri_c &
  (sa, ia, sw, iw, av2_i, h2_i, Xaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_covv_no3_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_covv_no3_x0_type1_eri_c &
...
end subroutine g_sigma_coov_covv_no3_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no3_x1_type1_eri_c &
...
call set_symblock_Xaa(sleft, W9, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_covv_no3_x1_type1_eri_c &
  (sa, ia, sw, iw, Xaa, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaa)

end subroutine g_if_sigma_coov_covv_no3_x1_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_coov_covv_no3_x1_type1_eri_c &
...
integer :: s_i, i_i, s_a0, i_a0, s_j, i_j
! S2(w,i,j,a) += (   -2.00000000) D1(i,a0) W9(w,a0,j,a) 
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
if( &
...
end subroutine g_sigma_coov_covv_no3_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no4_x0_type1_eri_c &
...
call g_sigma_coov_covv_no4_x0_type1_eri_c &
  (sa, ia, sw, iw, av2_i, h2_i, Xaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_covv_no4_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_covv_no4_x0_type1_eri_c &
...
end subroutine g_sigma_coov_covv_no4_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no4_x1_type1_eri_c &
...
call set_symblock_Xaa(sleft, W11, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_covv_no4_x1_type1_eri_c &
  (sa, ia, sw, iw, Xaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaa)

end subroutine g_if_sigma_coov_covv_no4_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_covv_no4_x1_type1_eri_c &
...
integer :: s_j, i_j, s_a1, i_a1, s_a0, i_a0, s_i, i_i
! S2(w,i,j,a) += (    1.00000000) D2(j,a1,a0,i) W11(w,a0,a1,a) 
do s_j = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_covv_no4_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no5_x0_type1_eri_c &
...
call g_sigma_coov_covv_no5_x0_type1_eri_c &
  (sa, ia, sw, iw, av2_i, h2_i, Xaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_covv_no5_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_covv_no5_x0_type1_eri_c &
...
end subroutine g_sigma_coov_covv_no5_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no5_x1_type1_eri_c &
...
call set_symblock_Xaa(sleft, W12, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_covv_no5_x1_type1_eri_c &
  (sa, ia, sw, iw, Xaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaa)

end subroutine g_if_sigma_coov_covv_no5_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_covv_no5_x1_type1_eri_c &
...
! S2(w,i,j,a) += (    1.00000000) D2(j,i,a0,a1) W12(w,a0,a1,a) 
do s_j = 0, nir-1
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
...
end subroutine g_sigma_coov_covv_no5_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no6_x0_type1_eri_c &
...
call g_sigma_coov_covv_no6_x0_type1_eri_c &
  (sa, ia, sw, iw, av2_i, h2_i, Xaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_covv_no6_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_covv_no6_x0_type1_eri_c &
...
end subroutine g_sigma_coov_covv_no6_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no6_x1_type1_eri_c &
...
call set_symblock_Xaa(sleft, W14, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_covv_no6_x1_type1_eri_c &
  (sa, ia, sw, iw, Xaa, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaa)

end subroutine g_if_sigma_coov_covv_no6_x1_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_coov_covv_no6_x1_type1_eri_c &
...
integer :: s_i, i_i, s_a0, i_a0, s_j, i_j
! S2(w,i,j,a) += (   -2.00000000) D1(i,a0) W14(w,a0,j,a) 
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
if( &
...
end subroutine g_sigma_coov_covv_no6_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no7_x0_type1_eri_c &
...
call g_sigma_coov_covv_no7_x0_type1_eri_c &
  (sa, ia, sw, iw, av2_i, h2_i, Xaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_covv_no7_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_covv_no7_x0_type1_eri_c &
...
end subroutine g_sigma_coov_covv_no7_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no7_x1_type1_eri_c &
...
call set_symblock_Xaa(sleft, W16, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_covv_no7_x1_type1_eri_c &
  (sa, ia, sw, iw, Xaa, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaa)

end subroutine g_if_sigma_coov_covv_no7_x1_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_coov_covv_no7_x1_type1_eri_c &
...
integer :: s_i, i_i, s_a0, i_a0, s_j, i_j
! S2(w,i,j,a) += (    1.00000000) D1(i,a0) W16(w,a0,j,a) 
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
if( &
...
end subroutine g_sigma_coov_covv_no7_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no0_x0_type1_eri_v &
...
call g_sigma_coov_covv_no0_x0_type1_eri_v &
  (sv0, iv0, h2_i, Xaaa, d3, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_coov_covv_no0_x0_type1_eri_v
...
! >> Score :: 111111
! The best shot!
! RDM is rotated :: D3(j,a2,a3,a1,a0,i)  >> D3(a1,a3,a2,j,i,a0) 
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_covv_no0_x0_type1_eri_v &
...
integer :: s_i, i_i
! W6(j,a0,i,v0) += (    1.00000000) V2(v0,a2,a3,a1) D3(j,a2,a3,a1,a0,i) 
do s_a2 = 0, nir-1
do s_a3 = 0, nir-1
do s_a1 = 0, nir-1
do s_j = 0, nir-1
...
IEOR(IEOR(s_j,s_a2),s_a3) == IEOR(IEOR(s_a1,s_a0),s_i)) then
...
call dgemm('n', 'n', psym(I_LENGTH,I_O, s_a0)*psym(I_LENGTH,I_O, s_i)*psym(I_LENGTH,I_O, s_j),&
                     ...
                     1.00000000d+00, &
                     D3_(s_a0, s_i, s_j, s_a2, s_a3, s_a1)%array,&
...
end subroutine g_sigma_coov_covv_no0_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no0_x1_type1_eri_v &
...
call set_symblock_Xaaa(sleft, W6, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_covv_no0_x1_type1_eri_v &
...
end subroutine g_if_sigma_coov_covv_no0_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_covv_no0_x1_type1_eri_v &
...
! S2(w,i,j,a) += (   -1.00000000) T2(w,a0,v0,a) W6(j,a0,i,v0) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_covv_no0_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no1_x0_type1_eri_v &
...
call g_sigma_coov_covv_no1_x0_type1_eri_v &
  (sv0, iv0, h2_i, Xaaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_coov_covv_no1_x0_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_coov_covv_no1_x0_type1_eri_v &
...
! W8(i,a0,j,v0) += (    1.00000000) V2(v0,a2,j,a1) D2(i,a0,a2,a1) 
do s_a2 = 0, nir-1
do s_j = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_covv_no1_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no1_x1_type1_eri_v &
...
call set_symblock_Xaaa(sleft, W8, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_covv_no1_x1_type1_eri_v &
  (sa, ia, sv0, iv0, av2_i, Xaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_covv_no1_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_covv_no1_x1_type1_eri_v &
...
! S2(w,i,j,a) += (   -1.00000000) T2(w,a0,v0,a) W8(i,a0,j,v0) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_coov_covv_no1_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no2_x0_type1_eri_v &
...
call g_sigma_coov_covv_no2_x0_type1_eri_v &
  (sv0, iv0, h2_i, Xaaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_coov_covv_no2_x0_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_coov_covv_no2_x0_type1_eri_v &
...
end subroutine g_sigma_coov_covv_no2_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no2_x1_type1_eri_v &
...
call set_symblock_Xaaa(sleft, W10, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_covv_no2_x1_type1_eri_v &
  (sa, ia, sv0, iv0, av2_i, Xaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_covv_no2_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_covv_no2_x1_type1_eri_v &
...
integer :: s_w, i_w, s_a0, i_a0, s_i, i_i, s_j, i_j
! S2(w,i,j,a) += (    2.00000000) T2(w,a0,v0,a) W10(i,a0,j,v0) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_coov_covv_no2_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no3_x0_type1_eri_v &
...
call g_sigma_coov_covv_no3_x0_type1_eri_v &
  (sv0, iv0, h2_i, Xaaa, d3, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_coov_covv_no3_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_covv_no3_x0_type1_eri_v &
...
end subroutine g_sigma_coov_covv_no3_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no3_x1_type1_eri_v &
...
call set_symblock_Xaaa(sleft, W13, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_covv_no3_x1_type1_eri_v &
  (sa, ia, sv0, iv0, av2_i, Xaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_covv_no3_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_covv_no3_x1_type1_eri_v &
...
integer :: s_w, i_w, s_a0, i_a0, s_j, i_j, s_i, i_i
! S2(w,i,j,a) += (   -1.00000000) T2(w,a0,a,v0) W13(j,a0,i,v0) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_covv_no3_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no4_x0_type1_eri_v &
...
call g_sigma_coov_covv_no4_x0_type1_eri_v &
  (sv0, iv0, h2_i, Xaaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_coov_covv_no4_x0_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_coov_covv_no4_x0_type1_eri_v &
...
end subroutine g_sigma_coov_covv_no4_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no4_x1_type1_eri_v &
...
call set_symblock_Xaaa(sleft, W15, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_covv_no4_x1_type1_eri_v &
  (sa, ia, sv0, iv0, av2_i, Xaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_covv_no4_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_covv_no4_x1_type1_eri_v &
...
integer :: s_w, i_w, s_a0, i_a0, s_i, i_i, s_j, i_j
! S2(w,i,j,a) += (   -1.00000000) T2(w,a0,a,v0) W15(i,a0,j,v0) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_coov_covv_no4_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no5_x0_type1_eri_v &
...
call g_sigma_coov_covv_no5_x0_type1_eri_v &
  (sv0, iv0, h2_i, Xaaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_coov_covv_no5_x0_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_coov_covv_no5_x0_type1_eri_v &
...
end subroutine g_sigma_coov_covv_no5_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no5_x1_type1_eri_v &
...
call set_symblock_Xaaa(sleft, W17, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_covv_no5_x1_type1_eri_v &
  (sa, ia, sv0, iv0, av2_i, Xaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_covv_no5_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_covv_no5_x1_type1_eri_v &
...
integer :: s_w, i_w, s_a0, i_a0, s_i, i_i, s_j, i_j
! S2(w,i,j,a) += (   -1.00000000) T2(w,a0,a,v0) W17(i,a0,j,v0) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_coov_covv_no5_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no6_x0_type1_eri_v &
...
call g_sigma_coov_covv_no6_x0_type1_eri_v &
...
end subroutine g_if_sigma_coov_covv_no6_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_covv_no6_x0_type1_eri_v &
...
end subroutine g_sigma_coov_covv_no6_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no6_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W18, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_covv_no6_x1_type1_eri_v &
  (sa, ia, Xcaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_covv_no6_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_covv_no6_x1_type1_eri_v &
...
integer :: s_j, i_j, s_i, i_i, s_a0, i_a0, s_a1, i_a1, s_w, i_w
! S2(w,i,j,a) += (   -1.00000000) D2(j,i,a0,a1) W18(w,a0,a1,a) 
do s_j = 0, nir-1
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
...
end subroutine g_sigma_coov_covv_no6_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no7_x0_type1_eri_v &
...
call g_sigma_coov_covv_no7_x0_type1_eri_v &
...
end subroutine g_if_sigma_coov_covv_no7_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_covv_no7_x0_type1_eri_v &
...
end subroutine g_sigma_coov_covv_no7_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no7_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W19, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_covv_no7_x1_type1_eri_v &
  (sa, ia, Xcaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_covv_no7_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_covv_no7_x1_type1_eri_v &
...
integer :: s_j, i_j, s_a1, i_a1, s_a0, i_a0, s_i, i_i, s_w, i_w
! S2(w,i,j,a) += (   -1.00000000) D2(j,a1,a0,i) W19(w,a0,a1,a) 
do s_j = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_covv_no7_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no8_x0_type1_eri_v &
...
call g_sigma_coov_covv_no8_x0_type1_eri_v &
  (sa, ia, sv0, iv0, av2_i, h2_i, Xcaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_covv_no8_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_covv_no8_x0_type1_eri_v &
...
end subroutine g_sigma_coov_covv_no8_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no8_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W20, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_covv_no8_x1_type1_eri_v &
  (sa, ia, Xcaa, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_covv_no8_x1_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_coov_covv_no8_x1_type1_eri_v &
...
end subroutine g_sigma_coov_covv_no8_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no9_x0_type1_eri_v &
...
call g_sigma_coov_covv_no9_x0_type1_eri_v &
  (sa, ia, sv1, iv1, av2_i, h2_i, Xcaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_covv_no9_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_covv_no9_x0_type1_eri_v &
...
end subroutine g_sigma_coov_covv_no9_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_covv_no9_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W21, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_covv_no9_x1_type1_eri_v &
  (sa, ia, Xcaa, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_covv_no9_x1_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_coov_covv_no9_x1_type1_eri_v &
...
integer :: s_i, i_i, s_a0, i_a0, s_w, i_w, s_j, i_j
! S2(w,i,j,a) += (   -1.00000000) D1(i,a0) W21(w,a0,j,a) 
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_coov_covv_no9_x1_type1_eri_v
