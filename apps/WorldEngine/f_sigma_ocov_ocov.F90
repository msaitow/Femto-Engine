...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no0_x0_type0_noeri &
...
call g_sigma_ocov_ocov_no0_x0_type0_noeri &
  (sa, ia, Fc0, av2_i, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(av2_i)

end subroutine g_if_sigma_ocov_ocov_no0_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no0_x0_type0_noeri &
...
! S2(i,w,j,a) += (    2.00000000) Fc0 T2(a1,w,a0,a) D2(j,i,a1,a0) 
do s_a1 = 0, nir-1
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_ocov_ocov_no0_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no1_x0_type0_noeri &
  (sa, ia, Fc0, T2, S2, nir, nsym, psym, flops)
...
call set_symblock_av2(sa, T2, nir, nsym, psym) ! -> av2_i (allocate)
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no1_x0_type0_noeri &
  (sa, ia, Fc0, av2_i, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(av2_i)

end subroutine g_if_sigma_ocov_ocov_no1_x0_type0_noeri
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no1_x0_type0_noeri &
...
! S2(i,w,j,a) += (    2.00000000) Fc0 T2(a0,w,j,a) D1(i,a0) 
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ocov_ocov_no1_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no2_x0_type0_noeri &
...
call g_sigma_ocov_ocov_no2_x0_type0_noeri &
  (sa, ia, av2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_ocov_ocov_no2_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no2_x0_type0_noeri &
...
end subroutine g_sigma_ocov_ocov_no2_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no2_x1_type0_noeri &
...
call set_symblock_Xcaa(sleft, W0, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no2_x1_type0_noeri &
  (sa, ia, Xcaa, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_ocov_ocov_no2_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no2_x1_type0_noeri &
...
! S2(i,w,j,a) += (   -2.00000000) Fc1(w,c0) W0(c0,j,i,a) 
do s_w = 0, nir-1
do s_c0 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ocov_ocov_no2_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no3_x0_type0_noeri &
...
call g_sigma_ocov_ocov_no3_x0_type0_noeri &
  (Xaaaa, d3, fc1, nir, nsym, psym, flops)

deallocate(Xaaaa)

end subroutine g_if_sigma_ocov_ocov_no3_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no3_x0_type0_noeri &
...
end subroutine g_sigma_ocov_ocov_no3_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no3_x1_type0_noeri &
...
call set_symblock_Xaaaa(sleft, W1, nir, nsym, psym) ! -> Xaaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no3_x1_type0_noeri &
...
end subroutine g_if_sigma_ocov_ocov_no3_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no3_x1_type0_noeri &
...
integer :: s_a1, i_a1, s_w, i_w, s_a0, i_a0, s_j, i_j, s_i, i_i
! S2(i,w,j,a) += (    2.00000000) T2(a1,w,a0,a) W1(j,a1,i,a0) 
do s_a1 = 0, nir-1
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_ocov_ocov_no3_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no4_x0_type0_noeri &
...
call g_sigma_ocov_ocov_no4_x0_type0_noeri &
  (Xaaaa, d2, fc1, nir, nsym, psym, flops)

deallocate(Xaaaa)

end subroutine g_if_sigma_ocov_ocov_no4_x0_type0_noeri
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no4_x0_type0_noeri &
...
end subroutine g_sigma_ocov_ocov_no4_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no4_x1_type0_noeri &
...
call set_symblock_Xaaaa(sleft, W2, nir, nsym, psym) ! -> Xaaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no4_x1_type0_noeri &
  (sa, ia, av2_i, Xaaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ocov_ocov_no4_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no4_x1_type0_noeri &
...
! S2(i,w,j,a) += (    2.00000000) T2(a0,w,a1,a) W2(i,a1,a0,j) 
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ocov_ocov_no4_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no5_x0_type0_noeri &
...
call g_sigma_ocov_ocov_no5_x0_type0_noeri &
  (sa, ia, av2_i, Xcaa, d1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_ocov_ocov_no5_x0_type0_noeri
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no5_x0_type0_noeri &
...
end subroutine g_sigma_ocov_ocov_no5_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no5_x1_type0_noeri &
...
call set_symblock_Xcaa(sleft, W3, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no5_x1_type0_noeri &
  (sa, ia, Xcaa, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_ocov_ocov_no5_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no5_x1_type0_noeri &
...
! S2(i,w,j,a) += (   -2.00000000) Fc1(w,c0) W3(c0,i,j,a) 
do s_w = 0, nir-1
do s_c0 = 0, nir-1
do s_i = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_ocov_ocov_no5_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no6_x0_type0_noeri &
...
call g_sigma_ocov_ocov_no6_x0_type0_noeri &
  (Xaa, d2, fc1, nir, nsym, psym, flops)

deallocate(Xaa)

end subroutine g_if_sigma_ocov_ocov_no6_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no6_x0_type0_noeri &
...
end subroutine g_sigma_ocov_ocov_no6_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no6_x1_type0_noeri &
...
call set_symblock_Xaa(sleft, W4, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no6_x1_type0_noeri &
...
end subroutine g_if_sigma_ocov_ocov_no6_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no6_x1_type0_noeri &
...
integer :: s_a0, i_a0, s_w, i_w, s_j, i_j, s_i, i_i
! S2(i,w,j,a) += (    2.00000000) T2(a0,w,j,a) W4(i,a0) 
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ocov_ocov_no6_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no7_x0_type0_noeri &
...
call g_sigma_ocov_ocov_no7_x0_type0_noeri &
  (Xaaaa, d2, fc1, nir, nsym, psym, flops)

deallocate(Xaaaa)

end subroutine g_if_sigma_ocov_ocov_no7_x0_type0_noeri
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no7_x0_type0_noeri &
...
end subroutine g_sigma_ocov_ocov_no7_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no7_x1_type0_noeri &
...
call set_symblock_Xaaaa(sleft, W5, nir, nsym, psym) ! -> Xaaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no7_x1_type0_noeri &
  (sa, ia, av2_i, Xaaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ocov_ocov_no7_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no7_x1_type0_noeri &
...
! S2(i,w,j,a) += (    2.00000000) T2(a0,w,a1,a) W5(j,a0,i,a1) 
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_a1 = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_ocov_ocov_no7_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no8_x0_type0_noeri &
...
call g_sigma_ocov_ocov_no8_x0_type0_noeri &
  (sa, ia, av2_i, Xcaa, d1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_ocov_ocov_no8_x0_type0_noeri
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no8_x0_type0_noeri &
...
end subroutine g_sigma_ocov_ocov_no8_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no8_x1_type0_noeri &
...
call set_symblock_Xcaa(sleft, W6, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no8_x1_type0_noeri &
  (sa, ia, Xcaa, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_ocov_ocov_no8_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no8_x1_type0_noeri &
...
! S2(i,w,j,a) += (    2.00000000) Fc1(j,a1) W6(w,i,a1,a) 
do s_j = 0, nir-1
do s_a1 = 0, nir-1
do s_w = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ocov_ocov_no8_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no9_x0_type0_noeri &
...
call g_sigma_ocov_ocov_no9_x0_type0_noeri &
  (sa0, ia0, av2_i, Xcaav, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaav)

end subroutine g_if_sigma_ocov_ocov_no9_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no9_x0_type0_noeri &
...
end subroutine g_sigma_ocov_ocov_no9_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no9_x1_type0_noeri &
...
call set_symblock_Xcaav(sleft, W7, nir, nsym, psym) ! -> Xcaav (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no9_x1_type0_noeri &
  (sa, ia, Xcaav, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaav)

end subroutine g_if_sigma_ocov_ocov_no9_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no9_x1_type0_noeri &
...
! S2(i,w,j,a) += (    2.00000000) Fc1(v0,a) W7(w,j,i,v0) 
do s_v0 = 0, nir-1
do s_w = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ocov_ocov_no9_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no10_x0_type0_noeri &
...
call g_sigma_ocov_ocov_no10_x0_type0_noeri &
  (sj, ij, av2_i, Xcav, d1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcav)

end subroutine g_if_sigma_ocov_ocov_no10_x0_type0_noeri
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no10_x0_type0_noeri &
...
end subroutine g_sigma_ocov_ocov_no10_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no10_x1_type0_noeri &
...
call set_symblock_Xcav(sleft, W8, nir, nsym, psym) ! -> Xcav (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no10_x1_type0_noeri &
  (sa, ia, sj, ij, Xcav, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcav)

end subroutine g_if_sigma_ocov_ocov_no10_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no10_x1_type0_noeri &
...
! S2(i,w,j,a) += (    2.00000000) Fc1(v0,a) W8(w,i,j,v0) 
do s_v0 = 0, nir-1
do s_w = 0, nir-1
do s_i = 0, nir-1
if( &
...
end subroutine g_sigma_ocov_ocov_no10_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no11_x0_type0_noeri &
...
call set_symblock_av2(sa, T2, nir, nsym, psym) ! -> av2_i (allocate)
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no11_x0_type0_noeri &
  (sa, ia, av2_i, av2_i2, c4f, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(av2_i)

end subroutine g_if_sigma_ocov_ocov_no11_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no11_x0_type0_noeri &
...
! S2(i,w,j,a) += (    1.00000000) T2(a1,w,a0,a) C4(a0,a1,i,j) 
do s_a1 = 0, nir-1
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ocov_ocov_no11_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no0_x0_type1_eri_c &
...
call g_sigma_ocov_ocov_no0_x0_type1_eri_c &
  (sw, iw, h2_i, Xcaaaa, d3, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xcaaaa)

end subroutine g_if_sigma_ocov_ocov_no0_x0_type1_eri_c
...
! >> Score :: 111111
! The best shot!
! RDM is rotated :: D3(j,i,a2,a3,a1,a0)  >> D3(a3,a2,a0,a1,i,j) 
! rowInd : @[j, "active"] @[i, "active"] @[a1, "active"] @[a0, "active"] 
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no0_x0_type1_eri_c &
...
! W9(w,c0,j,a1,i,a0) += (    1.00000000) V2(w,a3,c0,a2) D3(j,i,a2,a3,a1,a0) 
do s_a3 = 0, nir-1
do s_c0 = 0, nir-1
do s_a2 = 0, nir-1
do s_j = 0, nir-1
...
call dgemm('n', 'n', psym(I_LENGTH,I_O, s_j)*psym(I_LENGTH,I_O, s_i)*psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_a0),&
                     ...
                     1.00000000d+00, &
                     D3_(s_j, s_i, s_a1, s_a0, s_a2, s_a3)%array,&
                     psym(I_LENGTH,I_O, s_j)*psym(I_LENGTH,I_O, s_i)*psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_a0),&
                     Z2_,&
                     psym(I_LENGTH,I_O, s_a2)*psym(I_LENGTH,I_O, s_a3),&
                     0.0d+00,&
...
end subroutine g_sigma_ocov_ocov_no0_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no0_x1_type1_eri_c &
...
call set_symblock_Xcaaaa(sleft, W9, nir, nsym, psym) ! -> Xcaaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no0_x1_type1_eri_c &
...
end subroutine g_if_sigma_ocov_ocov_no0_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no0_x1_type1_eri_c &
...
integer :: s_a1, i_a1, s_c0, i_c0, s_a0, i_a0, s_j, i_j, s_i, i_i
! S2(i,w,j,a) += (    1.00000000) T2(a1,c0,a0,a) W9(w,c0,j,a1,i,a0) 
do s_a1 = 0, nir-1
do s_c0 = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_ocov_ocov_no0_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no1_x0_type1_eri_c &
...
call g_sigma_ocov_ocov_no1_x0_type1_eri_c &
  (sw, iw, h2_i, Xcaaaa, d3, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xcaaaa)

end subroutine g_if_sigma_ocov_ocov_no1_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no1_x0_type1_eri_c &
...
end subroutine g_sigma_ocov_ocov_no1_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no1_x1_type1_eri_c &
...
call set_symblock_Xcaaaa(sleft, W10, nir, nsym, psym) ! -> Xcaaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no1_x1_type1_eri_c &
  (sa, ia, sw, iw, av2_i, Xcaaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ocov_ocov_no1_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no1_x1_type1_eri_c &
...
integer :: s_a1, i_a1, s_c0, i_c0, s_a0, i_a0, s_j, i_j, s_i, i_i
! S2(i,w,j,a) += (   -2.00000000) T2(a1,c0,a0,a) W10(w,c0,j,a1,i,a0) 
do s_a1 = 0, nir-1
do s_c0 = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_ocov_ocov_no1_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no2_x0_type1_eri_c &
...
call g_sigma_ocov_ocov_no2_x0_type1_eri_c &
  (sa, ia, sc0, ic0, av2_i, Xaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xaa)

end subroutine g_if_sigma_ocov_ocov_no2_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no2_x0_type1_eri_c &
...
end subroutine g_sigma_ocov_ocov_no2_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no2_x1_type1_eri_c &
...
call set_symblock_Xaa(sleft, W11, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no2_x1_type1_eri_c &
...
end subroutine g_if_sigma_ocov_ocov_no2_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no2_x1_type1_eri_c &
...
end subroutine g_sigma_ocov_ocov_no2_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no3_x0_type1_eri_c &
...
call g_sigma_ocov_ocov_no3_x0_type1_eri_c &
  (sa, ia, sc0, ic0, av2_i, Xaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xaa)

end subroutine g_if_sigma_ocov_ocov_no3_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no3_x0_type1_eri_c &
...
end subroutine g_sigma_ocov_ocov_no3_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no3_x1_type1_eri_c &
...
call set_symblock_Xaa(sleft, W12, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no3_x1_type1_eri_c &
  (sa, ia, sc0, ic0, h2_i, Xaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ocov_ocov_no3_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no3_x1_type1_eri_c &
...
! S2(i,w,j,a) += (   -2.00000000) V2(c0,w,j,a2) W12(c0,i,a2,a) 
do s_w = 0, nir-1
do s_j = 0, nir-1
do s_a2 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ocov_ocov_no3_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no4_x0_type1_eri_c &
...
call g_sigma_ocov_ocov_no4_x0_type1_eri_c &
  (sw, iw, h2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_ocov_ocov_no4_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no4_x0_type1_eri_c &
...
end subroutine g_sigma_ocov_ocov_no4_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no4_x1_type1_eri_c &
...
call set_symblock_Xcaa(sleft, W14, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no4_x1_type1_eri_c &
...
end subroutine g_if_sigma_ocov_ocov_no4_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no4_x1_type1_eri_c &
...
integer :: s_a0, i_a0, s_c0, i_c0, s_j, i_j, s_i, i_i
! S2(i,w,j,a) += (    1.00000000) T2(a0,c0,j,a) W14(w,c0,i,a0) 
do s_a0 = 0, nir-1
do s_c0 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ocov_ocov_no4_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no5_x0_type1_eri_c &
...
call g_sigma_ocov_ocov_no5_x0_type1_eri_c &
  (sw, iw, h2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_ocov_ocov_no5_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no5_x0_type1_eri_c &
...
end subroutine g_sigma_ocov_ocov_no5_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no5_x1_type1_eri_c &
...
call set_symblock_Xcaa(sleft, W15, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no5_x1_type1_eri_c &
  (sa, ia, sw, iw, av2_i, Xcaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ocov_ocov_no5_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no5_x1_type1_eri_c &
...
integer :: s_a0, i_a0, s_c0, i_c0, s_j, i_j, s_i, i_i
! S2(i,w,j,a) += (   -2.00000000) T2(a0,c0,j,a) W15(w,c0,i,a0) 
do s_a0 = 0, nir-1
do s_c0 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ocov_ocov_no5_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no6_x0_type1_eri_c &
...
call g_sigma_ocov_ocov_no6_x0_type1_eri_c &
...
end subroutine g_if_sigma_ocov_ocov_no6_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no6_x0_type1_eri_c &
...
end subroutine g_sigma_ocov_ocov_no6_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no6_x1_type1_eri_c &
...
call set_symblock_Xaa(sleft, W17, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no6_x1_type1_eri_c &
  (sa, ia, sw, iw, Xaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaa)

end subroutine g_if_sigma_ocov_ocov_no6_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no6_x1_type1_eri_c &
...
! S2(i,w,j,a) += (    1.00000000) D2(j,i,a0,a2) W17(w,a0,a2,a) 
do s_j = 0, nir-1
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_a2 = 0, nir-1
...
end subroutine g_sigma_ocov_ocov_no6_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no7_x0_type1_eri_c &
...
call g_sigma_ocov_ocov_no7_x0_type1_eri_c &
  (sa, ia, sw, iw, av2_i, h2_i, Xaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ocov_ocov_no7_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no7_x0_type1_eri_c &
...
end subroutine g_sigma_ocov_ocov_no7_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no7_x1_type1_eri_c &
...
call set_symblock_Xaa(sleft, W18, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no7_x1_type1_eri_c &
  (sa, ia, sw, iw, Xaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaa)

end subroutine g_if_sigma_ocov_ocov_no7_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no7_x1_type1_eri_c &
...
integer :: s_j, i_j, s_i, i_i, s_a0, i_a0, s_a2, i_a2
! S2(i,w,j,a) += (   -2.00000000) D2(j,i,a0,a2) W18(w,a0,a2,a) 
do s_j = 0, nir-1
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_a2 = 0, nir-1
...
end subroutine g_sigma_ocov_ocov_no7_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no8_x0_type1_eri_c &
...
call g_sigma_ocov_ocov_no8_x0_type1_eri_c &
  (sa, ia, sw, iw, av2_i, h2_i, Xaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ocov_ocov_no8_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no8_x0_type1_eri_c &
...
end subroutine g_sigma_ocov_ocov_no8_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no8_x1_type1_eri_c &
...
call set_symblock_Xaa(sleft, W20, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no8_x1_type1_eri_c &
  (sa, ia, sw, iw, Xaa, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaa)

end subroutine g_if_sigma_ocov_ocov_no8_x1_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no8_x1_type1_eri_c &
...
end subroutine g_sigma_ocov_ocov_no8_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no9_x0_type1_eri_c &
...
call g_sigma_ocov_ocov_no9_x0_type1_eri_c &
  (sa, ia, sw, iw, av2_i, h2_i, Xaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ocov_ocov_no9_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no9_x0_type1_eri_c &
...
end subroutine g_sigma_ocov_ocov_no9_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no9_x1_type1_eri_c &
...
call set_symblock_Xaa(sleft, W22, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no9_x1_type1_eri_c &
  (sa, ia, sw, iw, Xaa, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaa)

end subroutine g_if_sigma_ocov_ocov_no9_x1_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no9_x1_type1_eri_c &
...
integer :: s_i, i_i, s_a0, i_a0, s_j, i_j
! S2(i,w,j,a) += (   -2.00000000) D1(i,a0) W22(w,a0,j,a) 
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
if( &
...
end subroutine g_sigma_ocov_ocov_no9_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no0_x0_type1_eri_o &
...
call g_sigma_ocov_ocov_no0_x0_type1_eri_o &
  (sj, ij, h2_i, Xaaa, d3, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_ocov_ocov_no0_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no0_x0_type1_eri_o &
...
end subroutine g_sigma_ocov_ocov_no0_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no0_x1_type1_eri_o &
...
call set_symblock_Xaaa(sleft, W13, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no0_x1_type1_eri_o &
...
end subroutine g_if_sigma_ocov_ocov_no0_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no0_x1_type1_eri_o &
...
integer :: s_a0, i_a0, s_w, i_w, s_a1, i_a1, s_i, i_i
! S2(i,w,j,a) += (    2.00000000) T2(a0,w,a1,a) W13(i,a1,a0,j) 
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ocov_ocov_no0_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no1_x0_type1_eri_o &
...
call g_sigma_ocov_ocov_no1_x0_type1_eri_o &
  (sa4, ia4, h2_i, Xaa, d3, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaa)

end subroutine g_if_sigma_ocov_ocov_no1_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no1_x0_type1_eri_o &
...
end subroutine g_sigma_ocov_ocov_no1_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no2_x0_type1_eri_o &
...
call g_sigma_ocov_ocov_no2_x0_type1_eri_o &
  (sa1, ia1, h2_i, Xaaa, d3, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_ocov_ocov_no2_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no2_x0_type1_eri_o &
...
end subroutine g_sigma_ocov_ocov_no2_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no2_x1_type1_eri_o &
...
call set_symblock_Xaaa(sleft, W19, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no2_x1_type1_eri_o &
...
end subroutine g_if_sigma_ocov_ocov_no2_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no2_x1_type1_eri_o &
...
! S2(i,w,j,a) += (    2.00000000) T2(w,a0,a,a1) W19(j,a0,i,a1) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ocov_ocov_no2_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no3_x0_type1_eri_o &
...
call g_sigma_ocov_ocov_no3_x0_type1_eri_o &
  (sj, ij, h2_i, Xaaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_ocov_ocov_no3_x0_type1_eri_o
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no3_x0_type1_eri_o &
...
end subroutine g_sigma_ocov_ocov_no3_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no3_x1_type1_eri_o &
...
call set_symblock_Xaaa(sleft, W21, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no3_x1_type1_eri_o &
  (sa, ia, sj, ij, av2_i, Xaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ocov_ocov_no3_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no3_x1_type1_eri_o &
...
integer :: s_a0, i_a0, s_w, i_w, s_a1, i_a1, s_i, i_i
! S2(i,w,j,a) += (    2.00000000) T2(a0,w,a1,a) W21(i,a0,j,a1) 
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ocov_ocov_no3_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no4_x0_type1_eri_o &
...
call g_sigma_ocov_ocov_no4_x0_type1_eri_o &
  (sj, ij, h2_i, Xaaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_ocov_ocov_no4_x0_type1_eri_o
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no4_x0_type1_eri_o &
...
end subroutine g_sigma_ocov_ocov_no4_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no4_x1_type1_eri_o &
...
call set_symblock_Xaaa(sleft, W23, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no4_x1_type1_eri_o &
  (sa, ia, sj, ij, av2_i, Xaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ocov_ocov_no4_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no4_x1_type1_eri_o &
...
! S2(i,w,j,a) += (    2.00000000) T2(a0,w,a2,a) W23(i,a0,j,a2) 
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_a2 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ocov_ocov_no4_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no0_x0_type2_eri_o &
...
call set_symblock_Xaa(sleft, W16, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no0_x0_type2_eri_o &
  (sa, ia, av2_i, Xaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ocov_ocov_no0_x0_type2_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no0_x0_type2_eri_o &
...
integer :: s_a0, i_a0, s_w, i_w, s_j, i_j, s_i, i_i
! S2(i,w,j,a) += (    1.00000000) T2(a0,w,j,a) W16(i,a0) 
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ocov_ocov_no0_x0_type2_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no0_x0_type1_eri_v &
...
call g_sigma_ocov_ocov_no0_x0_type1_eri_v &
...
end subroutine g_if_sigma_ocov_ocov_no0_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no0_x0_type1_eri_v &
...
end subroutine g_sigma_ocov_ocov_no0_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no0_x1_type1_eri_v &
...
call set_symblock_Xca(sleft, W24, nir, nsym, psym) ! -> Xca (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no0_x1_type1_eri_v &
  (sa, ia, sa0, ia0, Xca, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xca)

end subroutine g_if_sigma_ocov_ocov_no0_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no0_x1_type1_eri_v &
...
! S2(i,w,j,a) += (    4.00000000) D2(j,i,a1,a0) W24(w,a1,a0,a) 
do s_j = 0, nir-1
do s_i = 0, nir-1
do s_a1 = 0, nir-1
do s_w = 0, nir-1
...
end subroutine g_sigma_ocov_ocov_no0_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no1_x0_type1_eri_v &
...
call g_sigma_ocov_ocov_no1_x0_type1_eri_v &
...
end subroutine g_if_sigma_ocov_ocov_no1_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no1_x0_type1_eri_v &
...
end subroutine g_sigma_ocov_ocov_no1_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no1_x1_type1_eri_v &
...
call set_symblock_Xcaaa(sleft, W25, nir, nsym, psym) ! -> Xcaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no1_x1_type1_eri_v &
  (sa, ia, sa0, ia0, Xcaaa, av2_i2, d3, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaaa)

end subroutine g_if_sigma_ocov_ocov_no1_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no1_x1_type1_eri_v &
...
integer :: s_j, i_j, s_i, i_i, s_a3, i_a3, s_a2, i_a2, s_a1, i_a1
integer :: s_w, i_w
! S2(i,w,j,a) += (   -1.00000000) D3(j,i,a3,a2,a1,a0) W25(w,a1,a0,a3,a2,a) 
do s_j = 0, nir-1
do s_i = 0, nir-1
do s_a3 = 0, nir-1
do s_a2 = 0, nir-1
...
end subroutine g_sigma_ocov_ocov_no1_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no2_x0_type1_eri_v &
...
call g_sigma_ocov_ocov_no2_x0_type1_eri_v &
  (sa, ia, sa0, ia0, av2_i, h2_i, Xca, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ocov_ocov_no2_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no2_x0_type1_eri_v &
...
end subroutine g_sigma_ocov_ocov_no2_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no2_x1_type1_eri_v &
...
call set_symblock_Xca(sleft, W26, nir, nsym, psym) ! -> Xca (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no2_x1_type1_eri_v &
  (sa, ia, sa0, ia0, Xca, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xca)

end subroutine g_if_sigma_ocov_ocov_no2_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no2_x1_type1_eri_v &
...
end subroutine g_sigma_ocov_ocov_no2_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no3_x0_type1_eri_v &
...
call g_sigma_ocov_ocov_no3_x0_type1_eri_v &
  (sa, ia, sa0, ia0, av2_i, h2_i, Xcaaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ocov_ocov_no3_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no3_x0_type1_eri_v &
...
end subroutine g_sigma_ocov_ocov_no3_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no3_x1_type1_eri_v &
...
call set_symblock_Xcaaa(sleft, W27, nir, nsym, psym) ! -> Xcaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no3_x1_type1_eri_v &
  (sa, ia, sa0, ia0, Xcaaa, av2_i2, d3, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaaa)

end subroutine g_if_sigma_ocov_ocov_no3_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no3_x1_type1_eri_v &
...
integer :: s_j, i_j, s_i, i_i, s_a3, i_a3, s_a2, i_a2, s_a1, i_a1
integer :: s_w, i_w
! S2(i,w,j,a) += (    2.00000000) D3(j,i,a3,a2,a1,a0) W27(w,a1,a0,a3,a2,a) 
do s_j = 0, nir-1
do s_i = 0, nir-1
do s_a3 = 0, nir-1
do s_a2 = 0, nir-1
...
end subroutine g_sigma_ocov_ocov_no3_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no4_x0_type1_eri_v &
...
call g_sigma_ocov_ocov_no4_x0_type1_eri_v &
  (sv0, iv0, av2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_ocov_ocov_no4_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no4_x0_type1_eri_v &
...
end subroutine g_sigma_ocov_ocov_no4_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no4_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W28, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no4_x1_type1_eri_v &
...
end subroutine g_if_sigma_ocov_ocov_no4_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no4_x1_type1_eri_v &
...
! S2(i,w,j,a) += (    2.00000000) V2(v0,a,j,a2) W28(w,i,a2,v0) 
do s_j = 0, nir-1
do s_a2 = 0, nir-1
do s_w = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ocov_ocov_no4_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no5_x0_type1_eri_v &
...
call g_sigma_ocov_ocov_no5_x0_type1_eri_v &
...
end subroutine g_if_sigma_ocov_ocov_no5_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no5_x0_type1_eri_v &
...
end subroutine g_sigma_ocov_ocov_no5_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no5_x1_type1_eri_v &
...
call set_symblock_Xca(sleft, W29, nir, nsym, psym) ! -> Xca (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no5_x1_type1_eri_v &
  (sa, ia, sj, ij, Xca, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xca)

end subroutine g_if_sigma_ocov_ocov_no5_x1_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no5_x1_type1_eri_v &
...
! S2(i,w,j,a) += (    4.00000000) D1(i,a0) W29(w,a0,j,a) 
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_w = 0, nir-1
if( &
...
end subroutine g_sigma_ocov_ocov_no5_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no6_x0_type1_eri_v &
...
call g_sigma_ocov_ocov_no6_x0_type1_eri_v &
  (sa, ia, sv0, iv0, h2_i, Xaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaa)

end subroutine g_if_sigma_ocov_ocov_no6_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no6_x0_type1_eri_v &
...
! W30(i,a0,v0,a) += (    1.00000000) V2(v0,a1,a2,a) D2(i,a0,a1,a2) 
do s_a1 = 0, nir-1
do s_a2 = 0, nir-1
do s_i = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_ocov_ocov_no6_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no6_x1_type1_eri_v &
...
call set_symblock_Xaa(sleft, W30, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no6_x1_type1_eri_v &
...
end subroutine g_if_sigma_ocov_ocov_no6_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no6_x1_type1_eri_v &
...
integer :: s_a0, i_a0, s_w, i_w, s_j, i_j, s_i, i_i
! S2(i,w,j,a) += (   -1.00000000) T2(a0,w,j,v0) W30(i,a0,v0,a) 
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ocov_ocov_no6_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no7_x0_type1_eri_v &
...
call g_sigma_ocov_ocov_no7_x0_type1_eri_v &
  (sa, ia, sj, ij, av2_i, h2_i, Xca, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ocov_ocov_no7_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no7_x0_type1_eri_v &
...
end subroutine g_sigma_ocov_ocov_no7_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no7_x1_type1_eri_v &
...
call set_symblock_Xca(sleft, W31, nir, nsym, psym) ! -> Xca (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no7_x1_type1_eri_v &
  (sa, ia, sj, ij, Xca, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xca)

end subroutine g_if_sigma_ocov_ocov_no7_x1_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no7_x1_type1_eri_v &
...
end subroutine g_sigma_ocov_ocov_no7_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no8_x0_type1_eri_v &
...
call g_sigma_ocov_ocov_no8_x0_type1_eri_v &
  (sa, ia, sv0, iv0, h2_i, Xaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaa)

end subroutine g_if_sigma_ocov_ocov_no8_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no8_x0_type1_eri_v &
...
end subroutine g_sigma_ocov_ocov_no8_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no8_x1_type1_eri_v &
...
call set_symblock_Xaa(sleft, W32, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no8_x1_type1_eri_v &
  (sa, ia, sv0, iv0, av2_i, Xaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ocov_ocov_no8_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no8_x1_type1_eri_v &
...
integer :: s_a0, i_a0, s_w, i_w, s_j, i_j, s_i, i_i
! S2(i,w,j,a) += (    2.00000000) T2(a0,w,j,v0) W32(i,a0,v0,a) 
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_ocov_ocov_no8_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no9_x0_type1_eri_v &
...
call g_sigma_ocov_ocov_no9_x0_type1_eri_v &
  (sv0, iv0, av2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_ocov_ocov_no9_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no9_x0_type1_eri_v &
...
end subroutine g_sigma_ocov_ocov_no9_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no9_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W33, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no9_x1_type1_eri_v &
  (sa, ia, sv0, iv0, h2_i, Xcaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ocov_ocov_no9_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no9_x1_type1_eri_v &
...
end subroutine g_sigma_ocov_ocov_no9_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no10_x0_type1_eri_v &
...
call g_sigma_ocov_ocov_no10_x0_type1_eri_v &
...
end subroutine g_if_sigma_ocov_ocov_no10_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no10_x0_type1_eri_v &
...
end subroutine g_sigma_ocov_ocov_no10_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no10_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W34, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no10_x1_type1_eri_v &
  (sa, ia, Xcaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_ocov_ocov_no10_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no10_x1_type1_eri_v &
...
! S2(i,w,j,a) += (   -1.00000000) D2(j,i,a0,a1) W34(w,a0,a1,a) 
do s_j = 0, nir-1
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
...
end subroutine g_sigma_ocov_ocov_no10_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no11_x0_type1_eri_v &
...
call g_sigma_ocov_ocov_no11_x0_type1_eri_v &
...
end subroutine g_if_sigma_ocov_ocov_no11_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no11_x0_type1_eri_v &
...
end subroutine g_sigma_ocov_ocov_no11_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no11_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W35, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no11_x1_type1_eri_v &
  (sa, ia, Xcaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_ocov_ocov_no11_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no11_x1_type1_eri_v &
...
! S2(i,w,j,a) += (    2.00000000) D2(j,i,a0,a2) W35(w,a0,a2,a) 
do s_j = 0, nir-1
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_a2 = 0, nir-1
...
end subroutine g_sigma_ocov_ocov_no11_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no12_x0_type1_eri_v &
...
call g_sigma_ocov_ocov_no12_x0_type1_eri_v &
  (sa, ia, sa1, ia1, av2_i, h2_i, Xcaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ocov_ocov_no12_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no12_x0_type1_eri_v &
...
end subroutine g_sigma_ocov_ocov_no12_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no12_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W36, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no12_x1_type1_eri_v &
  (sa, ia, Xcaa, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_ocov_ocov_no12_x1_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no12_x1_type1_eri_v &
...
! S2(i,w,j,a) += (    2.00000000) D1(i,a0) W36(w,a0,j,a) 
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_ocov_ocov_no12_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no13_x0_type1_eri_v &
...
call g_sigma_ocov_ocov_no13_x0_type1_eri_v &
  (sa, ia, sa1, ia1, av2_i, h2_i, Xcaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ocov_ocov_no13_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no13_x0_type1_eri_v &
...
end subroutine g_sigma_ocov_ocov_no13_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ocov_ocov_no13_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W37, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ocov_ocov_no13_x1_type1_eri_v &
  (sa, ia, Xcaa, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_ocov_ocov_no13_x1_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ocov_ocov_no13_x1_type1_eri_v &
...
integer :: s_i, i_i, s_a0, i_a0, s_w, i_w, s_j, i_j
! S2(i,w,j,a) += (   -1.00000000) D1(i,a0) W37(w,a0,j,a) 
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_ocov_ocov_no13_x1_type1_eri_v
