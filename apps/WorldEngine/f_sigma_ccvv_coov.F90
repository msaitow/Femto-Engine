...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no0_x0_type0_noeri &
...
call g_sigma_ccvv_coov_no0_x0_type0_noeri &
  (sb, ib, av2_i, Xc, d1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xc)

end subroutine g_if_sigma_ccvv_coov_no0_x0_type0_noeri
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no0_x0_type0_noeri &
...
! W0(x,b) += (    1.00000000) T2(x,a1,a0,b) D1(a1,a0) 
do s_x = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
if( &
...
end subroutine g_sigma_ccvv_coov_no0_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no0_x1_type0_noeri &
...
call g_sigma_ccvv_coov_no0_x1_type0_noeri &
  (sb, ib, Xc, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xc)

end subroutine g_if_sigma_ccvv_coov_no0_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no0_x1_type0_noeri &
...
! S2(w,x,a,b) += (   -2.00000000) Fc1(w,a) W0(x,b) 
do s_w = 0, nir-1
do s_a = 0, nir-1
do s_x = 0, nir-1
if( &
...
end subroutine g_sigma_ccvv_coov_no0_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no1_x0_type0_noeri &
...
call g_sigma_ccvv_coov_no1_x0_type0_noeri &
  (sb, ib, av2_i, Xc, d1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xc)

end subroutine g_if_sigma_ccvv_coov_no1_x0_type0_noeri
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no1_x0_type0_noeri &
...
! W1(w,b) += (    1.00000000) T2(w,a1,a0,b) D1(a1,a0) 
do s_w = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
if( &
...
end subroutine g_sigma_ccvv_coov_no1_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no1_x1_type0_noeri &
...
call set_symblock_Xc(sleft, W1, nir, nsym, psym) ! -> Xc (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccvv_coov_no1_x1_type0_noeri &
  (sb, ib, Xc, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xc)

end subroutine g_if_sigma_ccvv_coov_no1_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no1_x1_type0_noeri &
...
! S2(w,x,a,b) += (    1.00000000) Fc1(x,a) W1(w,b) 
do s_x = 0, nir-1
do s_a = 0, nir-1
do s_w = 0, nir-1
if( &
...
end subroutine g_sigma_ccvv_coov_no1_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no2_x0_type0_noeri &
...
call g_sigma_ccvv_coov_no2_x0_type0_noeri &
  (sa, ia, av2_i, Xc, d1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xc)

end subroutine g_if_sigma_ccvv_coov_no2_x0_type0_noeri
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no2_x0_type0_noeri &
...
end subroutine g_sigma_ccvv_coov_no2_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no2_x1_type0_noeri &
...
call set_symblock_Xc(sleft, W2, nir, nsym, psym) ! -> Xc (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccvv_coov_no2_x1_type0_noeri &
  (sa, ia, sb, ib, Xc, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xc)

end subroutine g_if_sigma_ccvv_coov_no2_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no2_x1_type0_noeri &
...
integer :: s_w, i_w, s_x, i_x
! S2(w,x,a,b) += (    1.00000000) Fc1(w,b) W2(x,a) 
do s_w = 0, nir-1
do s_x = 0, nir-1
if( &
IEOR(s_w,s_x) == IEOR(s_a,s_b) .and. & 
...
end subroutine g_sigma_ccvv_coov_no2_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no3_x0_type0_noeri &
...
call g_sigma_ccvv_coov_no3_x0_type0_noeri &
  (sa, ia, av2_i, Xc, d1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xc)

end subroutine g_if_sigma_ccvv_coov_no3_x0_type0_noeri
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no3_x0_type0_noeri &
...
end subroutine g_sigma_ccvv_coov_no3_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no3_x1_type0_noeri &
...
call set_symblock_Xc(sleft, W3, nir, nsym, psym) ! -> Xc (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccvv_coov_no3_x1_type0_noeri &
  (sa, ia, sb, ib, Xc, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xc)

end subroutine g_if_sigma_ccvv_coov_no3_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no3_x1_type0_noeri &
  (s_a, i_a, s_b, i_b, W3_, S2_, Fc1_, nir, nsym, psym, flops)
...
integer :: s_x, i_x, s_w, i_w
! S2(w,x,a,b) += (   -2.00000000) Fc1(x,b) W3(w,a) 
do s_x = 0, nir-1
do s_w = 0, nir-1
if( &
IEOR(s_w,s_x) == IEOR(s_a,s_b) .and. & 
...
end subroutine g_sigma_ccvv_coov_no3_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no0_x0_type1_eri_c &
...
call g_sigma_ccvv_coov_no0_x0_type1_eri_c &
  (sb, ib, sc0, ic0, av2_i, W4, d1, nir, nsym, psym, flops)

deallocate(av2_i)

end subroutine g_if_sigma_ccvv_coov_no0_x0_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no0_x0_type1_eri_c &
...
! W4(c0,b) += (    1.00000000) T2(c0,a1,a0,b) D1(a1,a0) 
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
if( &
IEOR(s_c0,s_b) == 0 .and. & 
IEOR(s_c0,s_a1) == IEOR(s_a0,s_b) .and. &
IEOR(s_a1,s_a0) == 0) then
...
end subroutine g_sigma_ccvv_coov_no0_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no0_x1_type1_eri_c &
...
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccvv_coov_no0_x1_type1_eri_c &
  (sb, ib, sc0, ic0, h2_i, W4, av2_i2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(h2_i)

end subroutine g_if_sigma_ccvv_coov_no0_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no0_x1_type1_eri_c &
...
! S2(w,x,a,b) += (   -1.00000000) V2(c0,w,x,a) W4(c0,b) 
do s_w = 0, nir-1
do s_x = 0, nir-1
do s_a = 0, nir-1
if( &
...
end subroutine g_sigma_ccvv_coov_no0_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no1_x0_type1_eri_c &
...
call g_sigma_ccvv_coov_no1_x0_type1_eri_c &
  (sb, ib, sc0, ic0, av2_i, W5, d1, nir, nsym, psym, flops)

deallocate(av2_i)

end subroutine g_if_sigma_ccvv_coov_no1_x0_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no1_x0_type1_eri_c &
...
integer :: s_a1, i_a1, s_a0, i_a0
! W5(c0,b) += (    1.00000000) T2(c0,a1,a0,b) D1(a1,a0) 
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
if( &
IEOR(s_c0,s_b) == 0 .and. & 
...
end subroutine g_sigma_ccvv_coov_no1_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no1_x1_type1_eri_c &
...
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccvv_coov_no1_x1_type1_eri_c &
  (sb, ib, sc0, ic0, h2_i, W5, av2_i2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(h2_i)

end subroutine g_if_sigma_ccvv_coov_no1_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no1_x1_type1_eri_c &
...
! S2(w,x,a,b) += (    2.00000000) V2(c0,x,w,a) W5(c0,b) 
do s_x = 0, nir-1
do s_w = 0, nir-1
do s_a = 0, nir-1
if( &
...
end subroutine g_sigma_ccvv_coov_no1_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no2_x0_type1_eri_c &
...
call g_sigma_ccvv_coov_no2_x0_type1_eri_c &
  (sx, ix, h2_i, Xaav, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaav)

end subroutine g_if_sigma_ccvv_coov_no2_x0_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no2_x0_type1_eri_c &
  (s_x, i_x, V2_, W6_, D2_, nir, nsym, psym, flops)
...
! W6(x,a1,a0,a) += (    1.00000000) V2(x,a,a3,a2) D2(a3,a2,a1,a0) 
do s_a = 0, nir-1
do s_a3 = 0, nir-1
do s_a2 = 0, nir-1
do s_a1 = 0, nir-1
...
end subroutine g_sigma_ccvv_coov_no2_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no2_x1_type1_eri_c &
...
call set_symblock_Xaav(sleft, W6, nir, nsym, psym) ! -> Xaav (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccvv_coov_no2_x1_type1_eri_c &
...
end subroutine g_if_sigma_ccvv_coov_no2_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no2_x1_type1_eri_c &
...
integer :: s_w, i_w, s_a1, i_a1, s_a0, i_a0, s_a, i_a
! S2(w,x,a,b) += (    1.00000000) T2(w,a1,a0,b) W6(x,a1,a0,a) 
do s_w = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_a = 0, nir-1
...
end subroutine g_sigma_ccvv_coov_no2_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no3_x0_type1_eri_c &
...
call g_sigma_ccvv_coov_no3_x0_type1_eri_c &
  (sw, iw, h2_i, Xaav, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaav)

end subroutine g_if_sigma_ccvv_coov_no3_x0_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no3_x0_type1_eri_c &
  (s_w, i_w, V2_, W7_, D2_, nir, nsym, psym, flops)
...
integer :: s_a, i_a, s_a3, i_a3, s_a2, i_a2, s_a1, i_a1, s_a0, i_a0
! W7(w,a1,a0,a) += (    1.00000000) V2(w,a,a3,a2) D2(a3,a2,a1,a0) 
do s_a = 0, nir-1
do s_a3 = 0, nir-1
do s_a2 = 0, nir-1
do s_a1 = 0, nir-1
...
end subroutine g_sigma_ccvv_coov_no3_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no3_x1_type1_eri_c &
...
call set_symblock_Xaav(sleft, W7, nir, nsym, psym) ! -> Xaav (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccvv_coov_no3_x1_type1_eri_c &
...
end subroutine g_if_sigma_ccvv_coov_no3_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no3_x1_type1_eri_c &
...
integer :: s_x, i_x, s_a1, i_a1, s_a0, i_a0, s_a, i_a
! S2(w,x,a,b) += (   -2.00000000) T2(x,a1,a0,b) W7(w,a1,a0,a) 
do s_x = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_a = 0, nir-1
...
end subroutine g_sigma_ccvv_coov_no3_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no4_x0_type1_eri_c &
...
call g_sigma_ccvv_coov_no4_x0_type1_eri_c &
  (sx, ix, h2_i, Xaav, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaav)

end subroutine g_if_sigma_ccvv_coov_no4_x0_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no4_x0_type1_eri_c &
  (s_x, i_x, V2_, W8_, D2_, nir, nsym, psym, flops)
...
integer :: s_a2, i_a2, s_a3, i_a3, s_a, i_a, s_a0, i_a0, s_a1, i_a1
! W8(x,a1,a0,a) += (    1.00000000) V2(x,a2,a3,a) D2(a3,a0,a1,a2) 
do s_a2 = 0, nir-1
do s_a3 = 0, nir-1
do s_a = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_ccvv_coov_no4_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no4_x1_type1_eri_c &
...
call set_symblock_Xaav(sleft, W8, nir, nsym, psym) ! -> Xaav (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccvv_coov_no4_x1_type1_eri_c &
  (sb, ib, sx, ix, av2_i, Xaav, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccvv_coov_no4_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no4_x1_type1_eri_c &
...
integer :: s_w, i_w, s_a1, i_a1, s_a0, i_a0, s_a, i_a
! S2(w,x,a,b) += (    1.00000000) T2(w,a1,a0,b) W8(x,a1,a0,a) 
do s_w = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_a = 0, nir-1
...
end subroutine g_sigma_ccvv_coov_no4_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no5_x0_type1_eri_c &
...
call g_sigma_ccvv_coov_no5_x0_type1_eri_c &
  (sw, iw, h2_i, Xaav, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaav)

end subroutine g_if_sigma_ccvv_coov_no5_x0_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no5_x0_type1_eri_c &
...
! W9(w,a1,a0,a) += (    1.00000000) V2(w,a2,a3,a) D2(a3,a2,a1,a0) 
do s_a2 = 0, nir-1
do s_a3 = 0, nir-1
do s_a = 0, nir-1
do s_a1 = 0, nir-1
...
end subroutine g_sigma_ccvv_coov_no5_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no5_x1_type1_eri_c &
...
call set_symblock_Xaav(sleft, W9, nir, nsym, psym) ! -> Xaav (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccvv_coov_no5_x1_type1_eri_c &
  (sb, ib, sw, iw, av2_i, Xaav, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccvv_coov_no5_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no5_x1_type1_eri_c &
...
integer :: s_x, i_x, s_a1, i_a1, s_a0, i_a0, s_a, i_a
! S2(w,x,a,b) += (    1.00000000) T2(x,a1,a0,b) W9(w,a1,a0,a) 
do s_x = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_a = 0, nir-1
...
end subroutine g_sigma_ccvv_coov_no5_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no6_x0_type1_eri_c &
...
call g_sigma_ccvv_coov_no6_x0_type1_eri_c &
  (sx, ix, h2_i, Xaav, d1, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaav)

end subroutine g_if_sigma_ccvv_coov_no6_x0_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no6_x0_type1_eri_c &
...
! W16(x,a0,a1,a) += (    1.00000000) V2(x,a,a2,a1) D1(a2,a0) 
do s_a = 0, nir-1
do s_a2 = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_ccvv_coov_no6_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no6_x1_type1_eri_c &
  (sb, ib, sx, ix, T2, W16, S2, nir, nsym, psym, flops)
...
call set_symblock_Xaav(sleft, W16, nir, nsym, psym) ! -> Xaav (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccvv_coov_no6_x1_type1_eri_c &
  (sb, ib, sx, ix, av2_i, Xaav, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccvv_coov_no6_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no6_x1_type1_eri_c &
  (s_b, i_b, s_x, i_x, T2_, W16_, S2_, nir, nsym, psym, flops)
...
integer :: s_w, i_w, s_a0, i_a0, s_a1, i_a1, s_a, i_a
! S2(w,x,a,b) += (    1.00000000) T2(w,a0,a1,b) W16(x,a0,a1,a) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_a = 0, nir-1
...
end subroutine g_sigma_ccvv_coov_no6_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no7_x0_type1_eri_c &
  (sw, iw, V2, W17, nir, nsym, psym, flops)
...
call g_sigma_ccvv_coov_no7_x0_type1_eri_c &
  (sw, iw, h2_i, Xaav, d1, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaav)

end subroutine g_if_sigma_ccvv_coov_no7_x0_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no7_x0_type1_eri_c &
  (s_w, i_w, V2_, W17_, D1_, nir, nsym, psym, flops)
...
integer :: s_a, i_a, s_a2, i_a2, s_a1, i_a1, s_a0, i_a0
! W17(w,a0,a1,a) += (    1.00000000) V2(w,a,a2,a1) D1(a2,a0) 
do s_a = 0, nir-1
do s_a2 = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_ccvv_coov_no7_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no7_x1_type1_eri_c &
  (sb, ib, sw, iw, T2, W17, S2, nir, nsym, psym, flops)
...
call set_symblock_Xaav(sleft, W17, nir, nsym, psym) ! -> Xaav (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccvv_coov_no7_x1_type1_eri_c &
  (sb, ib, sw, iw, av2_i, Xaav, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccvv_coov_no7_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no7_x1_type1_eri_c &
  (s_b, i_b, s_w, i_w, T2_, W17_, S2_, nir, nsym, psym, flops)
...
integer :: s_x, i_x, s_a0, i_a0, s_a1, i_a1, s_a, i_a
! S2(w,x,a,b) += (   -2.00000000) T2(x,a0,a1,b) W17(w,a0,a1,a) 
do s_x = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_a = 0, nir-1
...
end subroutine g_sigma_ccvv_coov_no7_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no8_x0_type1_eri_c &
...
call g_sigma_ccvv_coov_no8_x0_type1_eri_c &
  (sw, iw, h2_i, Xaav, d1, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaav)

end subroutine g_if_sigma_ccvv_coov_no8_x0_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no8_x0_type1_eri_c &
...
end subroutine g_sigma_ccvv_coov_no8_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no8_x1_type1_eri_c &
...
call set_symblock_Xaav(sleft, W22, nir, nsym, psym) ! -> Xaav (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccvv_coov_no8_x1_type1_eri_c &
  (sb, ib, sw, iw, av2_i, Xaav, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccvv_coov_no8_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no8_x1_type1_eri_c &
...
integer :: s_x, i_x, s_a0, i_a0, s_a2, i_a2, s_a, i_a
! S2(w,x,a,b) += (    1.00000000) T2(x,a0,a2,b) W22(w,a0,a2,a) 
do s_x = 0, nir-1
do s_a0 = 0, nir-1
do s_a2 = 0, nir-1
do s_a = 0, nir-1
if( &
IEOR(s_w,s_x) == IEOR(s_a,s_b) .and. & 
IEOR(s_x,s_a0) == IEOR(s_a2,s_b) .and. &
...
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
Z2_(i_a0, i_a2, i_x) =  &
  T2_(s_a2, s_a0, s_x)%array(i_a2, i_a0, i_x)
end do
end do
end do
...
end subroutine g_sigma_ccvv_coov_no8_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no9_x0_type1_eri_c &
...
call g_sigma_ccvv_coov_no9_x0_type1_eri_c &
  (sx, ix, h2_i, Xaav, d1, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaav)

end subroutine g_if_sigma_ccvv_coov_no9_x0_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no9_x0_type1_eri_c &
...
end subroutine g_sigma_ccvv_coov_no9_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no9_x1_type1_eri_c &
...
call set_symblock_Xaav(sleft, W23, nir, nsym, psym) ! -> Xaav (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccvv_coov_no9_x1_type1_eri_c &
  (sb, ib, sx, ix, av2_i, Xaav, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccvv_coov_no9_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no9_x1_type1_eri_c &
...
integer :: s_w, i_w, s_a0, i_a0, s_a2, i_a2, s_a, i_a
! S2(w,x,a,b) += (   -2.00000000) T2(w,a0,a2,b) W23(x,a0,a2,a) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_a2 = 0, nir-1
do s_a = 0, nir-1
...
end subroutine g_sigma_ccvv_coov_no9_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no0_x0_type0_eri_v &
  (sa, ia, T2, W10, nir, nsym, psym, flops)
...
call g_sigma_ccvv_coov_no0_x0_type0_eri_v &
  (sa, ia, av2_i, Xcv, d1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcv)

end subroutine g_if_sigma_ccvv_coov_no0_x0_type0_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no0_x0_type0_eri_v &
  (s_a, i_a, T2_, W10_, D1_, nir, nsym, psym, flops)
...
end subroutine g_sigma_ccvv_coov_no0_x0_type0_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no1_x0_type0_eri_v &
  (sa, ia, T2, W11, nir, nsym, psym, flops)
...
call g_sigma_ccvv_coov_no1_x0_type0_eri_v &
  (sa, ia, av2_i, Xcv, d1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcv)

end subroutine g_if_sigma_ccvv_coov_no1_x0_type0_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no1_x0_type0_eri_v &
  (s_a, i_a, T2_, W11_, D1_, nir, nsym, psym, flops)
...
end subroutine g_sigma_ccvv_coov_no1_x0_type0_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no0_x0_type1_eri_v &
...
call set_symblock_Xcv(sleft, W10, nir, nsym, psym) ! -> Xcv (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccvv_coov_no0_x0_type1_eri_v &
...
end subroutine g_if_sigma_ccvv_coov_no0_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no0_x0_type1_eri_v &
...
! S2(w,x,a,b) += (    2.00000000) V2(b,x,w,c0) W10(c0,a) 
do s_x = 0, nir-1
do s_w = 0, nir-1
do s_c0 = 0, nir-1
do s_a = 0, nir-1
...
end subroutine g_sigma_ccvv_coov_no0_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no1_x0_type1_eri_v &
...
call set_symblock_Xcv(sleft, W11, nir, nsym, psym) ! -> Xcv (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccvv_coov_no1_x0_type1_eri_v &
  (sb, ib, h2_i, Xcv, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccvv_coov_no1_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no1_x0_type1_eri_v &
...
! S2(w,x,a,b) += (   -1.00000000) V2(b,w,x,c0) W11(c0,a) 
do s_w = 0, nir-1
do s_x = 0, nir-1
do s_c0 = 0, nir-1
do s_a = 0, nir-1
...
end subroutine g_sigma_ccvv_coov_no1_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no2_x0_type1_eri_v &
  (sb, ib, V2, W12, nir, nsym, psym, flops)
...
call g_sigma_ccvv_coov_no2_x0_type1_eri_v &
  (sb, ib, h2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_ccvv_coov_no2_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no2_x0_type1_eri_v &
  (s_b, i_b, V2_, W12_, D2_, nir, nsym, psym, flops)
...
integer :: s_x, i_x, s_a3, i_a3, s_a2, i_a2, s_a1, i_a1, s_a0, i_a0
...
do i_a1 = psym(I_BEGIN, I_O, s_a1), psym(I_END, I_O, s_a1)
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
W12_(s_a0, s_a1, s_x)%array(i_a0, i_a1, i_x) = &
    W12_(s_a0, s_a1, s_x)%array(i_a0, i_a1, i_x) &
  + Z3_(i_a1, i_a0, i_x)
end do
end do
...
end subroutine g_sigma_ccvv_coov_no2_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no2_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W12, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccvv_coov_no2_x1_type1_eri_v &
...
end subroutine g_if_sigma_ccvv_coov_no2_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no2_x1_type1_eri_v &
...
integer :: s_w, i_w, s_a1, i_a1, s_a0, i_a0, s_x, i_x
! S2(w,x,a,b) += (   -2.00000000) T2(w,a1,a0,a) W12(x,a1,a0,b) 
do s_w = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_x = 0, nir-1
...
end subroutine g_sigma_ccvv_coov_no2_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no3_x0_type1_eri_v &
...
call g_sigma_ccvv_coov_no3_x0_type1_eri_v &
  (sb, ib, h2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_ccvv_coov_no3_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no3_x0_type1_eri_v &
...
integer :: s_w, i_w, s_a3, i_a3, s_a2, i_a2, s_a1, i_a1, s_a0, i_a0
...
do i_a1 = psym(I_BEGIN, I_O, s_a1), psym(I_END, I_O, s_a1)
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
W13_(s_a0, s_a1, s_w)%array(i_a0, i_a1, i_w) = &
    W13_(s_a0, s_a1, s_w)%array(i_a0, i_a1, i_w) &
  + Z3_(i_a1, i_a0, i_w)
end do
end do
...
end subroutine g_sigma_ccvv_coov_no3_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no3_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W13, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccvv_coov_no3_x1_type1_eri_v &
  (sa, ia, sb, ib, av2_i, Xcaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccvv_coov_no3_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no3_x1_type1_eri_v &
...
integer :: s_x, i_x, s_a1, i_a1, s_a0, i_a0, s_w, i_w
! S2(w,x,a,b) += (    1.00000000) T2(x,a1,a0,a) W13(w,a1,a0,b) 
do s_x = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_w = 0, nir-1
...
end subroutine g_sigma_ccvv_coov_no3_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no4_x0_type1_eri_v &
...
call g_sigma_ccvv_coov_no4_x0_type1_eri_v &
  (sb, ib, h2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_ccvv_coov_no4_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no4_x0_type1_eri_v &
  (s_b, i_b, V2_, W14_, D2_, nir, nsym, psym, flops)
...
integer :: s_a2, i_a2, s_x, i_x, s_a3, i_a3, s_a1, i_a1, s_a0, i_a0
! W14(x,a1,a0,b) += (    1.00000000) V2(b,a2,x,a3) D2(a3,a2,a1,a0) 
do s_a2 = 0, nir-1
do s_x = 0, nir-1
do s_a3 = 0, nir-1
do s_a1 = 0, nir-1
...
do i_a1 = psym(I_BEGIN, I_O, s_a1), psym(I_END, I_O, s_a1)
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
W14_(s_a0, s_a1, s_x)%array(i_a0, i_a1, i_x) = &
    W14_(s_a0, s_a1, s_x)%array(i_a0, i_a1, i_x) &
  + Z3_(i_a1, i_a0, i_x)
end do
end do
...
end subroutine g_sigma_ccvv_coov_no4_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no4_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W14, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccvv_coov_no4_x1_type1_eri_v &
  (sa, ia, sb, ib, av2_i, Xcaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccvv_coov_no4_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no4_x1_type1_eri_v &
...
integer :: s_w, i_w, s_a0, i_a0, s_a1, i_a1, s_x, i_x
! S2(w,x,a,b) += (    1.00000000) T2(w,a0,a1,a) W14(x,a1,a0,b) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_x = 0, nir-1
...
end subroutine g_sigma_ccvv_coov_no4_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no5_x0_type1_eri_v &
...
call g_sigma_ccvv_coov_no5_x0_type1_eri_v &
  (sb, ib, h2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_ccvv_coov_no5_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no5_x0_type1_eri_v &
...
integer :: s_a2, i_a2, s_w, i_w, s_a3, i_a3, s_a0, i_a0, s_a1, i_a1
! W15(w,a1,a0,b) += (    1.00000000) V2(b,a2,w,a3) D2(a3,a0,a1,a2) 
do s_a2 = 0, nir-1
do s_w = 0, nir-1
do s_a3 = 0, nir-1
do s_a0 = 0, nir-1
...
do i_a1 = psym(I_BEGIN, I_O, s_a1), psym(I_END, I_O, s_a1)
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
W15_(s_a0, s_a1, s_w)%array(i_a0, i_a1, i_w) = &
    W15_(s_a0, s_a1, s_w)%array(i_a0, i_a1, i_w) &
  + Z3_(i_a0, i_a1, i_w)
end do
end do
...
end subroutine g_sigma_ccvv_coov_no5_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no5_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W15, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccvv_coov_no5_x1_type1_eri_v &
  (sa, ia, sb, ib, av2_i, Xcaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccvv_coov_no5_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no5_x1_type1_eri_v &
...
integer :: s_x, i_x, s_a0, i_a0, s_a1, i_a1, s_w, i_w
! S2(w,x,a,b) += (    1.00000000) T2(x,a0,a1,a) W15(w,a1,a0,b) 
do s_x = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_w = 0, nir-1
...
end subroutine g_sigma_ccvv_coov_no5_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no6_x0_type1_eri_v &
  (sb, ib, V2, W18, nir, nsym, psym, flops)
...
call g_sigma_ccvv_coov_no6_x0_type1_eri_v &
  (sb, ib, h2_i, Xcaa, d1, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_ccvv_coov_no6_x0_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no6_x0_type1_eri_v &
  (s_b, i_b, V2_, W18_, D1_, nir, nsym, psym, flops)
...
integer :: s_x, i_x, s_a2, i_a2, s_a1, i_a1, s_a0, i_a0
...
if(psym(I_LENGTH,I_C, s_x)*psym(I_LENGTH,I_O, s_a1) > 0 .and. &
   psym(I_LENGTH,I_O, s_a0) > 0 .and. &
   psym(I_LENGTH,I_O, s_a2) > 0) then
...
! Gemm Z1 * Z2 to form Z3
call dgemm('n', 'n', psym(I_LENGTH,I_C, s_x)*psym(I_LENGTH,I_O, s_a1),&
                     psym(I_LENGTH,I_O, s_a0),&
                     psym(I_LENGTH,I_O, s_a2),&
                     1.00000000d+00, &
                     Z1_,&
...
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
do i_a1 = psym(I_BEGIN, I_O, s_a1), psym(I_END, I_O, s_a1)
W18_(s_a1, s_a0, s_x)%array(i_a1, i_a0, i_x) = &
    W18_(s_a1, s_a0, s_x)%array(i_a1, i_a0, i_x) &
  + Z3_(i_x, i_a1, i_a0)
end do
end do
...
! Flop count
flops = flops + psym(I_LENGTH,I_C, s_x)*psym(I_LENGTH,I_O, s_a1) * &
                psym(I_LENGTH,I_O, s_a0) * &
                psym(I_LENGTH,I_O, s_a2) * 2.0d+00
...
end subroutine g_sigma_ccvv_coov_no6_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no6_x1_type1_eri_v &
  (sa, ia, sb, ib, T2, W18, S2, nir, nsym, psym, flops)
...
call set_symblock_Xcaa(sleft, W18, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccvv_coov_no6_x1_type1_eri_v &
  (sa, ia, sb, ib, av2_i, Xcaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccvv_coov_no6_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no6_x1_type1_eri_v &
  (s_a, i_a, s_b, i_b, T2_, W18_, S2_, nir, nsym, psym, flops)
...
integer :: s_w, i_w, s_a0, i_a0, s_a1, i_a1, s_x, i_x
! S2(w,x,a,b) += (   -2.00000000) T2(w,a0,a1,a) W18(x,a0,a1,b) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_x = 0, nir-1
...
end subroutine g_sigma_ccvv_coov_no6_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no7_x0_type1_eri_v &
  (sb, ib, V2, W19, nir, nsym, psym, flops)
...
call g_sigma_ccvv_coov_no7_x0_type1_eri_v &
  (sb, ib, h2_i, Xcaa, d1, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_ccvv_coov_no7_x0_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no7_x0_type1_eri_v &
  (s_b, i_b, V2_, W19_, D1_, nir, nsym, psym, flops)
...
integer :: s_w, i_w, s_a2, i_a2, s_a1, i_a1, s_a0, i_a0
...
end subroutine g_sigma_ccvv_coov_no7_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no7_x1_type1_eri_v &
  (sa, ia, sb, ib, T2, W19, S2, nir, nsym, psym, flops)
...
call set_symblock_Xcaa(sleft, W19, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccvv_coov_no7_x1_type1_eri_v &
  (sa, ia, sb, ib, av2_i, Xcaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccvv_coov_no7_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no7_x1_type1_eri_v &
  (s_a, i_a, s_b, i_b, T2_, W19_, S2_, nir, nsym, psym, flops)
...
integer :: s_x, i_x, s_a0, i_a0, s_a1, i_a1, s_w, i_w
! S2(w,x,a,b) += (    1.00000000) T2(x,a0,a1,a) W19(w,a0,a1,b) 
do s_x = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_w = 0, nir-1
...
end subroutine g_sigma_ccvv_coov_no7_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no8_x0_type1_eri_v &
...
call g_sigma_ccvv_coov_no8_x0_type1_eri_v &
  (sb, ib, h2_i, Xcaa, d1, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_ccvv_coov_no8_x0_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no8_x0_type1_eri_v &
...
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
do i_a1 = psym(I_BEGIN, I_O, s_a1), psym(I_END, I_O, s_a1)
W20_(s_a1, s_a0, s_w)%array(i_a1, i_a0, i_w) = &
    W20_(s_a1, s_a0, s_w)%array(i_a1, i_a0, i_w) &
  + Z3_(i_a1, i_w, i_a0)
end do
end do
...
end subroutine g_sigma_ccvv_coov_no8_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no8_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W20, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccvv_coov_no8_x1_type1_eri_v &
  (sa, ia, sb, ib, av2_i, Xcaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccvv_coov_no8_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no8_x1_type1_eri_v &
...
integer :: s_x, i_x, s_a0, i_a0, s_a1, i_a1, s_w, i_w
! S2(w,x,a,b) += (   -2.00000000) T2(x,a0,a1,a) W20(w,a0,a1,b) 
do s_x = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_w = 0, nir-1
...
end subroutine g_sigma_ccvv_coov_no8_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no9_x0_type1_eri_v &
...
call g_sigma_ccvv_coov_no9_x0_type1_eri_v &
  (sb, ib, h2_i, Xcaa, d1, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_ccvv_coov_no9_x0_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no9_x0_type1_eri_v &
...
if(psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_C, s_x) > 0 .and. &
   psym(I_LENGTH,I_O, s_a0) > 0 .and. &
   psym(I_LENGTH,I_O, s_a2) > 0) then
...
! Gemm Z1 * Z2 to form Z3
call dgemm('n', 'n', psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_C, s_x),&
                     psym(I_LENGTH,I_O, s_a0),&
                     psym(I_LENGTH,I_O, s_a2),&
                     1.00000000d+00, &
                     Z1_,&
                     psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_C, s_x),&
                     Z2_,&
                     psym(I_LENGTH,I_O, s_a2),&
                     0.0d+00,&
                     Z3_,&
...
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
do i_a1 = psym(I_BEGIN, I_O, s_a1), psym(I_END, I_O, s_a1)
W21_(s_a1, s_a0, s_x)%array(i_a1, i_a0, i_x) = &
    W21_(s_a1, s_a0, s_x)%array(i_a1, i_a0, i_x) &
  + Z3_(i_a1, i_x, i_a0)
end do
end do
...
! Flop count
flops = flops + psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_C, s_x) * &
                psym(I_LENGTH,I_O, s_a0) * &
                psym(I_LENGTH,I_O, s_a2) * 2.0d+00
...
end subroutine g_sigma_ccvv_coov_no9_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no9_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W21, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccvv_coov_no9_x1_type1_eri_v &
  (sa, ia, sb, ib, av2_i, Xcaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccvv_coov_no9_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no9_x1_type1_eri_v &
...
integer :: s_w, i_w, s_a0, i_a0, s_a1, i_a1, s_x, i_x
! S2(w,x,a,b) += (    1.00000000) T2(w,a0,a1,a) W21(x,a0,a1,b) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_x = 0, nir-1
...
end subroutine g_sigma_ccvv_coov_no9_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no10_x0_type1_eri_v &
...
call g_sigma_ccvv_coov_no10_x0_type1_eri_v &
  (sv0, iv0, av2_i, Xc, d1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xc)

end subroutine g_if_sigma_ccvv_coov_no10_x0_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no10_x0_type1_eri_v &
...
integer :: s_w, i_w, s_a1, i_a1, s_a0, i_a0
! W24(w,v0) += (    1.00000000) T2(w,a1,a0,v0) D1(a1,a0) 
do s_w = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
if( &
...
end subroutine g_sigma_ccvv_coov_no10_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no10_x1_type1_eri_v &
...
call set_symblock_Xc(sleft, W24, nir, nsym, psym) ! -> Xc (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccvv_coov_no10_x1_type1_eri_v &
...
end subroutine g_if_sigma_ccvv_coov_no10_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no10_x1_type1_eri_v &
...
integer :: s_x, i_x, s_a, i_a, s_w, i_w
! S2(w,x,a,b) += (    1.00000000) V2(v0,b,x,a) W24(w,v0) 
do s_x = 0, nir-1
do s_a = 0, nir-1
do s_w = 0, nir-1
if( &
...
end subroutine g_sigma_ccvv_coov_no10_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no11_x0_type1_eri_v &
...
call g_sigma_ccvv_coov_no11_x0_type1_eri_v &
  (sv0, iv0, av2_i, Xc, d1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xc)

end subroutine g_if_sigma_ccvv_coov_no11_x0_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no11_x0_type1_eri_v &
...
integer :: s_x, i_x, s_a1, i_a1, s_a0, i_a0
! W25(x,v0) += (    1.00000000) T2(x,a1,a0,v0) D1(a1,a0) 
do s_x = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
if( &
...
end subroutine g_sigma_ccvv_coov_no11_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no11_x1_type1_eri_v &
...
call set_symblock_Xc(sleft, W25, nir, nsym, psym) ! -> Xc (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccvv_coov_no11_x1_type1_eri_v &
  (sb, ib, sv0, iv0, h2_i, Xc, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccvv_coov_no11_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no11_x1_type1_eri_v &
...
integer :: s_w, i_w, s_a, i_a, s_x, i_x
! S2(w,x,a,b) += (   -2.00000000) V2(v0,b,w,a) W25(x,v0) 
do s_w = 0, nir-1
do s_a = 0, nir-1
do s_x = 0, nir-1
if( &
...
end subroutine g_sigma_ccvv_coov_no11_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no12_x0_type1_eri_v &
...
call g_sigma_ccvv_coov_no12_x0_type1_eri_v &
  (sv0, iv0, av2_i, Xc, d1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xc)

end subroutine g_if_sigma_ccvv_coov_no12_x0_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no12_x0_type1_eri_v &
...
integer :: s_w, i_w, s_a1, i_a1, s_a0, i_a0
! W26(w,v0) += (    1.00000000) T2(w,a1,a0,v0) D1(a1,a0) 
do s_w = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
if( &
...
end subroutine g_sigma_ccvv_coov_no12_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no12_x1_type1_eri_v &
...
call set_symblock_Xc(sleft, W26, nir, nsym, psym) ! -> Xc (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccvv_coov_no12_x1_type1_eri_v &
  (sb, ib, sv0, iv0, h2_i, Xc, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccvv_coov_no12_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no12_x1_type1_eri_v &
...
! S2(w,x,a,b) += (   -2.00000000) V2(v0,a,x,b) W26(w,v0) 
do s_a = 0, nir-1
do s_x = 0, nir-1
do s_w = 0, nir-1
if( &
...
end subroutine g_sigma_ccvv_coov_no12_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no13_x0_type1_eri_v &
...
call g_sigma_ccvv_coov_no13_x0_type1_eri_v &
  (sv0, iv0, av2_i, Xc, d1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xc)

end subroutine g_if_sigma_ccvv_coov_no13_x0_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no13_x0_type1_eri_v &
...
integer :: s_x, i_x, s_a1, i_a1, s_a0, i_a0
! W27(x,v0) += (    1.00000000) T2(x,a1,a0,v0) D1(a1,a0) 
do s_x = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
if( &
...
end subroutine g_sigma_ccvv_coov_no13_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_ccvv_coov_no13_x1_type1_eri_v &
...
call set_symblock_Xc(sleft, W27, nir, nsym, psym) ! -> Xc (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_ccvv_coov_no13_x1_type1_eri_v &
  (sb, ib, sv0, iv0, h2_i, Xc, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_ccvv_coov_no13_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_ccvv_coov_no13_x1_type1_eri_v &
...
! S2(w,x,a,b) += (    1.00000000) V2(v0,a,w,b) W27(x,v0) 
do s_a = 0, nir-1
do s_w = 0, nir-1
do s_x = 0, nir-1
if( &
...
end subroutine g_sigma_ccvv_coov_no13_x1_type1_eri_v
