...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_oovv_oovv_no0_x0_type0_noeri &
...
call g_sigma_oovv_oovv_no0_x0_type0_noeri &
  (sb, ib, Fc0, av2_i, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(av2_i)

end subroutine g_if_sigma_oovv_oovv_no0_x0_type0_noeri
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_oovv_oovv_no0_x0_type0_noeri &
  (s_b, i_b, Fc0, T2_, S2_, D2_, nir, nsym, psym, flops)
...
! S2(i,j,a,b) += (    2.00000000) Fc0 T2(a0,a1,a,b) D2(j,a1,i,a0) 
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_a = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_oovv_oovv_no0_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_oovv_oovv_no1_x0_type0_noeri &
...
call g_sigma_oovv_oovv_no1_x0_type0_noeri &
  (Xaaaa, d3, fc1, nir, nsym, psym, flops)

deallocate(Xaaaa)

end subroutine g_if_sigma_oovv_oovv_no1_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_oovv_oovv_no1_x0_type0_noeri &
  (W0_, D3_, Fc1_, nir, nsym, psym, flops)
...
integer :: s_a2, i_a2
! W0(j,i,a1,a0) += (    1.00000000) D3(j,a1,i,a0,a3,a2) Fc1(a3,a2) 
do s_j = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
do s_a0 = 0, nir-1
...
do i_a1 = psym(I_BEGIN, I_O, s_a1), psym(I_END, I_O, s_a1)
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
W0_(s_a0, s_a1, s_i, s_j)%array(i_a0, i_a1, i_i, i_j) = &
    W0_(s_a0, s_a1, s_i, s_j)%array(i_a0, i_a1, i_i, i_j) &
...
end subroutine g_sigma_oovv_oovv_no1_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_oovv_oovv_no1_x1_type0_noeri &
...
call set_symblock_Xaaaa(sleft, W0, nir, nsym, psym) ! -> Xaaaa (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_oovv_oovv_no1_x1_type0_noeri &
...
end subroutine g_if_sigma_oovv_oovv_no1_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_oovv_oovv_no1_x1_type0_noeri &
...
integer :: s_a0, i_a0, s_a1, i_a1, s_a, i_a, s_j, i_j, s_i, i_i
! S2(i,j,a,b) += (    2.00000000) T2(a0,a1,a,b) W0(j,i,a1,a0) 
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_a = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_oovv_oovv_no1_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_oovv_oovv_no2_x0_type0_noeri &
...
call g_sigma_oovv_oovv_no2_x0_type0_noeri &
  (sa, ia, av2_i, Xaav, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xaav)

end subroutine g_if_sigma_oovv_oovv_no2_x0_type0_noeri
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_oovv_oovv_no2_x0_type0_noeri &
...
! W1(j,i,v0,a) += (    1.00000000) T2(a1,a0,v0,a) D2(j,a1,i,a0) 
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_v0 = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_oovv_oovv_no2_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_oovv_oovv_no2_x1_type0_noeri &
...
call g_sigma_oovv_oovv_no2_x1_type0_noeri &
  (sa, ia, Xaav, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaav)

end subroutine g_if_sigma_oovv_oovv_no2_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_oovv_oovv_no2_x1_type0_noeri &
...
! S2(j,i,b,a) += (    2.00000000) Fc1(v0,b) W1(j,i,v0,a) 
do s_v0 = 0, nir-1
do s_b = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_oovv_oovv_no2_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_oovv_oovv_no3_x0_type0_noeri &
...
call g_sigma_oovv_oovv_no3_x0_type0_noeri &
  (sb, ib, av2_i, Xaav, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xaav)

end subroutine g_if_sigma_oovv_oovv_no3_x0_type0_noeri
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_oovv_oovv_no3_x0_type0_noeri &
  (s_b, i_b, T2_, W2_, D2_, nir, nsym, psym, flops)
...
! W2(j,i,b,v0) += (    1.00000000) T2(a0,a1,v0,b) D2(j,a1,i,a0) 
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_v0 = 0, nir-1
do s_j = 0, nir-1
...
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
do i_v0 = psym(I_BEGIN, I_V, s_v0), psym(I_END, I_V, s_v0)
W2_(s_v0, s_i, s_j)%array(i_v0, i_i, i_j) = &
    W2_(s_v0, s_i, s_j)%array(i_v0, i_i, i_j) &
  + Z3_(i_v0, i_j, i_i)
end do
end do
...
end subroutine g_sigma_oovv_oovv_no3_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_oovv_oovv_no3_x1_type0_noeri &
...
call set_symblock_Xaav(sleft, W2, nir, nsym, psym) ! -> Xaav (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_oovv_oovv_no3_x1_type0_noeri &
  (sb, ib, Xaav, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaav)

end subroutine g_if_sigma_oovv_oovv_no3_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_oovv_oovv_no3_x1_type0_noeri &
...
! S2(i,j,a,b) += (    2.00000000) Fc1(v0,a) W2(j,i,b,v0) 
do s_v0 = 0, nir-1
do s_a = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_oovv_oovv_no3_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_oovv_oovv_no4_x0_type0_noeri &
...
call set_symblock_av2(sb, T2, nir, nsym, psym) ! -> av2_i (allocate)
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_oovv_oovv_no4_x0_type0_noeri &
  (sb, ib, av2_i, av2_i2, c4f, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(av2_i)

end subroutine g_if_sigma_oovv_oovv_no4_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_oovv_oovv_no4_x0_type0_noeri &
  (s_b, i_b, T2_, S2_, C4_, nir, nsym, psym, flops)
...
integer :: s_a0, i_a0, s_a1, i_a1, s_a, i_a, s_j, i_j, s_i, i_i
! S2(i,j,a,b) += (    1.00000000) T2(a0,a1,a,b) C4(a1,j,a0,i) 
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_a = 0, nir-1
do s_j = 0, nir-1
...
IEOR(s_i,s_j) == IEOR(s_a,s_b) .and. & 
IEOR(s_a0,s_a1) == IEOR(s_a,s_b) .and. &
IEOR(s_a1,s_j) == IEOR(s_a0,s_i)) then
...
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
Z2_(i_a0, i_a1, i_j, i_i) =  &
  C4_(s_i, s_a0, s_j, s_a1)%array(i_i, i_a0, i_j, i_a1)
end do
end do
end do
end do
...
end subroutine g_sigma_oovv_oovv_no4_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_oovv_oovv_no0_x0_type1_eri_v &
...
call g_sigma_oovv_oovv_no0_x0_type1_eri_v &
...
subroutine g_sigma_oovv_oovv_no0_x0_type1_eri_v &
...
! W3(j,i,a1,a0,v0,a) += (    1.00000000) V2(v0,a2,a3,a) D3(j,a1,i,a3,a2,a0) 
do s_a2 = 0, nir-1
do s_a3 = 0, nir-1
do s_a = 0, nir-1
do s_j = 0, nir-1
...
! W3(j,i,a1,a0,v0,a)  <-- Z3
do i_j = psym(I_BEGIN, I_O, s_j), psym(I_END, I_O, s_j)
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
do i_a1 = psym(I_BEGIN, I_O, s_a1), psym(I_END, I_O, s_a1)
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
do i_a = psym(I_BEGIN, I_V, s_a), psym(I_END, I_V, s_a)
W3_(s_a, s_a0, s_a1, s_i, s_j)%array(i_a, i_a0, i_a1, i_i, i_j) = &
    W3_(s_a, s_a0, s_a1, s_i, s_j)%array(i_a, i_a0, i_a1, i_i, i_j) &
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_oovv_oovv_no0_x1_type1_eri_v &
  (sb, ib, sv0, iv0, T2, W3, S2, nir, nsym, psym, flops)
...
call set_symblock_Xaaaav(sleft, W3, nir, nsym, psym) ! -> Xaaaav (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_oovv_oovv_no0_x1_type1_eri_v &
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_oovv_oovv_no0_x1_type1_eri_v &
  (s_b, i_b, s_v0, i_v0, T2_, W3_, S2_, nir, nsym, psym, flops)
...
! S2(i,j,a,b) += (    2.00000000) T2(a1,a0,b,v0) W3(j,i,a1,a0,v0,a) 
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_oovv_oovv_no1_x0_type1_eri_v &
  (sb, ib, sv0, iv0, V2, W4, nir, nsym, psym, flops)
...
call set_symblock_Xaaaa(sleft, W4, nir, nsym, psym) ! -> Xaaaa (allocate) 
call g_sigma_oovv_oovv_no1_x0_type1_eri_v &
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_oovv_oovv_no1_x0_type1_eri_v &
  (s_b, i_b, s_v0, i_v0, V2_, W4_, D3_, nir, nsym, psym, flops)
...
integer :: s_a0, i_a0
! W4(j,i,a1,a0,v0,b) += (    1.00000000) V2(v0,a3,b,a2) D3(j,a2,i,a1,a3,a0) 
do s_a3 = 0, nir-1
do s_a2 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
! W4(j,i,a1,a0,v0,b)  <-- Z3
do i_j = psym(I_BEGIN, I_O, s_j), psym(I_END, I_O, s_j)
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
do i_a1 = psym(I_BEGIN, I_O, s_a1), psym(I_END, I_O, s_a1)
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
W4_(s_a0, s_a1, s_i, s_j)%array(i_a0, i_a1, i_i, i_j) = &
    W4_(s_a0, s_a1, s_i, s_j)%array(i_a0, i_a1, i_i, i_j) &
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_oovv_oovv_no1_x1_type1_eri_v &
...
call set_symblock_Xaaaa(sleft, W4, nir, nsym, psym) ! -> Xaaaa (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_oovv_oovv_no1_x1_type1_eri_v &
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_oovv_oovv_no1_x1_type1_eri_v &
...
! S2(i,j,a,b) += (    2.00000000) T2(a1,a0,a,v0) W4(j,i,a1,a0,v0,b) 
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_a = 0, nir-1
do s_j = 0, nir-1
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_oovv_oovv_no2_x0_type1_eri_v &
...
call g_sigma_oovv_oovv_no2_x0_type1_eri_v &
  (sb, ib, sv0, iv0, h2_i, Xaaaa, d3, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaaa)

end subroutine g_if_sigma_oovv_oovv_no2_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_oovv_oovv_no2_x0_type1_eri_v &
...
integer :: s_a0, i_a0
! W5(j,i,a1,a0,v0,b) += (    1.00000000) V2(v0,b,a3,a2) D3(j,a1,i,a0,a3,a2) 
do s_a3 = 0, nir-1
do s_a2 = 0, nir-1
do s_j = 0, nir-1
do s_a1 = 0, nir-1
...
end subroutine g_sigma_oovv_oovv_no2_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_oovv_oovv_no2_x1_type1_eri_v &
...
call set_symblock_Xaaaa(sleft, W5, nir, nsym, psym) ! -> Xaaaa (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_oovv_oovv_no2_x1_type1_eri_v &
  (sb, ib, sv0, iv0, av2_i, Xaaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_oovv_oovv_no2_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_oovv_oovv_no2_x1_type1_eri_v &
...
integer :: s_a0, i_a0, s_a1, i_a1, s_a, i_a, s_j, i_j, s_i, i_i
! S2(i,j,a,b) += (    2.00000000) T2(a0,a1,a,v0) W5(j,i,a1,a0,v0,b) 
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_a = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_oovv_oovv_no2_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_oovv_oovv_no3_x0_type1_eri_v &
...
call set_symblock_Xaaaav(sleft, W6, nir, nsym, psym) ! -> Xaaaav (allocate) 
call g_sigma_oovv_oovv_no3_x0_type1_eri_v &
  (sv0, iv0, h2_i, Xaaaav, d3, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaaav)

end subroutine g_if_sigma_oovv_oovv_no3_x0_type1_eri_v
...
subroutine g_sigma_oovv_oovv_no3_x0_type1_eri_v &
...
integer :: s_i, i_i, s_a0, i_a0
! W6(j,i,a1,a0,v0,a) += (    1.00000000) V2(v0,a,a3,a2) D3(j,a1,i,a0,a3,a2) 
do s_a = 0, nir-1
do s_a3 = 0, nir-1
do s_a2 = 0, nir-1
do s_j = 0, nir-1
...
! W6(j,i,a1,a0,v0,a)  <-- Z3
do i_j = psym(I_BEGIN, I_O, s_j), psym(I_END, I_O, s_j)
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
do i_a1 = psym(I_BEGIN, I_O, s_a1), psym(I_END, I_O, s_a1)
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
do i_a = psym(I_BEGIN, I_V, s_a), psym(I_END, I_V, s_a)
W6_(s_a, s_a0, s_a1, s_i, s_j)%array(i_a, i_a0, i_a1, i_i, i_j) = &
    W6_(s_a, s_a0, s_a1, s_i, s_j)%array(i_a, i_a0, i_a1, i_i, i_j) &
...
end subroutine g_sigma_oovv_oovv_no3_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_oovv_oovv_no3_x1_type1_eri_v &
...
call set_symblock_Xaaaav(sleft, W6, nir, nsym, psym) ! -> Xaaaav (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_oovv_oovv_no3_x1_type1_eri_v &
  (sb, ib, sv0, iv0, av2_i, Xaaaav, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_oovv_oovv_no3_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_oovv_oovv_no3_x1_type1_eri_v &
...
integer :: s_a1, i_a1, s_a0, i_a0, s_j, i_j, s_i, i_i, s_a, i_a
! S2(i,j,a,b) += (    2.00000000) T2(a1,a0,b,v0) W6(j,i,a1,a0,v0,a) 
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_oovv_oovv_no3_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_oovv_oovv_no4_x0_type1_eri_v &
  (sb, ib, sv0, iv0, T2, V2, W7, nir, nsym, psym, flops)
...
call g_sigma_oovv_oovv_no4_x0_type1_eri_v &
...
end subroutine g_if_sigma_oovv_oovv_no4_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_oovv_oovv_no4_x0_type1_eri_v &
  (s_b, i_b, s_v0, i_v0, T2_, V2_, W7_, nir, nsym, psym, flops)
...
! W7(a1,a0,b,a) += (    1.00000000) V2(b,v1,v0,a) T2(a1,a0,v1,v0) 
do s_v1 = 0, nir-1
do s_a = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_oovv_oovv_no4_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_oovv_oovv_no4_x1_type1_eri_v &
...
call set_symblock_Xaav(sleft, W7, nir, nsym, psym) ! -> Xaav (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_oovv_oovv_no4_x1_type1_eri_v &
  (sb, ib, Xaav, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaav)

end subroutine g_if_sigma_oovv_oovv_no4_x1_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_oovv_oovv_no4_x1_type1_eri_v &
  (s_b, i_b, W7_, S2_, D2_, nir, nsym, psym, flops)
...
! S2(i,j,a,b) += (    2.00000000) D2(j,a1,i,a0) W7(a1,a0,b,a) 
do s_j = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_oovv_oovv_no4_x1_type1_eri_v
