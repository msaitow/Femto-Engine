...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no0_x0_type0_noeri &
...
call g_sigma_coov_coov_no0_x0_type0_noeri &
  (sa, ia, Fc0, av2_i, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(av2_i)

end subroutine g_if_sigma_coov_coov_no0_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no0_x0_type0_noeri &
...
! S2(w,i,j,a) += (   -1.00000000) Fc0 T2(w,a1,a0,a) D2(j,a0,a1,i) 
do s_w = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
...
IEOR(s_j,s_a0) == IEOR(s_a1,s_i)) then
...
end subroutine g_sigma_coov_coov_no0_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no1_x0_type0_noeri &
  (sa, ia, Fc0, T2, S2, nir, nsym, psym, flops)
...
call set_symblock_av2(sa, T2, nir, nsym, psym) ! -> av2_i (allocate)
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no1_x0_type0_noeri &
  (sa, ia, Fc0, av2_i, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(av2_i)

end subroutine g_if_sigma_coov_coov_no1_x0_type0_noeri
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_coov_coov_no1_x0_type0_noeri &
...
! S2(w,i,j,a) += (    2.00000000) Fc0 T2(w,a0,j,a) D1(i,a0) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_coov_no1_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no2_x0_type0_noeri &
...
call g_sigma_coov_coov_no2_x0_type0_noeri &
  (sa, ia, av2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_coov_no2_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no2_x0_type0_noeri &
...
! W0(c0,j,i,a) += (    1.00000000) T2(c0,a1,a0,a) D2(j,a0,a1,i) 
do s_c0 = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_coov_coov_no2_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no2_x1_type0_noeri &
...
call set_symblock_Xcaa(sleft, W0, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no2_x1_type0_noeri &
  (sa, ia, Xcaa, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_coov_no2_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no2_x1_type0_noeri &
...
end subroutine g_sigma_coov_coov_no2_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no3_x0_type0_noeri &
...
call g_sigma_coov_coov_no3_x0_type0_noeri &
  (Xaaaa, d3, fc1, nir, nsym, psym, flops)

deallocate(Xaaaa)

end subroutine g_if_sigma_coov_coov_no3_x0_type0_noeri
...
! >> Score :: 111111
! The best shot!
! RDM is rotated :: D3(j,a0,a3,a2,a1,i)  >> D3(a2,a3,i,a1,a0,j) 
! rowInd : @[j, "active"] @[a0, "active"] @[a1, "active"] @[i, "active"] 
! summedInd : @[a3, "active"] @[a2, "active"] 
! -- Check2 is skipped 
!    -- is4RDM.second false
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no3_x0_type0_noeri &
...
integer :: s_j, i_j, s_a0, i_a0, s_a3, i_a3, s_a2, i_a2, s_a1, i_a1
integer :: s_i, i_i
! W1(j,a1,a0,i) += (    1.00000000) D3(j,a0,a3,a2,a1,i) Fc1(a3,a2) 
do s_j = 0, nir-1
do s_a0 = 0, nir-1
do s_a3 = 0, nir-1
do s_a2 = 0, nir-1
...
IEOR(IEOR(s_j,s_a0),s_a3) == IEOR(IEOR(s_a2,s_a1),s_i) .and. &
IEOR(s_a3,s_a2) == 0) then

if(psym(I_LENGTH,I_O, s_j)*psym(I_LENGTH,I_O, s_a0)*psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_i) > 0 .and. &
...
! Gemm Z1 * Z2 to form Z3
call dgemm('n', 'n', psym(I_LENGTH,I_O, s_j)*psym(I_LENGTH,I_O, s_a0)*psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_i),&
                     1,&
                     psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_a2),&
                     1.00000000d+00, &
                     D3_(s_j, s_a0, s_a1, s_i, s_a3, s_a2)%array,&
...
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
W1_(s_i, s_a0, s_a1, s_j)%array(i_i, i_a0, i_a1, i_j) = &
    W1_(s_i, s_a0, s_a1, s_j)%array(i_i, i_a0, i_a1, i_j) &
  + Z3_(i_j, i_a0, i_a1, i_i)
end do
end do
end do
end do
...
! Flop count
flops = flops + psym(I_LENGTH,I_O, s_j)*psym(I_LENGTH,I_O, s_a0)*psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_i) * &
                1 * &
...
end subroutine g_sigma_coov_coov_no3_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no3_x1_type0_noeri &
...
call set_symblock_Xaaaa(sleft, W1, nir, nsym, psym) ! -> Xaaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no3_x1_type0_noeri &
...
end subroutine g_if_sigma_coov_coov_no3_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no3_x1_type0_noeri &
...
integer :: s_w, i_w, s_a1, i_a1, s_a0, i_a0, s_j, i_j, s_i, i_i
! S2(w,i,j,a) += (   -1.00000000) T2(w,a1,a0,a) W1(j,a1,a0,i) 
do s_w = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_coov_coov_no3_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no4_x0_type0_noeri &
...
call g_sigma_coov_coov_no4_x0_type0_noeri &
  (Xaaaa, d2, fc1, nir, nsym, psym, flops)

deallocate(Xaaaa)

end subroutine g_if_sigma_coov_coov_no4_x0_type0_noeri
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_coov_coov_no4_x0_type0_noeri &
...
integer :: s_i, i_i, s_a0, i_a0, s_a1, i_a1, s_a2, i_a2, s_j, i_j
! W2(i,a1,a0,j) += (    1.00000000) D2(i,a0,a1,a2) Fc1(j,a2) 
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_a2 = 0, nir-1
...
IEOR(s_i,s_a0) == IEOR(s_a1,s_a2) .and. &
IEOR(s_j,s_a2) == 0) then

if(psym(I_LENGTH,I_O, s_j) > 0 .and. &
   psym(I_LENGTH,I_O, s_i)*psym(I_LENGTH,I_O, s_a0)*psym(I_LENGTH,I_O, s_a1) > 0 .and. &
...
end subroutine g_sigma_coov_coov_no4_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no4_x1_type0_noeri &
...
call set_symblock_Xaaaa(sleft, W2, nir, nsym, psym) ! -> Xaaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no4_x1_type0_noeri &
  (sa, ia, av2_i, Xaaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_coov_no4_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no4_x1_type0_noeri &
...
integer :: s_w, i_w, s_a0, i_a0, s_a1, i_a1, s_i, i_i, s_j, i_j
! S2(w,i,j,a) += (   -1.00000000) T2(w,a0,a1,a) W2(i,a1,a0,j) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_coov_no4_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no5_x0_type0_noeri &
...
call g_sigma_coov_coov_no5_x0_type0_noeri &
  (sa, ia, av2_i, Xcaa, d1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_coov_no5_x0_type0_noeri
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_coov_coov_no5_x0_type0_noeri &
...
integer :: s_c0, i_c0, s_a0, i_a0, s_j, i_j, s_i, i_i
! W3(c0,i,j,a) += (    1.00000000) T2(c0,a0,j,a) D1(i,a0) 
do s_c0 = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_coov_no5_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no5_x1_type0_noeri &
...
call set_symblock_Xcaa(sleft, W3, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no5_x1_type0_noeri &
  (sa, ia, Xcaa, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_coov_no5_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no5_x1_type0_noeri &
...
! S2(w,i,j,a) += (   -2.00000000) Fc1(w,c0) W3(c0,i,j,a) 
do s_w = 0, nir-1
do s_c0 = 0, nir-1
do s_i = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_coov_coov_no5_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no6_x0_type0_noeri &
...
call g_sigma_coov_coov_no6_x0_type0_noeri &
  (Xaa, d2, fc1, nir, nsym, psym, flops)

deallocate(Xaa)

end subroutine g_if_sigma_coov_coov_no6_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no6_x0_type0_noeri &
...
end subroutine g_sigma_coov_coov_no6_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no6_x1_type0_noeri &
...
call set_symblock_Xaa(sleft, W4, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no6_x1_type0_noeri &
...
end subroutine g_if_sigma_coov_coov_no6_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no6_x1_type0_noeri &
...
integer :: s_w, i_w, s_a0, i_a0, s_j, i_j, s_i, i_i
! S2(w,i,j,a) += (    2.00000000) T2(w,a0,j,a) W4(i,a0) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_coov_no6_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no7_x0_type0_noeri &
...
call g_sigma_coov_coov_no7_x0_type0_noeri &
  (Xaaaa, d2, fc1, nir, nsym, psym, flops)

deallocate(Xaaaa)

end subroutine g_if_sigma_coov_coov_no7_x0_type0_noeri
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_coov_coov_no7_x0_type0_noeri &
...
integer :: s_j, i_j, s_a2, i_a2, s_a0, i_a0, s_i, i_i, s_a1, i_a1
! W5(j,a0,i,a1) += (    1.00000000) D2(j,a2,a0,i) Fc1(a2,a1) 
do s_j = 0, nir-1
do s_a2 = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
...
if(psym(I_LENGTH,I_O, s_a1) > 0 .and. &
   psym(I_LENGTH,I_O, s_j)*psym(I_LENGTH,I_O, s_a0)*psym(I_LENGTH,I_O, s_i) > 0 .and. &
   psym(I_LENGTH,I_O, s_a2) > 0) then
...
end subroutine g_sigma_coov_coov_no7_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no7_x1_type0_noeri &
...
call set_symblock_Xaaaa(sleft, W5, nir, nsym, psym) ! -> Xaaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no7_x1_type0_noeri &
  (sa, ia, av2_i, Xaaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_coov_no7_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no7_x1_type0_noeri &
...
integer :: s_w, i_w, s_a0, i_a0, s_a1, i_a1, s_j, i_j, s_i, i_i
! S2(w,i,j,a) += (   -1.00000000) T2(w,a0,a1,a) W5(j,a0,i,a1) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_coov_coov_no7_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no8_x0_type0_noeri &
...
call g_sigma_coov_coov_no8_x0_type0_noeri &
  (sa, ia, av2_i, Xcaa, d1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_coov_no8_x0_type0_noeri
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_coov_coov_no8_x0_type0_noeri &
...
! W6(w,i,a1,a) += (    1.00000000) T2(w,a0,a1,a) D1(i,a0) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_coov_no8_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no8_x1_type0_noeri &
...
call set_symblock_Xcaa(sleft, W6, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no8_x1_type0_noeri &
  (sa, ia, Xcaa, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_coov_no8_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no8_x1_type0_noeri &
...
! S2(w,i,j,a) += (    2.00000000) Fc1(j,a1) W6(w,i,a1,a) 
do s_j = 0, nir-1
do s_a1 = 0, nir-1
do s_w = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_coov_no8_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no9_x0_type0_noeri &
  (sv0, iv0, T2, W7, nir, nsym, psym, flops)
...
call g_sigma_coov_coov_no9_x0_type0_noeri &
  (sv0, iv0, av2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_coov_no9_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no9_x0_type0_noeri &
  (s_v0, i_v0, T2_, W7_, D2_, nir, nsym, psym, flops)
...
integer :: s_w, i_w, s_a1, i_a1, s_a0, i_a0, s_j, i_j, s_i, i_i
! W7(w,j,i,v0) += (    1.00000000) T2(w,a1,a0,v0) D2(j,a0,a1,i) 
do s_w = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
...
do i_j = psym(I_BEGIN, I_O, s_j), psym(I_END, I_O, s_j)
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
W7_(s_i, s_j, s_w)%array(i_i, i_j, i_w) = &
    W7_(s_i, s_j, s_w)%array(i_i, i_j, i_w) &
  + Z3_(i_j, i_i, i_w)
end do
end do
...
end subroutine g_sigma_coov_coov_no9_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no9_x1_type0_noeri &
  (sa, ia, sv0, iv0, W7, S2, nir, nsym, psym, flops)
...
call set_symblock_Xcaa(sleft, W7, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no9_x1_type0_noeri &
  (sa, ia, sv0, iv0, Xcaa, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_coov_no9_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no9_x1_type0_noeri &
  (s_a, i_a, s_v0, i_v0, W7_, S2_, Fc1_, nir, nsym, psym, flops)
...
end subroutine g_sigma_coov_coov_no9_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no10_x0_type0_noeri &
...
call g_sigma_coov_coov_no10_x0_type0_noeri &
  (sv0, iv0, av2_i, Xcaa, d1, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_coov_no10_x0_type0_noeri
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_coov_coov_no10_x0_type0_noeri &
  (s_v0, i_v0, T2_, W8_, D1_, nir, nsym, psym, flops)
...
integer :: s_w, i_w, s_a0, i_a0, s_j, i_j, s_i, i_i
! W8(w,i,j,v0) += (    1.00000000) T2(w,a0,j,v0) D1(i,a0) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
do i_j = psym(I_BEGIN, I_O, s_j), psym(I_END, I_O, s_j)
W8_(s_j, s_i, s_w)%array(i_j, i_i, i_w) = &
    W8_(s_j, s_i, s_w)%array(i_j, i_i, i_w) &
  + Z3_(i_w, i_j, i_i)
end do
end do
...
end subroutine g_sigma_coov_coov_no10_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no10_x1_type0_noeri &
  (sa, ia, sv0, iv0, W8, S2, nir, nsym, psym, flops)
...
call set_symblock_Xcaa(sleft, W8, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no10_x1_type0_noeri &
  (sa, ia, sv0, iv0, Xcaa, av2_i2, fc1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_coov_no10_x1_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no10_x1_type0_noeri &
  (s_a, i_a, s_v0, i_v0, W8_, S2_, Fc1_, nir, nsym, psym, flops)
...
! S2(w,i,j,a) += (    2.00000000) Fc1(v0,a) W8(w,i,j,v0) 
do s_w = 0, nir-1
do s_i = 0, nir-1
do s_j = 0, nir-1
if( &
...
end subroutine g_sigma_coov_coov_no10_x1_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no11_x0_type0_noeri &
...
call set_symblock_av2(sa, T2, nir, nsym, psym) ! -> av2_i (allocate)
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no11_x0_type0_noeri &
  (sa, ia, av2_i, av2_i2, c4f, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(av2_i)

end subroutine g_if_sigma_coov_coov_no11_x0_type0_noeri
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no11_x0_type0_noeri &
...
integer :: s_w, i_w, s_a1, i_a1, s_a0, i_a0, s_i, i_i, s_j, i_j
! S2(w,i,j,a) += (   -0.50000000) T2(w,a1,a0,a) C4(i,a1,a0,j) 
do s_w = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
...
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
Z1_(i_i, i_j, i_a1, i_a0) =  &
  C4_(s_j, s_a0, s_a1, s_i)%array(i_j, i_a0, i_a1, i_i)
end do
end do
end do
end do
...
end subroutine g_sigma_coov_coov_no11_x0_type0_noeri
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no0_x0_type1_eri_c &
...
call g_sigma_coov_coov_no0_x0_type1_eri_c &
  (sw, iw, h2_i, Xcaaaa, d3, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xcaaaa)

end subroutine g_if_sigma_coov_coov_no0_x0_type1_eri_c
...
! Information for debugging 
! >> Score :: 111010
! RDM is rotated :: D3(j,a3,a2,a0,a1,i)  >> D3(a0,a2,i,a1,a3,j) 
! rowInd : @[j, "active"] @[a0, "active"] @[a1, "active"] @[i, "active"] 
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no0_x0_type1_eri_c &
...
integer :: s_a1, i_a1, s_i, i_i
! W9(w,c0,j,a1,a0,i) += (    1.00000000) V2(w,a3,c0,a2) D3(j,a3,a2,a0,a1,i) 
do s_a3 = 0, nir-1
do s_c0 = 0, nir-1
do s_a2 = 0, nir-1
do s_j = 0, nir-1
...
do s_i = 0, nir-1
if( &
IEOR(IEOR(s_w,s_c0),s_j) == IEOR(IEOR(s_a1,s_a0),s_i) .and. & 
IEOR(s_w,s_a3) == IEOR(s_c0,s_a2) .and. &
IEOR(IEOR(s_j,s_a3),s_a2) == IEOR(IEOR(s_a0,s_a1),s_i)) then

if(psym(I_LENGTH,I_O, s_j)*psym(I_LENGTH,I_O, s_a0)*psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_i) > 0 .and. &
   psym(I_LENGTH,I_C, s_c0) > 0 .and. &
   psym(I_LENGTH,I_O, s_a2)*psym(I_LENGTH,I_O, s_a3) > 0) then

! Z1 <-- D3(a0,a2,i,a1,a3,j) 
allocate(Z1_(psym(I_BEGIN,I_O, s_j):psym(I_END,I_O, s_j), &
             psym(I_BEGIN,I_O, s_a0):psym(I_END,I_O, s_a0), &
             psym(I_BEGIN,I_O, s_a1):psym(I_END,I_O, s_a1), &
             psym(I_BEGIN,I_O, s_i):psym(I_END,I_O, s_i), &
...
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
do i_j = psym(I_BEGIN, I_O, s_j), psym(I_END, I_O, s_j)
Z1_(i_j, i_a0, i_a1, i_i, i_a2, i_a3) =  &
  D3_(s_j, s_a3, s_a1, s_i, s_a2, s_a0)%array(i_j, i_a3, i_a1, i_i, i_a2, i_a0)
end do
end do
end do
end do
...
! W9(w,c0,j,a1,a0,i)  <-- Z3
do i_c0 = psym(I_BEGIN, I_C, s_c0), psym(I_END, I_C, s_c0)
do i_j = psym(I_BEGIN, I_O, s_j), psym(I_END, I_O, s_j)
do i_a1 = psym(I_BEGIN, I_O, s_a1), psym(I_END, I_O, s_a1)
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
W9_(s_i, s_a0, s_a1, s_j, s_c0)%array(i_i, i_a0, i_a1, i_j, i_c0) = &
    W9_(s_i, s_a0, s_a1, s_j, s_c0)%array(i_i, i_a0, i_a1, i_j, i_c0) &
  + Z3_(i_j, i_a0, i_a1, i_i, i_c0)
end do
end do
end do
end do
...
end subroutine g_sigma_coov_coov_no0_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no0_x1_type1_eri_c &
...
call set_symblock_Xcaaaa(sleft, W9, nir, nsym, psym) ! -> Xcaaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no0_x1_type1_eri_c &
...
end subroutine g_if_sigma_coov_coov_no0_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no0_x1_type1_eri_c &
...
integer :: s_c0, i_c0, s_a1, i_a1, s_a0, i_a0, s_j, i_j, s_i, i_i
! S2(w,i,j,a) += (    1.00000000) T2(c0,a1,a0,a) W9(w,c0,j,a1,a0,i) 
do s_c0 = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_coov_coov_no0_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no1_x0_type1_eri_c &
...
call g_sigma_coov_coov_no1_x0_type1_eri_c &
  (sw, iw, h2_i, Xcaaaa, d3, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xcaaaa)

end subroutine g_if_sigma_coov_coov_no1_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no1_x0_type1_eri_c &
...
integer :: s_c0, i_c0, s_a3, i_a3, s_a2, i_a2, s_j, i_j, s_a0, i_a0
integer :: s_a1, i_a1, s_i, i_i
! W10(w,c0,j,a1,a0,i) += (    1.00000000) V2(w,c0,a3,a2) D3(j,a0,a3,a2,a1,i) 
do s_c0 = 0, nir-1
do s_a3 = 0, nir-1
do s_a2 = 0, nir-1
do s_j = 0, nir-1
...
IEOR(IEOR(s_j,s_a0),s_a3) == IEOR(IEOR(s_a2,s_a1),s_i)) then
...
! W10(w,c0,j,a1,a0,i)  <-- Z3
do i_c0 = psym(I_BEGIN, I_C, s_c0), psym(I_END, I_C, s_c0)
do i_j = psym(I_BEGIN, I_O, s_j), psym(I_END, I_O, s_j)
do i_a1 = psym(I_BEGIN, I_O, s_a1), psym(I_END, I_O, s_a1)
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
W10_(s_i, s_a0, s_a1, s_j, s_c0)%array(i_i, i_a0, i_a1, i_j, i_c0) = &
    W10_(s_i, s_a0, s_a1, s_j, s_c0)%array(i_i, i_a0, i_a1, i_j, i_c0) &
  + Z3_(i_j, i_a0, i_a1, i_i, i_c0)
end do
end do
...
end subroutine g_sigma_coov_coov_no1_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no1_x1_type1_eri_c &
...
call set_symblock_Xcaaaa(sleft, W10, nir, nsym, psym) ! -> Xcaaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no1_x1_type1_eri_c &
  (sa, ia, sw, iw, av2_i, Xcaaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_coov_no1_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no1_x1_type1_eri_c &
...
integer :: s_c0, i_c0, s_a1, i_a1, s_a0, i_a0, s_j, i_j, s_i, i_i
! S2(w,i,j,a) += (    1.00000000) T2(c0,a1,a0,a) W10(w,c0,j,a1,a0,i) 
do s_c0 = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_coov_coov_no1_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no2_x0_type1_eri_c &
...
call g_sigma_coov_coov_no2_x0_type1_eri_c &
  (sa, ia, sc0, ic0, av2_i, Xaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xaa)

end subroutine g_if_sigma_coov_coov_no2_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no2_x0_type1_eri_c &
...
! W11(c0,i,a2,a) += (    1.00000000) T2(c0,a0,a1,a) D2(i,a0,a1,a2) 
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
do s_a2 = 0, nir-1
...
end subroutine g_sigma_coov_coov_no2_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no2_x1_type1_eri_c &
...
call set_symblock_Xaa(sleft, W11, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no2_x1_type1_eri_c &
...
end subroutine g_if_sigma_coov_coov_no2_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no2_x1_type1_eri_c &
...
end subroutine g_sigma_coov_coov_no2_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no3_x0_type1_eri_c &
...
call g_sigma_coov_coov_no3_x0_type1_eri_c &
  (sa, ia, sc0, ic0, av2_i, Xaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xaa)

end subroutine g_if_sigma_coov_coov_no3_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no3_x0_type1_eri_c &
...
integer :: s_a0, i_a0, s_a1, i_a1, s_i, i_i, s_a2, i_a2
! W12(c0,i,a2,a) += (    1.00000000) T2(c0,a0,a1,a) D2(i,a0,a1,a2) 
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
do s_a2 = 0, nir-1
...
end subroutine g_sigma_coov_coov_no3_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no3_x1_type1_eri_c &
...
call set_symblock_Xaa(sleft, W12, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no3_x1_type1_eri_c &
  (sa, ia, sc0, ic0, h2_i, Xaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_coov_no3_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no3_x1_type1_eri_c &
...
end subroutine g_sigma_coov_coov_no3_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no4_x0_type1_eri_c &
...
call g_sigma_coov_coov_no4_x0_type1_eri_c &
  (sw, iw, h2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_coov_no4_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no4_x0_type1_eri_c &
...
! W14(w,c0,i,a0) += (    1.00000000) V2(w,a2,c0,a1) D2(i,a0,a2,a1) 
do s_a2 = 0, nir-1
do s_c0 = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_coov_no4_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no4_x1_type1_eri_c &
...
call set_symblock_Xcaa(sleft, W14, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no4_x1_type1_eri_c &
...
end subroutine g_if_sigma_coov_coov_no4_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no4_x1_type1_eri_c &
...
integer :: s_c0, i_c0, s_a0, i_a0, s_j, i_j, s_i, i_i
! S2(w,i,j,a) += (    1.00000000) T2(c0,a0,j,a) W14(w,c0,i,a0) 
do s_c0 = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_coov_no4_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no5_x0_type1_eri_c &
...
call g_sigma_coov_coov_no5_x0_type1_eri_c &
  (sw, iw, h2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_coov_no5_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no5_x0_type1_eri_c &
...
end subroutine g_sigma_coov_coov_no5_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no5_x1_type1_eri_c &
...
call set_symblock_Xcaa(sleft, W15, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no5_x1_type1_eri_c &
  (sa, ia, sw, iw, av2_i, Xcaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_coov_no5_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no5_x1_type1_eri_c &
...
integer :: s_c0, i_c0, s_a0, i_a0, s_j, i_j, s_i, i_i
! S2(w,i,j,a) += (   -2.00000000) T2(c0,a0,j,a) W15(w,c0,i,a0) 
do s_c0 = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_coov_no5_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no6_x0_type1_eri_c &
...
call g_sigma_coov_coov_no6_x0_type1_eri_c &
...
end subroutine g_if_sigma_coov_coov_no6_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no6_x0_type1_eri_c &
...
! W17(w,a0,a2,a) += (    1.00000000) V2(w,a2,c0,a1) T2(c0,a0,a1,a) 
do s_a2 = 0, nir-1
do s_c0 = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_coov_coov_no6_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no6_x1_type1_eri_c &
...
call set_symblock_Xaa(sleft, W17, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no6_x1_type1_eri_c &
  (sa, ia, sw, iw, Xaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaa)

end subroutine g_if_sigma_coov_coov_no6_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no6_x1_type1_eri_c &
...
! S2(w,i,j,a) += (   -2.00000000) D2(j,a2,a0,i) W17(w,a0,a2,a) 
do s_j = 0, nir-1
do s_a2 = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_coov_no6_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no7_x0_type1_eri_c &
...
call g_sigma_coov_coov_no7_x0_type1_eri_c &
  (sa, ia, sw, iw, av2_i, h2_i, Xaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_coov_no7_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no7_x0_type1_eri_c &
...
! W18(w,a0,a2,a) += (    1.00000000) V2(w,c0,a2,a1) T2(c0,a0,a1,a) 
do s_c0 = 0, nir-1
do s_a2 = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_coov_coov_no7_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no7_x1_type1_eri_c &
...
call set_symblock_Xaa(sleft, W18, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no7_x1_type1_eri_c &
  (sa, ia, sw, iw, Xaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaa)

end subroutine g_if_sigma_coov_coov_no7_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no7_x1_type1_eri_c &
...
integer :: s_j, i_j, s_a2, i_a2, s_a0, i_a0, s_i, i_i
! S2(w,i,j,a) += (    1.00000000) D2(j,a2,a0,i) W18(w,a0,a2,a) 
do s_j = 0, nir-1
do s_a2 = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_coov_no7_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no8_x0_type1_eri_c &
...
call g_sigma_coov_coov_no8_x0_type1_eri_c &
  (sa, ia, sw, iw, av2_i, h2_i, Xaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_coov_no8_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no8_x0_type1_eri_c &
...
! W20(w,a0,j,a) += (    1.00000000) V2(w,j,c0,a1) T2(c0,a0,a1,a) 
do s_j = 0, nir-1
do s_c0 = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_coov_coov_no8_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no8_x1_type1_eri_c &
...
call set_symblock_Xaa(sleft, W20, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no8_x1_type1_eri_c &
  (sa, ia, sw, iw, Xaa, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaa)

end subroutine g_if_sigma_coov_coov_no8_x1_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_coov_coov_no8_x1_type1_eri_c &
...
! S2(w,i,j,a) += (    4.00000000) D1(i,a0) W20(w,a0,j,a) 
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
if( &
...
end subroutine g_sigma_coov_coov_no8_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no9_x0_type1_eri_c &
...
call g_sigma_coov_coov_no9_x0_type1_eri_c &
  (sa, ia, sw, iw, av2_i, h2_i, Xaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_coov_no9_x0_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no9_x0_type1_eri_c &
...
! W22(w,a0,j,a) += (    1.00000000) V2(w,c0,j,a1) T2(c0,a0,a1,a) 
do s_c0 = 0, nir-1
do s_j = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_coov_coov_no9_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no9_x1_type1_eri_c &
...
call set_symblock_Xaa(sleft, W22, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no9_x1_type1_eri_c &
  (sa, ia, sw, iw, Xaa, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaa)

end subroutine g_if_sigma_coov_coov_no9_x1_type1_eri_c
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_coov_coov_no9_x1_type1_eri_c &
...
integer :: s_i, i_i, s_a0, i_a0, s_j, i_j
! S2(w,i,j,a) += (   -2.00000000) D1(i,a0) W22(w,a0,j,a) 
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
if( &
...
end subroutine g_sigma_coov_coov_no9_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no0_x0_type1_eri_o &
...
call g_sigma_coov_coov_no0_x0_type1_eri_o &
  (sj, ij, h2_i, Xaaa, d3, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_coov_coov_no0_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no0_x0_type1_eri_o &
...
integer :: s_a1, i_a1
! W13(i,a1,a0,j) += (    1.00000000) V2(j,a3,a4,a2) D3(i,a0,a4,a2,a1,a3) 
do s_a3 = 0, nir-1
do s_a4 = 0, nir-1
do s_a2 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_coov_no0_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no0_x1_type1_eri_o &
...
call set_symblock_Xaaa(sleft, W13, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no0_x1_type1_eri_o &
...
end subroutine g_if_sigma_coov_coov_no0_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no0_x1_type1_eri_o &
...
integer :: s_w, i_w, s_a0, i_a0, s_a1, i_a1, s_i, i_i
! S2(w,i,j,a) += (   -1.00000000) T2(w,a0,a1,a) W13(i,a1,a0,j) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_coov_no0_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no1_x0_type1_eri_o &
...
call g_sigma_coov_coov_no1_x0_type1_eri_o &
  (sa4, ia4, h2_i, Xaa, d3, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaa)

end subroutine g_if_sigma_coov_coov_no1_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no1_x0_type1_eri_o &
...
end subroutine g_sigma_coov_coov_no1_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no2_x0_type1_eri_o &
...
call g_sigma_coov_coov_no2_x0_type1_eri_o &
  (sa1, ia1, h2_i, Xaaa, d3, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_coov_coov_no2_x0_type1_eri_o
...
! >> Score :: 111111
! The best shot!
! RDM is rotated :: D3(j,a3,a4,a2,a0,i)  >> D3(a2,a4,a3,j,i,a0) 
! rowInd : @[a0, "active"] @[i, "active"] @[j, "active"] 
! summedInd : @[a3, "active"] @[a4, "active"] @[a2, "active"] 
! -- Check2 is skipped 
!    -- is4RDM.second false
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no2_x0_type1_eri_o &
...
integer :: s_i, i_i
! W19(j,a0,i,a1) += (    1.00000000) V2(a1,a3,a4,a2) D3(j,a3,a4,a2,a0,i) 
do s_a3 = 0, nir-1
do s_a4 = 0, nir-1
do s_a2 = 0, nir-1
do s_j = 0, nir-1
...
IEOR(IEOR(s_j,s_a3),s_a4) == IEOR(IEOR(s_a2,s_a0),s_i)) then

if(psym(I_LENGTH,I_O, s_a0)*psym(I_LENGTH,I_O, s_i)*psym(I_LENGTH,I_O, s_j) > 0 .and. &
   psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_a4)*psym(I_LENGTH,I_O, s_a2) > 0) then
...
! Gemm Z1 * Z2 to form Z3
call dgemm('n', 'n', psym(I_LENGTH,I_O, s_a0)*psym(I_LENGTH,I_O, s_i)*psym(I_LENGTH,I_O, s_j),&
                     1,&
                     psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_a4)*psym(I_LENGTH,I_O, s_a2),&
                     1.00000000d+00, &
                     D3_(s_a0, s_i, s_j, s_a3, s_a4, s_a2)%array,&
                     psym(I_LENGTH,I_O, s_a0)*psym(I_LENGTH,I_O, s_i)*psym(I_LENGTH,I_O, s_j),&
                     Z2_,&
                     psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_a4)*psym(I_LENGTH,I_O, s_a2),&
                     0.0d+00,&
                     Z3_,&
...
! Flop count
flops = flops + psym(I_LENGTH,I_O, s_a0)*psym(I_LENGTH,I_O, s_i)*psym(I_LENGTH,I_O, s_j) * &
                1 * &
                psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_a4)*psym(I_LENGTH,I_O, s_a2) * 2.0d+00
...
end subroutine g_sigma_coov_coov_no2_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no2_x1_type1_eri_o &
...
call set_symblock_Xaaa(sleft, W19, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no2_x1_type1_eri_o &
...
end subroutine g_if_sigma_coov_coov_no2_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no2_x1_type1_eri_o &
...
integer :: s_w, i_w, s_a0, i_a0, s_j, i_j, s_i, i_i
! S2(w,i,j,a) += (   -1.00000000) T2(w,a0,a1,a) W19(j,a0,i,a1) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_coov_no2_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no3_x0_type1_eri_o &
...
call g_sigma_coov_coov_no3_x0_type1_eri_o &
  (sj, ij, h2_i, Xaaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_coov_coov_no3_x0_type1_eri_o
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_coov_coov_no3_x0_type1_eri_o &
...
integer :: s_a2, i_a2, s_a3, i_a3, s_a1, i_a1, s_i, i_i, s_a0, i_a0
! W21(i,a0,j,a1) += (    1.00000000) V2(j,a2,a3,a1) D2(i,a0,a3,a2) 
do s_a2 = 0, nir-1
do s_a3 = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_coov_no3_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no3_x1_type1_eri_o &
...
call set_symblock_Xaaa(sleft, W21, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no3_x1_type1_eri_o &
  (sa, ia, sj, ij, av2_i, Xaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_coov_no3_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no3_x1_type1_eri_o &
...
integer :: s_w, i_w, s_a0, i_a0, s_a1, i_a1, s_i, i_i
! S2(w,i,j,a) += (   -1.00000000) T2(w,a0,a1,a) W21(i,a0,j,a1) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_coov_no3_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no4_x0_type1_eri_o &
...
call g_sigma_coov_coov_no4_x0_type1_eri_o &
  (sj, ij, h2_i, Xaaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaa)

end subroutine g_if_sigma_coov_coov_no4_x0_type1_eri_o
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_coov_coov_no4_x0_type1_eri_o &
...
end subroutine g_sigma_coov_coov_no4_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no4_x1_type1_eri_o &
...
call set_symblock_Xaaa(sleft, W23, nir, nsym, psym) ! -> Xaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no4_x1_type1_eri_o &
  (sa, ia, sj, ij, av2_i, Xaaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_coov_no4_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no4_x1_type1_eri_o &
...
! S2(w,i,j,a) += (    2.00000000) T2(w,a0,a2,a) W23(i,a0,j,a2) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_a2 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_coov_no4_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no0_x0_type2_eri_o &
...
call set_symblock_Xaa(sleft, W16, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no0_x0_type2_eri_o &
  (sa, ia, av2_i, Xaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_coov_no0_x0_type2_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no0_x0_type2_eri_o &
...
integer :: s_w, i_w, s_a0, i_a0, s_j, i_j, s_i, i_i
! S2(w,i,j,a) += (    1.00000000) T2(w,a0,j,a) W16(i,a0) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_coov_no0_x0_type2_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no0_x0_type1_eri_v &
  (sa, ia, sv0, iv0, T2, V2, W24, nir, nsym, psym, flops)
...
call g_sigma_coov_coov_no0_x0_type1_eri_v &
...
end subroutine g_if_sigma_coov_coov_no0_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no0_x0_type1_eri_v &
  (s_a, i_a, s_v0, i_v0, T2_, V2_, W24_, nir, nsym, psym, flops)
...
! W24(w,a1,a0,a) += (    1.00000000) V2(a,w,v0,c0) T2(c0,a1,a0,v0) 
do s_w = 0, nir-1
do s_c0 = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
...
do i_a1 = psym(I_BEGIN, I_O, s_a1), psym(I_END, I_O, s_a1)
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
W24_(s_a0, s_a1, s_w)%array(i_a0, i_a1, i_w) = &
    W24_(s_a0, s_a1, s_w)%array(i_a0, i_a1, i_w) &
  + Z3_(i_a1, i_a0, i_w)
end do
end do
...
end subroutine g_sigma_coov_coov_no0_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no0_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W24, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no0_x1_type1_eri_v &
  (sa, ia, Xcaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_coov_no0_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no0_x1_type1_eri_v &
  (s_a, i_a, W24_, S2_, D2_, nir, nsym, psym, flops)
...
! S2(w,i,j,a) += (    1.00000000) D2(j,i,a1,a0) W24(w,a1,a0,a) 
do s_j = 0, nir-1
do s_i = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_coov_coov_no0_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no1_x0_type1_eri_v &
  (sa, ia, sv0, iv0, T2, V2, W25, nir, nsym, psym, flops)
...
call set_symblock_Xcaaaa(sleft, W25, nir, nsym, psym) ! -> Xcaaaa (allocate) 
call g_sigma_coov_coov_no1_x0_type1_eri_v &
  (sa, ia, sv0, iv0, av2_i, h2_i, Xcaaaa, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(h2_i)
deallocate(Xcaaaa)

end subroutine g_if_sigma_coov_coov_no1_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no1_x0_type1_eri_v &
  (s_a, i_a, s_v0, i_v0, T2_, V2_, W25_, nir, nsym, psym, flops)
...
type(symblock3), intent(inout) :: T2_(0:nir-1, 0:nir-1, 0:nir-1)
type(symblock3), intent(inout) :: V2_(0:nir-1, 0:nir-1, 0:nir-1)
type(symblock5), intent(inout) :: W25_(0:nir-1, 0:nir-1, 0:nir-1, 0:nir-1, 0:nir-1)
...
integer :: s_a3, i_a3, s_a2, i_a2, s_w, i_w, s_a1, i_a1, s_a0, i_a0
! W25(w,a1,a0,a3,a2,a) += (    1.00000000) V2(a,a3,v0,a2) T2(w,a1,a0,v0) 
do s_a3 = 0, nir-1
do s_a2 = 0, nir-1
do s_w = 0, nir-1
do s_a1 = 0, nir-1
...
IEOR(s_w,s_a1) == IEOR(s_a0,s_v0)) then

if(psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_a2) > 0 .and. &
   psym(I_LENGTH,I_C, s_w)*psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_a0) > 0) then
...
call dgemm('n', 'n', psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_a2),&
                     psym(I_LENGTH,I_C, s_w)*psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_a0),&
                     1,&
                     1.00000000d+00, &
                     Z1_,&
                     psym(I_LENGTH,I_O, s_a3)*psym(I_LENGTH,I_O, s_a2),&
...
do i_a3 = psym(I_BEGIN, I_O, s_a3), psym(I_END, I_O, s_a3)
do i_a2 = psym(I_BEGIN, I_O, s_a2), psym(I_END, I_O, s_a2)
W25_(s_a2, s_a3, s_a0, s_a1, s_w)%array(i_a2, i_a3, i_a0, i_a1, i_w) = &
    W25_(s_a2, s_a3, s_a0, s_a1, s_w)%array(i_a2, i_a3, i_a0, i_a1, i_w) &
  + Z3_(i_a3, i_a2, i_w, i_a1, i_a0)
end do
end do
end do
end do
...
end subroutine g_sigma_coov_coov_no1_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no1_x1_type1_eri_v &
...
call set_symblock_Xcaaaa(sleft, W25, nir, nsym, psym) ! -> Xcaaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no1_x1_type1_eri_v &
  (sa, ia, Xcaaaa, av2_i2, d3, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaaaa)

end subroutine g_if_sigma_coov_coov_no1_x1_type1_eri_v
...
! Information for debugging 
! >> Score :: 111010
! RDM is rotated :: D3(j,a0,a3,i,a1,a2)  >> D3(i,a3,a2,a1,a0,j) 
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no1_x1_type1_eri_v &
  (s_a, i_a, W25_, S2_, D3_, nir, nsym, psym, flops)
...
integer :: s_j, i_j, s_a0, i_a0, s_a3, i_a3, s_i, i_i, s_a1, i_a1
integer :: s_a2, i_a2, s_w, i_w
! S2(w,i,j,a) += (   -1.00000000) D3(j,a0,a3,i,a1,a2) W25(w,a1,a0,a3,a2,a) 
do s_j = 0, nir-1
do s_a0 = 0, nir-1
do s_a3 = 0, nir-1
do s_i = 0, nir-1
...
if( &
IEOR(s_w,s_i) == IEOR(s_j,s_a) .and. & 
IEOR(IEOR(s_j,s_a0),s_a3) == IEOR(IEOR(s_i,s_a1),s_a2) .and. &
...
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
do i_j = psym(I_BEGIN, I_O, s_j), psym(I_END, I_O, s_j)
Z1_(i_j, i_i, i_a1, i_a2, i_a3, i_a0) =  &
  D3_(s_j, s_a0, s_a1, s_a2, s_a3, s_i)%array(i_j, i_a0, i_a1, i_a2, i_a3, i_i)
end do
end do
end do
end do
...
end subroutine g_sigma_coov_coov_no1_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no2_x0_type1_eri_v &
  (sa, ia, sv0, iv0, T2, V2, W26, nir, nsym, psym, flops)
...
call g_sigma_coov_coov_no2_x0_type1_eri_v &
  (sa, ia, sv0, iv0, av2_i, h2_i, Xcaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_coov_no2_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no2_x0_type1_eri_v &
  (s_a, i_a, s_v0, i_v0, T2_, V2_, W26_, nir, nsym, psym, flops)
...
integer :: s_w, i_w, s_c0, i_c0, s_a1, i_a1, s_a0, i_a0
! W26(w,a1,a0,a) += (    1.00000000) V2(a,v0,w,c0) T2(c0,a1,a0,v0) 
do s_w = 0, nir-1
do s_c0 = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_coov_coov_no2_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no2_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W26, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no2_x1_type1_eri_v &
  (sa, ia, Xcaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_coov_no2_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no2_x1_type1_eri_v &
...
! S2(w,i,j,a) += (    1.00000000) D2(j,a0,a1,i) W26(w,a1,a0,a) 
do s_j = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_coov_no2_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no3_x0_type1_eri_v &
...
call g_sigma_coov_coov_no3_x0_type1_eri_v &
  (sa, ia, sv0, iv0, av2_i, h2_i, Xcaaaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_coov_no3_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no3_x0_type1_eri_v &
...
integer :: s_a3, i_a3, s_a2, i_a2, s_w, i_w, s_a1, i_a1, s_a0, i_a0
! W27(w,a1,a0,a3,a2,a) += (    1.00000000) V2(a,v0,a3,a2) T2(w,a1,a0,v0) 
do s_a3 = 0, nir-1
do s_a2 = 0, nir-1
do s_w = 0, nir-1
do s_a1 = 0, nir-1
...
do i_a3 = psym(I_BEGIN, I_O, s_a3), psym(I_END, I_O, s_a3)
do i_a2 = psym(I_BEGIN, I_O, s_a2), psym(I_END, I_O, s_a2)
W27_(s_a2, s_a3, s_a0, s_a1, s_w)%array(i_a2, i_a3, i_a0, i_a1, i_w) = &
    W27_(s_a2, s_a3, s_a0, s_a1, s_w)%array(i_a2, i_a3, i_a0, i_a1, i_w) &
  + Z3_(i_a3, i_a2, i_w, i_a1, i_a0)
end do
end do
...
end subroutine g_sigma_coov_coov_no3_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no3_x1_type1_eri_v &
...
call set_symblock_Xcaaaa(sleft, W27, nir, nsym, psym) ! -> Xcaaaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no3_x1_type1_eri_v &
  (sa, ia, Xcaaaa, av2_i2, d3, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaaaa)

end subroutine g_if_sigma_coov_coov_no3_x1_type1_eri_v
...
! Information for debugging 
! >> Score :: 110101
! RDM is rotated :: D3(j,a0,a3,a2,a1,i)  >> D3(a2,a3,a0,j,i,a1) 
! rowInd : @[j, "active"] @[i, "active"] 
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no3_x1_type1_eri_v &
  (s_a, i_a, W27_, S2_, D3_, nir, nsym, psym, flops)
...
! S2(w,i,j,a) += (   -1.00000000) D3(j,a0,a3,a2,a1,i) W27(w,a1,a0,a3,a2,a) 
do s_j = 0, nir-1
do s_a0 = 0, nir-1
do s_a3 = 0, nir-1
do s_a2 = 0, nir-1
...
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
do i_j = psym(I_BEGIN, I_O, s_j), psym(I_END, I_O, s_j)
Z1_(i_j, i_i, i_a1, i_a0, i_a3, i_a2) =  &
  D3_(s_a1, s_i, s_j, s_a0, s_a3, s_a2)%array(i_a1, i_i, i_j, i_a0, i_a3, i_a2)
end do
end do
end do
end do
...
end subroutine g_sigma_coov_coov_no3_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no4_x0_type1_eri_v &
...
call g_sigma_coov_coov_no4_x0_type1_eri_v &
  (sv0, iv0, av2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_coov_no4_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no4_x0_type1_eri_v &
...
! W28(w,i,a2,v0) += (    1.00000000) T2(w,a0,a1,v0) D2(i,a0,a1,a2) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_coov_no4_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no4_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W28, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no4_x1_type1_eri_v &
...
end subroutine g_if_sigma_coov_coov_no4_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no4_x1_type1_eri_v &
...
end subroutine g_sigma_coov_coov_no4_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no5_x0_type1_eri_v &
...
call g_sigma_coov_coov_no5_x0_type1_eri_v &
  (sa, ia, sv0, iv0, av2_i, h2_i, Xcaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_coov_no5_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no5_x0_type1_eri_v &
...
! W29(w,a0,j,a) += (    1.00000000) V2(a,w,v0,c0) T2(c0,a0,j,v0) 
do s_w = 0, nir-1
do s_c0 = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
...
IEOR(s_w,s_a0) == IEOR(s_j,s_a) .and. & 
IEOR(s_a,s_w) == IEOR(s_v0,s_c0) .and. &
IEOR(s_c0,s_a0) == IEOR(s_j,s_v0)) then
...
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
do i_j = psym(I_BEGIN, I_O, s_j), psym(I_END, I_O, s_j)
W29_(s_j, s_a0, s_w)%array(i_j, i_a0, i_w) = &
    W29_(s_j, s_a0, s_w)%array(i_j, i_a0, i_w) &
  + Z3_(i_a0, i_j, i_w)
end do
end do
...
end subroutine g_sigma_coov_coov_no5_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no5_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W29, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no5_x1_type1_eri_v &
  (sa, ia, Xcaa, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_coov_no5_x1_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_coov_coov_no5_x1_type1_eri_v &
...
! S2(w,i,j,a) += (    1.00000000) D1(i,a0) W29(w,a0,j,a) 
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_coov_coov_no5_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no6_x0_type1_eri_v &
...
call g_sigma_coov_coov_no6_x0_type1_eri_v &
  (sa, ia, sv0, iv0, h2_i, Xaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaa)

end subroutine g_if_sigma_coov_coov_no6_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no6_x0_type1_eri_v &
...
end subroutine g_sigma_coov_coov_no6_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no6_x1_type1_eri_v &
...
call set_symblock_Xaa(sleft, W30, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no6_x1_type1_eri_v &
...
end subroutine g_if_sigma_coov_coov_no6_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no6_x1_type1_eri_v &
...
integer :: s_w, i_w, s_a0, i_a0, s_j, i_j, s_i, i_i
! S2(w,i,j,a) += (    2.00000000) T2(w,a0,j,v0) W30(i,a0,v0,a) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_coov_no6_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no7_x0_type1_eri_v &
  (sa, ia, sv0, iv0, T2, V2, W31, nir, nsym, psym, flops)
...
call g_sigma_coov_coov_no7_x0_type1_eri_v &
  (sa, ia, sv0, iv0, av2_i, h2_i, Xcaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_coov_no7_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no7_x0_type1_eri_v &
  (s_a, i_a, s_v0, i_v0, T2_, V2_, W31_, nir, nsym, psym, flops)
...
integer :: s_w, i_w, s_c0, i_c0, s_a0, i_a0, s_j, i_j
! W31(w,a0,j,a) += (    1.00000000) V2(a,v0,w,c0) T2(c0,a0,j,v0) 
do s_w = 0, nir-1
do s_c0 = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_coov_coov_no7_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no7_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W31, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no7_x1_type1_eri_v &
  (sa, ia, Xcaa, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_coov_no7_x1_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_coov_coov_no7_x1_type1_eri_v &
...
integer :: s_i, i_i, s_a0, i_a0, s_w, i_w, s_j, i_j
! S2(w,i,j,a) += (   -2.00000000) D1(i,a0) W31(w,a0,j,a) 
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_coov_coov_no7_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no8_x0_type1_eri_v &
...
call g_sigma_coov_coov_no8_x0_type1_eri_v &
  (sa, ia, sv0, iv0, h2_i, Xaa, d2, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaa)

end subroutine g_if_sigma_coov_coov_no8_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no8_x0_type1_eri_v &
...
end subroutine g_sigma_coov_coov_no8_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no8_x1_type1_eri_v &
...
call set_symblock_Xaa(sleft, W32, nir, nsym, psym) ! -> Xaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no8_x1_type1_eri_v &
  (sa, ia, sv0, iv0, av2_i, Xaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_coov_no8_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no8_x1_type1_eri_v &
...
integer :: s_w, i_w, s_a0, i_a0, s_j, i_j, s_i, i_i
! S2(w,i,j,a) += (    2.00000000) T2(w,a0,j,v0) W32(i,a0,v0,a) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_coov_no8_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no9_x0_type1_eri_v &
...
call g_sigma_coov_coov_no9_x0_type1_eri_v &
  (sv0, iv0, av2_i, Xcaa, d2, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_coov_no9_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no9_x0_type1_eri_v &
...
integer :: s_w, i_w, s_a0, i_a0, s_a1, i_a1, s_i, i_i, s_a2, i_a2
! W33(w,i,a2,v0) += (    1.00000000) T2(w,a0,a1,v0) D2(i,a2,a1,a0) 
do s_w = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_coov_no9_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no9_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W33, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no9_x1_type1_eri_v &
  (sa, ia, sv0, iv0, h2_i, Xcaa, av2_i2, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_coov_no9_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no9_x1_type1_eri_v &
...
integer :: s_j, i_j, s_a2, i_a2, s_w, i_w, s_i, i_i
! S2(w,i,j,a) += (   -1.00000000) V2(v0,j,a2,a) W33(w,i,a2,v0) 
do s_j = 0, nir-1
do s_a2 = 0, nir-1
do s_w = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_coov_no9_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no10_x0_type1_eri_v &
...
call g_sigma_coov_coov_no10_x0_type1_eri_v &
  (sa, ia, sv0, iv0, av2_i, h2_i, Xcaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_coov_no10_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no10_x0_type1_eri_v &
...
! W34(w,a0,a1,a) += (    1.00000000) V2(a,a2,v0,a1) T2(w,a0,a2,v0) 
do s_a2 = 0, nir-1
do s_a1 = 0, nir-1
do s_w = 0, nir-1
do s_a0 = 0, nir-1
...
IEOR(s_w,s_a0) == IEOR(s_a2,s_v0)) then
...
end subroutine g_sigma_coov_coov_no10_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no10_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W34, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no10_x1_type1_eri_v &
  (sa, ia, Xcaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_coov_no10_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no10_x1_type1_eri_v &
...
! S2(w,i,j,a) += (   -1.00000000) D2(j,i,a0,a1) W34(w,a0,a1,a) 
do s_j = 0, nir-1
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
...
end subroutine g_sigma_coov_coov_no10_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no11_x0_type1_eri_v &
  (sa, ia, sv0, iv0, T2, V2, W35, nir, nsym, psym, flops)
...
call g_sigma_coov_coov_no11_x0_type1_eri_v &
  (sa, ia, sv0, iv0, av2_i, h2_i, Xcaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_coov_no11_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no11_x0_type1_eri_v &
  (s_a, i_a, s_v0, i_v0, T2_, V2_, W35_, nir, nsym, psym, flops)
...
integer :: s_a2, i_a2, s_a1, i_a1, s_w, i_w, s_a0, i_a0
! W35(w,a0,a2,a) += (    1.00000000) V2(a,v0,a2,a1) T2(w,a0,a1,v0) 
do s_a2 = 0, nir-1
do s_a1 = 0, nir-1
do s_w = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_coov_coov_no11_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no11_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W35, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no11_x1_type1_eri_v &
  (sa, ia, Xcaa, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_coov_no11_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no11_x1_type1_eri_v &
...
integer :: s_j, i_j, s_a2, i_a2, s_a0, i_a0, s_i, i_i, s_w, i_w
! S2(w,i,j,a) += (   -1.00000000) D2(j,a2,a0,i) W35(w,a0,a2,a) 
do s_j = 0, nir-1
do s_a2 = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_coov_coov_no11_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no12_x0_type1_eri_v &
  (sa, ia, sv0, iv0, T2, V2, W36, nir, nsym, psym, flops)
...
call g_sigma_coov_coov_no12_x0_type1_eri_v &
  (sa, ia, sv0, iv0, av2_i, h2_i, Xcaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_coov_no12_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no12_x0_type1_eri_v &
  (s_a, i_a, s_v0, i_v0, T2_, V2_, W36_, nir, nsym, psym, flops)
...
! W36(w,a0,j,a) += (    1.00000000) V2(a,v0,j,a1) T2(w,a0,a1,v0) 
do s_j = 0, nir-1
do s_a1 = 0, nir-1
do s_w = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_coov_coov_no12_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no12_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W36, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no12_x1_type1_eri_v &
  (sa, ia, Xcaa, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_coov_no12_x1_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_coov_coov_no12_x1_type1_eri_v &
...
integer :: s_i, i_i, s_a0, i_a0, s_w, i_w, s_j, i_j
! S2(w,i,j,a) += (    2.00000000) D1(i,a0) W36(w,a0,j,a) 
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_coov_coov_no12_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no13_x0_type1_eri_v &
...
call g_sigma_coov_coov_no13_x0_type1_eri_v &
  (sa, ia, sv0, iv0, av2_i, h2_i, Xcaa, nir, nsym, psym, flops)
...
end subroutine g_if_sigma_coov_coov_no13_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_coov_coov_no13_x0_type1_eri_v &
...
integer :: s_a1, i_a1, s_j, i_j, s_w, i_w, s_a0, i_a0
! W37(w,a0,j,a) += (    1.00000000) V2(a,a1,v0,j) T2(w,a0,a1,v0) 
do s_a1 = 0, nir-1
do s_j = 0, nir-1
do s_w = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_coov_coov_no13_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_coov_coov_no13_x1_type1_eri_v &
...
call set_symblock_Xcaa(sleft, W37, nir, nsym, psym) ! -> Xcaa (allocate) 
call set_symblock_av2_2(sa, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_coov_coov_no13_x1_type1_eri_v &
  (sa, ia, Xcaa, av2_i2, d1, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xcaa)

end subroutine g_if_sigma_coov_coov_no13_x1_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_coov_coov_no13_x1_type1_eri_v &
...
integer :: s_i, i_i, s_a0, i_a0, s_w, i_w, s_j, i_j
! S2(w,i,j,a) += (   -1.00000000) D1(i,a0) W37(w,a0,j,a) 
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_w = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_coov_coov_no13_x1_type1_eri_v
