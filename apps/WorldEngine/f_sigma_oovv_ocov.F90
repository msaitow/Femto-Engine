...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_oovv_ocov_no0_x0_type1_eri_c &
...
call g_sigma_oovv_ocov_no0_x0_type1_eri_c &
  (sc0, ic0, h2_i, Xaaaav, d3, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xaaaav)

end subroutine g_if_sigma_oovv_ocov_no0_x0_type1_eri_c
...
! >> Score :: 111001
! RDM is rotated :: D3(j,a2,i,a3,a1,a0)  >> D3(a2,j,a0,a1,a3,i) 
! summedInd : @[a2, "active"] @[a3, "active"] 
! colInd : @[a1, "active"] @[a0, "active"] @[j, "active"] @[i, "active"] 
subroutine g_sigma_oovv_ocov_no0_x0_type1_eri_c &
...
integer :: s_a2, i_a2, s_a3, i_a3, s_a, i_a, s_j, i_j, s_i, i_i
integer :: s_a1, i_a1, s_a0, i_a0
! W0(c0,j,i,a1,a0,a) += (    1.00000000) V2(c0,a2,a3,a) D3(j,a2,i,a3,a1,a0) 
do s_a2 = 0, nir-1
do s_a3 = 0, nir-1
do s_a = 0, nir-1
do s_j = 0, nir-1
...
if(psym(I_LENGTH,I_V, s_a) > 0 .and. &
   psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_a0)*psym(I_LENGTH,I_O, s_j)*psym(I_LENGTH,I_O, s_i) > 0 .and. &
...
do i_a3 = psym(I_BEGIN, I_O, s_a3), psym(I_END, I_O, s_a3)
do i_a2 = psym(I_BEGIN, I_O, s_a2), psym(I_END, I_O, s_a2)
Z2_(i_a2, i_a3, i_a1, i_a0, i_j, i_i) =  &
  D3_(s_i, s_a3, s_a1, s_a0, s_j, s_a2)%array(i_i, i_a3, i_a1, i_a0, i_j, i_a2)
end do
end do
end do
end do
...
call dgemm('n', 'n', psym(I_LENGTH,I_V, s_a),&
                     psym(I_LENGTH,I_O, s_a1)*psym(I_LENGTH,I_O, s_a0)*psym(I_LENGTH,I_O, s_j)*psym(I_LENGTH,I_O, s_i),&
...
end subroutine g_sigma_oovv_ocov_no0_x0_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_oovv_ocov_no0_x1_type1_eri_c &
...
call g_sigma_oovv_ocov_no0_x1_type1_eri_c &
...
end subroutine g_if_sigma_oovv_ocov_no0_x1_type1_eri_c
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_oovv_ocov_no0_x1_type1_eri_c &
...
! S2(i,j,a,b) += (   -1.00000000) T2(a0,c0,a1,b) W0(c0,j,i,a1,a0,a) 
do s_a0 = 0, nir-1
do s_a1 = 0, nir-1
do s_j = 0, nir-1
do s_i = 0, nir-1
...
end subroutine g_sigma_oovv_ocov_no0_x1_type1_eri_c
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_oovv_ocov_no0_x0_type1_eri_o &
...
call g_sigma_oovv_ocov_no0_x0_type1_eri_o &
...
end subroutine g_if_sigma_oovv_ocov_no0_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_oovv_ocov_no0_x0_type1_eri_o &
...
! W2(a0,a2,b,a) += (    1.00000000) V2(a2,a,c0,a1) T2(a0,c0,a1,b) 
do s_a = 0, nir-1
do s_c0 = 0, nir-1
do s_a1 = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_oovv_ocov_no0_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_oovv_ocov_no0_x1_type1_eri_o &
...
call set_symblock_Xav(sleft, W2, nir, nsym, psym) ! -> Xav (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_oovv_ocov_no0_x1_type1_eri_o &
  (sa2, ia2, sb, ib, Xav, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xav)

end subroutine g_if_sigma_oovv_ocov_no0_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_oovv_ocov_no0_x1_type1_eri_o &
...
! S2(i,j,a,b) += (   -1.00000000) D2(j,a0,i,a2) W2(a0,a2,b,a) 
do s_j = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
do s_a = 0, nir-1
...
end subroutine g_sigma_oovv_ocov_no0_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_oovv_ocov_no1_x0_type1_eri_o &
...
call g_sigma_oovv_ocov_no1_x0_type1_eri_o &
...
end subroutine g_if_sigma_oovv_ocov_no1_x0_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_oovv_ocov_no1_x0_type1_eri_o &
...
! W5(a0,a1,b,a) += (    1.00000000) V2(a1,c0,a2,a) T2(a0,c0,a2,b) 
do s_c0 = 0, nir-1
do s_a2 = 0, nir-1
do s_a = 0, nir-1
do s_a0 = 0, nir-1
...
IEOR(s_a0,s_c0) == IEOR(s_a2,s_b)) then
...
end subroutine g_sigma_oovv_ocov_no1_x0_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_oovv_ocov_no1_x1_type1_eri_o &
...
call set_symblock_Xav(sleft, W5, nir, nsym, psym) ! -> Xav (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_oovv_ocov_no1_x1_type1_eri_o &
  (sa1, ia1, sb, ib, Xav, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xav)

end subroutine g_if_sigma_oovv_ocov_no1_x1_type1_eri_o
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_oovv_ocov_no1_x1_type1_eri_o &
...
integer :: s_j, i_j, s_i, i_i, s_a0, i_a0, s_a, i_a
! S2(i,j,a,b) += (   -1.00000000) D2(j,a1,i,a0) W5(a0,a1,b,a) 
do s_j = 0, nir-1
do s_i = 0, nir-1
do s_a0 = 0, nir-1
do s_a = 0, nir-1
...
end subroutine g_sigma_oovv_ocov_no1_x1_type1_eri_o
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_oovv_ocov_no0_x0_type1_eri_v &
  (sa1, ia1, sb, ib, V2, W1, nir, nsym, psym, flops)
...
call g_sigma_oovv_ocov_no0_x0_type1_eri_v &
  (sa1, ia1, sb, ib, h2_i, Xcaaa, d3, nir, nsym, psym, flops)

deallocate(h2_i)
deallocate(Xcaaa)

end subroutine g_if_sigma_oovv_ocov_no0_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_oovv_ocov_no0_x0_type1_eri_v &
  (s_a1, i_a1, s_b, i_b, V2_, W1_, D3_, nir, nsym, psym, flops)
...
integer :: s_a0, i_a0
! W1(c0,j,i,a1,a0,b) += (    1.00000000) V2(b,a2,c0,a3) D3(j,a2,i,a3,a1,a0) 
do s_a2 = 0, nir-1
do s_c0 = 0, nir-1
do s_a3 = 0, nir-1
do s_j = 0, nir-1
...
do i_i = psym(I_BEGIN, I_O, s_i), psym(I_END, I_O, s_i)
do i_a0 = psym(I_BEGIN, I_O, s_a0), psym(I_END, I_O, s_a0)
W1_(s_a0, s_i, s_j, s_c0)%array(i_a0, i_i, i_j, i_c0) = &
    W1_(s_a0, s_i, s_j, s_c0)%array(i_a0, i_i, i_j, i_c0) &
  + Z3_(i_j, i_i, i_a0, i_c0)
end do
end do
end do
end do
...
end subroutine g_sigma_oovv_ocov_no0_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_oovv_ocov_no0_x1_type1_eri_v &
  (sa1, ia1, sb, ib, T2, W1, S2, nir, nsym, psym, flops)
...
call set_symblock_Xcaaa(sleft, W1, nir, nsym, psym) ! -> Xcaaa (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_oovv_ocov_no0_x1_type1_eri_v &
  (sa1, ia1, sb, ib, av2_i, Xcaaa, av2_i2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(av2_i)
deallocate(Xcaaa)

end subroutine g_if_sigma_oovv_ocov_no0_x1_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_oovv_ocov_no0_x1_type1_eri_v &
  (s_a1, i_a1, s_b, i_b, T2_, W1_, S2_, nir, nsym, psym, flops)
...
integer :: s_c0, i_c0, s_a0, i_a0, s_a, i_a, s_j, i_j, s_i, i_i
! S2(i,j,a,b) += (   -1.00000000) T2(c0,a0,a,a1) W1(c0,j,i,a1,a0,b) 
do s_c0 = 0, nir-1
do s_a0 = 0, nir-1
do s_a = 0, nir-1
do s_j = 0, nir-1
...
end subroutine g_sigma_oovv_ocov_no0_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_oovv_ocov_no1_x0_type1_eri_v &
  (sa2, ia2, sb, ib, T2, V2, W3, nir, nsym, psym, flops)
...
call g_sigma_oovv_ocov_no1_x0_type1_eri_v &
...
end subroutine g_if_sigma_oovv_ocov_no1_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_oovv_ocov_no1_x0_type1_eri_v &
  (s_a2, i_a2, s_b, i_b, T2_, V2_, W3_, nir, nsym, psym, flops)
...
! W3(a0,a1,a,b) += (    1.00000000) V2(b,a1,c0,a2) T2(c0,a0,a,a2) 
do s_a1 = 0, nir-1
do s_c0 = 0, nir-1
do s_a0 = 0, nir-1
do s_a = 0, nir-1
...
IEOR(s_c0,s_a0) == IEOR(s_a,s_a2)) then
...
do i_a1 = psym(I_BEGIN, I_O, s_a1), psym(I_END, I_O, s_a1)
do i_a = psym(I_BEGIN, I_V, s_a), psym(I_END, I_V, s_a)
W3_(s_a, s_a1, s_a0)%array(i_a, i_a1, i_a0) = &
    W3_(s_a, s_a1, s_a0)%array(i_a, i_a1, i_a0) &
  + Z3_(i_a0, i_a, i_a1)
end do
end do
...
end subroutine g_sigma_oovv_ocov_no1_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_oovv_ocov_no1_x1_type1_eri_v &
...
call set_symblock_Xaav(sleft, W3, nir, nsym, psym) ! -> Xaav (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_oovv_ocov_no1_x1_type1_eri_v &
  (sb, ib, Xaav, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaav)

end subroutine g_if_sigma_oovv_ocov_no1_x1_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_oovv_ocov_no1_x1_type1_eri_v &
  (s_b, i_b, W3_, S2_, D2_, nir, nsym, psym, flops)
...
! S2(i,j,a,b) += (   -1.00000000) D2(j,a1,i,a0) W3(a0,a1,a,b) 
do s_j = 0, nir-1
do s_a1 = 0, nir-1
do s_i = 0, nir-1
do s_a0 = 0, nir-1
...
end subroutine g_sigma_oovv_ocov_no1_x1_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_oovv_ocov_no2_x0_type1_eri_v &
...
call g_sigma_oovv_ocov_no2_x0_type1_eri_v &
  (sa1, ia1, sb, ib, av2_i, h2_i, Xaav, nir, nsym, psym, flops)

deallocate(av2_i)
deallocate(h2_i)
deallocate(Xaav)

end subroutine g_if_sigma_oovv_ocov_no2_x0_type1_eri_v
...
!    -- allRDM.second false
!    -- precedence    -1
subroutine g_sigma_oovv_ocov_no2_x0_type1_eri_v &
...
integer :: s_c0, i_c0, s_a2, i_a2, s_a0, i_a0, s_a, i_a
! W4(a0,a2,a,b) += (    1.00000000) V2(b,a1,c0,a2) T2(c0,a0,a,a1) 
do s_c0 = 0, nir-1
do s_a2 = 0, nir-1
do s_a0 = 0, nir-1
do s_a = 0, nir-1
...
do i_a2 = psym(I_BEGIN, I_O, s_a2), psym(I_END, I_O, s_a2)
do i_a = psym(I_BEGIN, I_V, s_a), psym(I_END, I_V, s_a)
W4_(s_a, s_a2, s_a0)%array(i_a, i_a2, i_a0) = &
    W4_(s_a, s_a2, s_a0)%array(i_a, i_a2, i_a0) &
  + Z3_(i_a0, i_a, i_a2)
end do
end do
...
end subroutine g_sigma_oovv_ocov_no2_x0_type1_eri_v
...
!                                                                       
! **********************************************************************
subroutine g_if_sigma_oovv_ocov_no2_x1_type1_eri_v &
  (sb, ib, W4, S2, nir, nsym, psym, flops)
...
call set_symblock_Xaav(sleft, W4, nir, nsym, psym) ! -> Xaav (allocate) 
call set_symblock_av2_2(sb, S2, nir, nsym, psym) ! -> av2_i2 (allocate)
call g_sigma_oovv_ocov_no2_x1_type1_eri_v &
  (sb, ib, Xaav, av2_i2, d2, nir, nsym, psym, flops)

deallocate(av2_i2)
deallocate(Xaav)

end subroutine g_if_sigma_oovv_ocov_no2_x1_type1_eri_v
...
!    -- allRDM.second true
!    -- precedence    -1
subroutine g_sigma_oovv_ocov_no2_x1_type1_eri_v &
  (s_b, i_b, W4_, S2_, D2_, nir, nsym, psym, flops)
...
integer :: s_j, i_j, s_a0, i_a0, s_i, i_i, s_a2, i_a2, s_a, i_a
! S2(i,j,a,b) += (   -1.00000000) D2(j,a0,i,a2) W4(a0,a2,a,b) 
do s_j = 0, nir-1
do s_a0 = 0, nir-1
do s_i = 0, nir-1
do s_a2 = 0, nir-1
...
end subroutine g_sigma_oovv_ocov_no2_x1_type1_eri_v
